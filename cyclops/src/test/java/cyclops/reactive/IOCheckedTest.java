...
public class IOCheckedTest {
    ...
    @Test
    public void async() {
        assertThat(IO.fromPublisher(Future.of(() -> 10,
                                              ex))
                     .checkedMap(this::addOne)
                     .run()
                     .orElse(-1),
    ...
    public void asyncError() {
        MatcherAssert.assertThat(IO.fromPublisher(Future.of(() -> 10,
                                                            ex))
                                   .map(i -> {
                                       throw re;
                                   })
    ...
    public void shouldSucceedAfterFewAsynchronousRetries() throws Throwable {
        ...
        BDDMockito.given(serviceMock.apply(Matchers.anyInt()))
                  .willThrow(new RuntimeException(new SocketException("First")),
    ...
    @Test
    public void shouldRethrowOriginalExceptionFromUserFutureCompletion() throws Throwable {

        BDDMockito.given(serviceMock.apply(Matchers.anyInt()))
                  .willThrow(new RuntimeException("DONT PANIC"));
        ...
        assertThat(result,
                   equalTo("IO[Failure[java.lang.RuntimeException: DONT PANIC]]"));
