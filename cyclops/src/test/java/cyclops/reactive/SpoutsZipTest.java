...
public class SpoutsZipTest {
    ...
    public void zip2() {
        ...
        ReactiveSeq<Seq<Integer>> zipped = it1.zip(it2,
                                                   Seq::of);
    ...
    public void zip3() {
        ...
        ReactiveSeq<Seq<Integer>> zipped = it1.zip3(it2,
                                                    it3,
                                                    Seq::of);
    ...
    public void zip4() {
        ...
        ReactiveSeq<Seq<Integer>> zipped = it1.zip4(it2,
                                                    it3,
                                                    it4,
                                                    Seq::of);
    ...
    public void zip3Tuple() {
        ...
        ReactiveSeq<Tuple3<Integer, Integer, Integer>> zipped = it1.zip3(it2,
                                                                         it3);
    ...
    public void zip4Tuple() {
        ...
        ReactiveSeq<Tuple4<Integer, Integer, Integer, Integer>> zipped = it1.zip4(it2,
                                                                                  it3,
                                                                                  it4);
    ...
    public void emptyNonEmpty() {
        ...
        Spouts.<Integer>empty().zip(Spouts.of(1,
                                              2,
                                              3,
                                              4,
                                              5,
    ...
    public void emptyNonEmptyIncremental() {
        ...
        Subscription sub = Spouts.<Integer>empty().zip(Spouts.of(1,
                                                                 2,
                                                                 3,
                                                                 4,
                                                                 5,
    ...
    public void pairWise() {
        ...
        assertNull(error.get());
        assertThat(values.get(),
                   equalTo(Vector.of(Tuple.tuple(1,
                                                 "testtest2"))));
    }
    ...
    public void pushFlatMap() {
        ...
        ReactiveSeq<Integer> odds = Spouts.of(1,
                                              3,
                                              5,
                                              7,
                                              9);
        ReactiveSeq<Integer> even = Spouts.of(2,
                                              4,
                                              6);

        ReactiveSeq<Vector<Tuple2<Integer, Integer>>> zipped = odds.zip((t1, t2) -> Tuple.tuple(t1,
                                                                                                t2),
                                                                        even)
