...
public class TckWhiteBoxSubscriberTest extends SubscriberWhiteboxVerification<Long> {
    ...
    @Override
    public Subscriber<Long> createSubscriber(org.reactivestreams.tck.SubscriberWhiteboxVerification.WhiteboxSubscriberProbe<Long> probe) {

        return new QueueBasedSubscriber<Long>(new QueueBasedSubscriber.Counter(),
                                              500) {
            @Override
