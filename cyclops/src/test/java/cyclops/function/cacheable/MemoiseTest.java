...
public class MemoiseTest {
    ...
    public void testAsync() throws InterruptedException {
        ...
        Supplier<Integer> caching = Memoize.memoizeSupplierAsync(() -> value.incrementAndGet(),
                                                                 ex,
                                                                 100);
    ...
    public void testNullFunction() {
        Function<String, String> str = memoizeFunction(a -> {
            ++called;
            return "hello";
        });
        assertThat(str.apply(null),
                   equalTo("hello"));
        assertThat(str.apply(null),
                   equalTo("hello"));
        assertThat(str.apply(null),
    ...
    public void testNullPredicate() {
        Predicate<String> str = memoizePredicate(a -> {
            ++called;
            return true;
        });
        assertThat(str.test(null),
                   equalTo(true));
        assertThat(str.test(null),
                   equalTo(true));
        assertThat(str.test(null),
    ...
    public void testMemoiseFunction() {
        ...
        assertThat(s.apply(0),
                   equalTo(1));
        assertThat(s.apply(0),
                   equalTo(1));
        assertThat(s.apply(0),
                   equalTo(1));
        assertThat(s.apply(1),
                   equalTo(3));
        assertThat(s.apply(1),
                   equalTo(3));
    }
