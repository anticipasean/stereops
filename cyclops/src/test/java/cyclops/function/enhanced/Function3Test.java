...
public class Function3Test {
    ...
    @Test
    public void lift() {
        assertThat(some.lift3()
                       .apply(3,
                              3,
                              4),
                   equalTo(Option.some(10)));
        assertThat(none.lift3()
                       .apply(3,
                              3,
                              4),
                   equalTo(Option.none()));
    ...
    @Test
    public void liftEx() {
        assertThat(some.lift3(ForkJoinPool.commonPool())
                       .apply(3,
                              3,
                              4)
                       .orElse(-1),
                   equalTo(Future.ofResult(10)
                                 .orElse(-1)));
        assertThat(none.lift3(ForkJoinPool.commonPool())
                       .apply(3,
                              3,
                              4)
                       .orElse(-1),
    ...
    @Test
    public void liftTry() {
        assertThat(some.liftTry3()
                       .apply(3,
                              3,
                              4),
                   equalTo(Try.success(10)));
        assertThat(ex.liftTry3()
                     .apply(3,
                            3,
                            4)
                     .isFailure(),
                   equalTo(true));
        assertThat(none.liftTry3()
                       .apply(3,
                              3,
                              4)
                       .isFailure(),
    ...
    public void lazyLift() {
        assertThat(some.lazyLift3()
                       .apply(3,
                              3,
                              4),
                   equalTo(Maybe.just(10)));
        assertThat(none.lazyLift3()
                       .apply(3,
                              3,
                              4),
