...
public class PartialFunctionTest {
    ...
    public void asFunction() {
        ...
        assertThat(fn.apply("hello"),
                   equalTo(pf.apply("hello")));
        assertThat(fn.apply("bob"),
                   equalTo(pf.apply("bob")));
    }

    @Test
    public void map() {
        assertThat(pf.mapFn(i -> i + 1)
                     .apply("hello",
                            -1),
                   equalTo(11));
    }
    ...
    @Test
    public void flatMap() {
        assertThat(pf.flatMapFn(i -> in -> i + 1)
                     .apply("hello",
                            -1),
                   equalTo(11));
    }
