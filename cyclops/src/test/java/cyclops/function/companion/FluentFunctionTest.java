...
public class FluentFunctionTest {
    ...
    public Integer exceptionalLessThanZeroWithBiParams(Integer input1,
                                                       Integer input2) throws IOException {
        if (input1 + input2 < 0) {
            throw new IOException();
        }
    ...
    public Integer exceptionalLessThanZeroWithTriParams(Integer input1,
                                                        Integer input2,
                                                        Integer input3) throws IOException {
    ...
    public void fluentFunctionVisitEvent() {
        ...
        Integer i = FluentFunctions.ofChecked(this::exceptionalLessThanZero)
                                   .visitEvent(value -> future.complete(value),
    ...
    public void fluentBiFunctionVisitEvent() {
        CompletableFuture<Integer> future = new CompletableFuture<>();
        Integer i = FluentFunctions.ofChecked(this::exceptionalLessThanZeroWithBiParams)
                                   .visitEvent(value -> future.complete(value),
                                               error -> future.completeExceptionally(error))
                                   .apply(10,
                                          10);
    ...
    public void fluentTriFunctionVisitEvent() {
        CompletableFuture<Integer> future = new CompletableFuture<>();
        Integer i = FluentFunctions.ofChecked(this::exceptionalLessThanZeroWithTriParams)
                                   .visitEvent(value -> future.complete(value),
                                               error -> future.completeExceptionally(error))
                                   .apply(10,
                                          10,
    ...
    public void memoizeWithCache() throws InterruptedException {
        ...
        Function fn = FluentFunctions.of(addOne)
                                     .name("myFunction")
                                     .memoize((key, f) -> cache.get(key,
                                                                    () -> f.apply(key)));
