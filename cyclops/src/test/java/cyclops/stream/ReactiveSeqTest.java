...
import static cyclops.reactive.ReactiveSeq.mapDoubles;
import static cyclops.reactive.ReactiveSeq.mapInts;
import static cyclops.reactive.ReactiveSeq.mapLongs;
...
public class ReactiveSeqTest {
    ...
    public void testCycleWhileNoReplayable() {
        ...
        ReactiveSeq<Integer> ch = ReactiveSeq.of(1,
                                                 2,
                                                 3)
                                             .cycleWhile(next -> count++ < 6);

        assertThat(ch.toList(),
                   equalTo(asList(1,
                                  2,
                                  3,
                                  1,
    ...
    public void generateReplay() {
        ReactiveSeq<String> s = ReactiveSeq.generate(() -> "hello")
                                           .take(1);
        assertThat(s.toList()
                    .size(),
                   equalTo(1));
    ...
    public void cycleWhile() {
        of(1).toList();
        count = 0;
        List<Integer> b = ReactiveSeq.fromStream(Stream.of(1,
                                                           2,
                                                           3))
    ...
    public void recoverTest() {
        for (int i = 0; i < 100; i++) {
            ...
            txn.put("5000",
                    Lists.newArrayList("5001",
                                       "5002",
                                       "5003",
                                       "5004a"));
            txn.put("6000",
                    Lists.newArrayList("6001",
                                       "6002a",
                                       "6003",
                                       "6004"));
            txn.put("7000",
                    Lists.newArrayList("7001",
                                       "7002a",
                                       "7003",
                                       "7004"));
            txn.put("8000",
                    Lists.newArrayList("8001",
                                       "8002",
                                       "8003a",
                                       "8004"));
            ...
            assertThat(Arrays.asList(7001l,
                                     -1l,
                                     7003l,
                                     7004l,
                                     8001l,
    ...
    public void cycleUntil() {
        System.out.println("List " + Bag.of(1,
                                            2,
                                            3)
                                        .peek(System.out::println)
                                        .cycleUntil(next -> count++ == 6)
    ...
    public void multipathsInts() {
        ...
        ReactiveSeq<Integer> list = ReactiveSeq.ofInts(1,
                                                       2,
                                                       3);
        ...
        assertThat(by10.toList(),
                   equalTo(Arrays.asList(10,
                                         20,
                                         30)));
        assertThat(plus2.toList(),
                   equalTo(Arrays.asList(3,
                                         4,
                                         5)));
        assertThat(by10Plus2.toList(),
                   equalTo(Arrays.asList(12,
                                         22,
                                         32)));
    }
    ...
    public void multipathsLongs() {
        ...
        ReactiveSeq<Long> list = ReactiveSeq.ofLongs(1,
                                                     2,
                                                     3);
    ...
    public void multipathsDoubles() {
        ...
        ReactiveSeq<Double> list = ReactiveSeq.ofDoubles(1,
                                                         2,
                                                         3);
        ...
        assertThat(by10.toList(),
                   equalTo(Arrays.asList(10d,
                                         20d,
                                         30d)));
        assertThat(plus2.toList(),
                   equalTo(Arrays.asList(3d,
                                         4d,
                                         5d)));
        assertThat(by10Plus2.toList(),
                   equalTo(Arrays.asList(12d,
                                         22d,
                                         32d)));
    }
    ...
    public void replayable() {
        ...
        Stream<Integer> stream = ReactiveSeq.range(0,
                                                   1000)
                                            .map(i -> i * 2);
    ...
    public void compareConcat() {
        List<Integer> oneThousand = Stream.iterate(1,
                                                   i -> i + 1)
                                          .limit(1000)
        ...
        for (int x = 0; x < 10; x++) {
            ...
            total += Stream.concat(oneThousand.stream(),
                                   oneThousand.stream())
                           .count();
        ...
        for (int k = 0; k < 5000; k++) {
            count += Stream.concat(oneThousand.stream(),
                                   oneThousand.stream())
                           .count();
        }
        long stream = System.currentTimeMillis() - time;
        for (int x = 0; x < 10; x++) {
            ...
            total += ReactiveSeq.concat(oneThousand.stream(),
                                        oneThousand.stream())
                                .count();
        ...
        long time2 = System.currentTimeMillis();
        for (int k = 0; k < 5000; k++) {
            count += ReactiveSeq.concat(oneThousand.stream(),
                                        oneThousand.stream())
                                .count();
        }
        long rs = System.currentTimeMillis() - time2;
    ...
    public void compareFlatMap() {
        for (int k = 0; k < 10; k++) {
            count += Stream.generate(() -> 1)
                           .limit(100)
                           .flatMap(i -> Stream.iterate(1,
                                                        x -> x + i)
                                               .limit(500))
                           .count();
        }
    ...
    public void compareMap() {
        ...
        ReactiveSeq<Integer> s = ReactiveSeq.generate(() -> 1)
                                            .limit(1_0000)
                                            .map(i -> i * 2)
                                            .map(i -> i * 10)
                                            .map(i -> i * 100);
    ...
    public void mapFuseTest() {
        ...
        for (int x = 0; x < 10; x++) {
            ...
            total += Stream.concat(IntStream.range(0,
                                                   1000)
                                            .boxed(),
        ...
        ReactiveSeq<Integer> stream = ReactiveSeq.iterate(1,
                                                          i -> i + 1)
                                                 .limit(10000)
                                                 .map(i -> i * 100)
                                                 .map(i -> i * 2)
    ...
    public void filterFuseTest() {
        ...
        for (int x = 0; x < 1000; x++) {
            ...
            total += ReactiveSeq.generate(() -> 1000)
                                .limit(1_0000)
                                .map(i -> i + 1)
                                .filter(i -> i > 5)
                                .filter(i -> i > 6)
        ...
        time = System.currentTimeMillis();
        ;
        ReactiveSeq<Integer> stream = ReactiveSeq.generate(() -> 1000)
                                                 .limit(1_0000)
                                                 .map(i -> i + 1)
                                                 .filter(i -> i > 5)
                                                 .filter(i -> i > 6)
        ...
        for (int x = 0; x < 5000; x++) {
            ...
            total += stream.collect(Collectors.toList())
                           .size();
        ...
        time = System.currentTimeMillis();
        ;
        ReactiveSeq<Integer> stream2 = ReactiveSeq.generate(() -> 1000)
                                                  .limit(1_0000)
                                                  .map(i -> i + 1)
                                                  .filter(i -> i > 5)
                                                  .filter(i -> i > 6)
        ...
        for (int x = 0; x < 5000; x++) {
            ...
            total += stream2.collect(() -> new ArrayList(),
                                     List::add,
                                     (l1, l2) -> l1.addAll(l2))
                            .size();
    ...
    public void coflatMapTest() {
        ReactiveSeq<ReactiveSeq<Integer>> stream = ReactiveSeq.fromIterable(Arrays.asList(1,
                                                                                          2,
                                                                                          3))
                                                              .coflatMap(s -> s);

        ReactiveSeq<Integer> stream2 = stream.flatMap(s -> s)
                                             .map(i -> i * 10);
        ReactiveSeq<Integer> stream3 = stream.flatMap(s -> s)
                                             .map(i -> i * 100);

        assertThat(stream2.toList(),
                   equalTo(Arrays.asList(10,
                                         20,
                                         30)));
        assertThat(stream3.toList(),
    ...
    public void arrayConcat() {
        assertThat(ReactiveSeq.concat(of(1,
                                         2,
                                         3),
                                      of(100,
                                         200,
    ...
    public void testReverseList() {
        ...
        assertThat(ReactiveSeq.fromList(Arrays.asList(10,
                                                      400,
                                                      2,
                                                      -1))
                              .reverse()
    ...
    public void testReverseRange() {
        ...
        assertThat(ReactiveSeq.range(0,
                                     10)
                              .reverse()
                              .toList(),
                   equalTo(asList(9,
    ...
    public void rangeLongMultiReverse() {
        assertThat(ReactiveSeq.rangeLong(0,
                                         5)
                              .reverse()
                              .reverse()
                              .count(),
    ...
    public void rangeLong() {
        ReactiveSeq.rangeLong(0,
                              5)
                   .reverse()
                   .reverse()
                   .reverse()
                   .printOut();
        of('a').zipWithStream(ReactiveSeq.rangeLong(0,
                                                    100))
               .printOut();
    }
    ...
    public void fillReplay() {
        ...
        ReactiveSeq<Integer> seq1 = seq.take(100)
                                       .map(i -> i * 2);
    ...
    public void testReplay() {
        ...
        ReactiveSeq<Integer> streama = ReactiveSeq.range(1,
                                                         100);
        ReactiveSeq<Integer> streamb = streama.map(i -> i * 2);

        System.out.println(streama.count());
        System.out.println(streama.map(i -> i * 3)
                                  .zipWithIndex()
                                  .count());
        System.out.println(streamb.zipWithIndex()
                                  .count());
    }
    ...
    public void replayStream() {
        ...
        ReactiveSeq.fromSpliterator(sp)
                   .forEach(System.out::println);
    ...
    /**
     * @Test @Ignore public void limitPushTest(){ ReactiveSubscriber<String> pushable = ReactiveSeq.pushable();
     * ReactiveSeq<String> stream = pushable.stream(); ReactiveSeq<List<String>> res = stream.map(i->i+"-hello").limit(2)
     * .collectSeq(CyclopsCollectors.toList()); pushable.onNext("hello1"); pushable.onNext("hello2"); pushable.onNext("hello3");
     * <p>
     * <p>
     * //LimitSpliterator only supports iteration assertThat(res.single().size(),equalTo(3)); }
     **/
    ...
    public void zip() {
        ...
        assertThat(stream.zipWithStream(Stream.of(1,
                                                  2))
                         .toList()
                         .size(),
                   equalTo(1));
    ...
    public void push() {
        ...
        pushable.onNext("hello");
        pushable.onComplete();
        assertThat(list.orElse(new ArrayList<>())
                       .size(),
                   equalTo(1));
    ...
    @Test
    public void foldInt() {
        Double res = ReactiveSeq.range(1,
                                       1000)
                                .mapToInt(i -> i)
                                .map(i -> i * 2)
                                .filter(i -> i < 500)
    ...
    @Test
    public void intOps() {
        assertThat(ReactiveSeq.range(1,
                                     1000)
                              .ints(i -> i,
                                    s -> s.map(i -> i * 2)
                                          .filter(i -> i < 500))
    ...
    @Test
    public void longs() {
        assertThat(ReactiveSeq.rangeLong(1,
                                         1000)
                              .longs(i -> i,
                                     s -> s.map(i -> i * 2)
                                           .filter(i -> i < 500))
    ...
    public void ofTestObj() {
        assertThat(of("a").singleOrElse(null),
                   equalTo("a"));
    }
    ...
    public void test2() {
        of(1,
           ...
           3).filter(anyOf(not(in(2,
                                  3,
                                  4)),
                           Predicates.<Integer>greaterThan(10)));
    }
    ...
    public void test3() {
        of(Arrays.asList(1,
           ...
           Arrays.asList(3,
                         4,
                         5)).filter(hasItems(Arrays.asList(2,
                                                           3)));
    }
    ...
    public void test4() {
        of(Arrays.asList(1,
           ...
           Arrays.asList(3,
                         4,
                         5)).filter(not(hasItems(Arrays.asList(2,
                                                               3))));
    }
    ...
    public void test() {
        ...
        Predicate<? super Integer> inOne = in(2.4,
                                              3,
                                              4);
        Predicate<? super Integer> inTwo = in(1,
                                              10,
                                              20);
        of(1,
           2,
           3).filter(anyOf(not(inOne),
                           inTwo));
        of(1,
           2,
           3).filter(anyOf(not(in(2.4,
                                  3,
                                  4)),
                           in(1,
                              10,
