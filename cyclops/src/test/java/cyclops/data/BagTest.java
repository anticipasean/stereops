...
public class BagTest extends BaseImmutableSetTest {
    ...
    public void testBag() {
        Bag<Integer> bag1 = Bag.of(1,
                                   ...
                                   1,
                                   2);
        Bag<Integer> bag2 = Bag.fromStream(Stream.of(1,
                                                     2,
                                                     3,
                                                     4,
                                                     10,
    ...
    public IterableX<Integer> range(int start,
                                    int end) {
        return Bag.fromStream(ReactiveSeq.range(start,
                                                end));
    }
    ...
    public IterableX<Long> rangeLong(long start,
                                     long end) {
        return Bag.fromStream(ReactiveSeq.rangeLong(start,
                                                    end));
    }
    ...
    public <T> IterableX<T> iterate(int times,
                                    T seed,
                                    UnaryOperator<T> fn) {
        return Bag.fromStream(ReactiveSeq.iterate(seed,
                                                  fn)
                                         .take(times));
    }
    ...
    public <T> IterableX<T> generate(int times,
                                     Supplier<T> fn) {
        return Bag.fromStream(ReactiveSeq.generate(fn)
                                         .take(times));
    }
    ...
    public <U, T> IterableX<T> unfold(U seed,
        ...
        return Bag.fromStream(ReactiveSeq.unfold(seed,
                                                 unfolder));
    }
