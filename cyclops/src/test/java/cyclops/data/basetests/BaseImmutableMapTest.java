...
public abstract class BaseImmutableMapTest {
    ...
    protected abstract <K, V> ImmutableMap<K, V> of(K k1,
                                                    V v1);
    ...
    public void collisions() {
        ...
        for (int i = 0; i <= size; i++) {
            map1 = map1.put(new Collider(i,
                                         i % 10),
                            i);
            map2 = map2.put(new Collider(size - i,
                                         (size - i) % 10),
                            size - i);
        }
        assertEquals(map1,
    ...
    public void equalsTest() {
        ...
        assertThat(empty(),
                   equalTo(cyclops.data.HashMap.empty()));
        assertThat(this.<Integer, Integer>empty(),
                   equalTo(cyclops.data.TreeMap.empty(Comparator.<Integer>naturalOrder())));
        assertThat(this.<Integer, Integer>of(1,
                                             2),
                   equalTo(cyclops.data.TreeMap.of(Comparator.<Integer>naturalOrder(),
                                                   1,
                                                   2)));
        assertThat(this.<Integer, Integer>of(1,
                                             2),
                   equalTo(cyclops.data.HashMap.of(1,
                                                   2)));
        assertThat(this.<Integer, Integer>of(1,
                                             2,
                                             3,
    ...
    @Test
    public void lookup() {
        assertThat(empty().put(1,
                               2)
                          .get(1),
                   equalTo(Option.some(2)));
        assertThat(empty().put(1,
                               2)
                          .get(2),
                   equalTo(Option.none()));
    ...
    public void removeAllKeys() {
        ImmutableMap<Integer, Integer> test = this.<Integer, Integer>empty().put(1,
                                                                                 10)
                                                                            .put(2,
                                                                                 20)
                                                                            .put(3,
                                                                                 20);
        assertThat(test.removeAllKeys(Vector.of(1,
                                                2)),
                   equalTo(of(3,
                              20)));
        assertThat(test.removeAllKeys(Vector.of()),
                   equalTo(test));
        assertThat(test.removeAllKeys(Vector.of(100,
                                                200,
                                                300)),
                   equalTo(test));
    ...
    public void removeAll() {
        ImmutableMap<Integer, Integer> test = this.<Integer, Integer>empty().put(1,
                                                                            ...
                                                                            .put(3,
                                                                                 20);
        assertThat(test.removeAll(1,
                                  2),
                   equalTo(of(3,
                              20)));
        assertThat(test.removeAll(),
                   equalTo(test));
        assertThat(test.removeAll(100,
                                  200,
                                  300),
                   equalTo(test));
    ...
    @Test
    public void toSeq() {
        ImmutableMap<String, Integer> maps = of("a",
                                                1,
                                                "b",
                                                2);
    ...
    @Test
    public void onEmpty() {
        assertThat(empty().onEmpty(Tuple.tuple("hello",
                                               10))
                          .get("hello"),
                   equalTo(Option.some(10)));
        assertThat(empty().put("world",
                               20)
                          .onEmpty(Tuple.tuple("hello",
                                               10))
                          .get("hello"),
                   equalTo(Option.none()));
    }
    ...
    public void onEmptyGet() {
        assertThat(empty().onEmptyGet(() -> Tuple.tuple("hello",
                                                        10))
                          .get("hello"),
                   equalTo(Option.some(10)));
        assertThat(empty().put("world",
                               20)
                          .onEmptyGet(() -> Tuple.tuple("hello",
                                                        10))
                          .get("hello"),
                   equalTo(Option.none()));
    }
    ...
    public void onEmptySwitch() {
        ...
        m.put("hello",
              10);
        assertThat(this.<String, Integer>empty().onEmptySwitch(() -> fromMap(m))
                                                .get("hello"),
                   equalTo(Option.some(10)));
    }
    ...
    @Test
    public void testOf() {
        assertThat(this.empty()
                       .javaMap(),
                   equalTo(new java.util.HashMap()));
    }
    ...
    public void testMapKVPutAll() {
        ...
        map2.put("6",
                 6);
        assertThat(of("1",
                      1).putAll(cyclops.data.HashMap.fromMap(map2))
                        .javaMap(),
                   equalTo(map));
    }
    ...
    public void bipeek() {
        ...
        ImmutableMap<Integer, Integer> map2 = map.bipeek(k -> key.updateAndGet(v -> v.append(k)),
                                                         v -> value.updateAndGet(vec -> vec.append(v)));

        assertThat(map2.keys()
                       .toHashSet(),
                   equalTo(keys));
    ...
    public void map() {
        ...
        ImmutableMap<Integer, Integer> map2 = map.bimap(k -> k * 2,
                                                        v -> v * 10);

        assertThat(map2.stream()
                       .map(t -> t._1())
                       .sumInt(i -> i),
                   equalTo(map.stream()
                              .map(t -> t._1())
    ...
    public void flatMap() {
        ...
        ImmutableMap<Integer, Integer> map2 = map.flatMap((k, v) -> of(k * 2,
                                                                       v * 10));
        assertThat(map2.stream()
                       .map(t -> t._1())
                       .sumInt(i -> i),
    ...
    public void viewTest() {
        Map<Integer, String> map = of(1,
                                      "hello",
                                      2,
                                      "world").mapView();
        Map<Integer, String> hashMap = of(1,
                                          "hello",
                                          2,
                                          "world").mapView();
        assertThat(map.size(),
    ...
    public void removeObjectViewTest() {
        ...
        assertThat(map.remove((Object) 1),
                   equalTo("hello"));
