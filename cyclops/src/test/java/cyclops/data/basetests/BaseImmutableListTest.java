...
public abstract class BaseImmutableListTest extends AbstractIterableXTest {
    ...
    public void visit() {
        ...
        String res = of(1,
                        2,
                        3).fold((x, xs) -> xs.join(x > 2 ? "hello" : "world"),
                                () -> "boo!");
    ...
    public void testFoldLeftA() {
        ...
        assertThat(fromStream(ReactiveSeq.range(0,
                                                100_000)).foldLeft(Monoids.intSum),
                   equalTo(704982704));
    ...
    public void replaceFirstTest() {
        ...
        assertThat(of(1,
                   ...
                   equalTo(of(1,
                              ...
                              2,
                              3)));
        assertThat(empty().replaceFirst(2,
                                        3),
                   equalTo(of()));
    }
