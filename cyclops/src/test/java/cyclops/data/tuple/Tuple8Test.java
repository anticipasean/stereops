...
public class Tuple8Test {
    ...
    public void _7() throws Exception {
        ...
        assertThat(tuple._7(),
                   equalTo(10));
        assertThat(tuple.map7(i -> i + 8)
                        ._7(),
                   equalTo(18));
        assertThat(tuple.lazyMap7(i -> i + 8)
                        ._7(),
                   equalTo(18));
    }
    ...
    public void _8() throws Exception {
        ...
        assertThat(tuple._8(),
                   equalTo(10));
        assertThat(tuple.map8(i -> i + 5)
                        ._8(),
                   equalTo(15));
        assertThat(tuple.lazyMap8(i -> i + 5)
                        ._8(),
                   equalTo(15));
    }
    ...
    public void visit() throws Exception {
        assertThat(tuple.fold((a, b, c, d, e, f, g, h) -> a + b + c + d + e + f + g + h),
                   equalTo(67));
    }
    ...
    public void testToString() throws Exception {
        assertThat(tuple.toString(),
                   equalTo("[2,5,10,10,10,10,10,10]"));
    }


    @Test
    public void transform() {
        assertThat(lazyT1.transform((a, b, c, d, e, f, g, h) -> a + b + c + d + e + f + g + h),
                   equalTo("hello12348105"));
    }
