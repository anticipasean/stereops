...
import static cyclops.container.persistent.impl.Chain.singleton;
...
public class ChainTest {
    ...
    public void large() {
        fromStream(ReactiveSeq.range(0,
                                     100_000)).forEach(System.out::println);
    ...
    public void single() {
        ...
        assertThat(ten.isEmpty(),
                   equalTo(false));
        assertThat(ten.toString(),
                   equalTo("[10]"));
    }

    @Test
    public void append() {
        Chain<Integer> two = Chain.append(singleton(10),
                                          singleton(20));
        ...
        assertThat(two.isEmpty(),
                   equalTo(false));
        assertThat(two.toString(),
                   equalTo("[10, 20]"));
    }

    @Test
    public void wrap() {
        Chain<Integer> three = Chain.wrap(LazySeq.of(10,
                                                     20,
                                                     30));
        assertThat(three,
                   equalTo(Seq.of(10,
                                  20,
                                  30)));
        assertThat(three.size(),
                   equalTo(3));
        assertThat(three.isEmpty(),
                   equalTo(false));
        assertThat(three.toString(),
                   equalTo("[10, 20, 30]"));
    }
