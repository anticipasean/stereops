...
import cyclops.container.persistent.impl.base.HAMT.BitsetNode;
import cyclops.container.persistent.impl.base.HAMT.Node;
...
public class HAMTTest {
    ...
    public void put1() throws Exception {
        Node<Integer, Integer> node = HAMT.<Integer, Integer>empty().plus(0,
                                                                          one.hashCode(),
                                                                          one,
                                                                          one);
    ...
    public void minusCollision() {
        ...
        Node<Integer, Integer> node2 = node.plus(0,
                                                 10,
                                                 100,
                                                 80)
                                           .plus(0,
        ...
        assertThat(node2.size(),
                   equalTo(2));
        System.out.println(node + " " + node.size());
        Node<Integer, Integer> node3 = node2.minus(0,
                                                   10,
                                                   110);
        assertThat(node3.size(),
                   equalTo(1));
        Node<Integer, Integer> node4 = node2.minus(0,
                                                   10,
                                                   100);
        assertThat(node4.size(),
                   equalTo(1));
        Node<Integer, Integer> node5 = node2.minus(0,
                                                   10,
                                                   8000);
        assertThat(node5.size(),
                   equalTo(2));
    }
    ...
    public void orderCompare() {
        HAMT.Node<String, String> a = HAMT.<String, String>empty().put("hello",
                                                                       "world")
                                                                  .put("world",
                                                                       "hello");
        HAMT.Node<String, String> b = HAMT.<String, String>empty().put("world",
                                                                       "hello")
                                                                  .put("hello",
                                                                       "world");
    ...
    public void bitSetShouldCallSupplierOnlyIfKeyIsNotPresent() {
        ...
        String val = node.getOrElseGet(0,
                                       0,
                                       0,
                                       supplier);
        assertEquals("-100",
