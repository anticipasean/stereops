...
public class Tuple4Test {
    ...
    public void eager() throws Exception {
        assertThat(Tuple.lazy(() -> "w1",
                              () -> "new",
                              () -> "boo!",
                              () -> "hello")
                        .eager(),
                   equalTo(Tuple.tuple("w1",
                                       "new",
                                       "boo!",
                                       "hello")));
    }
    ...
    public void flatMap() throws Exception {
        assertThat(tuple.flatMap(Monoids.intSum,
                                 Monoids.intSum,
                                 Monoids.intSum,
                                 i -> Tuple.tuple(5,
                                                  2,
    ...
    public void visit() throws Exception {
        assertThat(tuple.fold((a, b, c, d) -> a + b + c + d),
                   equalTo(27));
    }
    ...
    public void transform() {
        assertThat(lazy.transform((a, b, c, d) -> a + b + c + d),
                   equalTo("lazy1050"));
    }
