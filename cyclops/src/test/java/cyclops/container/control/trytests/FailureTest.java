...
public class FailureTest {
    ...
    @Test
    public void testMap() {
        assertThat(failure.map(x -> x + 1),
                   equalTo(failure));
    }

    @Test
    public void testFlatMap() {
        assertThat(failure.flatMap(x -> Try.success(10)),
                   equalTo(failure));
    }

    @Test
    public void testFilter() {
        assertThat(failure.filter(x -> x == 10),
                   equalTo(Maybe.nothing()));
    }

    @Test
    public void testRecoverWithFor() {
        assertThat(failure.recoverFlatMapFor(FileNotFoundException.class,
                                             e -> Try.success(10)),
    ...
    public void testRecoverWithForSubclass() {
        ...
        assertThat(failure.recoverFlatMapFor(FileSystemException.class,
                                             e -> Try.success(10)),
                   equalTo(Try.failure(error)));
        assertThat(failure.recoverFlatMapFor(FileNotFoundException.class,
                                             e -> Try.success(10)),
                   equalTo(Try.success(10)));
    ...
    public void testRecoverWithForIgnore() {
        assertThat(failure.recoverFlatMapFor((Class) RuntimeException.class,
                                             e -> Try.success(10)),
                   equalTo(failure));
    }
    ...
    public void testRecoverFor() {
        assertThat(failure.recoverFor(FileNotFoundException.class,
                                      e -> 10),
                   equalTo(Try.success(10)));
    }
    ...
    public void testRecoverForInherited() {
        Try<Integer, IOException> failure = Try.failure(error);
        assertThat(failure.recoverFor(FileSystemException.class,
                                      e -> 10),
                   equalTo(Try.failure(error)));
        assertThat(failure.recoverFor(FileNotFoundException.class,
                                      e -> 10),
    ...
    public void testRecoverForIgnore() {
        assertThat(failure.recoverFor((Class) RuntimeException.class,
                                      e -> 10),
                   equalTo(failure));
    }
    ...
    public void testRecover() {
        assertThat(failure.recover(e -> 10),
                   equalTo(Try.success(10)));
    }

    @Test
    public void testRecoverSupplier() {
        assertThat(failure.recover(() -> 10),
                   equalTo(Try.success(10)));
    }

    @Test
    public void testRecoverWith() {
        assertThat(failure.recoverFlatMap(e -> Try.success(10)),
                   equalTo(Try.success(10)));
    }

    @Test
    public void testOrElse() {
        assertThat(failure.orElse(10),
                   equalTo(10));
    }

    @Test
    public void testOrElseGet() {
        assertThat(failure.orElseGet(() -> 10),
                   equalTo(10));
    }

    @Test
    public void testToOptional() {
        assertThat(failure.toOptional(),
                   equalTo(Optional.empty()));
    }

    @Test
    public void testToStream() {
        assertThat(failure.stream()
    ...
    public void testOnFailConsumerOfX() {
        ...
        assertThat(error,
                   equalTo(errorCaptured));
    }

    @Test
    public void testOnFailClassOfQextendsXConsumerOfX() {
        errorCaptured = null;
        failure.onFail(FileNotFoundException.class,
                       e -> errorCaptured = e);
        assertThat(error,
                   equalTo(errorCaptured));
    }
    ...
    public void testOnFailClassOfQextendsXConsumerOfXIgnored() {
        errorCaptured = null;
        failure.onFail((Class) RuntimeException.class,
                       e -> errorCaptured = e);
        assertThat(errorCaptured,
                   is(nullValue()));
    }
    ...
    public void testToFailedOptional() {
        assertThat(failure.toFailedOption(),
                   equalTo(Option.of(error)));
    }

    @Test
    public void testToFailedStream() {
        assertThat(failure.toFailedStream()
                          .collect(Collectors.toList()),
                   equalTo(Stream.of(error)
                                 .collect(Collectors.toList())));
    }
