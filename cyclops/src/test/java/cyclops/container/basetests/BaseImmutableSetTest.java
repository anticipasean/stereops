...
public abstract class BaseImmutableSetTest extends AbstractIterableXTest {
    ...
    public void testMapA() {
        assertThat(of(1,
                      2,
                      3).map(i -> i * 2),
                   equalTo(HashSet.of(2,
                                      4,
                                      6)));
        assertThat(this.<Integer>empty().map(i -> i * 2),
                   equalTo(HashSet.empty()));
    }
    ...
    public void testFlatMapA() {
        assertThat(of(1,
                   ...
                   equalTo(HashSet.of(2,
                                      4,
                                      6)));
        assertThat(this.<Integer>empty().concatMap(i -> of(i * 2)),
                   equalTo(HashSet.empty()));
    }
    ...
    public void testSorted() {
        ...
        assertTrue(s1.contains(tuple(1,
                                     "replaceWith")));
        assertTrue(s1.contains(tuple(2,
                                     "two")));
    ...
    public void testFoldRightA() {
        assertThat(fromStream(ReactiveSeq.range(0,
                                                100_000)).foldRight(Monoids.intSum),
                   equalTo(704982704));
    }
    ...
    public void slidingNoOrd() {
        ...
        System.out.println(list);
        assertTrue(list.contains(Vector.of(1,
                                           2)));
    }
    ...
    public void permuations3() {
        System.out.println(of(1,
                              ...
                              3).permutations()
                                .map(s -> s.toList())
                                .toList());
        ImmutableSet<List<Integer>> x = of(1,
                                           2,
                                           3).permutations()
                                             .map(s -> s.toList());

        assertTrue(x.containsValue(Arrays.asList(1,
                                                 2,
                                                 3)));
        assertTrue(x.containsValue(Arrays.asList(3,
                                                 2,
                                                 1)));
        assertTrue(x.containsValue(Arrays.asList(2,
                                                 1,
                                                 3)));
        assertTrue(x.containsValue(Arrays.asList(2,
                                                 3,
    ...
    public void batchWhileCollection() {
        assertThat(of(1,
                      ...
                      6).groupedWhile(i -> i % 3 != 0,
                        ...
                        .size(),
                   equalTo(2));
        ImmutableSet<Vector<Integer>> x = of(1,
                                             2,
                                             3,
                                             4,
                                             5,
        ...
        assertTrue(x.containsValue(Vector.of(1,
                                             2,
                                             3)));
        assertTrue(x.containsValue(Vector.of(4,
                                             5,
                                             6)));
    ...
    public void onEmptyThrow() {
        ...
        assertTrue(empty().onEmptyTry(() -> new RuntimeException("hello"))
                          .isFailure());
        assertFalse(of(1,
                       2).onEmptyTry(() -> new RuntimeException("hello"))
                         .isFailure());
    }

    @Test
    public void viewTest() {
        Set<Integer> list = of(1,
                               2,
                               3).setView();
        assertThat(list.size(),
                   equalTo(3));
        assertThat(list,
                   equalTo(new java.util.HashSet<>(Arrays.asList(1,
                                                                 2,
                                                                 3))));

        assertThat(list.contains(2),
                   equalTo(true));
        assertThat(list.containsAll(Arrays.asList(2,
                                                  3)),
                   equalTo(true));
        assertThat(list.containsAll(Arrays.asList(2,
                                                  3,
    ...
    public void addAllView() {
        Set<Integer> list = of(1,
                               2,
                               3).setView();
        assertThat(list.addAll(Arrays.asList(1)),
                   equalTo(false));
        ...
        assertThat(list.remove(1),
                   equalTo(false));
        assertThat(list.remove((Object) 1),
                   equalTo(false));
        assertThat(list.removeAll(Arrays.asList(1)),
                   equalTo(false));
    }
    ...
    public void pushFlatMap() {
        ...
        System.out.println(x);
        assertThat(x,
                   containsInAnyOrder(Tuple.tuple(1,
                                                  2),
                                      Tuple.tuple(3,
                                                  4),
                                      Tuple.tuple(5,
    ...
    public void prependAppend3() {
        Assert.assertThat(of(1).prependStream(Stream.of(2))
                               .toList(),
                          hasItems(ReactiveSeq.fromIterable(asList(1))
