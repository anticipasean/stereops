...
public abstract class BaseImmutableSortedSetTest extends BaseImmutableSetTest {
    ...
    public void batchWhileCollection() {
        ...
        assertTrue(l.containsValue(Vector.of(1,
                                             2,
                                             3)));
        assertTrue(l.containsValue(Vector.of(4,
                                             5,
                                             6)));
    ...
    public void sortedSetViewTest() {
        SortedSet<Integer> list = of(1,
                                     2,
                                     3).sortedSetView();
        assertThat(list.size(),
                   equalTo(3));
        assertThat(list,
                   equalTo(new java.util.TreeSet<>(Arrays.asList(1,
                                                                 2,
                                                                 3))));
