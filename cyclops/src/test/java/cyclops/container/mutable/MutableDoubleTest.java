...
import cyclops.container.mutable.MutableDouble;
...
public class MutableDoubleTest {
    ...
    @Test
    public void testSet() {
        assertThat(new MutableDouble().set(1000)
                                      .getAsDouble(),
                   is(1000.0));
    }
    ...
    public void testClosedVar() {
        assertThat(new MutableDouble(10).getAsDouble(),
                   equalTo(10.0));
    }

    @Test
    public void testClosedVarEquals() {
        assertThat(new MutableDouble(10),
                   equalTo(new MutableDouble(10)));
    }

    @Test
    public void testClosedVarEqualsFalse() {
        assertThat(new MutableDouble(10),
                   not(equalTo(new MutableDouble(20))));
    }

    @Test
    public void testClosedVarHashCode() {
        assertThat(new MutableDouble(10).hashCode(),
                   equalTo(new MutableDouble(10).hashCode()));
    }

    @Test
    public void testClosedVarHashCodeFalse() {
        assertThat(new MutableDouble(10).hashCode(),
                   not(equalTo(new MutableDouble(20).hashCode())));
    }

    @Test
    public void externalSet() {
        value = 0;
        MutableDouble ext = MutableDouble.fromExternal(() -> value,
                                                       v -> this.value = v);
        ext.set(10l);
        assertThat(value,
                   equalTo(10d));
    ...
    public void externalMapInputObj() {
        value = 0;
        Mutable<Double> ext = MutableDouble.fromExternal(() -> value,
                                                         v -> this.value = v)
