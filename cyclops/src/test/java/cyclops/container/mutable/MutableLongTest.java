...
import cyclops.container.mutable.MutableLong;
...
public class MutableLongTest {
    ...
    @Test
    public void testSet() {
        assertThat(new MutableLong().set(1000)
                                    .getAsLong(),
                   is(1000l));
    }
    ...
    public void testClosedVar() {
        assertThat(new MutableLong(10).getAsLong(),
                   equalTo(10l));
    }

    @Test
    public void testClosedVarEquals() {
        assertThat(new MutableLong(10),
                   equalTo(new MutableLong(10)));
    }

    @Test
    public void testClosedVarEqualsFalse() {
        assertThat(new MutableLong(10),
                   not(equalTo(new MutableLong(20))));
    }

    @Test
    public void testClosedVarHashCode() {
        assertThat(new MutableLong(10).hashCode(),
                   equalTo(new MutableLong(10).hashCode()));
    }

    @Test
    public void testClosedVarHashCodeFalse() {
        assertThat(new MutableLong(10).hashCode(),
                   not(equalTo(new MutableLong(20).hashCode())));
    }

    @Test
    public void externalSet() {
        value = 0;
        MutableLong ext = MutableLong.fromExternal(() -> value,
                                                   v -> this.value = v);
        ext.set(10l);
        assertThat(value,
                   equalTo(10l));
    ...
    public void externalMapInputObj() {
        value = 0;
        Mutable<Long> ext = MutableLong.fromExternal(() -> value,
                                                     v -> this.value = v)
