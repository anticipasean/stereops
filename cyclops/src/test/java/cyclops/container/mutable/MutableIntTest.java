...
import cyclops.container.mutable.MutableInt;
...
public class MutableIntTest {
    ...
    @Test
    public void testSet() {
        assertThat(new MutableInt().set(1000)
                                   .getAsInt(),
                   is(1000));
    }
    ...
    public void testClosedVar() {
        assertThat(new MutableInt(10).getAsInt(),
                   equalTo(10));
    }

    @Test
    public void testClosedVarEquals() {
        assertThat(new MutableInt(10),
                   equalTo(new MutableInt(10)));
    }

    @Test
    public void testClosedVarEqualsFalse() {
        assertThat(new MutableInt(10),
                   not(equalTo(new MutableInt(20))));
    }

    @Test
    public void testClosedVarHashCode() {
        assertThat(new MutableInt(10).hashCode(),
                   equalTo(new MutableInt(10).hashCode()));
    }

    @Test
    public void testClosedVarHashCodeFalse() {
        assertThat(new MutableInt(10).hashCode(),
                   not(equalTo(new MutableInt(20).hashCode())));
    }

    @Test
    public void externalSet() {
        value = 0;
        MutableInt ext = MutableInt.fromExternal(() -> value,
                                                 v -> this.value = v);
        ext.set(10);
        assertThat(value,
                   equalTo(10));
    ...
    public void externalMapInputObj() {
        value = 0;
        Mutable<Integer> ext = MutableInt.fromExternal(() -> value,
                                                       v -> this.value = v)
