...
public class MutableTest {
    ...
    @Test
    public void testSet() {
        assertThat(new Mutable().set("hello")
                                .get(),
                   is("hello"));
    }
    ...
    public void testClosedVar() {
        assertThat(new Mutable(10).get(),
                   equalTo(10));
    }

    @Test
    public void testClosedVarEquals() {
        assertThat(new Mutable(10),
                   equalTo(new Mutable(10)));
    }

    @Test
    public void testClosedVarEqualsFalse() {
        assertThat(new Mutable(10),
                   not(equalTo(new Mutable(20))));
    }

    @Test
    public void testClosedVarHashCode() {
        assertThat(new Mutable(10).hashCode(),
                   equalTo(new Mutable(10).hashCode()));
    }

    @Test
    public void testClosedVarHashCodeFalse() {
        assertThat(new Mutable(10).hashCode(),
                   not(equalTo(new Mutable(20).hashCode())));
    }

    @Test
    public void toIterator() {
        assertThat(Mutable.of(10)
                          .iterator()
                          .next(),
                   equalTo(10));
    }
    ...
    public void externalSet() {
        value = "";
        Mutable<String> ext = Mutable.fromExternal(() -> value,
                                                   v -> this.value = v);
        ext.set("hello");
        assertThat(value,
                   equalTo("hello"));
