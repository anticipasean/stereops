...
public class Tuple2Test {
    ...
    public void map() throws Exception {
        assertThat(t2.bimap(i -> i + 1,
                            i -> i + 1),
                   equalTo(Tuple.tuple(6,
                                       11)));
    }
    ...
    public void eager() throws Exception {
        assertThat(Tuple.lazy(() -> "boo!",
                              () -> "hello")
                        .eager(),
                   equalTo(Tuple.tuple("boo!",
                                       "hello")));
    }
    ...
    public void flatMap() throws Exception {
        assertThat(t2.flatMap(Monoids.intSum,
                              i -> Tuple.tuple(5,
                                               i + 1)),
