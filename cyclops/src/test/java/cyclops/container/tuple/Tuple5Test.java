...
public class Tuple5Test {
    ...
    Tuple5<String, Integer, Integer, Integer, Integer> lazyT1;
    int called;
    ...
    public void eager() throws Exception {
        assertThat(Tuple.lazy(() -> "x1",
                              () -> "w1",
                              () -> "new",
                              () -> "boo!",
                              () -> "hello")
                        .eager(),
                   equalTo(Tuple.tuple("x1",
                                       "w1",
                                       "new",
                                       "boo!",
                                       "hello")));
    ...
    public void visit() throws Exception {
        assertThat(tuple.fold((a, b, c, d, e) -> a + b + c + d + e),
                   equalTo(37));
    }
    ...
    public void testToString() throws Exception {
        assertThat(tuple.toString(),
                   equalTo("[2,5,10,10,10]"));
    }


    @Test
    public void transform() {
        assertThat(lazyT1.transform((a, b, c, d, e) -> a + b + c + d + e),
                   equalTo("hello1234"));
    }
