...
public class BaseSequenceTest {
    ...
    public void testScanRightStringConcatMonoid() {
        assertThat(of("a",
                      "b",
                      "c").scanRight(Monoid.fromBiFunction("",
                                                           String::concat))
                          .toList()
                          .size(),
                   is(asList("",
    ...
    public void testReverseListLimitOneShot() {
        ...
        assertThat(ReactiveSeq.oneShotList(Arrays.asList(10,
                                                         400,
                                                         2,
                                                         -1))
                              .limit(2)
    ...
    public void testDuplicateLimit() {
        Tuple2<ReactiveSeq<Integer>, ReactiveSeq<Integer>> copies = of(1,
                                                                       ...
                                                                       5,
                                                                       6).duplicate();
        System.out.println(copies._1()
                                 .limit(3)
                                 .toList());
        System.out.println(copies._2()
                                 .limit(3)
                                 .toList());
        assertTrue(copies._1()
                         .limit(3)
    ...
    public void takeWhile() {
        assertThat(ReactiveSeq.of(1,
                   ...
                   equalTo(Arrays.asList(1,
                                         2)));
        assertThat(ReactiveSeq.<Integer>of().takeWhile(i -> i < 3)
                                            .toList(),
    ...
    public void takeWhileInclusive() {
        ...
        assertThat(ReactiveSeq.of(1,
                   ...
                   equalTo(Arrays.asList(1,
                                         2,
                                         3)));
        assertThat(ReactiveSeq.<Integer>of().takeWhileInclusive(i -> i < 3)
                                            .toList(),
                   equalTo(Arrays.asList()));
        assertThat(ReactiveSeq.range(1,
                                     1_000_000)
