...
public class ReactiveRangeTest {
    ...
    public void reversedRangeLong() {
        assertThat(Spouts.rangeLong(10,
                                    -10)
                         .count(),
                   equalTo(20L));
    }
    ...
    public void longStreamCompareReversed() {
        assertThat(Spouts.rangeLong(-5,
                                    6)
                         .toList(),
                   equalTo(ReactiveSeq.of(-5,
                                          -4,
                                          -3,
                                          -2,
                                          -1,
    ...
    public void negativeLong() {
        assertThat(Spouts.rangeLong(-1000L,
                                    Long.MAX_VALUE)
                         .limit(100)
                         .count(),
                   equalTo(100L));
