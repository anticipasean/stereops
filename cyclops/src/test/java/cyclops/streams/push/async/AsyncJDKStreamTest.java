...
public class AsyncJDKStreamTest {
    ...
    public void fluxConcatMap() {
        System.out.println(Flux.just(1,
                                     2,
                                     3)
                               .concatMap(i -> Flux.just(i + 100,
                                                         200))
    ...
    public void flatMapFlux() {
        System.out.println(this.flux(1,
                                     2,
                                     3,
                                     4,
                                     5,
    ...
    public void testFlatMap() {
        assertThat(of(asList("1",
                             "10"),
                      asList("2"),
                      asList("3"),
                      asList("4")).flatMapStream(list -> list.stream())
                                  .collect(Collectors.toList()),
                   hasItem("10"));
    }
    ...
    public void testFlatMap2() {
        ...
        System.out.println(of(asList("1",
                                     "10"),
                              asList("2"),
                              asList("3"),
                              asList("4")).flatMap(list -> list.stream())
                                          .collect(Collectors.toList()));
    ...
    public void testMapToInt() {
        assertThat(of("1",
                      "2",
                      "3",
                      "4").mapToInt(it -> Integer.valueOf(it))
                          .max()
                          .getAsInt(),
                   equalTo(4));
    ...
    public void mapToLong() {
        assertThat(of("1",
                      "2",
                      "3",
                      "4").mapToLong(it -> Long.valueOf(it))
                          .max()
                          .getAsLong(),
                   equalTo(4l));
    }
    ...
    public void mapToDouble() {
        assertThat(of("1",
                      "2",
                      "3",
                      "4").mapToDouble(it -> Double.valueOf(it))
                          .max()
                          .getAsDouble(),
                   equalTo(4d));
    }
    ...
    public void flatMapToInt() {
        assertThat(of(asList("1",
                      ...
                      asList("2"),
                      asList("3"),
                      asList("4")).flatMapToInt(list -> list.stream()
    ...
    public void flatMapToLong() {
        assertThat(of(asList("1",
                      ...
                      asList("2"),
                      asList("3"),
                      asList("4")).flatMapToLong(list -> list.stream()
    ...
    public void flatMapToDouble() {
        ...
        assertThat(of(asList("1",
                      ...
                      asList("2"),
                      asList("3"),
                      asList("4")).flatMapToDouble(list -> list.stream()
    ...
    public void forEachOrderedx() {
        ...
        of(1,
           ...
           3,
           4,
           2).forEachOrdered(it -> list.add(it));
        assertThat(list,
                   hasItem(1));
        assertThat(list,
                   hasItem(2));
