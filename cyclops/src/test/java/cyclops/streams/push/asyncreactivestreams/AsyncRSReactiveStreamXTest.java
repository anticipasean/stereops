...
public class AsyncRSReactiveStreamXTest {
    ...
    public void iterateCycleStream() {
        for (int i = 0; i < 10000l; i++) {
            ...
            Iterator<Integer> it = of(1).stream()
                                        .cycle(2)
                                        .iterator();//of(1).stream().cycle(2).iterator();
    ...
    public void iterateFlatMapStream() {
        for (int i = 0; i < 100000l; i++) {
            System.out.println("Next cycle " + i);
            Iterator<Integer> it = of(1).stream()
                                        .concatMap(a -> ReactiveSeq.of(a * 2))
                                        .iterator();
            List<Integer> list2 = new ArrayList<>();
            while (it.hasNext()) {
                list2.add(it.next());
    ...
    public void testReverseList() {
        ...
        assertThat(Spouts.fromIterable(Arrays.asList(10,
                                                     400,
                                                     2,
                                                     -1))
                         .reverse()
    ...
    public void flatMapSynchronous() {
        for (int i = 0; i < ITERATIONS; i++) {
            ...
            assertThat(ReactiveSeq.fromPublisher(of(1).flatMap(in -> of(1,
                                                                        2,
                                                                        3)))
                                  .toList(),
                       equalTo(Arrays.asList(1,
    ...
    public void flatMapPSynchronous() {
        for (int i = 0; i < ITERATIONS; i++) {
            System.out.println("Iteration " + i);
            assertThat(ReactiveSeq.fromPublisher(of(1).mergeMap(in -> of(1,
                                                                         2,
                                                                         3)))
                                  .toList(),
                       equalTo(Arrays.asList(1,
    ...
    public void mergeMapToList() {
        assertThat(of(1).mergeMap(a -> ReactiveSeq.of(1))
                        .toList(),
                   equalTo(Arrays.asList(1)));
    }
    ...
    public void flattenEmpty() throws Exception {
        assertTrue(this.<ReactiveSeq<Integer>>of().to(ReactiveSeq::flatten)
                                                  .toList()
                                                  .isEmpty());
    }
    ...
    public void flatten() throws Exception {
        assertThat(of(Arrays.asList(1,
                                    2)).to(ReactiveSeq::flattenIterable)
                                       .toList()
                                       .size(),
                   equalTo(asList(1,
                                  2).size()));
