...
public class ExtensionOperatorsTest {
    ...
    public void singleEmpty() {
        assertNull(Spouts.of()
                         .singleOrElse(null));
    }

    @Test
    public void single2() {
        assertNull(Spouts.of(1,
                             2)
                         .singleOrElse(null));
    }
    ...
    public void singleOptionalEmpty() {
        assertFalse(Spouts.of()
                          .single()
                          .isPresent());
        assertFalse(Spouts.from(Flux.empty())
                          .single()
                          .isPresent());
    }
    ...
    public void limitTime() {
        List<Integer> result = Spouts.of(1,
                                         2,
                                         3,
                                         4,
                                         5,
    ...
    public void streamable() {
        Streamable<Integer> repeat = Streamable.fromStream(Spouts.of(1,
                                                                     2,
                                                                     3,
                                                                     4,
                                                                     5,
    ...
    public void concurrentLazyStreamable() {
        Streamable<Integer> repeat = Spouts.of(1,
                                               2,
                                               3,
                                               4,
                                               5,
    ...
    public void testLazy() {
        Collection<Integer> col = Spouts.of(1,
                                            2,
                                            3,
                                            4,
                                            5)
