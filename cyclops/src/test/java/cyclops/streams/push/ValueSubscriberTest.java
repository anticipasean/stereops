...
public class ValueSubscriberTest {
    ...
    public void maybeFromPublisherTest() {
        ...
        ReactiveSeq<Integer> stream = Spouts.of(1,
                                                2,
                                                3);
    ...
    public void maybeNonePublisherTest() {
        ValueSubscriber<Integer> sub = ValueSubscriber.subscriber();
        Maybe.<Integer>nothing().subscribe(sub);
    ...
    public void xorPublisherErrorTest() {
        ValueSubscriber<Integer> sub = ValueSubscriber.subscriber();
        Either.<Integer, Integer>left(1).subscribe(sub);
    ...
    public void xorSecondryPublisherTest() {
        ...
        Either<Integer, Throwable> maybe = sub.toEither()
                                              .swap();
        assertThat(maybe.swap()
                        .orElse(null),
                   equalTo(1));
    }
    ...
    public void xorSecondaryPublisherErrorTest() {
        ...
        Either<Integer, Throwable> xor = sub.toEither()
                                            .swap();
        assertThat(xor.orElse(null),
                   instanceOf(NoSuchElementException.class));
    }
    ...
    public void iorPublisherErrorTest() {
        ValueSubscriber<Integer> sub = ValueSubscriber.subscriber();
        Ior.<Integer, Integer>left(1).subscribe(sub);
    ...
    public void iorSecondryPublisherTest() {
        ...
        Ior<Integer, Throwable> maybe = sub.toIor()
                                           .swap();
        assertThat(maybe.swap()
                        .orElse(null),
                   equalTo(1));
    ...
    public void iorSecondaryPublisherErrorTest() {
        ...
        Ior<Integer, Throwable> xor = sub.toIor()
                                         .swap();
        assertThat(xor.orElse(null),
                   instanceOf(NoSuchElementException.class));
    }
