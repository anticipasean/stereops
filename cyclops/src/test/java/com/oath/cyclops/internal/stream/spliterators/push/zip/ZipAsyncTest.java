...
public class ZipAsyncTest {
    ...
    public void zipErrors() {
        ...
        Spouts.of(1,
                  2,
                  3)
              .zipWithPublisher(Spouts.reactiveStream(Fixtures.threeErrorsSource))
    ...
    public void zip2of() {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            System.out.println("*************Iteration " + i);
            System.out.println("*************Iteration " + i + "***********************");
            List<Tuple2<Integer, Integer>> list = flux(1,
                                                       2,
                                                       3,
                                                       4,
                                                       5,
            ...
            Assert.assertThat(Arrays.asList(1,
                                            2,
                                            3,
                                            4,
                                            5,
    ...
    public void zip2InvertedOf() {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            System.out.println("*************Iteration " + i);
            System.out.println("*************Iteration " + i + "***********************");
            List<Tuple2<Integer, Integer>> list = flux(100,
                                                       200,
                                                       300,
                                                       400).zip(flux(1,
                                                                     2,
            ...
            List<Integer> left = list.stream()
                                     ...
                                     .collect(Collectors.toList());
            System.out.println(left);
            Assert.assertThat(Arrays.asList(100,
                                            200,
                                            300,
                                            400),
                              hasItem(left.get(0)));
    ...
    public void zip2ofIterator() {
        ...
        for (int i = 0; i < 5000; i++) {
            ...
            Iterator<Tuple2<Integer, Integer>> it = flux(1,
                                                         2,
                                                         3,
                                                         4,
                                                         5,
    ...
    public void asyncZip() {
        ...
        assertThat(Spouts.of(1,
                         ...
                         .flatMap(i -> i.stream())
                         .toList(),
                   equalTo(Arrays.asList(Tuple.tuple(1,
                                                     1),
                                         Tuple.tuple(2,
                                                     2))));
