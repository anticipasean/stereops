...
public abstract class AbstractOperatorTest {
    ...
    public void subscribeEmpty() throws Exception {
        Subscription sub = empty.subscribe(values::add,
                                           errors::add,
                                           () -> onComplete = true);
        sub.request(1l);
    ...
    public void subscribeOne() throws Exception {
        Subscription sub = one.subscribe(values::add,
                                         errors::add,
                                         () -> onComplete = true);
        sub.request(1l);
        assertThat(values.size(),
    ...
    public void subscribeThree() throws Exception {
        Subscription sub = three.subscribe(values::add,
                                           errors::add,
                                           () -> onComplete = true);
        sub.request(1l);
        assertThat(values.size(),
    ...
    public void subscribeTwoAndError() throws Exception {
        Subscription sub = twoAndError.subscribe(values::add,
                                                 errors::add,
                                                 () -> onComplete = true);
        sub.request(1l);
        assertThat(values.size(),
    ...
    public void subscribeAllTwoAndError() throws Exception {
        twoAndError.subscribeAll(values::add,
                                 errors::add,
                                 () -> onComplete = true);
    ...
    public void subscribeAllThreeErrors() throws Exception {
        threeErrors.subscribeAll(values::add,
                                 errors::add,
                                 () -> onComplete = true);
