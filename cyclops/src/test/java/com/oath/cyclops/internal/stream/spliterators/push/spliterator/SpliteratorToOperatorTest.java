package com.oath.cyclops.internal.stream.spliterators.push.spliterator;
...
public class SpliteratorToOperatorTest {
    ...
    public void cancel() {
        ...
        Spouts.fromSpliterator(ReactiveSeq.iterate(0l,
                                                   i -> i + 1l)
                                          .spliterator())
              .limit(5)
              .filter(i -> true)
    ...
    public void request1() {
        new SpliteratorToOperator<Integer>(ReactiveSeq.of(1,
                                                          2,
                                                          3)
                                                      .spliterator()).subscribe(values::add,
                                                                                errors::add,
                                                                                () -> onComplete = true)
                                                                     .request(1l);
    ...
    public void requestOne() {
        Subscription sub = new FilterOperator<>(new SpliteratorToOperator<Integer>(ReactiveSeq.fill(10)
                                                                                              .limit(100)
                                                                                              .spliterator()),
                                                i -> true).subscribe(values::add,
                                                                     errors::add,
                                                                     () -> onComplete = true);
    ...
    public void requestTwo() {
        new SpliteratorToOperator<Integer>(ReactiveSeq.fill(10)
                                                      .limit(100)
                                                      .spliterator()).subscribe(values::add,
                                                                                errors::add,
                                                                                () -> onComplete = true)
    ...
    public void streamOf2() {
        new ReactiveStreamX<>(new SpliteratorToOperator<>(Stream.of(2,
                                                                    3)
                                                                .spliterator())).subscribe(new Subscriber<Integer>() {
            @Override
            public void onSubscribe(Subscription s) {
                sub = s;
