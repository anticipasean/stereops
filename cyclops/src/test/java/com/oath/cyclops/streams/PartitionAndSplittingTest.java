...
public class PartitionAndSplittingTest {
    ...
    public void splitAtHeadBug() {
        final Tuple2<ReactiveSeq<Integer>, ReactiveSeq<Integer>> Tuple2 = ReactiveSeq.of(1)
                                                                                     .splitAt(1);

        Option<LazySeq<Integer>> a = Tuple2._1()
                                           .to()
                                           .option();
        Option<Option<Integer>> x = a.flatMap(l -> l.size() > 0 ? Option.of(l.get(0)) : Option.none());
    ...
    public void testSplitAtHead() {
        ...
        Tuple2<Option<Integer>, ReactiveSeq<Integer>> x = ReactiveSeq.of(1)
                                                                     .splitAtHead();
        assertEquals(Option.of(1),
                     ReactiveSeq.of(1)
                                .splitAtHead()
