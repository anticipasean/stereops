...
public class CoreReactiveSeqTest {
    ...
    public void parallelFanOut() {
        ...
        assertThat(ReactiveSeq.of(1,
                                  ...
                                  3,
                                  4)
                              .parallelFanOutZipIn(ForkJoinPool.commonPool(),
                                                   s1 -> s1.filter(i -> i % 2 == 0)
                                                           .map(i -> i * 2),
                                                   s2 -> s2.filter(i -> i % 2 != 0)
                                                           .map(i -> i * 100),
                                                   (a, b) -> a + b)
                              .toList(),
                   equalTo(Arrays.asList(104,
                                         308)));
    }

    @Test
    public void mergePTest() {
        List<Integer> list = ReactiveSeq.of(3,
                                            6,
                                            9)
                                        .mergeP(ReactiveSeq.of(2,
                                                               4,
                                                               8),
                                                ReactiveSeq.of(1,
                                                               5,
    ...
    public void duplicateTest() {
        Tuple2<ReactiveSeq<Integer>, ReactiveSeq<Integer>> tuples = ReactiveSeq.of(1,
                                                                                   2,
                                                                                   3,
                                                                                   4,
                                                                                   5,
    ...
    public void duplicatePropertiesTest() {
        for (int i = 0; i < 100; i++) {
            Tuple2<ReactiveSeq<Integer>, ReactiveSeq<Integer>> tuples = ReactiveSeq.range(0,
                                                                                          i)
                                                                                   .duplicate();
    ...
    public void bufferingCopierTest() {
        for (int i = 0; i < 10; i++) {
            for (int k = 1; k < 5; k++) {
                ...
                Seq<Iterable<Integer>> list = Streams.toBufferingCopier(LazySeq.range(0,
                                                                                      i),
                                                                        k);
    ...
    public void bufferingCopierTriplicateCompare() {
        ...
        Seq<Iterable<Integer>> list = Streams.toBufferingCopier(ReactiveSeq.of(0,
                                                                               1),
                                                                3);
        Tuple3<Iterator<Integer>, Iterator<Integer>, Iterator<Integer>> its = Tuple.tuple(list.getOrElse(0,
                                                                                                         Arrays.asList())
                                                                                              .iterator(),
                                                                                          list.getOrElse(1,
                                                                                                         Arrays.asList())
    ...
    public void triplicateBug() {
        Tuple3<ReactiveSeq<Integer>, ReactiveSeq<Integer>, ReactiveSeq<Integer>> tuples = ReactiveSeq.of(0,
                                                                                                         1)
                                                                                                     .triplicate();
    ...
    public void triplicatePropertiesTest() {
        for (int i = 0; i < 100; i++) {
            Tuple3<ReactiveSeq<Integer>, ReactiveSeq<Integer>, ReactiveSeq<Integer>> tuples = ReactiveSeq.range(0,
                                                                                                                i)
                                                                                                         .triplicate();
    ...
    public void triplicateTest() {
        Tuple3<ReactiveSeq<Integer>, ReactiveSeq<Integer>, ReactiveSeq<Integer>> tuples = ReactiveSeq.of(1,
                                                                                                         2,
                                                                                                         3,
                                                                                                         4,
                                                                                                         5,
    ...
    public void triplicateFanOut() {
        ...
        assertThat(ReactiveSeq.of(1,
                                  ...
                                  8,
                                  9)
                              .fanOut(s1 -> s1.peek(System.out::println)
                                              .filter(i -> i % 3 == 0)
                                              .map(i -> i * 2),
    ...
    public void iteratePred() {
        ...
        assertThat(ReactiveSeq.iterate(0,
                                       i -> i < 10,
                                       i -> i + 1)
                              .toList()
                              .size(),
    ...
    public void broadcastTest() {
        Topic<Integer> topic = ReactiveSeq.of(1,
                                              2,
                                              3)
                                          .broadcast();
    ...
    public void broadcastThreads() throws InterruptedException {
        Topic<Integer> topic = ReactiveSeq.range(0,
                                                 100_000)
                                          .broadcast();
    ...
    public void cycleIterateIterable() {
        Iterator<Integer> it = ReactiveSeq.fromIterable(Arrays.asList(1))
                                          .stream()
                                          .cycle(2)
                                          .iterator();
    ...
    public void cycleIterate() {
        Iterator<Integer> it = ReactiveSeq.of(1)
                                          .stream()
                                          .cycle(2)
                                          .iterator();
        List<Integer> list2 = new ArrayList<>();
    ...
    public void testCycleLong() {
        assertEquals(asList(1,
                            ...
                            1,
                            2),
                     Streams.oneShotStream(Stream.of(1,
                                                     2))
                            .cycle(3)
                            .toList());
        assertEquals(asList(1,
    ...
    public void onEmptySwitchEmpty() {
        assertThat(of().onEmptySwitch(() -> of(1,
                                               2,
                                               3))
                       .toList(),
                   equalTo(Arrays.asList(1,
    ...
    public void flattenEmpty() throws Exception {
        assertTrue(ReactiveSeq.<ReactiveSeq<Integer>>of().to(ReactiveSeq::flatten)
                                                         .toList()
                                                         .isEmpty());
    }
    ...
    public void flatten() throws Exception {
        assertThat(ReactiveSeq.of(Arrays.asList(1,
                                                2))
                              .to(ReactiveSeq::flattenIterable)
                              .toList()
                              .size(),
                   equalTo(asList(1,
                                  2).size()));
    ...
    public void flattenEmptyStream() throws Exception {
        ...
        assertThat(ReactiveSeq.<Integer>of(1,
                                           2,
                                           3,
                                           4,
                                           5,
