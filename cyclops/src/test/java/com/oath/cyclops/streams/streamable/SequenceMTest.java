...
public class SequenceMTest {
    ...
    public void allPermutations3() {
        ...
        assertThat(Streamable.of(1,
                             ...
                             .map(s -> s.toList())
                             .toList(),
                   equalTo(Streamable.of(Streamable.of(1,
                                                       2,
                                                       3),
                                         Streamable.of(1,
                                                       3,
    ...
    public void limitTime() {
        List<Integer> result = Streamable.of(1,
                                             2,
                                             3,
                                             4,
                                             5,
    ...
    public void testLazy() {
        Collection<Integer> col = Streamable.of(1,
                                                2,
                                                3,
                                                4,
                                                5)
