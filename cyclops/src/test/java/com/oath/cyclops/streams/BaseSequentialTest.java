...
public class BaseSequentialTest {
    ...
    public void publishTest() {
        for (int k = 0; k < ITERATIONS; k++) {
            ...
            of(1,
               2,
               3).peek(i -> System.out.println("publishing " + i))
                 .publishTo(queue)
    ...
    public void parallelFanOut() {
        ...
        assertThat(of(1,
                      2,
                      3,
                      4).parallelFanOut(ForkJoinPool.commonPool(),
                                        s1 -> s1.filter(i -> i % 2 == 0)
                                                .map(i -> i * 2),
                                        s2 -> s2.filter(i -> i % 2 != 0)
                                                .map(i -> i * 100))
                        .collect(Collectors.toList()),
                   Matchers.equalTo(Arrays.asList(4,
                                                  100,
                                                  8,
                                                  300)));
        ...
        assertThat(of(1,
                      2,
                      3,
                      4).parallelFanOutZipIn(ForkJoinPool.commonPool(),
                                             s1 -> s1.filter(i -> i % 2 == 0)
                                                     .map(i -> i * 2),
                                             s2 -> s2.filter(i -> i % 2 != 0)
                                                     .map(i -> i * 100),
                                             (a, b) -> a + b)
                        .toList(),
                   Matchers.equalTo(Arrays.asList(104,
                                                  308)));
    ...
    public void triplicateFanOut() {
        ...
        for (int k = 0; k < ITERATIONS; k++) {
            ...
            List<Integer> res = of(1,
                                   ...
                                   7,
                                   8,
                                   9).fanOut(s1 -> s1.peek(System.out::println)
                                                     .filter(i -> i % 3 == 0)
                                                     .map(i -> i * 2),
    ...
    public void fanOut() {
        for (int k = 0; k < ITERATIONS; k++) {
            ...
            assertThat(of(1,
                          ...
                          10,
                          11,
                          12).fanOut(s1 -> s1.filter(i -> i % 4 == 0)
                                             .map(i -> i * 2),
                                     s2 -> s2.filter(i -> i % 4 == 1)
                                             .map(i -> i * 100),
                                     s3 -> s3.filter(i -> i % 4 == 2)
                                             .map(i -> i * 1000),
                                     s4 -> s4.filter(i -> i % 4 == 3)
                                             .map(i -> i * 10000))
                             .toList(),
                       Matchers.hasItems(8,
                                         100,
    ...
    public void parallelFanOut2() {
        for (int k = 0; k < ITERATIONS; k++) {
            ...
            assertThat(of(1,
                          ...
                          9).parallelFanOut(ForkJoinPool.commonPool(),
                                            ...
                                            s3 -> s3.filter(i -> i % 3 == 2)
                                                    .map(i -> i * 1000))
                            .toList(),
                       Matchers.equalTo(Arrays.asList(6,
                                                      100,
                                                      2000,
                                                      12,
                                                      400,
            ...
            assertThat(of(1,
                          ...
                          10,
                          11,
                          12).parallelFanOut(ForkJoinPool.commonPool(),
                                             s1 -> s1.filter(i -> i % 4 == 0)
                                                     .map(i -> i * 2),
                                             s2 -> s2.filter(i -> i % 4 == 1)
                                                     .map(i -> i * 100),
                                             s3 -> s3.filter(i -> i % 4 == 2)
                                             ...
                                             s4 -> s4.filter(i -> i % 4 == 3)
                                                     .map(i -> i * 10000))
                             .toList(),
                       Matchers.equalTo(Arrays.asList(8,
                                                      100,
                                                      2000,
                                                      30000,
                                                      16,
    ...
    public void ambTest() {
        assertThat(of(1,
                      2,
                      3).ambWith(Flux.just(10,
                                           20,
                                           30))
                        .toList(),
                   isOneOf(Arrays.asList(10,
                                         20,
                                         30),
                           Arrays.asList(1,
                                         2,
    ...
    public void flatMapStreamFilter() {
        assertThat(of(1,
                      2,
                      3,
                      null).flatMap(i -> ReactiveSeq.of(i)
    ...
    public void concatMapStream() {
        assertThat(of(1,
                      2,
                      3,
                      null).concatMap(i -> ReactiveSeq.of(i)
                                                      .filter(Objects::nonNull))
                           .collect(Collectors.toList()),
                   Matchers.equalTo(Arrays.asList(1,
                                                  2,
    ...
    public void concatMapMaybe() {
        assertThat(of(1,
                      2,
                      3,
                      null).concatMap(Maybe::ofNullable)
                           .collect(Collectors.toList()),
                   Matchers.equalTo(Arrays.asList(1,
                                                  2,
                                                  3)));
    ...
    public void flatMapSimple() {
        assertThat(of(1).flatMap(i -> Stream.of(10,
                                                20))
                        .toList(),
                   equalTo(Arrays.asList(10,
                                         20)));
    ...
    public void combineOneFirstOrError() {
        assertThat(of(1).combine((a, b) -> a < 5,
                                 Semigroups.intSum)
                        .findFirstOrError(),
                   Matchers.equalTo(LazyEither.right(1)));
    }
    ...
    public void combineEmpty() {
        assertThat(this.<Integer>of().combine((a, b) -> a < 5,
                                              Semigroups.intSum)
                                     .takeOne(),
                   Matchers.equalTo(Maybe.nothing()));
    }
    ...
    public void combineTerminate() {
        assertThat(of(1,
                      ...
                      8).combine((a, b) -> a < 5,
                                 Semigroups.intSum)
                        .findFirst(),
                   Matchers.equalTo(Optional.of(6)));
    }
    ...
    public void dropWhileEmptyInclusive() {
        assertThat(of().dropWhileInclusive(p -> true)
                       .toList(),
                   equalTo(Arrays.asList()));
    }
    ...
    public void takeUntilInclusiveEmpty() {
        assertThat(of().takeUntilInclusive(p -> true)
                       .toList(),
                   equalTo(Arrays.asList()));
    }
    ...
    public void takeWhileInclusiveEmpty() {
        assertThat(of().takeWhileInclusive(p -> true)
                       .toList(),
                   equalTo(Arrays.asList()));
    }
    ...
    public void batchBySize() {
        System.out.println("Grouped " + of(1,
                                           2,
                                           3,
                                           4,
                                           5,
    ...
    public void insertAtEmpty() {
        for (int k = 0; k < ITERATIONS; k++) {
            List<String> result = of().insertAt(0,
                                                100,
                                                200,
                                                300)
                                      .map(it -> it + "!!")
    ...
    public void insertAtOutOfRangeEmpty() {
        for (int k = 0; k < ITERATIONS; k++) {
            List<String> result = of().insertAt(1,
                                                100,
                                                200,
                                                300)
                                      .map(it -> it + "!!")
    ...
    public void insertAtSOutOfRangeEmpty() {
        for (int k = 0; k < 1000; k++) {
            List<String> result = of().insertStreamAt(1,
                                                      Stream.of(100,
                                                                200,
                                                                300))
                                      .map(it -> it + "!!")
    ...
    public void insertAtStreamEmpty() {
        for (int k = 0; k < ITERATIONS; k++) {
            List<String> result = of().insertStreamAt(0,
                                                      Stream.of(100,
                                                                200,
                                                                300))
                                      .map(it -> it + "!!")
    ...
    public void zipEmpty() throws Exception {
        ...
        final ReactiveSeq<Integer> zipped = empty.zip(this.<Integer>of(),
                                                      (a, b) -> a + b);
    ...
    public void testOptional() {
        assertEquals(asList(1),
                     of(Optional.of(1)).toList());
        assertEquals(asList(),
                     of(Optional.empty()).toList());
    }
    ...
    public void testSkipUntilWithNulls() {
        Supplier<ReactiveSeq<Integer>> s = () -> ReactiveSeq.of(1,
                                                                2,
                                                                null,
                                                                3,
                                                                4,
    ...
    public void testSkipUntilInclusive() {
        ...
        assertEquals(asList(),
                     s.dropUntilInclusive(i -> false)
                      .toList());
        assertEquals(asList(4,
                            5),
                     s.dropUntilInclusive(i -> i % 3 == 0)
                      .toList());
        assertEquals(asList(4,
                            5),
                     s.dropUntilInclusive(i -> i == 3)
                      .toList());
        assertEquals(asList(5),
                     s.dropUntilInclusive(i -> i == 4)
                      .toList());
        assertEquals(asList(2,
                            3,
                            4,
                            5),
                     s.dropUntilInclusive(i -> true)
                      .toList());
    }
    ...
    public void testLimitWhileInclusive() {
        ReactiveSeq<Integer> s = ReactiveSeq.of(1,
                                                2,
                                                3,
                                                4,
                                                5);
        ...
        assertEquals(asList(1),
                     s.takeWhileInclusive(i -> false)
                      .toList());
        assertEquals(asList(1,
                            2,
                            3),
                     s.takeWhileInclusive(i -> i % 3 != 0)
                      .toList());
        assertEquals(asList(1,
                            2,
                            3),
                     s.takeWhileInclusive(i -> i < 3)
                      .toList());
        assertEquals(asList(1,
                            2,
                            3,
                            4),
                     s.takeWhileInclusive(i -> i < 4)
                      .toList());
        assertEquals(asList(1,
                            2,
                            3,
    ...
    public void testFoldLeft() {
        Supplier<ReactiveSeq<String>> s = () -> of("a",
                                                   "b",
                                                   "c");
    ...
    public void flattenEmpty() throws Exception {
        assertTrue(this.<Integer>of().flatMap(i -> asList(i,
                                                          -i).stream())
                                     .toList()
                                     .isEmpty());
    }
    ...
    public void flatten() throws Exception {
        assertThat(this.<Integer>of(1,
                                    2).flatMap(i -> asList(i,
                                                           -i).stream())
                                      .toList(),
                   equalTo(asList(1,
                                  -1,
