...
public class RangeTest {
    ...
    public void reversedRangeLong() {
        assertThat(ReactiveSeq.rangeLong(10,
                                         -10)
                              .count(),
                   equalTo(20L));
    }
    ...
    public void longStreamCompare0() {
        assertThat(LongStream.range(0,
                                    10)
                             .sum(),
                   equalTo(ReactiveSeq.rangeLong(0,
                                                 10)
                                      .sumLong(i -> i)));
    }
    ...
    public void longStreamCompareReversed() {
        assertThat(0L,
                   equalTo(ReactiveSeq.rangeLong(-5,
                                                 6)
                                      .reverse()
                                      .sumLong(i -> i)));
    }
    ...
    public void longStreamCompare() {
        assertThat(LongStream.range(-1l,
                                    10l)
                             .sum(),
                   equalTo(ReactiveSeq.rangeLong(-1l,
                                                 10l)
                                      .sumLong(i -> i)));
    }
    ...
    public void negative() {
        assertThat(ReactiveSeq.range(-1000,
                                     Integer.MAX_VALUE)
                              .limit(100)
                              .count(),
                   equalTo(100L));
    ...
    public void negativeLong() {
        assertThat(ReactiveSeq.rangeLong(-1000L,
                                         Long.MAX_VALUE)
                              .limit(100)
                              .count(),
                   equalTo(100L));
    ...
    public void rangeLongReversed() {
        assertThat(ReactiveSeq.rangeLong(0,
                              ...
                              .limit(2)
                              .toList(),
                   equalTo(Arrays.asList(9223372036854775806l,
    ...
    public void rangeIntReversed() {
        assertThat(ReactiveSeq.range(0,
                              ...
                              .limit(2)
                              .toList(),
                   equalTo(Arrays.asList(2147483646,
                                         2147483645)));
    }
    ...
    public void rangeIntReversedSkip() {
        ...
        assertThat(ReactiveSeq.range(0,
                              ...
                              .skip(8)
                              .toList(),
                   equalTo(Arrays.asList(2147483638,
                                         2147483637)));
    }
    ...
    public void reversedOfArray() throws InterruptedException {
        ...
        assertThat(ReactiveSeq.reversedOf(1,
                                          2)
                              .toList(),
