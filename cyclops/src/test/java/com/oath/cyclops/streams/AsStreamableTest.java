...
public class AsStreamableTest {
    ...
    public void testAsStreamableT() {
        ...
        List<Integer> result = Streamable.<Integer>fromIterable(Arrays.asList(1,
                                                                              2,
                                                                              3)).stream()
                                                                                 .map(i -> i + 2)
    ...
    public void testAsStreamableStreamOfT() {
        ...
        List<Integer> result1 = streamable.stream()
                                          .map(i -> i + 2)
                                          .collect(Collectors.toList());
        List<Integer> result2 = streamable.stream()
                                          .map(i -> i + 2)
                                          .collect(Collectors.toList());
        List<Integer> result3 = streamable.stream()
                                          .map(i -> i + 2)
                                          .collect(Collectors.toList());
