...
public class ZippingTest {
    ...
    public void zipEmpty() throws Exception {
        ...
        final Streamable<Integer> zipped = empty.zip(Streamable.<Integer>of(),
                                                     (a, b) -> a + b);
    ...
    public void testUnzip3WithLimits() {
        ...
        Supplier<Streamable<Tuple3<Integer, String, Long>>> s = () -> of(new Tuple3(1,
                                                                                    "a",
                                                                                    2l),
                                                                         new Tuple3(2,
                                                                                    "b",
    ...
    public void testUnzip4() {
        ...
        Supplier<Streamable<Tuple4<Integer, String, Long, Character>>> s = () -> of(new Tuple4(1,
                                                                                               "a",
                                                                                               2l,
                                                                                               'z'),
                                                                                    new Tuple4(2,
