...
public class SequenceMTest {
    ...
    public void permuations3() {
        ...
        assertThat(ReactiveSeq.of(1,
                              ...
                              .map(s -> s.toList())
                              .toList(),
                   equalTo(ReactiveSeq.of(ReactiveSeq.of(1,
                                                         2,
                                                         3),
                                          ReactiveSeq.of(1,
                                                         3,
    ...
    public void onEmptySwitchEmpty() {
        assertThat(ReactiveSeq.of()
                              .onEmptySwitch(() -> ReactiveSeq.of(1,
                                                                  2,
                                                                  3))
                              .toList(),
    ...
    public void singleEmpty() {
        assertNull(ReactiveSeq.of()
                              .singleOrElse(null));
    }

    @Test
    public void single2() {
        assertNull(ReactiveSeq.of(1,
                                  2)
                              .singleOrElse(null));
    }
    ...
    public void limitTime() {
        List<Integer> result = ReactiveSeq.of(1,
                                              2,
                                              3,
                                              4,
                                              5,
    ...
    public void streamable() {
        Streamable<Integer> repeat = Streamable.fromIterable(ReactiveSeq.of(1,
                                                                            2,
                                                                            3,
                                                                            4,
                                                                            5,
    ...
    public void testLazy() {
        Collection<Integer> col = ReactiveSeq.of(1,
                                                 2,
                                                 3,
                                                 4,
                                                 5)
