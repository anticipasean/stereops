...
public class CoreStreamableTest {
    ...
    public void coflatMapTest() {
        Streamable<Streamable<Integer>> list = Streamable.of(1,
                                                             2,
                                                             3)
                                                         .coflatMap(s -> s);

        Streamable<Integer> stream2 = list.flatMap(s -> s)
                                          .map(i -> i * 10);
        Streamable<Integer> stream3 = list.flatMap(s -> s)
                                          .map(i -> i * 100);
    ...
    public void testFlatMap() {
        assertThat(Streamable.of(1,
                                 2,
                                 3)
                             .flatMap(i -> Streamable.of(i))
                             .toList(),
    ...
    public void testTriplicate() {
        Tuple3<Streamable<Integer>, Streamable<Integer>, Streamable<Integer>> copies = of(1,
                                                                                          2,
                                                                                          3,
                                                                                          4,
                                                                                          5,
    ...
    public void testQuadriplicate() {
        Tuple4<Streamable<Integer>, Streamable<Integer>, Streamable<Integer>, Streamable<Integer>> copies = of(1,
                                                                                                               2,
                                                                                                               3,
                                                                                                               4,
                                                                                                               5,
    ...
    public void skipLast1() {
        System.out.println("List " + Streamable.of(1,
                                                   2,
                                                   3,
                                                   4)
                                               .dropRight(1)
    ...
    public void testSkipWhile() {
        Streamable<Integer> s = of(1,
                                   2,
                                   3,
                                   4,
                                   5);

        System.out.println(s.dropWhile(i -> false)
                            .toList());
