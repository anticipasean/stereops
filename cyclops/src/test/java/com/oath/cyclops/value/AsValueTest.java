...
public class AsValueTest {
    /**
     ...
     @Test public void testAsValue_Match() {
     List list = new ArrayList();
     ...
     @Test public void testAsValue_MatchDefault() {
     List list = new ArrayList();
     ...
     @AllArgsConstructor(access=AccessLevel.PACKAGE) static class Parent{
     int val;
     }
