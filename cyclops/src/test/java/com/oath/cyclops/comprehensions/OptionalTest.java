...
public class OptionalTest {
    ...
    public void forComprehension() {
        ...
        Optional<Integer> result = Optionals.forEach3(two,
                                                      a -> four,
                                                      (a, b) -> three,
                                                      (v1, v2, v3) -> f2.apply(v1,
                                                                               v2));

        assertThat(result,
                   equalTo(Optional.of(8)));
    ...
    public void test1() {
        ...
        Optional<Integer> result = Optionals.forEach2(one,
                                                      a -> Optional.of(20),
                                                      (a, b) -> f2.apply(a,
                                                                         10));
