...
public class CompletableFutureTest {
    ...
    public void cf() {
        ...
        CompletableFuture<String> result = CompletableFutures.forEach3(f,
                                                                       a -> f2,
                                                                       (a, b) -> f3,
                                                                       (v1, v2, v3) -> v1 + v2 + v3);

        assertThat(result.join(),
                   equalTo("hello world23"));
    }
    ...
    public void cfFromCallable() {
        ...
        Future<String> result = Future.of(() -> "hello world")
                                      .forEach3(a -> f2,
                                                (a, b) -> f3,
                                                (v1, v2, v3) -> v1 + v2 + v3);

        assertThat(result.getFuture()
                         .join(),
                   equalTo("hello world23"));
    }
