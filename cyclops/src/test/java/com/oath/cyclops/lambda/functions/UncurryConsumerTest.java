...
import cyclops.function.UncurryConsumer;
...
public class UncurryConsumerTest {
    ...
    public void testUncurry2() {
        UncurryConsumer.uncurryC2((Integer a) -> (Integer b) -> value = a + b)
                       .accept(2,
                               3);
        assertThat(value,
                   equalTo(5));
    ...
    public void testUncurry3() {
        UncurryConsumer.uncurryC3((Integer a) -> (Integer b) -> (Integer c) -> value = a + b + c)
                       .accept(2,
                               3,
                               4);
        assertThat(value,
