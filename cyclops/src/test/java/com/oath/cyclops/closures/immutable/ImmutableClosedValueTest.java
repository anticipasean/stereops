...
public class ImmutableClosedValueTest {
    ...
    public void setOnceLazy() {
        ...
        assertThat(s.get(),
                   is(10));
        assertThat(value.computeIfAbsent(() -> 20),
                   is(10));
    ...
    public void testRightIdentity() {
        ...
        assertThat(m.flatMap(LazyImmutable::of)
                    .get(),
                   equalTo(m.get()));
    ...
    public void associativity() {
        ...
        assertThat(m.flatMap(f)
                    .flatMap(g)
                    .get(),
                   equalTo(m.flatMap(x -> f.apply(x)
                                           .flatMap(g))
                            .get()));
    }
    ...
    public void testRightIdentityUninitialised() {
        ...
        assertThat(m.<Integer>flatMap(LazyImmutable::of),
                   equalTo(m));
    ...
    public void associativityUninitialised() {
        ...
        Function<Integer, LazyImmutable<Integer>> f = i -> LazyImmutable.of(i + 10);
        Function<Integer, LazyImmutable<Integer>> g = i -> LazyImmutable.of(i * 10);
        assertThat(m.<Integer>flatMap(f).<Integer>flatMap(g),
                   equalTo(m.<Integer>flatMap(x -> f.apply(x)
                                                    .flatMap(g))));
    }
}
