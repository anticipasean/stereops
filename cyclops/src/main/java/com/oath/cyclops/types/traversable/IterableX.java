...
public interface IterableX<T> extends Traversable<T>, Folds<T>, Iterable<T>, ReactiveStreamsTerminalOperations<T> {
     ...
     */
    default <R> Future<R> foldFuture(Executor ex,
                                     Function<? super IterableX<T>, ? extends R> fn) {

        return Future.of(() -> fn.apply(this),
                         ex);
    }

    default Future<Void> runFuture(Executor ex,
                                   Consumer<? super IterableX<T>> fn) {
        return Future.of(() -> {
                             fn.accept(this);
                             return null;
                         },
    ...
    default <R, X extends Throwable> Try<R, X> foldTry(Function<? super IterableX<T>, ? extends R> fn,
        ...
        return Try.withCatch(() -> fn.apply(this),
                             classes);
    }

    default Function1<Long, T> asFunction() {
        return index -> this.elementAt(index)
                            .orElse(null);
    }
    ...
    default <X extends Throwable> Subscription forEachSubscribe(Consumer<? super T> consumer) {
        Subscription result = ReactiveStreamsTerminalOperations.super.forEachSubscribe(consumer,
                                                                                       e -> e.printStackTrace(),
                                                                                       () -> {
                                                                                       });
        return result;
    ...
    @Override
    default <X extends Throwable> Subscription forEach(long numberOfElements,
    ...
    @Override
    default <X extends Throwable> void forEach(Consumer<? super T> consumerElement,
                                               Consumer<? super Throwable> consumerError) {
    ...
    @Override
    default <T2, R> IterableX<R> zip(final BiFunction<? super T, ? super T2, ? extends R> fn,
                                     final Publisher<? extends T2> publisher) {
        return (IterableX<R>) Traversable.super.zip(fn,
                                                    publisher);
    }
    ...
    @Override
    default <T2, R> IterableX<R> zipWithStream(final Stream<? extends T2> other,
                                               final BiFunction<? super T, ? super T2, ? extends R> fn) {
        return (IterableX<R>) Traversable.super.zipWithStream(other,
                                                              fn);
    }
    ...
    @Override
    default <S, U, R> IterableX<R> zip3(final Iterable<? extends S> second,
                                        final Iterable<? extends U> third,
                                        final Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (IterableX) Traversable.super.zip3(second,
                                                  third,
                                                  fn3);
    }

    @Override
    default <T2, T3, T4, R> IterableX<R> zip4(final Iterable<? extends T2> second,
                                              final Iterable<? extends T3> third,
                                              final Iterable<? extends T4> fourth,
                                              final Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (IterableX) Traversable.super.zip4(second,
                                                  third,
                                                  fourth,
                                                  fn);
    }
    ...
    @Override
    default IterableX<T> combine(final BiPredicate<? super T, ? super T> predicate,
                                 final BinaryOperator<T> op) {
        return (IterableX) Traversable.super.combine(predicate,
                                                     op);
    }

    @Override
    default IterableX<T> combine(final Monoid<T> op,
                                 final BiPredicate<? super T, ? super T> predicate) {
        return (IterableX) Traversable.super.combine(op,
                                                     predicate);
    }
    ...
    @Override
    default IterableX<T> cycle(final Monoid<T> m,
                               final long times) {
        return (IterableX) Traversable.super.cycle(m,
                                                   times);
    }
    ...
    @Override
    default <U, R> IterableX<R> zip(final Iterable<? extends U> other,
                                    final BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (IterableX<R>) Traversable.super.zip(other,
                                                    zipper);
    }

    @Override
    default <S, U> IterableX<Tuple3<T, S, U>> zip3(final Iterable<? extends S> second,
                                                   final Iterable<? extends U> third) {
        return (IterableX) Traversable.super.zip3(second,
                                                  third);
    }
    ...
    @Override
    default <T2, T3, T4> IterableX<Tuple4<T, T2, T3, T4>> zip4(final Iterable<? extends T2> second,
                                                               final Iterable<? extends T3> third,
                                                               final Iterable<? extends T4> fourth) {
        return (IterableX) Traversable.super.zip4(second,
                                                  third,
    ...
    @Override
    default <C extends PersistentCollection<? super T>> IterableX<C> grouped(final int size,
                                                                             final Supplier<C> supplier) {
        return (IterableX<C>) Traversable.super.grouped(size,
                                                        supplier);
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> IterableX<C> groupedWhile(final Predicate<? super T> predicate,
                                                                                  final Supplier<C> factory) {
        return (IterableX<C>) Traversable.super.groupedWhile(predicate,
                                                             factory);
    }

    @Override
    default <C extends PersistentCollection<? super T>> IterableX<C> groupedUntil(final Predicate<? super T> predicate,
                                                                                  final Supplier<C> factory) {
        return (IterableX<C>) Traversable.super.groupedUntil(predicate,
                                                             factory);
    }
    ...
    @Override
    default <U> IterableX<U> scanLeft(final U seed,
                                      final BiFunction<? super U, ? super T, ? extends U> function) {
        return (IterableX<U>) Traversable.super.scanLeft(seed,
                                                         function);
    }
    ...
    @Override
    default <U> IterableX<U> scanRight(final U identity,
                                       final BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (IterableX<U>) Traversable.super.scanRight(identity,
                                                          combiner);
    }
    ...
    @Override
    default IterableX<T> slice(final long from,
                               final long to) {
        return (IterableX<T>) Traversable.super.slice(from,
                                                      to);
    }
    ...
    @Override
    default IterableX<T> updateAt(int pos,
                                  T value) {
        if (pos < 0) {
            return this;
        }
        return (IterableX<T>) Traversable.super.updateAt(pos,
                                                         value);
    }

    @Override
    default IterableX<T> deleteBetween(int start,
                                       int end) {
        return (IterableX<T>) Traversable.super.deleteBetween(start,
                                                              end);
    }


    @Override
    default IterableX<T> insertStreamAt(int pos,
                                        Stream<T> stream) {
        return (IterableX<T>) Traversable.super.insertStreamAt(pos,
                                                               stream);
    }
    ...
    /**
     * Perform a flatMap operation on this IterableX. Results from the returned Iterables (from the provided transformation
     * function) are flattened into the resulting toX.
     *
    ...
    default <R> IterableX<R> mergeMap(int maxConcurecy,
                                      Function<? super T, ? extends Publisher<? extends R>> fn) {
        return stream().mergeMap(maxConcurecy,
                                 fn);
    }

    default IterableX<T> insertAt(int i,
                                  T value) {
    ...
    @Override
    default IterableX<T> insertAt(int pos,
                                  T... values) {
    ...
    default boolean containsValue(T v) {
        return stream().filter(t -> Objects.equals(t,
                                                   v))
                       .findFirst()
                       .isPresent();
    }
