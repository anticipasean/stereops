 ...
 */
public abstract class BaseComposableSpliterator<T, R, X extends Spliterator<?>> extends
                                                                                Spliterators.AbstractSpliterator<R> implements
                                                                                                                    ComposableFunction<R, T, X> {
     ...
     * @param additionalCharacteristics properties of this spliterator's source or elements.  If {@code SIZED} is reported
     *                                  transform this spliterator will additionally report {@code SUBSIZED}.
     */
    protected BaseComposableSpliterator(long est,
