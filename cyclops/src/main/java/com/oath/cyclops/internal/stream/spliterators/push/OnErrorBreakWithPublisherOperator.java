...
public class OnErrorBreakWithPublisherOperator<T> extends BaseOperator<T, Publisher<? extends T>> {
    ...
    public OnErrorBreakWithPublisherOperator(Operator<T> source,
                                             Function<Throwable, ? extends Publisher<? extends T>> recover) {
        super(source);
    ...
    @Override
    public StreamSubscription subscribe(Consumer<? super Publisher<? extends T>> onNext,
    ...
    @Override
    public void subscribeAll(Consumer<? super Publisher<? extends T>> onNext,
                             Consumer<? super Throwable> onError,
