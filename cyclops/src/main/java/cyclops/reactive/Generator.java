...
public class Generator<T> implements Iterable<T>, ToStream<T> {
    ...
    public Generator(Suspended suspended,
                     Maybe<T> value,
                     GeneratorSupplier<T> remainderOfWorkToBeDone) {
        this.value = value;
    ...
    public static <T> Generator<T> suspend(GeneratorFunction<T> value) {
        ...
        Generator<T> res = new Generator<T>(suspended,
                                            suspended.local);
    ...
    public static <T> Generator<T> suspend(BooleanSupplier pred,
                                           GeneratorFunction<T> value) {
    ...
    public static <T> Generator<T> suspend(Predicate<? super T> pred,
                                           GeneratorFunction<T> value) {
        Suspended<T> suspended = new Suspended<>(new Suspended<>());
    ...
    private static <T> Generator<T> empty(Suspended<T> suspended) {
        return new Generator(suspended,
                             Maybe.nothing(),
                             null);
    }
    ...
    public static <T> Generator<T> suspendRef(BooleanSupplier pred,
                                              Supplier<T> value) {
        return suspend(pred,
                       s -> s.yield(value.get()));
    }

    public static <T> Generator<T> suspendRef(Predicate<? super T> pred,
                                              Supplier<T> value) {
        return suspend(pred,
                       s -> s.yield(value.get()));
    }
    ...
    Ior<T, Generator<T>> proceed() {
        return value.fold(v -> Ior.both(v,
                                        remainderOfWorkToBeDone.get()),
    ...
    private Generator<T> copy() {
        return new Generator<>(suspended.copy(),
                               value,
                               this.remainderOfWorkToBeDone);
    }
    ...
    public static class Suspended<T> {
        ...
        public Generator<T> yieldAll(Iterable<T> next) {
            ...
            if (it.hasNext()) {
                T nextA = it.next();
                return yieldAll(nextA,
                                () -> it);
            }
            return empty(this);
        }

        public Generator<T> yieldAll(T value,
                                     Iterable<T> next) {
        ...
        public Generator<T> yield(T value,
                                  GeneratorSupplier<T> nextA,
                                  GeneratorSupplier<T> nextB) {
        ...
        public Generator<T> yield(T value,
                                  GeneratorSupplier<T>... next) {
            Iterator<GeneratorSupplier<T>> it = Arrays.asList(next)
                                                      .iterator();
        ...
        public Generator<T> yieldRef(T value,
                                     Supplier<T>... next) {

            Iterator<Supplier<T>> it = Arrays.asList(next)
                                             .iterator();
        ...
        public Generator<T> yieldAndStop(T value) {
            ...
            stopped.value = value;
            stopped.local = local;
            return new Generator<T>(stopped,
                                    value,
                                    null);
        }
