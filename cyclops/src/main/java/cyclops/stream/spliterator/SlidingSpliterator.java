 ...
 */
public class SlidingSpliterator<T, R> extends Spliterators.AbstractSpliterator<R> implements CopyableSpliterator<R>,
                                                                                             ComposableFunction<R, T, SlidingSpliterator<T, ?>> {
    ...
    public <R2> SlidingSpliterator<T, ?> compose(Function<? super R, ? extends R2> fn) {
        return new SlidingSpliterator<T, R2>(CopyableSpliterator.copy(source),
    ...
    public Spliterator<R> copy() {
        return new SlidingSpliterator<T, R>(CopyableSpliterator.copy(source),
                                            finalizer,
                                            windowSize,
                                            increment);
    }
