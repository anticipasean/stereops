...
public class PublisherFlatMappingSpliterator<T, R> extends Spliterators.AbstractSpliterator<R> implements CopyableSpliterator<R> {
    ...
    public PublisherFlatMappingSpliterator(final Spliterator<T> source,
                                           Function<? super T, ? extends Publisher<? extends R>> mapper) {
    ...
    public static <T2, T, R> PublisherFlatMappingSpliterator<T2, R> compose(FunctionSpliterator<T2, T> fnS,
                                                                            Function<? super T, ? extends Publisher<? extends R>> mapper) {
    ...
    public Spliterator<R> copy() {
        return new PublisherFlatMappingSpliterator<>(CopyableSpliterator.copy(source),
                                                     mapper);
    }
}
