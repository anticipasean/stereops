...
public class SkipLastSpliterator<T> extends AbstractSpliterator<T> implements CopyableSpliterator<T> {
    ...
    public static <T> Spliterator<T> dropRight(Spliterator<T> source,
                                               int skip) {
        ...
        return new SkipLastSpliterator<T>(source,
                                          skip);
    }
    ...
    public Spliterator<T> copy() {
        return new SkipLastSpliterator<T>(CopyableSpliterator.copy(source),
                                          skip);
    }
}
