 ...
 */
@FunctionalInterface
public interface Streamable<T> extends To<Streamable<T>>, ToStream<T>, Stream<T>, RecoverableTraversable<T>, IterableX<T>,
                                       Contains<T>, Unit<T> {
     ...
     */
    static <T> Streamable<T> iterate(final T seed,
     ...
     */
    @Override
    default Streamable<T> combine(final BiPredicate<? super T, ? super T> predicate,
                                  final BinaryOperator<T> op) {

        return Streamable.fromIterable(IterableX.super.combine(predicate,
                                                               op));
    }

    @Override
    default Streamable<T> combine(final Monoid<T> op,
                                  final BiPredicate<? super T, ? super T> predicate) {
        return (Streamable<T>) IterableX.super.combine(op,
                                                       predicate);
    }
     ...
     */
    @Override
    default <U, R> Streamable<R> zip(final Iterable<? extends U> other,
                                     final BiFunction<? super T, ? super U, ? extends R> zipper) {

        return Streamable.fromIterable(IterableX.super.zip(other,
                                                           zipper));
    }

    default <U, R> Streamable<R> zipWithStream(final Stream<? extends U> other,
                                               final BiFunction<? super T, ? super U, ? extends R> zipper) {
    ...
    @Override
    default <T2, R> Streamable<R> zip(final BiFunction<? super T, ? super T2, ? extends R> fn,
                                      final Publisher<? extends T2> publisher) {
        return Streamable.fromIterable(IterableX.super.zip(fn,
                                                           publisher));
    }
    ...
    @Override
    default <S, U, R> Streamable<R> zip3(final Iterable<? extends S> second,
                                         final Iterable<? extends U> third,
                                         final Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return Streamable.fromIterable(IterableX.super.zip3(second,
                                                            third,
                                                            fn3));
    }

    @Override
    default <T2, T3, T4, R> Streamable<R> zip4(final Iterable<? extends T2> second,
                                               final Iterable<? extends T3> third,
                                               final Iterable<? extends T4> fourth,
                                               final Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return Streamable.fromIterable(IterableX.super.zip4(second,
                                                            third,
                                                            fourth,
                                                            fn));
    }
    ...
    @Override
    default <S, U> Streamable<Tuple3<T, S, U>> zip3(final Iterable<? extends S> second,
                                                    final Iterable<? extends U> third) {
    ...
    /* (non-Javadoc)
     * @see cyclops.data.traversable.Traversable#zip4(java.util.stream.Stream, java.util.stream.Stream, java.util.stream.Stream)
     */
    @Override
    default <T2, T3, T4> Streamable<Tuple4<T, T2, T3, T4>> zip4(final Iterable<? extends T2> second,
                                                                final Iterable<? extends T3> third,
                                                                final Iterable<? extends T4> fourth) {
    ...
    /* (non-Javadoc)
     * @see cyclops.data.traversable.Traversable#groupedStatefullyUntil(java.util.function.BiPredicate)
     */
    @Override
    ...
    default Streamable<T> dropWhile(final Predicate<? super T> p) {
        ...
        return Streamable.fromStream(this.stream()
                                         .dropWhile(p));
    }
     ...
     */
    default <U> U foldLeft(final U identity,
                           final BiFunction<U, ? super T, U> function) {
        return this.stream()
                   .foldLeft(identity,
                             function);
    }
     ...
     */
    @Override
    default <U> U foldRight(final U seed,
     ...
     * @return this Streamable converted to an Optional List
     ...
     @Override default Optional<Seq<T>> optional() {
    ...
    default <R> Streamable<R> coflatMap(Function<? super Streamable<T>, ? extends R> fn) {
        return Streamable.fromStream(this.stream()
                                         .coflatMap(i -> fn.apply(Streamable.fromStream(i))));
    ...
    /**
     * Return a Streamable with elements before the provided skip index removed, and elements after the provided take index
     * removed
     *
     * <pre>
     * {@code
     ...
     */
    default Streamable<T> subStream(final int start,
                                    final int end) {
        return Streamable.fromStream(this.stream()
                                         .subStream(start,
                                                    end));
    ...
    default Tuple2<Option<T>, Streamable<T>> splitAtHead() {
        return this.stream()
                   .splitAtHead()
                   .map2(s -> Streamable.fromStream(s));
    }
     ...
     */
    @Override
    default Streamable<T> cycle(final Monoid<T> m,
                                final long times) {
     ...
     * </pre>
     */
    default <S, U> Streamable<Tuple3<T, S, U>> zip3(final Streamable<? extends S> second,
                                                    final Streamable<? extends U> third) {
        return fromStream(stream().zip3(second.stream(),
                                        third.stream()));
    }
     ...
     * </pre>
     */
    default <T2, T3, T4> Streamable<Tuple4<T, T2, T3, T4>> zip4(final Streamable<? extends T2> second,
                                                                final Streamable<? extends T3> third,
     ...
     */
    @Override
    default <U> Streamable<U> scanLeft(final U identity,
     ...
     */
    @Override
    default <U> Streamable<U> scanRight(final U identity,
     ...
     */
    @Override
    default boolean xMatch(final int num,
    ...
    /**
     * Attempt to transform this Monad to the same type as the supplied Monoid, using supplied function Then use Monoid to reduce
     * values
     *
     * <pre>
     *  {@code
     ...
     */
    @Override
    default <R> R foldMap(final Function<? super T, ? extends R> mapper,
     ...
     */
    default T reduce(final T identity,
    ...
    /**
     * Reduce with multiple reducers in parallel NB if this Monad is an Optional [Arrays.asList(1,2,3)]  reduce will operate on
     * the Optional as if the list was one value To reduce over the values on the list, called streamedMonad() first. I.e.
    ...
    @Override
    default Streamable<T> insertStreamAt(int pos,
                                         Stream<T> stream) {
        return fromStream(this.stream()
                              .insertStreamAt(pos,
                                              stream));
     ...
     */
    default Streamable<T> insertAt(final int pos,
                                   final T... values) {
        return fromStream(this.stream()
                              .insertAt(pos,
                                        values));
     ...
     */
    default Streamable<T> deleteBetween(final int start,
                                        final int end) {
        return fromStream(this.stream()
                              .deleteBetween(start,
                                             end));
     ...
     */
    default Streamable<T> insertStreamableAt(final int pos,
                                             final Streamable<T> stream) {
        return fromStream(this.stream()
                              .insertStreamAt(pos,
                                              stream.stream()));
    }
     ...
     */
    default Streamable<T> drop(final long time,
                               final TimeUnit unit) {
        return fromStream(this.stream()
                              .drop(time,
                                    unit));
     ...
     */
    default Streamable<T> take(final long time,
                               final TimeUnit unit) {
        return fromStream(this.stream()
                              .take(time,
                                    unit));
    ...
    /**
     * Turns this Streamable into a Connectable, a connectable Stream, being executed on a thread on the supplied executor, that
     * is producing data
     * <pre>
     * {@code
    ...
    @Override
    default Streamable<T> slice(final long from,
                                final long to) {
        return fromStream(this.stream()
                              .slice(from,
                                     to));
     ...
     */
    default ReactiveSeq<T> xPer(final int x,
                                final long time,
                                final TimeUnit t) {
        return this.stream()
                   .xPer(x,
     ...
     */
    default ReactiveSeq<T> onePer(final long time,
                                  final TimeUnit t) {
        return this.stream()
                   .onePer(time,
                           t);
     ...
     * @return
     */
    default Streamable<T> debounce(final long time,
                                   final TimeUnit t) {
        return fromStream(this.stream()
                              .debounce(time,
                                        t));
     ...
     */
    default Streamable<Vector<T>> groupedBySizeAndTime(final int size,
                                                       final long time,
                                                       final TimeUnit t) {
        return fromStream(this.stream()
     ...
     * @return Streamable batched by size and time
     */
    default <C extends PersistentCollection<? super T>> Streamable<C> groupedBySizeAndTime(final int size,
                                                                                           final long time,
                                                                                           final TimeUnit unit,
     ...
     */
    default Streamable<Vector<T>> groupedByTime(final long time,
                                                final TimeUnit t) {
        return fromStream(this.stream()
                              .groupedByTime(time,
                                             t));
     ...
     */
    default <C extends PersistentCollection<? super T>> Streamable<C> groupedByTime(final long time,
                                                                                    final TimeUnit unit,
                                                                                    final Supplier<C> factory) {
        return fromStream(this.stream()
                              .groupedByTime(time,
     ...
     */
    @Override
    default <C extends PersistentCollection<? super T>> Streamable<C> grouped(final int size,
     ...
     */
    default ReactiveSeq<T> fixedDelay(final long l,
                                      final TimeUnit unit) {
        return this.stream()
                   .fixedDelay(l,
                               unit);
     ...
     */
    @Override
    default <C extends PersistentCollection<? super T>> Streamable<C> groupedWhile(final Predicate<? super T> predicate,
                                                                                   final Supplier<C> factory) {
        return fromStream(this.stream()
                              .groupedWhile(predicate,
                                            factory));
     ...
     */
    @Override
    default <C extends PersistentCollection<? super T>> Streamable<C> groupedUntil(final Predicate<? super T> predicate,
                                                                                   final Supplier<C> factory) {
        return fromStream(this.stream()
                              .groupedUntil(predicate,
                                            factory));
     ...
     */
    default <EX extends Throwable> Streamable<T> recover(final Class<EX> exceptionClass,
                                                         final Function<? super EX, ? extends T> fn) {
        return fromStream(this.stream()
                              .recover(exceptionClass,
                                       fn));
