 ...
 */
public class Tuple1<T> implements To<Tuple1<T>>, Serializable, Transformable<T>, Filterable<T>, EqualTo<tuple1, T, Tuple1<T>>,
    ...
    public static <T, R> Tuple1<R> tailRec(T initial,
                                           Function<? super T, ? extends Tuple1<? extends Either<T, R>>> fn) {
    ...
    public int compareTo(Tuple1<T> o) {
        return Comparators.naturalOrderIdentityComparator()
                          .compare(_1(),
                                   o._1());
    }
    ...
    public <T2, R> Tuple1<R> zip(Tuple1<T2> t2,
                                 BiFunction<? super T, ? super T2, ? extends R> zipper) {
        return of(zipper.apply(_1(),
                               t2._1()));
    }

    public <T2, R> Tuple1<R> lazyZip(Tuple1<T2> t2,
                                     BiFunction<? super T, ? super T2, ? extends R> zipper) {
        return lazy(() -> zipper.apply(_1(),
                                       t2._1()));
    }
    ...
    public Option<T> filterNot(Predicate<? super T> predicate) {
        return (Option<T>) Filterable.super.filterNot(predicate);
    }
