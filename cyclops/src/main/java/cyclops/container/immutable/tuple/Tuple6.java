...
public class Tuple6<T1, T2, T3, T4, T5, T6> implements To<Tuple6<T1, T2, T3, T4, T5, T6>>, Serializable,
    ...
    public static <T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> lazy(Supplier<? extends T1> supplier1,
        ...
        return new Tuple6<T1, T2, T3, T4, T5, T6>(null,
                                                  null,
                                                  null,
                                                  null,
                                                  null,
    ...
    public <R1, R2, R3, R4, R5, R6> Tuple6<R1, R2, R3, R4, R5, R6> mapAll(Function<? super T1, ? extends R1> fn1,
    ...
    public <R1, R2, R3, R4, R5, R6> Tuple6<R1, R2, R3, R4, R5, R6> lazyMapAll(Function<? super T1, ? extends R1> fn1,
                                                                              Function<? super T2, ? extends R2> fn2,
                                                                              Function<? super T3, ? extends R3> fn3,
                                                                              Function<? super T4, ? extends R4> fn4,
                                                                              Function<? super T5, ? extends R5> fn5,
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof Tuple6)) {
            return false;
        }
        Tuple6<?, ?, ?, ?, ?, ?> tuple6 = (Tuple6<?, ?, ?, ?, ?, ?>) o;
        return Objects.equals(_1(),
                              tuple6._1()) && Objects.equals(_2(),
                                                             tuple6._2()) && Objects.equals(_3(),
                                                                                            tuple6._3()) && Objects.equals(_4(),
                                                                                                                           tuple6._4())
            && Objects.equals(_5(),
                              tuple6._5()) && Objects.equals(_6(),
                                                             tuple6._6());
    }
