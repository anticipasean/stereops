...
import cyclops.function.hkt.DataWitness.tuple3;
...
public class Tuple3<T1, T2, T3> implements To<Tuple3<T1, T2, T3>>, Serializable, Higher3<tuple3, T1, T2, T3>,
    ...
    public static <T1, T2, T3> Tuple3<T1, T2, T3> of(T1 value1,
                                                     T2 value2,
                                                     T3 value3) {
        return new Tuple3<>(value1,
                            value2,
                            value3);
    }

    public static <T1, T2, T3> Tuple3<T1, T2, T3> lazy(Supplier<? extends T1> supplier1,
                                                       Supplier<? extends T2> supplier2,
                                                       Supplier<? extends T3> supplier3) {
        return new Tuple3<T1, T2, T3>(null,
                                      null,
                                      null) {
            @Override
            public T1 _1() {
    ...
    public <R> Tuple3<T1, T2, R> flatMap(Monoid<T1> m1,
                                         Monoid<T2> m2,
                                         Function<? super T3, ? extends Tuple3<T1, T2, R>> fn) {
        return fn.apply(_3())
                 .map1(t1 -> m1.apply(t1,
                                      _1()))
                 .map2(t2 -> m2.apply(t2,
    ...
    public <R1, R2, R3> Tuple3<R1, R2, R3> mapAll(Function<? super T1, ? extends R1> fn1,
    ...
    public <R1, R2, R3> Tuple3<R1, R2, R3> lazyMapAll(Function<? super T1, ? extends R1> fn1,
                                                      Function<? super T2, ? extends R2> fn2,
                                                      Function<? super T3, ? extends R3> fn3) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(_1(),
                              tuple3._1()) && Objects.equals(_2(),
                                                             tuple3._2()) && Objects.equals(_3(),
                                                                                            tuple3._3());
    }
