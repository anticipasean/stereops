...
import cyclops.function.hkt.DataWitness.tuple4;
import cyclops.function.hkt.Higher;
import cyclops.function.hkt.Higher4;
import cyclops.container.comparative.EqualTo;
import cyclops.function.order.OrderedBy;
...
public class Tuple4<T1, T2, T3, T4> implements To<Tuple4<T1, T2, T3, T4>>, Serializable, Higher4<tuple4, T1, T2, T3, T4>,
    ...
    public static <T1, T2, T3, T4> Tuple4<T1, T2, T3, T4> lazy(Supplier<? extends T1> supplier1,
        ...
        return new Tuple4<T1, T2, T3, T4>(null,
                                          null,
                                          null,
                                          null) {
            @Override
    ...
    public <R> Tuple4<T1, T2, T3, R> flatMap(Monoid<T1> m1,
                                             Monoid<T2> m2,
                                             Monoid<T3> m3,
                                             Function<? super T4, ? extends Tuple4<T1, T2, T3, R>> fn) {
        return fn.apply(_4())
                 .map1(t1 -> m1.apply(t1,
                                      _1()))
                 .map2(t2 -> m2.apply(t2,
    ...
    public <R1, R2, R3, R4> Tuple4<R1, R2, R3, R4> mapAll(Function<? super T1, ? extends R1> fn1,
    ...
    public <R1, R2, R3, R4> Tuple4<R1, R2, R3, R4> lazyMapAll(Function<? super T1, ? extends R1> fn1,
                                                              Function<? super T2, ? extends R2> fn2,
                                                              Function<? super T3, ? extends R3> fn3,
                                                              Function<? super T4, ? extends R4> fn4) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof Tuple4)) {
            return false;
        }
        Tuple4<?, ?, ?, ?> tuple4 = (Tuple4<?, ?, ?, ?>) o;
        return Objects.equals(_1(),
                              tuple4._1()) && Objects.equals(_2(),
                                                             tuple4._2()) && Objects.equals(_3(),
                                                                                            tuple4._3()) && Objects.equals(_4(),
                                                                                                                           tuple4._4());
    }
