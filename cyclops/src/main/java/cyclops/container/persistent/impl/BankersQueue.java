...
import cyclops.function.hkt.DataWitness.bankersQueue;
...
public interface BankersQueue<T> extends ImmutableQueue<T>, Higher<bankersQueue, T>, Serializable {
    ...
    static <T> Collector<T, List<T>, BankersQueue<T>> collector() {
        ...
        return Collectors.<T, List<T>, Iterable<T>, BankersQueue<T>>collectingAndThen((Collector) c,
                                                                                      BankersQueue::fromIterable);
    }
    ...
    default Tuple2<T, BankersQueue<T>> dequeue(T defaultValue) {
        return foldBankersQueue(c -> c.dequeue(),
                                n -> Tuple.tuple(defaultValue,
                                                 this));
    }
    ...
    BankersQueue<T> replace(T currentElement,
                            T newElement);
    ...
    <R> R foldBankersQueue(Function<? super Cons<T>, ? extends R> fn1,
                           Function<? super Nil<T>, ? extends R> fn2);

    default BankersQueue<T> tail() {
        return foldBankersQueue(cons -> cons,
                                nil -> nil);
    }
    ...
    default BankersQueue<T> prependAll(Iterable<? extends T> value) {
        ...
        Iterator<? extends T> it = ReactiveSeq.fromIterable(value)
                                              .reverse()
                                              .iterator();
    ...
    default BankersQueue<T> removeValue(T value) {
        return removeFirst(e -> Objects.equals(e,
                                               value));
    }
    ...
    default <R1, R2> Tuple2<BankersQueue<R1>, BankersQueue<R2>> unzip(Function<? super T, Tuple2<? extends R1, ? extends R2>> fn) {
        Tuple2<BankersQueue<R1>, BankersQueue<Tuple2<? extends R1, ? extends R2>>> x = map(fn).duplicate()
    ...
    @Override
    <R> BankersQueue<R> mergeMap(int maxConcurecy,
    ...
    @Override
    default <T2, R> BankersQueue<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
                                        Publisher<? extends T2> publisher) {
        return (BankersQueue<R>) ImmutableQueue.super.zip(fn,
                                                          publisher);
    }

    @Override
    default <U, R> BankersQueue<R> zipWithStream(Stream<? extends U> other,
                                                 BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (BankersQueue<R>) ImmutableQueue.super.zipWithStream(other,
                                                                    zipper);
    }
    ...
    @Override
    default <S, U, R> BankersQueue<R> zip3(Iterable<? extends S> second,
                                           Iterable<? extends U> third,
                                           Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (BankersQueue<R>) ImmutableQueue.super.zip3(second,
                                                           third,
                                                           fn3);
    }

    @Override
    default <T2, T3, T4, R> BankersQueue<R> zip4(Iterable<? extends T2> second,
                                                 Iterable<? extends T3> third,
                                                 Iterable<? extends T4> fourth,
                                                 Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (BankersQueue<R>) ImmutableQueue.super.zip4(second,
                                                           third,
                                                           fourth,
                                                           fn);
    }
    ...
    @Override
    default BankersQueue<T> combine(BiPredicate<? super T, ? super T> predicate,
                                    BinaryOperator<T> op) {
        return (BankersQueue<T>) ImmutableQueue.super.combine(predicate,
                                                              op);
    }

    @Override
    default BankersQueue<T> combine(Monoid<T> op,
                                    BiPredicate<? super T, ? super T> predicate) {
        return (BankersQueue<T>) ImmutableQueue.super.combine(op,
                                                              predicate);
    }
    ...
    @Override
    default BankersQueue<T> cycle(Monoid<T> m,
                                  long times) {
        return (BankersQueue<T>) ImmutableQueue.super.cycle(m,
                                                            times);
    }
    ...
    @Override
    default <U, R> BankersQueue<R> zip(Iterable<? extends U> other,
                                       BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (BankersQueue<R>) ImmutableQueue.super.zip(other,
                                                          zipper);
    }

    @Override
    default <S, U> BankersQueue<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                                      Iterable<? extends U> third) {
        return (BankersQueue) ImmutableQueue.super.zip3(second,
                                                        third);
    }

    @Override
    default <T2, T3, T4> BankersQueue<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
                                                                  Iterable<? extends T3> third,
                                                                  Iterable<? extends T4> fourth) {
        return (BankersQueue) ImmutableQueue.super.zip4(second,
                                                        third,
                                                        fourth);
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> BankersQueue<C> grouped(int size,
                                                                                Supplier<C> supplier) {
        return (BankersQueue<C>) ImmutableQueue.super.grouped(size,
                                                              supplier);
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> BankersQueue<C> groupedWhile(Predicate<? super T> predicate,
                                                                                     Supplier<C> factory) {
        return (BankersQueue<C>) ImmutableQueue.super.groupedWhile(predicate,
                                                                   factory);
    }

    @Override
    default <C extends PersistentCollection<? super T>> BankersQueue<C> groupedUntil(Predicate<? super T> predicate,
                                                                                     Supplier<C> factory) {
        return (BankersQueue<C>) ImmutableQueue.super.groupedUntil(predicate,
                                                                   factory);
    }
    ...
    @Override
    default <U> BankersQueue<U> scanLeft(U seed,
                                         BiFunction<? super U, ? super T, ? extends U> function) {
        return (BankersQueue<U>) ImmutableQueue.super.scanLeft(seed,
                                                               function);
    }
    ...
    @Override
    default <U> BankersQueue<U> scanRight(U identity,
                                          BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (BankersQueue<U>) ImmutableQueue.super.scanRight(identity,
                                                                combiner);
    }
    ...
    @Override
    default BankersQueue<T> slice(long from,
                                  long to) {
        return (BankersQueue<T>) ImmutableQueue.super.slice(from,
                                                            to);
    }
    ...
    @Override
    default BankersQueue<T> deleteBetween(int start,
                                          int end) {
        return (BankersQueue<T>) ImmutableQueue.super.deleteBetween(start,
                                                                    end);
    }

    @Override
    default BankersQueue<T> insertStreamAt(int pos,
                                           Stream<T> stream) {
        return (BankersQueue<T>) ImmutableQueue.super.insertStreamAt(pos,
                                                                     stream);
    }
    ...
    @Override
    default <R1, R2, R3, R> BankersQueue<R> forEach4(Function<? super T, ? extends Iterable<R1>> iterable1,
        ...
        return (BankersQueue<R>) ImmutableQueue.super.forEach4(iterable1,
                                                               iterable2,
                                                               iterable3,
                                                               yieldingFunction);
    }
    ...
    @Override
    default <R1, R2, R> BankersQueue<R> forEach3(Function<? super T, ? extends Iterable<R1>> iterable1,
                                                 BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
                                                 Function3<? super T, ? super R1, ? super R2, ? extends R> yieldingFunction) {
        return (BankersQueue<R>) ImmutableQueue.super.forEach3(iterable1,
                                                               iterable2,
                                                               yieldingFunction);
    }
    ...
    @Override
    default <R1, R> BankersQueue<R> forEach2(Function<? super T, ? extends Iterable<R1>> iterable1,
                                             BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (BankersQueue<R>) ImmutableQueue.super.forEach2(iterable1,
                                                               yieldingFunction);
    }
    ...
    @Override
    default BankersQueue<T> updateAt(int pos,
                                     T value) {
        return (BankersQueue<T>) ImmutableQueue.super.updateAt(pos,
                                                               value);
    }

    @Override
    default BankersQueue<T> insertAt(int pos,
                                     Iterable<? extends T> values) {
        return (BankersQueue<T>) ImmutableQueue.super.insertAt(pos,
                                                               values);
    }

    @Override
    default BankersQueue<T> insertAt(int i,
                                     T value) {
        return (BankersQueue<T>) ImmutableQueue.super.insertAt(i,
                                                               value);
    }
    ...
    public static final class Cons<T> implements BankersQueue<T>, ImmutableQueue.Some<T> {
        ...
        private Cons(ImmutableList<T> front,
                     ImmutableList<T> back) {
        ...
        private static <T> BankersQueue<T> check(Cons<T> check) {
            ...
            return new Cons((check.sizeFront + check.sizeBack),
                            check.front.appendAll(check.back.reverse()),
                            0,
                            LazySeq.empty());
        }
        ...
        public BankersQueue<T> enqueue(T value) {
            return check(new Cons(sizeFront,
                                  front,
                                  sizeBack + 1,
                                  back.prepend(value)));
        }
        ...
        public <R> BankersQueue<R> flatMap(Function<? super T, ? extends ImmutableQueue<? extends R>> fn) {
            return check(new Cons(sizeFront,
                                  front.flatMap(fn.andThen(q -> q.lazySeq())),
                                  sizeBack,
                                  back.flatMap(fn.andThen(q -> q.lazySeq()))));
        }
        ...
        @Override
        public <R> BankersQueue<R> mergeMap(int maxConcurecy,
                                            Function<? super T, ? extends Publisher<? extends R>> fn) {
        ...
        @Override
        public <R> R foldBankersQueue(Function<? super Cons<T>, ? extends R> fn1,
                                      Function<? super Nil<T>, ? extends R> fn2) {
            return fn1.apply(this);
        }
        ...
        public Tuple2<T, BankersQueue<T>> dequeue() {
            ...
            return front.fold(cons -> cons.fold((head, tail) -> Tuple.tuple(head,
                                                                            tail())),
                              nil -> {
        ...
        public T head() {
            return front.fold(s -> s.fold((h, t) -> h),
                              n -> back.fold(s2 -> s2.fold((h2, t2) -> h2),
                                             nil -> {
                                                 throw new RuntimeException("Unreachable!");
                                             }));
        }
        ...
        public BankersQueue<T> tail() {
            ...
            if (sizeFront == 0) {
                return BankersQueue.ofAll(back.fold(s -> s.fold((h, t) -> t),
                                                    n -> n));
            }
            if (sizeFront == 1) {
                return ofAll(back);
            }
            return new BankersQueue.Cons<>(sizeFront - 1,
                                           front.fold(s -> s.fold((h, t) -> t),
                                                      n -> n),
                                           sizeBack,
                                           back);
        ...
        public BankersQueue<T> replace(T currentElement,
                                       T newElement) {
            ImmutableList<T> replaceF = front.replaceFirst(currentElement,
                                                           newElement);
            ImmutableList<T> replaceB = back.replaceFirst(currentElement,
                                                          newElement);
            return front == replaceF && back == replaceB ? this : new Cons<>(replaceF,
                                                                             replaceB);
        }
        ...
        @Override
        public T getOrElse(int n,
                           T alt) {
            if (n < sizeFront) {
                return front.getOrElse(sizeFront - n - 1,
                                       alt);
            } else if (n < sizeFront + sizeBack) {
                int pos = n - sizeFront;
                return back.getOrElse(sizeBack - pos - 1,
                                      alt);
            }
            return alt;
        }
