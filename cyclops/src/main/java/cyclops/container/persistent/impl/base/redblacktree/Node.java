package cyclops.container.persistent.impl.base.redblacktree;

import cyclops.matching.Deconstruct.Deconstruct5;
...
@Getter
public final class Node<K, V> implements Tree<K, V>, Deconstruct5<Boolean, Tree<K, V>, Tree<K, V>, K, V> {
    ...
    static <K, V> cyclops.container.persistent.impl.base.redblacktree.Node<K, V> RED(Tree<K, V> left,
                                                                                     Tree<K, V> right,
                                                                                     K key,
                                                                                     V value,
                                                                                     Comparator<? super K> comp) {
        return new cyclops.container.persistent.impl.base.redblacktree.Node(false,
                                                                            left,
                                                                            right,
                                                                            key,
                                                                            value,
    ...
    static <K, V> cyclops.container.persistent.impl.base.redblacktree.Node<K, V> BLACK(Tree<K, V> left,
                                                                                       Tree<K, V> right,
                                                                                       K key,
                                                                                       V value,
                                                                                       Comparator<? super K> comp) {
        return new cyclops.container.persistent.impl.base.redblacktree.Node(true,
                                                                            left,
                                                                            right,
                                                                            key,
                                                                            value,
    ...
    static <K, V> cyclops.container.persistent.impl.base.redblacktree.Node<K, V> LEFT_BLACK(Tree<K, V> left,
                                                                                            Tree<K, V> right,
                                                                                            K key,
                                                                                            V value,
                                                                                            Comparator<? super K> comp) {
    ...
    static <K, V> cyclops.container.persistent.impl.base.redblacktree.Node<K, V> RIGHT_BLACK(Tree<K, V> left,
                                                                                             Tree<K, V> right,
                                                                                             K key,
                                                                                             V value,
                                                                                             Comparator<? super K> comp) {
    ...
    public Tree<K, V> plus(K key,
        ...
        if (compRes > 0) {
            ...
            return new cyclops.container.persistent.impl.base.redblacktree.Node(isBlack,
                                                                                left,
                                                                                right,
                                                                                key,
                                                                                value,
    ...
    @Override
    public <R> R fold(Function<? super cyclops.container.persistent.impl.base.redblacktree.Node<K, V>, ? extends R> fn1,
    ...
    public cyclops.container.persistent.impl.base.redblacktree.Node<K, V> withBlack(boolean black) {
        return new cyclops.container.persistent.impl.base.redblacktree.Node<>(black,
                                                                              this.left,
                                                                              this.right,
                                                                              this.key,
                                                                              this.value,
