...
import cyclops.function.hkt.DataWitness.treeMap;
...
public final class TreeMap<K, V> implements ImmutableMap<K, V>, Higher2<treeMap, K, V>, Serializable {
    ...
    public static <K, V> TreeMap<K, V> empty(Comparator<K> comp) {
        return new TreeMap<>(RedBlackTree.empty(comp),
                             comp);
    }

    public static <K, V> TreeMap<K, V> of(Comparator<K> comp,
                                          K k,
                                          V v) {
        return TreeMap.<K, V>empty(comp).put(k,
                                             v);
    }
    ...
    public static <K, V> TreeMap<K, V> of(Comparator<K> comp,
                                          ...
                                          K k2,
                                          V v2) {
        return TreeMap.<K, V>empty(comp).put(k1,
                                             v1)
                                        .put(k2,
                                             v2);
    }

    public static <K, V> TreeMap<K, V> fromStream(Stream<Tuple2<K, V>> stream,
                                                  Comparator<K> comp) {
    ...
    public static <K, V> TreeMap<K, V> fromMap(Comparator<K> comp,
                                               Map<K, V> map) {
        Stream<Tuple2<K, V>> s = map.entrySet()
                                    .stream()
                                    .map(e -> Tuple.tuple(e.getKey(),
                                                          e.getValue()));
        return new TreeMap<>(RedBlackTree.fromStream(comp,
                                                     s),
                             comp);
    }
    ...
    @Override
    public <R1, R2> TreeMap<R1, R2> bimap(Function<? super K, ? extends R1> fn1,
    ...
    public <KR, VR> TreeMap<KR, VR> bimap(Comparator<KR> comp,
                                          Function<? super K, ? extends KR> keyMapper,
                                          Function<? super V, ? extends VR> valueMapper) {
        ReactiveSeq<? extends Tuple2<? extends KR, ? extends VR>> s = map.stream()
                                                                         .map(t -> t.transform((k, v) -> Tuple.tuple(keyMapper.apply(k),
                                                                                                                     valueMapper.apply(v))));
        return new TreeMap<>(RedBlackTree.fromStream(comp,
                                                     s),
                             comp);
    ...
    @Override
    public TreeMap<K, V> put(K key,
                             V value) {
        return new TreeMap<K, V>(map.plus(key,
                                          value),
                                 comparator);
    }
    ...
    public TreeMap<K, V> put(Tuple2<K, V> keyAndValue) {
        return new TreeMap<K, V>(map.plus(keyAndValue._1(),
                                          keyAndValue._2()),
                                 comparator);
    }
    ...
    @Override
    public TreeMap<K, V> bipeek(Consumer<? super K> c1,
                                Consumer<? super V> c2) {
        return (TreeMap<K, V>) ImmutableMap.super.bipeek(c1,
                                                         c2);
    }
    ...
    @Override
    public <K1, K2, K3, K4, R1, R2, R3, R> TreeMap<K4, R> forEach4(Function<? super Tuple2<K, V>, ? extends Iterable<Tuple2<K1, R1>>> iterable1,
        ...
        return (TreeMap<K4, R>) ImmutableMap.super.forEach4(iterable1,
                                                            iterable2,
                                                            iterable3,
                                                            yieldingFunction);
    }
    ...
    @Override
    public <K1, K2, K3, R1, R2, R> TreeMap<K3, R> forEach3(Function<? super Tuple2<K, V>, ? extends Iterable<Tuple2<K1, R1>>> iterable1,
                                                           BiFunction<? super Tuple2<K, V>, ? super Tuple2<K1, R1>, ? extends Iterable<Tuple2<K2, R2>>> iterable2,
                                                           Function3<? super Tuple2<K, V>, ? super Tuple2<K1, R1>, ? super Tuple2<K2, R2>, ? extends Tuple2<K3, R>> yieldingFunction) {
        return (TreeMap<K3, R>) ImmutableMap.super.forEach3(iterable1,
                                                            iterable2,
                                                            yieldingFunction);
    }
    ...
    @Override
    public <K1, K2, R1, R> TreeMap<K2, R> forEach2(Function<? super Tuple2<K, V>, ? extends Iterable<Tuple2<K1, R1>>> iterable1,
                                                   BiFunction<? super Tuple2<K, V>, ? super Tuple2<K1, R1>, ? extends Tuple2<K2, R>> yieldingFunction) {
        return (TreeMap<K2, R>) ImmutableMap.super.forEach2(iterable1,
                                                            yieldingFunction);
