...
import cyclops.function.hkt.DataWitness.hashSet;
import cyclops.function.hkt.Higher;
import cyclops.container.persistent.PersistentCollection;
import cyclops.container.persistent.PersistentSet;
import cyclops.control.Option;
import cyclops.container.persistent.impl.base.HAMT;
...
public final class HashSet<T> implements ImmutableSet<T>, Higher<hashSet, T>, Serializable {
    ...
    static <T> Collector<T, Set<T>, HashSet<T>> collector() {
        ...
        return Collectors.<T, Set<T>, Iterable<T>, HashSet<T>>collectingAndThen((Collector) c,
    ...
    public static <U, T> HashSet<T> unfold(final U seed,
                                           final Function<? super U, Option<Tuple2<T, U>>> unfolder) {
        return fromStream(ReactiveSeq.unfold(seed,
                                             unfolder));
    }

    public static <T> HashSet<T> iterate(final T seed,
    ...
    public static <T> HashSet<T> generate(Supplier<T> s,
                                          int max) {
    ...
    public static HashSet<Integer> range(final int start,
                                         final int end) {
        return HashSet.fromStream(ReactiveSeq.range(start,
                                                    end));
    ...
    public static HashSet<Long> rangeLong(final long start,
                                          final long step,
                                          final long end) {
        return HashSet.fromStream(ReactiveSeq.rangeLong(start,
                                                        step,
                                                        end));
    }
    ...
    public HashSet<T> removeValue(T value) {
        return new HashSet<>(map.minus(0,
                                       value.hashCode(),
                                       value));
    }
    ...
    @Override
    public <R> HashSet<R> mergeMap(Function<? super T, ? extends Publisher<? extends R>> fn) {
        return fromStream(stream().mergeMap(fn));
    }

    @Override
    public <R> HashSet<R> mergeMap(int maxConcurecy,
    ...
    @Override
    public <R1, R2, R3, R> HashSet<R> forEach4(Function<? super T, ? extends Iterable<R1>> iterable1,
        ...
        return (HashSet<R>) ImmutableSet.super.forEach4(iterable1,
                                                        iterable2,
                                                        iterable3,
                                                        yieldingFunction);
    }
    ...
    @Override
    public <R1, R2, R> HashSet<R> forEach3(Function<? super T, ? extends Iterable<R1>> iterable1,
                                           BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
                                           Function3<? super T, ? super R1, ? super R2, ? extends R> yieldingFunction) {
        return (HashSet<R>) ImmutableSet.super.forEach3(iterable1,
                                                        iterable2,
                                                        yieldingFunction);
    }
    ...
    @Override
    public <R1, R> HashSet<R> forEach2(Function<? super T, ? extends Iterable<R1>> iterable1,
                                       BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (HashSet<R>) ImmutableSet.super.forEach2(iterable1,
                                                        yieldingFunction);
    }
    ...
    public <R1, R2> Tuple2<HashSet<R1>, HashSet<R2>> unzip(Function<? super T, Tuple2<? extends R1, ? extends R2>> fn) {
        Tuple2<HashSet<R1>, HashSet<Tuple2<? extends R1, ? extends R2>>> x = map(fn).duplicate()
    ...
    @Override
    public <T2, R> HashSet<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
                                  Publisher<? extends T2> publisher) {
        return (HashSet<R>) ImmutableSet.super.zip(fn,
                                                   publisher);
    }

    @Override
    public <U, R> HashSet<R> zipWithStream(Stream<? extends U> other,
                                           BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (HashSet<R>) ImmutableSet.super.zipWithStream(other,
                                                             zipper);
    }
    ...
    @Override
    public <S, U, R> HashSet<R> zip3(Iterable<? extends S> second,
                                     Iterable<? extends U> third,
                                     Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (HashSet<R>) ImmutableSet.super.zip3(second,
                                                    third,
                                                    fn3);
    }

    @Override
    public <T2, T3, T4, R> HashSet<R> zip4(Iterable<? extends T2> second,
                                           Iterable<? extends T3> third,
                                           Iterable<? extends T4> fourth,
                                           Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (HashSet<R>) ImmutableSet.super.zip4(second,
                                                    third,
                                                    fourth,
                                                    fn);
    }
    ...
    @Override
    public HashSet<T> combine(BiPredicate<? super T, ? super T> predicate,
                              BinaryOperator<T> op) {
        return (HashSet<T>) ImmutableSet.super.combine(predicate,
                                                       op);
    }

    @Override
    public HashSet<T> combine(Monoid<T> op,
                              BiPredicate<? super T, ? super T> predicate) {
        return (HashSet<T>) ImmutableSet.super.combine(op,
                                                       predicate);
    }
    ...
    @Override
    public HashSet<T> cycle(Monoid<T> m,
                            long times) {
        return (HashSet<T>) ImmutableSet.super.cycle(m,
                                                     times);
    }
    ...
    @Override
    public <U, R> HashSet<R> zip(Iterable<? extends U> other,
                                 BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (HashSet<R>) ImmutableSet.super.zip(other,
                                                   zipper);
    }

    @Override
    public <S, U> HashSet<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                                Iterable<? extends U> third) {
        return (HashSet) ImmutableSet.super.zip3(second,
                                                 third);
    }

    @Override
    public <T2, T3, T4> HashSet<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
                                                            Iterable<? extends T3> third,
                                                            Iterable<? extends T4> fourth) {
        return (HashSet) ImmutableSet.super.zip4(second,
                                                 third,
                                                 fourth);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> HashSet<C> grouped(int size,
                                                                          Supplier<C> supplier) {
        return (HashSet<C>) ImmutableSet.super.grouped(size,
                                                       supplier);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> HashSet<C> groupedWhile(Predicate<? super T> predicate,
                                                                               Supplier<C> factory) {
        return (HashSet<C>) ImmutableSet.super.groupedWhile(predicate,
                                                            factory);
    }

    @Override
    public <C extends PersistentCollection<? super T>> HashSet<C> groupedUntil(Predicate<? super T> predicate,
                                                                               Supplier<C> factory) {
        return (HashSet<C>) ImmutableSet.super.groupedUntil(predicate,
                                                            factory);
    }
    ...
    @Override
    public <U> HashSet<U> scanLeft(U seed,
                                   BiFunction<? super U, ? super T, ? extends U> function) {
        return (HashSet<U>) ImmutableSet.super.scanLeft(seed,
                                                        function);
    }
    ...
    @Override
    public <U> HashSet<U> scanRight(U identity,
                                    BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (HashSet<U>) ImmutableSet.super.scanRight(identity,
                                                         combiner);
    }
    ...
    @Override
    public HashSet<T> slice(long from,
                            long to) {
        return (HashSet<T>) ImmutableSet.super.slice(from,
                                                     to);
    }
    ...
    @Override
    public HashSet<T> deleteBetween(int start,
                                    int end) {
        return (HashSet<T>) ImmutableSet.super.deleteBetween(start,
                                                             end);
    }

    @Override
    public HashSet<T> insertStreamAt(int pos,
                                     Stream<T> stream) {
        return (HashSet<T>) ImmutableSet.super.insertStreamAt(pos,
                                                              stream);
    }
    ...
    @Override
    public HashSet<T> updateAt(int pos,
                               T value) {
        return (HashSet<T>) ImmutableSet.super.updateAt(pos,
                                                        value);
    }

    @Override
    public HashSet<T> insertAt(int pos,
                               Iterable<? extends T> values) {
        return (HashSet<T>) ImmutableSet.super.insertAt(pos,
                                                        values);
    }

    @Override
    public HashSet<T> insertAt(int i,
                               T value) {
        return (HashSet<T>) ImmutableSet.super.insertAt(i,
                                                        value);
    }
