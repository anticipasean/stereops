...
public interface ImmutableSortedSet<T> extends ImmutableSet<T>, PersistentSortedSet<T> {
    ...
    ImmutableSortedSet<T> subSet(T fromElement,
                                 T toElement);
    ...
    @Override
    <R> ImmutableSortedSet<R> mergeMap(int maxConcurecy,
    ...
    @Override
    default <R1, R2, R3, R> ImmutableSortedSet<R> forEach4(Function<? super T, ? extends Iterable<R1>> iterable1,
        ...
        return (ImmutableSortedSet<R>) ImmutableSet.super.forEach4(iterable1,
                                                                   iterable2,
                                                                   iterable3,
                                                                   yieldingFunction);
    }
    ...
    @Override
    default <R1, R2, R> ImmutableSortedSet<R> forEach3(Function<? super T, ? extends Iterable<R1>> iterable1,
                                                       BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
                                                       Function3<? super T, ? super R1, ? super R2, ? extends R> yieldingFunction) {
        return (ImmutableSortedSet<R>) ImmutableSet.super.forEach3(iterable1,
                                                                   iterable2,
                                                                   yieldingFunction);
    }
    ...
    @Override
    default <R1, R> ImmutableSortedSet<R> forEach2(Function<? super T, ? extends Iterable<R1>> iterable1,
                                                   BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (ImmutableSortedSet<R>) ImmutableSet.super.forEach2(iterable1,
                                                                   yieldingFunction);
    }
    ...
    ImmutableSortedSet<T> unitStream(Stream<T> stream,
    ...
    @Override
    default <T2, R> ImmutableSortedSet<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
    ...
    @Override
    default <U, R> ImmutableSortedSet<R> zipWithStream(Stream<? extends U> other,
    ...
    @Override
    default <S, U, R> ImmutableSortedSet<R> zip3(Iterable<? extends S> second,
    ...
    @Override
    default <T2, T3, T4, R> ImmutableSortedSet<R> zip4(Iterable<? extends T2> second,
    ...
    @Override
    default ImmutableSortedSet<T> combine(BiPredicate<? super T, ? super T> predicate,
                                          BinaryOperator<T> op) {
    ...
    @Override
    default ImmutableSortedSet<T> combine(Monoid<T> op,
    ...
    @Override
    default ImmutableSortedSet<T> cycle(Monoid<T> m,
                                        long times) {
    ...
    @Override
    default <U, R> ImmutableSortedSet<R> zip(Iterable<? extends U> other,
                                             BiFunction<? super T, ? super U, ? extends R> zipper) {
        return unitStream(stream().zip(other,
                                       zipper));
    }
    ...
    @Override
    default <S, U> ImmutableSortedSet<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                                            Iterable<? extends U> third) {
        return unitStream(stream().zip3(second,
                                        third));
    }
    ...
    @Override
    default <T2, T3, T4> ImmutableSortedSet<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
                                                                        Iterable<? extends T3> third,
                                                                        Iterable<? extends T4> fourth) {
        return unitStream(stream().zip4(second,
                                        third,
    ...
    @Override
    default <C extends PersistentCollection<? super T>> ImmutableSortedSet<C> grouped(int size,
                                                                                      Supplier<C> supplier) {
    ...
    @Override
    default <C extends PersistentCollection<? super T>> ImmutableSortedSet<C> groupedWhile(Predicate<? super T> predicate,
                                                                                           Supplier<C> factory) {
        return unitStream(stream().groupedWhile(predicate,
                                                factory));
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> ImmutableSortedSet<C> groupedUntil(Predicate<? super T> predicate,
                                                                                           Supplier<C> factory) {
        return unitStream(stream().groupedUntil(predicate,
                                                factory));
    }
    ...
    @Override
    default <U> ImmutableSortedSet<U> scanLeft(U seed,
    ...
    @Override
    default <U> ImmutableSortedSet<U> scanRight(U identity,
    ...
    @Override
    default ImmutableSortedSet<T> slice(long from,
                                        long to) {
    ...
    @Override
    default ImmutableSortedSet<T> insertAt(int pos,
                                           T... values) {
    ...
    @Override
    default ImmutableSortedSet<T> deleteBetween(int start,
                                                int end) {
    ...
    @Override
    default ImmutableSortedSet<T> insertStreamAt(int pos,
                                                 Stream<T> stream) {
