...
public interface IntPatriciaTrie<V> {
    ...
    static <V> Node<V>[] emptyArray() {
        return Arrays.copyOf((Node<V>[]) EMPTY_ARRAY,
                             BUCKET_SIZE);
    }
    ...
    static class EmptyNode<V> implements Node<V> {
        ...
        @Override
        public <R> R fold(Function<? super EmptyNode<V>, ? extends R> fn1,
                          Function<? super SingleNode<V>, ? extends R> fn2,
                          Function<? super ArrayNode<V>, ? extends R> fn4) {
    ...
    static class ArrayNode<V> implements Node<V>, Deconstruct1<Node<V>[]> {
        ...
        public Node<V> put(int hash,
            ...
            int newHash = hash >>> BITS;
            int index = hash & MASK;
            Node<V>[] newNodes = Arrays.copyOf(nodes,
                                               nodes.length);
        ...
        /**
         * @Override public ReactiveSeq<V> stream() { return ReactiveSeq.of(nodes).flatMap(n->n.stream()); }
         **/
        @Override
        public boolean isEmpty() {
