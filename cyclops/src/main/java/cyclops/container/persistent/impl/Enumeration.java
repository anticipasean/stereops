...
public interface Enumeration<E> {
    ...
    default E toEnumOrElse(int e,
                           E value) {
        return toEnum(e).orElse(value);
    }

    default E toEnumOrElseGet(int e,
                              Supplier<? extends E> value) {
        return toEnum(e).orElse(value.get());
    }

    default E succOrElse(E e,
                         E value) {
        return toEnumOrElse(fromEnum(e) + 1,
                            value);
    }

    default E predOrElse(E e,
                         E value) {
        return toEnumOrElse(fromEnum(e) - 1,
                            value);
    }

    default E succOrElseGet(E e,
                            Supplier<? extends E> value) {
        return toEnumOrElseGet(fromEnum(e) + 1,
                               value);
    }

    default E predOrElseGet(E e,
                            Supplier<? extends E> value) {
        return toEnumOrElseGet(fromEnum(e) - 1,
                               value);
    }
    ...
    default ReactiveSeq<E> streamTo(E e,
                                    E end) {
        return ReactiveSeq.range(fromEnum(e),
                                 fromEnum(end))
                          .map(this::toEnum)
    ...
    default ReactiveSeq<E> streamThenTo(E e,
                                        E next,
                                        E end) {
    ...
    static class EnumerationByEnum<E extends Enum<E>> implements Enumeration<E> {
        ...
        public E toEnumOrElse(int a,
                              E e) {

            return a > -1 && a < values.length ? values[a] : e;
        }

        public E toEnumOrElseGet(int a,
                                 Supplier<? extends E> e) {
    ...
    static class EnumerationByIndexed<E> implements Enumeration<E> {
        ...
        @Override
        public E toEnumOrElse(int e,
                              E value) {
            return seq.getOrElse(e,
                                 value);
        }

        @Override
        public E toEnumOrElseGet(int e,
                                 Supplier<? extends E> value) {
            return seq.getOrElseGet(e,
                                    value);
        }
