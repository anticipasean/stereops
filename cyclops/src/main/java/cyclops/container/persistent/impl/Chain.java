...
public abstract class Chain<T> implements ImmutableList<T> {
    ...
    public static <T> NonEmptyChain<T> append(NonEmptyChain<? extends T> left,
                                              NonEmptyChain<? extends T> right) {
        return new Append(left,
                          right);
    }

    public static <T> NonEmptyChain<T> append(Chain<? extends T> left,
                                              NonEmptyChain<? extends T> right) {
        return left.isEmpty() ? (NonEmptyChain<T>) right : new Append((NonEmptyChain<T>) left,
                                                                      right);
    }

    public static <T> NonEmptyChain<T> append(NonEmptyChain<? extends T> left,
                                              Chain<? extends T> right) {
        return right.isEmpty() ? (NonEmptyChain<T>) left : new Append(left,
                                                                      (NonEmptyChain<T>) right);
    }
    ...
    @Override
    public <U, R> Chain<R> zipWithStream(Stream<? extends U> other,
    ...
    public <U> Chain<Tuple2<T, U>> zipWithStream(Stream<? extends U> other) {
        return zipWithStream(other,
                             Tuple::tuple);
    }

    @Override
    public Chain<T> insertStreamAt(int pos,
                                   Stream<T> stream) {
        if (stream instanceof ReactiveSeq && !(stream instanceof OneShotStreamX)) {
            return (Chain<T>) ImmutableList.super.insertStreamAt(pos,
                                                                 stream);
        } else {
            return insertAt(pos,
    ...
    public Chain<T> removeStream(Stream<? extends T> stream) {
        if (stream instanceof ReactiveSeq && !(stream instanceof OneShotStreamX)) {
            ...
            return (Chain<T>) ImmutableList.super.removeStream(ReactiveSeq.fromIterable(ReactiveSeq.fromStream(stream)
                                                                                                   .toList()));
        }
    }
    ...
    public Chain<T> retainStream(Stream<? extends T> stream) {
        if (stream instanceof ReactiveSeq && !(stream instanceof OneShotStreamX)) {
            ...
            return (Chain<T>) ImmutableList.super.retainStream(ReactiveSeq.fromIterable(ReactiveSeq.fromStream(stream)
                                                                                                   .toList()));
        }
    }
    ...
    @Override
    public abstract T getOrElse(int pos,
                                T alt);

    @Override
    public abstract T getOrElseGet(int pos,
    ...
    @Override
    public abstract <R> R fold(Function<? super Some<T>, ? extends R> fn1,
    ...
    @Override
    public <R> Chain<R> mergeMap(int maxConcurecy,
    ...
    @Override
    public Chain<T> replaceFirst(T currentElement,
                                 T newElement) {
        return (Chain<T>) ImmutableList.super.replaceFirst(currentElement,
                                                           newElement);
    }
    ...
    @Override
    public Chain<T> subList(int start,
                            int end) {
        return (Chain<T>) ImmutableList.super.subList(start,
                                                      end);
    }
    ...
    @Override
    public <R1, R2, R3, R> Chain<R> forEach4(Function<? super T, ? extends Iterable<R1>> iterable1,
        ...
        return (Chain<R>) ImmutableList.super.forEach4(iterable1,
                                                       iterable2,
                                                       iterable3,
                                                       yieldingFunction);
    }
    ...
    @Override
    public <R1, R2, R> Chain<R> forEach3(Function<? super T, ? extends Iterable<R1>> iterable1,
                                         BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
                                         Function3<? super T, ? super R1, ? super R2, ? extends R> yieldingFunction) {
        return (Chain<R>) ImmutableList.super.forEach3(iterable1,
                                                       iterable2,
                                                       yieldingFunction);
    }
    ...
    @Override
    public <R1, R> Chain<R> forEach2(Function<? super T, ? extends Iterable<R1>> iterable1,
                                     BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (Chain<R>) ImmutableList.super.forEach2(iterable1,
                                                       yieldingFunction);
    }
    ...
    public <T2, R> Chain<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
        ...
        return (Chain<R>) ImmutableList.super.zip(fn,
                                                  publisher);
    }
    ...
    @Override
    public <S, U, R> Chain<R> zip3(Iterable<? extends S> second,
                                   Iterable<? extends U> third,
                                   Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (Chain<R>) ImmutableList.super.zip3(second,
                                                   third,
                                                   fn3);
    }

    @Override
    public <T2, T3, T4, R> Chain<R> zip4(Iterable<? extends T2> second,
                                         Iterable<? extends T3> third,
                                         Iterable<? extends T4> fourth,
                                         Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (Chain<R>) ImmutableList.super.zip4(second,
                                                   third,
                                                   fourth,
                                                   fn);
    }
    ...
    @Override
    public Chain<T> combine(BiPredicate<? super T, ? super T> predicate,
                            BinaryOperator<T> op) {
        return (Chain<T>) ImmutableList.super.combine(predicate,
                                                      op);
    }

    @Override
    public Chain<T> combine(Monoid<T> op,
                            BiPredicate<? super T, ? super T> predicate) {
        return (Chain<T>) ImmutableList.super.combine(op,
                                                      predicate);
    }
    ...
    @Override
    public Chain<T> cycle(Monoid<T> m,
                          long times) {
        return (Chain<T>) ImmutableList.super.cycle(m,
                                                    times);
    }
    ...
    @Override
    public <U, R> Chain<R> zip(Iterable<? extends U> other,
                               BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (Chain<R>) ImmutableList.super.zip(other,
                                                  zipper);
    }

    @Override
    public <S, U> Chain<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                              Iterable<? extends U> third) {
        return (Chain) ImmutableList.super.zip3(second,
                                                third);
    }

    @Override
    public <T2, T3, T4> Chain<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
                                                          Iterable<? extends T3> third,
                                                          Iterable<? extends T4> fourth) {
        return (Chain) ImmutableList.super.zip4(second,
                                                third,
                                                fourth);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> Chain<C> grouped(int size,
                                                                        Supplier<C> supplier) {
        return (Chain<C>) ImmutableList.super.grouped(size,
                                                      supplier);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> Chain<C> groupedWhile(Predicate<? super T> predicate,
                                                                             Supplier<C> factory) {
        return (Chain<C>) ImmutableList.super.groupedWhile(predicate,
                                                           factory);
    }

    @Override
    public <C extends PersistentCollection<? super T>> Chain<C> groupedUntil(Predicate<? super T> predicate,
                                                                             Supplier<C> factory) {
        return (Chain<C>) ImmutableList.super.groupedUntil(predicate,
                                                           factory);
    }
    ...
    @Override
    public <U> Chain<U> scanLeft(U seed,
                                 BiFunction<? super U, ? super T, ? extends U> function) {
        return (Chain<U>) ImmutableList.super.scanLeft(seed,
                                                       function);
    }
    ...
    @Override
    public <U> Chain<U> scanRight(U identity,
                                  BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (Chain<U>) ImmutableList.super.scanRight(identity,
                                                        combiner);
    }
    ...
    @Override
    public Chain<T> slice(long from,
                          long to) {
        return (Chain<T>) ImmutableList.super.slice(from,
                                                    to);
    }
    ...
    @Override
    public Chain<T> insertAt(int pos,
                             T... values) {
        return (Chain<T>) ImmutableList.super.insertAt(pos,
                                                       values);
    }

    @Override
    public Chain<T> deleteBetween(int start,
                                  int end) {
        return (Chain<T>) ImmutableList.super.deleteBetween(start,
                                                            end);
    }
    ...
    @Override
    public Chain<T> updateAt(int pos,
                             T value) {
        return (Chain<T>) ImmutableList.super.updateAt(pos,
                                                       value);
    }
    ...
    @Override
    public Chain<T> insertAt(int i,
                             T value) {
        return (Chain<T>) ImmutableList.super.insertAt(i,
                                                       value);
    }
    ...
    private static final class Singleton<T> extends NonEmptyChain<T> {
        ...
        public NonEmptyChain<T> concat(Chain<T> b) {
            return b.isEmpty() ? this : new Append(this,
                                                   (NonEmptyChain<T>) b);
        }
    ...
    static final class Wrap<T> extends NonEmptyChain<T> {
            ...
            Supplier<T> go = () -> {
                ...
                while (loop) {
                    ...
                    if (c instanceof Singleton) {
                        ...
                        c = rights.foldLeft((a, b) -> append(b,
                                                             a))
                                  .orElse(null);
                        rights = Vector.empty();
                        return value;
