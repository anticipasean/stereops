...
import cyclops.function.hkt.DataWitness.hashMap;
...
public final class HashMap<K, V> implements ImmutableMap<K, V>, PersistentMap<K, V>, Higher2<hashMap, K, V>, Serializable {
    ...
    public static <K, V> HashMap<K, V> of(K k,
                                          V v) {
    ...
    @Override
    public <R1, R2> HashMap<R1, R2> bimap(Function<? super K, ? extends R1> fn1,
    ...
    public HashMap<K, V> put(K key,
                             V value) {
        return new HashMap<K, V>(map.plus(0,
                                          key.hashCode(),
                                          key,
                                          value));
    }
    ...
    public HashMap<K, V> remove(K key) {
        return new HashMap<>(map.minus(0,
                                       key.hashCode(),
                                       key));
    }
    ...
    @Override
    public HashMap<K, V> bipeek(Consumer<? super K> c1,
                                Consumer<? super V> c2) {
        return (HashMap<K, V>) ImmutableMap.super.bipeek(c1,
                                                         c2);
    }
    ...
    @Override
    public <K1, K2, K3, K4, R1, R2, R3, R> HashMap<K4, R> forEach4(Function<? super Tuple2<K, V>, ? extends Iterable<Tuple2<K1, R1>>> iterable1,
        ...
        return (HashMap<K4, R>) ImmutableMap.super.forEach4(iterable1,
                                                            iterable2,
                                                            iterable3,
                                                            yieldingFunction);
    }
    ...
    @Override
    public <K1, K2, K3, R1, R2, R> HashMap<K3, R> forEach3(Function<? super Tuple2<K, V>, ? extends Iterable<Tuple2<K1, R1>>> iterable1,
                                                           BiFunction<? super Tuple2<K, V>, ? super Tuple2<K1, R1>, ? extends Iterable<Tuple2<K2, R2>>> iterable2,
                                                           Function3<? super Tuple2<K, V>, ? super Tuple2<K1, R1>, ? super Tuple2<K2, R2>, ? extends Tuple2<K3, R>> yieldingFunction) {
        return (HashMap<K3, R>) ImmutableMap.super.forEach3(iterable1,
                                                            iterable2,
                                                            yieldingFunction);
    }
    ...
    @Override
    public <K1, K2, R1, R> HashMap<K2, R> forEach2(Function<? super Tuple2<K, V>, ? extends Iterable<Tuple2<K1, R1>>> iterable1,
                                                   BiFunction<? super Tuple2<K, V>, ? super Tuple2<K1, R1>, ? extends Tuple2<K2, R>> yieldingFunction) {
        return (HashMap<K2, R>) ImmutableMap.super.forEach2(iterable1,
                                                            yieldingFunction);
