...
import cyclops.function.hkt.DataWitness.intMap;
...
import cyclops.container.persistent.impl.base.IntPatriciaTrie;
...
public class IntMap<T> implements ImmutableList<T>, Serializable, Higher<intMap, T> {
    ...
    static <T> IntMap<T> fill(T t,
                              int max) {
        return IntMap.fromStream(ReactiveSeq.fill(t)
                                            .take(max));
    }

    static <U, T> IntMap<T> unfold(final U seed,
                                   final Function<? super U, Option<Tuple2<T, U>>> unfolder) {
        return fromStream(ReactiveSeq.unfold(seed,
                                             unfolder));
    }

    static <T> IntMap<T> iterate(final T seed,
    ...
    static <T> IntMap<T> generate(Supplier<T> s,
                                  int max) {
    ...
    static IntMap<Integer> range(final int start,
                                 final int end) {
        return IntMap.fromStream(ReactiveSeq.range(start,
                                                   end));
    ...
    static IntMap<Long> rangeLong(final long start,
                                  final long step,
                                  final long end) {
        return IntMap.fromStream(ReactiveSeq.rangeLong(start,
                                                       step,
                                                       end));
    }
    ...
    public IntMap<T> plus(T value) {
        return new IntMap<>(intMap.put(size,
                                       size,
                                       value),
                            size + 1);
    }
    ...
    public T getOrElseGet(int pos,
        ...
        return intMap.getOrElseGet(pos,
                                   pos,
                                   alt);
    }
    ...
    @Override
    public <R1, R2, R3, R> IntMap<R> forEach4(Function<? super T, ? extends Iterable<R1>> iterable1,
        ...
        return (IntMap<R>) ImmutableList.super.forEach4(iterable1,
                                                        iterable2,
                                                        iterable3,
                                                        yieldingFunction);
    }
    ...
    @Override
    public <R1, R2, R> IntMap<R> forEach3(Function<? super T, ? extends Iterable<R1>> iterable1,
                                          BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
                                          Function3<? super T, ? super R1, ? super R2, ? extends R> yieldingFunction) {
        return (IntMap<R>) ImmutableList.super.forEach3(iterable1,
                                                        iterable2,
                                                        yieldingFunction);
    }
    ...
    @Override
    public <R1, R> IntMap<R> forEach2(Function<? super T, ? extends Iterable<R1>> iterable1,
                                      BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (IntMap<R>) ImmutableList.super.forEach2(iterable1,
                                                        yieldingFunction);
    }
    ...
    @Override
    public <R> IntMap<R> mergeMap(int maxConcurecy,
                                  Function<? super T, ? extends Publisher<? extends R>> fn) {
        return unitStream(stream().mergeMap(maxConcurecy,
                                            fn));
    }

    @Override
    public IntMap<T> replaceFirst(T currentElement,
                                  T newElement) {
        return (IntMap<T>) ImmutableList.super.replaceFirst(currentElement,
                                                            newElement);
    }

    @Override
    public IntMap<T> subList(int start,
                             int end) {
        return (IntMap<T>) ImmutableList.super.subList(start,
                                                       end);
    }
    ...
    @Override
    public <T2, R> IntMap<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
                                 Publisher<? extends T2> publisher) {
        return (IntMap<R>) ImmutableList.super.zip(fn,
                                                   publisher);
    }

    @Override
    public <U, R> IntMap<R> zipWithStream(Stream<? extends U> other,
                                          BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (IntMap<R>) ImmutableList.super.zipWithStream(other,
                                                             zipper);
    }
    ...
    @Override
    public <S, U, R> IntMap<R> zip3(Iterable<? extends S> second,
                                    Iterable<? extends U> third,
                                    Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (IntMap<R>) ImmutableList.super.zip3(second,
                                                    third,
                                                    fn3);
    }

    @Override
    public <T2, T3, T4, R> IntMap<R> zip4(Iterable<? extends T2> second,
                                          Iterable<? extends T3> third,
                                          Iterable<? extends T4> fourth,
                                          Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (IntMap<R>) ImmutableList.super.zip4(second,
                                                    third,
                                                    fourth,
                                                    fn);
    }
    ...
    @Override
    public IntMap<T> combine(BiPredicate<? super T, ? super T> predicate,
                             BinaryOperator<T> op) {
        return (IntMap<T>) ImmutableList.super.combine(predicate,
                                                       op);
    }

    @Override
    public IntMap<T> combine(Monoid<T> op,
                             BiPredicate<? super T, ? super T> predicate) {
        return (IntMap<T>) ImmutableList.super.combine(op,
                                                       predicate);
    }
    ...
    @Override
    public IntMap<T> cycle(Monoid<T> m,
                           long times) {
        return (IntMap<T>) ImmutableList.super.cycle(m,
                                                     times);
    }
    ...
    @Override
    public <U, R> IntMap<R> zip(Iterable<? extends U> other,
                                BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (IntMap<R>) ImmutableList.super.zip(other,
                                                   zipper);
    }

    @Override
    public <S, U> IntMap<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                               Iterable<? extends U> third) {
        return (IntMap) ImmutableList.super.zip3(second,
                                                 third);
    }

    @Override
    public <T2, T3, T4> IntMap<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
                                                           Iterable<? extends T3> third,
                                                           Iterable<? extends T4> fourth) {
        return (IntMap) ImmutableList.super.zip4(second,
                                                 third,
                                                 fourth);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> IntMap<C> grouped(int size,
                                                                         Supplier<C> supplier) {
        return (IntMap<C>) ImmutableList.super.grouped(size,
                                                       supplier);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> IntMap<C> groupedWhile(Predicate<? super T> predicate,
                                                                              Supplier<C> factory) {
        return (IntMap<C>) ImmutableList.super.groupedWhile(predicate,
                                                            factory);
    }

    @Override
    public <C extends PersistentCollection<? super T>> IntMap<C> groupedUntil(Predicate<? super T> predicate,
                                                                              Supplier<C> factory) {
        return (IntMap<C>) ImmutableList.super.groupedUntil(predicate,
                                                            factory);
    }
    ...
    @Override
    public <U> IntMap<U> scanLeft(U seed,
                                  BiFunction<? super U, ? super T, ? extends U> function) {
        return (IntMap<U>) ImmutableList.super.scanLeft(seed,
                                                        function);
    }
    ...
    @Override
    public <U> IntMap<U> scanRight(U identity,
                                   BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (IntMap<U>) ImmutableList.super.scanRight(identity,
                                                         combiner);
    }
    ...
    @Override
    public IntMap<T> slice(long from,
                           long to) {
        return (IntMap<T>) ImmutableList.super.slice(from,
                                                     to);
    }
    ...
    @Override
    public IntMap<T> deleteBetween(int start,
                                   int end) {
        return (IntMap<T>) ImmutableList.super.deleteBetween(start,
                                                             end);
    }

    @Override
    public IntMap<T> insertStreamAt(int pos,
                                    Stream<T> stream) {
        return (IntMap<T>) ImmutableList.super.insertStreamAt(pos,
                                                              stream);
    }
    ...
    public IntMap<T> removeAt(long pos) {
        ...
        return new IntMap<>(intMap.minus(i,
                                         i),
                            size - 1);
    }

    @Override
    public IntMap<T> insertAt(int pos,
                              T... values) {
        return (IntMap<T>) ImmutableList.super.insertAt(pos,
                                                        values);
    }
    ...
    @Override
    public IntMap<T> insertAt(int i,
                              T value) {
        return (IntMap<T>) ImmutableList.super.insertAt(i,
                                                        value);
    }
