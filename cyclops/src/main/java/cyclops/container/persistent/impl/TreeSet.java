...
import cyclops.function.hkt.DataWitness.treeSet;
...
public final class TreeSet<T> implements ImmutableSortedSet<T>, Higher<treeSet, T>, Serializable {
    ...
    static <T extends Comparable<? super T>> Collector<T, Set<T>, TreeSet<T>> collector() {
        ...
        return Collectors.<T, Set<T>, Iterable<T>, TreeSet<T>>collectingAndThen((Collector) c,
                                                                                TreeSet::fromIterable);
    }

    public static <T extends Comparable<? super T>> TreeSet<T> empty() {
        return new TreeSet<T>(RedBlackTree.empty(Comparators.naturalComparator()),
                              Comparators.naturalComparator());
    }

    public static <T extends Comparable<? super T>> TreeSet<T> singleton(T value) {
        return new TreeSet<T>(RedBlackTree.empty(Comparators.naturalComparator()),
                              Comparators.naturalComparator()).plus(value);
    }

    public static <T> TreeSet<T> singleton(Comparator<? super T> comp,
                                           T value) {
        return new TreeSet<T>(RedBlackTree.empty(comp),
                              comp).plus(value);
    }
    ...
    public static <T> TreeSet<T> fromStream(Stream<T> stream,
                                            Comparator<? super T> comp) {
    ...
    public static <T> TreeSet<T> fromIterable(Iterable<T> it,
                                              Comparator<? super T> comp) {
    ...
    public static <T extends Comparable<? super T>> TreeSet<T> fromIterable(Iterable<T> it) {
        return ReactiveSeq.fromIterable(it)
                          .foldLeft(empty(Comparators.naturalComparator()),
                                    (m, t2) -> m.plus(t2));
    }

    static <U, T> TreeSet<T> unfold(final U seed,
    ...
    static <T> TreeSet<T> iterate(final T seed,
    ...
    static <T> TreeSet<T> generate(Supplier<T> s,
                                   int max) {
    ...
    static TreeSet<Integer> range(final int start,
                                  final int end) {
        return TreeSet.fromStream(ReactiveSeq.range(start,
                                                    end),
    ...
    static TreeSet<Long> rangeLong(final long start,
                                   final long step,
                                   final long end) {
    ...
    public static <T> TreeSet<T> fromSortedSet(SortedSet<T> set,
                                               Comparator<? super T> comp) {
        Stream<Tuple2<T, T>> s = set.stream()
                                    .map(e -> Tuple.tuple(e,
                                                          e));
        return new TreeSet<T>(RedBlackTree.fromStream(set.comparator(),
                                                      s),
                              comp);
    }
    ...
    public TreeSet<T> add(T value) {
        return new TreeSet<>(map.plus(value,
                                      value),
                             comp);
    }
    ...
    @Override
    public <R> TreeSet<R> mergeMap(int maxConcurecy,
    ...
    @Override
    public ImmutableSortedSet<T> unitStream(Stream<T> stream,
                                            Comparator<? super T> comp) {
        return fromStream(ReactiveSeq.fromStream(stream),
                          comp);
    }
    ...
    @Override
    public ImmutableSortedSet<T> subSet(T fromElement,
                                        T toElement) {

        return fromStream(stream().dropWhile(e -> !Objects.equals(e,
                                                                  fromElement))
                                  .takeUntil(e -> Objects.equals(e,
                                                                 toElement)),
                          comp);
    ...
    public <R1, R2> Tuple2<TreeSet<R1>, TreeSet<R2>> unzip(Function<? super T, Tuple2<? extends R1, ? extends R2>> fn) {
        Tuple2<TreeSet<R1>, TreeSet<Tuple2<? extends R1, ? extends R2>>> x = map(fn).duplicate()
    ...
    @Override
    public <T2, R> TreeSet<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
                                  Publisher<? extends T2> publisher) {
        return (TreeSet<R>) ImmutableSortedSet.super.zip(fn,
                                                         publisher);
    }

    @Override
    public <U, R> TreeSet<R> zipWithStream(Stream<? extends U> other,
                                           BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (TreeSet<R>) ImmutableSortedSet.super.zipWithStream(other,
                                                                   zipper);
    }
    ...
    @Override
    public <S, U, R> TreeSet<R> zip3(Iterable<? extends S> second,
                                     Iterable<? extends U> third,
                                     Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (TreeSet<R>) ImmutableSortedSet.super.zip3(second,
                                                          third,
                                                          fn3);
    }

    @Override
    public <T2, T3, T4, R> TreeSet<R> zip4(Iterable<? extends T2> second,
                                           Iterable<? extends T3> third,
                                           Iterable<? extends T4> fourth,
                                           Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (TreeSet<R>) ImmutableSortedSet.super.zip4(second,
                                                          third,
                                                          fourth,
                                                          fn);
    }
    ...
    @Override
    public TreeSet<T> combine(BiPredicate<? super T, ? super T> predicate,
                              BinaryOperator<T> op) {
        return (TreeSet<T>) ImmutableSortedSet.super.combine(predicate,
                                                             op);
    }

    @Override
    public TreeSet<T> combine(Monoid<T> op,
                              BiPredicate<? super T, ? super T> predicate) {
        return (TreeSet<T>) ImmutableSortedSet.super.combine(op,
                                                             predicate);
    }
    ...
    @Override
    public TreeSet<T> cycle(Monoid<T> m,
                            long times) {
        return (TreeSet<T>) ImmutableSortedSet.super.cycle(m,
                                                           times);
    }
    ...
    @Override
    public <U, R> TreeSet<R> zip(Iterable<? extends U> other,
                                 BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (TreeSet<R>) ImmutableSortedSet.super.zip(other,
                                                         zipper);
    }

    @Override
    public <S, U> TreeSet<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                                Iterable<? extends U> third) {
        return (TreeSet) ImmutableSortedSet.super.zip3(second,
                                                       third);
    }

    @Override
    public <T2, T3, T4> TreeSet<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
                                                            Iterable<? extends T3> third,
                                                            Iterable<? extends T4> fourth) {
        return (TreeSet) ImmutableSortedSet.super.zip4(second,
                                                       third,
                                                       fourth);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> TreeSet<C> grouped(int size,
                                                                          Supplier<C> supplier) {
        return (TreeSet<C>) ImmutableSortedSet.super.grouped(size,
                                                             supplier);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> TreeSet<C> groupedWhile(Predicate<? super T> predicate,
                                                                               Supplier<C> factory) {
        return (TreeSet<C>) ImmutableSortedSet.super.groupedWhile(predicate,
                                                                  factory);
    }

    @Override
    public <C extends PersistentCollection<? super T>> TreeSet<C> groupedUntil(Predicate<? super T> predicate,
                                                                               Supplier<C> factory) {
        return (TreeSet<C>) ImmutableSortedSet.super.groupedUntil(predicate,
                                                                  factory);
    }
    ...
    @Override
    public <U> TreeSet<U> scanLeft(U seed,
                                   BiFunction<? super U, ? super T, ? extends U> function) {
        return (TreeSet<U>) ImmutableSortedSet.super.scanLeft(seed,
                                                              function);
    }
    ...
    @Override
    public <U> TreeSet<U> scanRight(U identity,
                                    BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (TreeSet<U>) ImmutableSortedSet.super.scanRight(identity,
                                                               combiner);
    }
    ...
    @Override
    public TreeSet<T> slice(long from,
                            long to) {
        return (TreeSet<T>) ImmutableSortedSet.super.slice(from,
                                                           to);
    }
    ...
    @Override
    public TreeSet<T> deleteBetween(int start,
                                    int end) {
        return (TreeSet<T>) ImmutableSortedSet.super.deleteBetween(start,
                                                                   end);
    }

    @Override
    public TreeSet<T> insertStreamAt(int pos,
                                     Stream<T> stream) {
        return (TreeSet<T>) ImmutableSortedSet.super.insertStreamAt(pos,
                                                                    stream);
    }
    ...
    @Override
    public <R1, R2, R3, R> TreeSet<R> forEach4(Function<? super T, ? extends Iterable<R1>> iterable1,
        ...
        return (TreeSet<R>) ImmutableSortedSet.super.forEach4(iterable1,
                                                              iterable2,
                                                              iterable3,
                                                              yieldingFunction);
    }
    ...
    @Override
    public <R1, R2, R> TreeSet<R> forEach3(Function<? super T, ? extends Iterable<R1>> iterable1,
                                           BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
                                           Function3<? super T, ? super R1, ? super R2, ? extends R> yieldingFunction) {
        return (TreeSet<R>) ImmutableSortedSet.super.forEach3(iterable1,
                                                              iterable2,
                                                              yieldingFunction);
    }
    ...
    @Override
    public <R1, R> TreeSet<R> forEach2(Function<? super T, ? extends Iterable<R1>> iterable1,
                                       BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (TreeSet<R>) ImmutableSortedSet.super.forEach2(iterable1,
                                                              yieldingFunction);
    }
    ...
    @Override
    public TreeSet<T> updateAt(int pos,
                               T value) {
        return (TreeSet<T>) ImmutableSortedSet.super.updateAt(pos,
                                                              value);
    }

    @Override
    public TreeSet<T> insertAt(int pos,
                               Iterable<? extends T> values) {
        return (TreeSet<T>) ImmutableSortedSet.super.insertAt(pos,
                                                              values);
    }

    @Override
    public TreeSet<T> insertAt(int i,
                               T value) {
        return (TreeSet<T>) ImmutableSortedSet.super.insertAt(i,
                                                              value);
    }
