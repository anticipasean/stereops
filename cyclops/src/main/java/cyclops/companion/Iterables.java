...
public class Iterables {
    ...
    public static <T, R1, R2, R3, R> IterableX<R> forEach4(Iterable<T> host,
                                                           final Function<? super T, ? extends Iterable<R1>> iterable1,
    ...
    public static <T, R1, R2, R> IterableX<R> forEach3(Iterable<T> host,
                                                       final Function<? super T, ? extends Iterable<R1>> iterable1,
                                                       final BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
    ...
    public static <T, R1, R> IterableX<R> forEach2(Iterable<T> host,
                                                   final Function<? super T, ? extends Iterable<R1>> iterable1,
