 ...
 * @author johnmcclean
 */
public interface LazyEither4<LT1, LT2, LT3, RT> extends Transformable<RT>, Filters<RT>, Higher4<lazyEither4, LT1, LT2, LT3, RT>,
    ...
    static <LT2, LT3, RT> LazyEither4.CompletableEither4<RT, LT2, LT3, RT> either4() {
        ...
        return new LazyEither4.CompletableEither4<RT, LT2, LT3, RT>(c,
     ...
     */
    static <X, LT1 extends X, LT2 extends X, LT3 extends X, RT extends X> Consumer<Consumer<? super X>> consumeAny(LazyEither4<LT1, LT2, LT3, RT> either) {
        return in -> visitAny(in,
                              either);
    }

    static <X, LT1 extends X, LT2 extends X, LT3 extends X, RT extends X, R> Function<Function<? super X, R>, R> applyAny(LazyEither4<LT1, LT2, LT3, RT> either) {
        return in -> visitAny(either,
                              in);
    }

    @Deprecated //use foldAny
    static <X, LT1 extends X, LT2 extends X, LT3 extends X, RT extends X, R> R visitAny(LazyEither4<LT1, LT2, LT3, RT> either,
                                                                                        Function<? super X, ? extends R> fn) {
        return foldAny(either,
                       fn);
    }

    static <X, LT1 extends X, LT2 extends X, LT3 extends X, RT extends X, R> R foldAny(LazyEither4<LT1, LT2, LT3, RT> either,
                                                                                       Function<? super X, ? extends R> fn) {
    ...
    static <LT2, LT3, RT> LazyEither4<Throwable, LT2, LT3, RT> fromFuture(Future<RT> future) {
        return fromLazy(Eval.fromFuture(future.<LazyEither4<Throwable, LT2, LT3, RT>>map(LazyEither4::right).recover(e -> LazyEither4.left1(e.getCause()))));
    ...
    public static <L1, L2, L3, T> LazyEither4<L1, L2, L3, ReactiveSeq<T>> sequence(ReactiveSeq<? extends LazyEither4<L1, L2, L3, T>> stream) {
        ...
        BiFunction<LazyEither4<L1, L2, L3, ReactiveSeq<T>>, LazyEither4<L1, L2, L3, T>, LazyEither4<L1, L2, L3, ReactiveSeq<T>>> combineToStream = (acc, next) -> acc.zip(next,
                                                                                                                                                                          (a, b) -> a.append(b));

        BinaryOperator<LazyEither4<L1, L2, L3, ReactiveSeq<T>>> combineStreams = (a, b) -> a.zip(b,
    ...
    /**
     * TraverseOps a Collection of Either3 producing an Either4 with a Seq, applying the transformation function to every element
     * in the list
     *
    ...
    default LazyEither4<LT1, LT2, LT3, RT> filter(Predicate<? super RT> test,
    ...
    default <R> R fold(Function<? super LT1, ? extends R> fn1,
                       ...
                       Function<? super RT, ? extends R> fn4) {
     ...
     */
    <RT1> LazyEither4<LT1, LT2, LT3, RT1> flatMap(Function<? super RT, ? extends LazyEither4<LT1, LT2, LT3, ? extends RT1>> mapper);
    ...
    default <T2, R> LazyEither4<LT1, LT2, LT3, R> zip(final LazyEither4<LT1, LT2, LT3, ? extends T2> app,
    ...
    default <T2, R1, R2, R3, R> LazyEither4<LT1, LT2, LT3, R> forEach4(Function<? super RT, ? extends LazyEither4<LT1, LT2, LT3, R1>> value1,
        ...
        return this.flatMap(in -> {
            ...
            return a.flatMap(ina -> {
                LazyEither4<LT1, LT2, LT3, R2> b = value2.apply(in,
                                                                ina);
                return b.flatMap(inb -> {
                    LazyEither4<LT1, LT2, LT3, R3> c = value3.apply(in,
                                                                    ina,
                                                                    inb);
     ...
     */
    @Override
    default LazyEither4<LT1, LT2, LT3, RT> bipeek(final Consumer<? super LT3> c1,
                                                  final Consumer<? super RT> c2) {

        return (LazyEither4<LT1, LT2, LT3, RT>) BiTransformable.super.bipeek(c1,
                                                                             c2);
    }
    ...
    static class CompletableEither4<ORG, LT1, LT2, RT> implements LazyEither4<Throwable, LT1, LT2, RT>, Completable<ORG> {
        ...
        @Override
        public <R1, R2> LazyEither4<Throwable, LT1, R1, R2> bimap(Function<? super LT2, ? extends R1> fn1,
                                                                  Function<? super RT, ? extends R2> fn2) {
    ...
    final static class Lazy<ST, M, M2, PT> implements LazyEither4<ST, M, M2, PT> {
        ...
        @Override
        public <RT1> LazyEither4<ST, M, M2, RT1> flatMap(final Function<? super PT, ? extends LazyEither4<ST, M, M2, ? extends RT1>> mapper) {
        ...
        public <R1, R2> LazyEither4<ST, M, R1, R2> bimap(final Function<? super M2, ? extends R1> fn1,
            ...
            return LazyEither4.fromLazy(lazy.map(m -> m.bimap(fn1,
                                                              fn2)));
        }
        ...
        @Override
        public int hashCode() {
            return this.fold(LazyEither4::left1,
                             LazyEither4::left2,
                             LazyEither4::left3,
                             LazyEither4::right)
                       .hashCode();
    ...
    static class Right<ST, M, M2, PT> implements LazyEither4<ST, M, M2, PT> {
        ...
        public <R> LazyEither4<ST, M, M2, R> map(final Function<? super PT, ? extends R> fn) {
            return new Right<ST, M, M2, R>(value.map(fn));
        }
