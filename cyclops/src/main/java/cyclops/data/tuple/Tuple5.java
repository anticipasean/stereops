...
public class Tuple5<T1, T2, T3, T4, T5> implements To<Tuple5<T1, T2, T3, T4, T5>>, Serializable,
    ...
    public static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> lazy(Supplier<? extends T1> supplier1,
        ...
        return new Tuple5<T1, T2, T3, T4, T5>(null,
                                              null,
                                              null,
                                              null,
                                              null) {
    ...
    public <R1, R2, R3, R4, R5> Tuple5<R1, R2, R3, R4, R5> mapAll(Function<? super T1, ? extends R1> fn1,
    ...
    public <R1, R2, R3, R4, R5> Tuple5<R1, R2, R3, R4, R5> lazyMapAll(Function<? super T1, ? extends R1> fn1,
                                                                      Function<? super T2, ? extends R2> fn2,
                                                                      Function<? super T3, ? extends R3> fn3,
                                                                      Function<? super T4, ? extends R4> fn4,
                                                                      Function<? super T5, ? extends R5> fn5) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof Tuple5)) {
            return false;
        }
        Tuple5<?, ?, ?, ?, ?> tuple5 = (Tuple5<?, ?, ?, ?, ?>) o;
        return Objects.equals(_1(),
                              tuple5._1()) && Objects.equals(_2(),
                                                             tuple5._2()) && Objects.equals(_3(),
                                                                                            tuple5._3()) && Objects.equals(_4(),
                                                                                                                           tuple5._4())
            && Objects.equals(_5(),
                              tuple5._5());
    }
