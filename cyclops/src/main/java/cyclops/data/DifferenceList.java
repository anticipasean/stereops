...
public final class DifferenceList<T> implements Folds<T>, Transformable<T>, ImmutableList<T>, Higher<differenceList, T> {
    ...
    public static <U, T> DifferenceList<T> unfold(final U seed,
    ...
    public static <T> DifferenceList<T> iterate(final T seed,
    ...
    public static DifferenceList<Integer> range(final int start,
                                                final int end) {
        return of(LazySeq.range(start,
                                end));
    ...
    public static DifferenceList<Long> rangeLong(final long start,
                                                 final long step,
                                                 final long end) {
        return of(LazySeq.rangeLong(start,
                                    step,
                                    end));
    }
    ...
    public ImmutableList<T> run() {
        return appending.apply(LazySeq.empty())
                        .result();
    }
    ...
    public DifferenceList<T> append(DifferenceList<T> append) {
        ...
        return new DifferenceList<T>(l -> appending2.apply(l)
                                                    .flatMap(l2 -> Trampoline.more(() -> appending.apply(l2))));
    }
    ...
    @Override
    public DifferenceList<T> replaceFirst(T currentElement,
                                          T newElement) {
        return of(LazySeq.fromIterable(ImmutableList.super.replaceFirst(currentElement,
                                                                        newElement)));
    }
    ...
    @Override
    public DifferenceList<T> subList(int start,
                                     int end) {
        return (DifferenceList<T>) ImmutableList.super.subList(start,
                                                               end);
    }
    ...
    @Override
    public <R> R fold(BiFunction<? super T, ? super ImmutableList<T>, ? extends R> fn,
                      Supplier<? extends R> alt) {
        return run().fold(fn,
                          alt);
    }
    ...
    @Override
    public <R1, R2, R3, R> DifferenceList<R> forEach4(Function<? super T, ? extends Iterable<R1>> iterable1,
        ...
        return (DifferenceList<R>) ImmutableList.super.forEach4(iterable1,
                                                                iterable2,
                                                                iterable3,
                                                                yieldingFunction);
    }
    ...
    @Override
    public <R1, R2, R> DifferenceList<R> forEach3(Function<? super T, ? extends Iterable<R1>> iterable1,
                                                  BiFunction<? super T, ? super R1, ? extends Iterable<R2>> iterable2,
                                                  Function3<? super T, ? super R1, ? super R2, ? extends R> yieldingFunction) {
        return (DifferenceList<R>) ImmutableList.super.forEach3(iterable1,
                                                                iterable2,
                                                                yieldingFunction);
    ...
    @Override
    public <R1, R> DifferenceList<R> forEach2(Function<? super T, ? extends Iterable<R1>> iterable1,
                                              BiFunction<? super T, ? super R1, ? extends R> yieldingFunction) {
        return (DifferenceList<R>) ImmutableList.super.forEach2(iterable1,
                                                                yieldingFunction);
    }
    ...
    @Override
    public <T2, R> DifferenceList<R> zip(BiFunction<? super T, ? super T2, ? extends R> fn,
                                         Publisher<? extends T2> publisher) {
        return (DifferenceList<R>) ImmutableList.super.zip(fn,
                                                           publisher);
    }

    @Override
    public <U, R> DifferenceList<R> zipWithStream(Stream<? extends U> other,
                                                  BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (DifferenceList<R>) ImmutableList.super.zipWithStream(other,
                                                                     zipper);
    }
    ...
    @Override
    public <S, U, R> DifferenceList<R> zip3(Iterable<? extends S> second,
                                            Iterable<? extends U> third,
                                            Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (DifferenceList<R>) ImmutableList.super.zip3(second,
                                                            third,
                                                            fn3);
    }

    @Override
    public <T2, T3, T4, R> DifferenceList<R> zip4(Iterable<? extends T2> second,
                                                  Iterable<? extends T3> third,
                                                  Iterable<? extends T4> fourth,
                                                  Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (DifferenceList<R>) ImmutableList.super.zip4(second,
                                                            third,
                                                            fourth,
                                                            fn);
    }
    ...
    @Override
    public DifferenceList<T> combine(BiPredicate<? super T, ? super T> predicate,
                                     BinaryOperator<T> op) {
        return (DifferenceList<T>) ImmutableList.super.combine(predicate,
                                                               op);
    }

    @Override
    public DifferenceList<T> combine(Monoid<T> op,
                                     BiPredicate<? super T, ? super T> predicate) {
        return (DifferenceList<T>) ImmutableList.super.combine(op,
                                                               predicate);
    }
    ...
    @Override
    public DifferenceList<T> cycle(Monoid<T> m,
                                   long times) {
        return (DifferenceList<T>) ImmutableList.super.cycle(m,
                                                             times);
    }
    ...
    @Override
    public <U, R> DifferenceList<R> zip(Iterable<? extends U> other,
                                        BiFunction<? super T, ? super U, ? extends R> zipper) {
        return (DifferenceList<R>) ImmutableList.super.zip(other,
                                                           zipper);
    }

    @Override
    public <S, U> DifferenceList<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                                       Iterable<? extends U> third) {
        return (DifferenceList<Tuple3<T, S, U>>) ImmutableList.super.zip3(second,
                                                                          third);
    }

    @Override
    public <T2, T3, T4> DifferenceList<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
                                                                   Iterable<? extends T3> third,
                                                                   Iterable<? extends T4> fourth) {
        return (DifferenceList<Tuple4<T, T2, T3, T4>>) ImmutableList.super.zip4(second,
                                                                                third,
                                                                                fourth);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> DifferenceList<C> grouped(int size,
                                                                                 Supplier<C> supplier) {
        return (DifferenceList<C>) ImmutableList.super.grouped(size,
                                                               supplier);
    }
    ...
    @Override
    public <C extends PersistentCollection<? super T>> DifferenceList<C> groupedWhile(Predicate<? super T> predicate,
                                                                                      Supplier<C> factory) {
        return (DifferenceList<C>) ImmutableList.super.groupedWhile(predicate,
                                                                    factory);
    }

    @Override
    public <C extends PersistentCollection<? super T>> DifferenceList<C> groupedUntil(Predicate<? super T> predicate,
                                                                                      Supplier<C> factory) {
        return (DifferenceList<C>) ImmutableList.super.groupedUntil(predicate,
                                                                    factory);
    }
    ...
    @Override
    public <U> DifferenceList<U> scanLeft(U seed,
                                          BiFunction<? super U, ? super T, ? extends U> function) {
        return (DifferenceList<U>) ImmutableList.super.scanLeft(seed,
                                                                function);
    }
    ...
    @Override
    public <U> DifferenceList<U> scanRight(U identity,
                                           BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (DifferenceList<U>) ImmutableList.super.scanRight(identity,
                                                                 combiner);
    }
    ...
    @Override
    public DifferenceList<T> slice(long from,
                                   long to) {
        return (DifferenceList<T>) ImmutableList.super.slice(from,
                                                             to);
    }
    ...
    @Override
    public <R> DifferenceList<R> mergeMap(int maxConcurecy,
    ...
    @Override
    public DifferenceList<T> insertAt(int pos,
                                      T... values) {
        return (DifferenceList<T>) ImmutableList.super.insertAt(pos,
                                                                values);
    }

    @Override
    public DifferenceList<T> deleteBetween(int start,
                                           int end) {
        return (DifferenceList<T>) ImmutableList.super.deleteBetween(start,
                                                                     end);
    }

    @Override
    public DifferenceList<T> insertStreamAt(int pos,
                                            Stream<T> stream) {
        return (DifferenceList<T>) ImmutableList.super.insertStreamAt(pos,
                                                                      stream);
    }
    ...
    @Override
    public DifferenceList<T> updateAt(int pos,
                                      T value) {
        return (DifferenceList<T>) ImmutableList.super.updateAt(pos,
                                                                value);
    }
    ...
    @Override
    public DifferenceList<T> insertAt(int i,
                                      T value) {
        return (DifferenceList<T>) ImmutableList.super.insertAt(i,
                                                                value);
    }
