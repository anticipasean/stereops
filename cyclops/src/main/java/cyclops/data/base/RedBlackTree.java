...
import static cyclops.data.base.RedBlackTree.Node.LEFT_BLACK;
import static cyclops.data.base.RedBlackTree.Node.RED;
import static cyclops.data.base.RedBlackTree.Node.RIGHT_BLACK;
...
public interface RedBlackTree extends Serializable {
    ...
    public static final class Node<K, V> implements Tree<K, V>, Deconstruct5<Boolean, Tree<K, V>, Tree<K, V>, K, V> {
        ...
        static <K, V> Node<K, V> BLACK(Tree<K, V> left,
                                       Tree<K, V> right,
                                       K key,
                                       V value,
                                       Comparator<? super K> comp) {
        ...
        static <K, V> Node<K, V> LEFT_BLACK(Tree<K, V> left,
                                            Tree<K, V> right,
                                            K key,
                                            V value,
                                            Comparator<? super K> comp) {
        ...
        static <K, V> Node<K, V> RIGHT_BLACK(Tree<K, V> left,
                                             Tree<K, V> right,
                                             K key,
                                             V value,
                                             Comparator<? super K> comp) {
