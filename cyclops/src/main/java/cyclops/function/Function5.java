...
public interface Function5<T1, T2, T3, T4, T5, R> extends
    ...
    default Function1<T3, Function1<T4, Function1<T5, R>>> apply(final T1 s,
                                                                 final T2 s2) {
        return Curry.curry5(this)
                    .apply(s)
                    .apply(s2);
    ...
    default Function1<T4, Function1<T5, R>> apply(final T1 s,
                                                  final T2 s2,
                                                  final T3 s3) {
        return Curry.curry5(this)
                    .apply(s)
    ...
    default Function1<T5, R> apply(final T1 s,
                                   final T2 s2,
                                   final T3 s3,
                                   final T4 s4) {
        return Curry.curry5(this)
    ...
    default Function5<T1, T2, T3, T4, T5, Future<R>> lift5(Executor ex) {
        ...
        return (s1, s2, s3, s4, s5) -> Future.of(() -> apply(s1,
                                                             s2,
                                                             s3,
                                                             s4,
                                                             s5),
    ...
    default Function5<T1, T2, T3, T4, T5, Try<R, Throwable>> liftTry5() {
        return (s1, s2, s3, s4, s5) -> Try.withCatch(() -> apply(s1,
                                                                 s2,
                                                                 s3,
                                                                 s4,
                                                                 s5),
    ...
    default Function5<T1, T2, T3, T4, T5, Option<R>> lift5() {
        ...
        return (s1, s2, s3, s4, s5) -> Option.ofNullable(apply(s1,
                                                               s2,
                                                               s3,
                                                               s4,
                                                               s5));
    ...
    default <V> Function5<T1, T2, T3, T4, T5, V> andThen5(Function<? super R, ? extends V> after) {
        return (t1, t2, t3, t4, t5) -> after.apply(apply(t1,
                                                         t2,
                                                         t3,
                                                         t4,
                                                         t5));
