...
public class Memoize {
    ...
    /**
     * Memoize a Supplier and update the cached values asynchronously using the provided Scheduled Executor Service Does not
     * support null keys
     *
     ...
     */
    public static <R> Function0<R> memoizeSupplierAsync(final Supplier<R> fn,
                                                        ScheduledExecutorService ex,
                                                        long updateRateInMillis) {
        return () -> Memoize.memoizeFunctionAsync(a -> fn.get(),
                                                  ex,
                                                  updateRateInMillis)
                            .apply("k");
    }
    ...
    public static Runnable memoizeRunnable(final Runnable r) {
        final AtomicReference<Boolean> isSet = new AtomicReference<>(false);
    ...
    public static <T, R> Function1<T, R> memoizeFunction(final Function<T, R> fn) {
        ...
        return t -> t == null ? nullR.computeIfAbsent(() -> fn.apply(null)) : lazy.computeIfAbsent(t,
                                                                                                   fn);
    }

    /**
     * Memoize a function and update the cached values asynchronously using the provided Scheduled Executor Service Does not
     * support null keys
     *
     ...
     * @return Memoized asynchronously updating function
     */
    public static <T, R> Function1<T, R> memoizeFunctionAsync(final Function<T, R> fn,
                                                              ScheduledExecutorService ex,
                                                              long updateRateInMillis) {
        final Map<T, R> lazy = new ConcurrentHashMap<>();
        ...
        ReactiveSeq.generate(() -> {
            ...
            return null;
                   ...
                   .scheduleFixedRate(updateRateInMillis,
                                      ex);

        return t -> lazy.computeIfAbsent(t,
                                         fn);
    }
     ...
     * @return Memoized asynchronously updating function
     */
    public static <T1, T2, R> Function2<T1, T2, R> memoizeBiFunctionAsync(final BiFunction<T1, T2, R> fn,
                                                                          ScheduledExecutorService ex,
                                                                          long updateRateInMillis) {
        val memoise2 = memoizeFunctionAsync((final Tuple2<T1, T2> pair) -> fn.apply(pair._1(),
                                                                                    pair._2()),
                                            ex,
                                            updateRateInMillis);
        return (t1, t2) -> memoise2.apply(tuple(t1,
                                                t2));
    }
    ...
    public static <T1, T2, R> Function2<T1, T2, R> memoizeBiFunction(final BiFunction<T1, T2, R> fn) {
        Function1<Tuple2<T1, T2>, R> memoise2 = memoizeFunction((final Tuple2<T1, T2> pair) -> fn.apply(pair._1(),
                                                                                                        pair._2()));
        return (t1, t2) -> memoise2.apply(tuple(t1,
                                                t2));
    }
    ...
    public static <T1, T2, T3, R> Function3<T1, T2, T3, R> memoizeTriFunction(final Function3<T1, T2, T3, R> fn) {
        val memoise2 = memoizeFunction((final Tuple3<T1, T2, T3> triple) -> fn.apply(triple._1(),
                                                                                     triple._2(),
                                                                                     triple._3()));
        return (t1, t2, t3) -> memoise2.apply(tuple(t1,
                                                    t2,
                                                    t3));
    }
     ...
     * @return Memoized asynchronously updating function
     */
    public static <T1, T2, T3, R> Function3<T1, T2, T3, R> memoizeTriFunctionAsync(final Function3<T1, T2, T3, R> fn,
                                                                                   ScheduledExecutorService ex,
                                                                                   String cron) {
        Function1<Tuple3<T1, T2, T3>, R> memoise2 = memoizeFunctionAsync((final Tuple3<T1, T2, T3> triple) -> fn.apply(triple._1(),
                                                                                                                       triple._2(),
                                                                                                                       triple._3()),
                                                                         ex,
                                                                         cron);
    ...
    public static <T1, T2, T3, R> Function3<T1, T2, T3, R> memoizeTriFunction(final Function3<T1, T2, T3, R> fn,
                                                                              final Cacheable<R> cache) {
        Function1<Tuple3<T1, T2, T3>, R> memoise2 = memoizeFunction((final Tuple3<T1, T2, T3> triple) -> fn.apply(triple._1(),
                                                                                                                  triple._2(),
                                                                                                                  triple._3()),
                                                                    cache);
        return (t1, t2, t3) -> memoise2.apply(tuple(t1,
    ...
    public static <T1, T2, T3, T4, R> Function4<T1, T2, T3, T4, R> memoizeQuadFunction(final Function4<T1, T2, T3, T4, R> fn) {
        Function1<Tuple4<T1, T2, T3, T4>, R> memoise2 = memoizeFunction((final Tuple4<T1, T2, T3, T4> quad) -> fn.apply(quad._1(),
                                                                                                                        quad._2(),
                                                                                                                        quad._3(),
                                                                                                                        quad._4()));
        return (t1, t2, t3, t4) -> memoise2.apply(tuple(t1,
                                                        t2,
                                                        t3,
                                                        t4));
    }
     ...
     * @return Memoized asynchronously updating function
     */
    public static <T1, T2, T3, T4, R> Function4<T1, T2, T3, T4, R> memoizeQuadFunctionAsync(final Function4<T1, T2, T3, T4, R> fn,
                                                                                            ScheduledExecutorService ex,
                                                                                            String cron) {
        Function1<Tuple4<T1, T2, T3, T4>, R> memoise2 = memoizeFunctionAsync((final Tuple4<T1, T2, T3, T4> quad) -> fn.apply(quad._1(),
                                                                                                                             quad._2(),
                                                                                                                             quad._3(),
                                                                                                                             quad._4()),
                                                                             ex,
