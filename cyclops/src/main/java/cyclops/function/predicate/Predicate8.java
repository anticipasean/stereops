...
public interface Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> self(Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> pred) {
        return pred;
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> and(Predicate<? super T1> p1,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> first(Predicate<? super T1> p1,
                                                                                                    Predicate<? super T2> p2,
                                                                                                    Predicate<? super T3> p3,
                                                                                                    Predicate<? super T4> p4,
                                                                                                    Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> second(Predicate<? super T1> p1,
                                                                                                     Predicate<? super T2> p2,
                                                                                                     Predicate<? super T3> p3,
                                                                                                     Predicate<? super T4> p4,
                                                                                                     Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> third(Predicate<? super T1> p1,
                                                                                                    Predicate<? super T2> p2,
                                                                                                    Predicate<? super T3> p3,
                                                                                                    Predicate<? super T4> p4,
                                                                                                    Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> fourth(Predicate<? super T1> p1,
                                                                                                     Predicate<? super T2> p2,
                                                                                                     Predicate<? super T3> p3,
                                                                                                     Predicate<? super T4> p4,
                                                                                                     Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> fifth(Predicate<? super T1> p1,
                                                                                                    Predicate<? super T2> p2,
                                                                                                    Predicate<? super T3> p3,
                                                                                                    Predicate<? super T4> p4,
                                                                                                    Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> sixt(Predicate<? super T1> p1,
                                                                                                   Predicate<? super T2> p2,
                                                                                                   Predicate<? super T3> p3,
                                                                                                   Predicate<? super T4> p4,
                                                                                                   Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> seventh(Predicate<? super T1> p1,
                                                                                                      Predicate<? super T2> p2,
                                                                                                      Predicate<? super T3> p3,
                                                                                                      Predicate<? super T4> p4,
                                                                                                      Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> eight(Predicate<? super T1> p1,
                                                                                                    Predicate<? super T2> p2,
                                                                                                    Predicate<? super T3> p3,
                                                                                                    Predicate<? super T4> p4,
                                                                                                    Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> or(Predicate<? super T1> p1,
                                                                                                 Predicate<? super T2> p2,
                                                                                                 Predicate<? super T3> p3,
                                                                                                 Predicate<? super T4> p4,
                                                                                                 Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Predicate8<T1, T2, T3, T4, T5, T6, T7, T8> xor(Predicate<? super T1> p1,
                                                                                                  Predicate<? super T2> p2,
                                                                                                  Predicate<? super T3> p3,
                                                                                                  Predicate<? super T4> p4,
                                                                                                  Predicate<? super T5> p5,
