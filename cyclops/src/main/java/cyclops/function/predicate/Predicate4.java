...
public interface Predicate4<T1, T2, T3, T4> {
    ...
    public static <T1, T2, T3, T4> Predicate4<T1, T2, T3, T4> and(Predicate<? super T1> p1,
    ...
    public static <T1, T2, T3, T4> Predicate4<T1, T2, T3, T4> first(Predicate<? super T1> p1,
                                                                    Predicate<? super T2> p2,
                                                                    Predicate<? super T3> p3,
                                                                    Predicate<? super T4> p4) {
        return (a, b, c, d) -> p1.test(a) && !p2.test(b) && !p3.test(c) && !p4.test(d);
    ...
    public static <T1, T2, T3, T4> Predicate4<T1, T2, T3, T4> second(Predicate<? super T1> p1,
                                                                     Predicate<? super T2> p2,
                                                                     Predicate<? super T3> p3,
                                                                     Predicate<? super T4> p4) {
        return (a, b, c, d) -> !p1.test(a) && p2.test(b) && !p3.test(c) && p4.test(d);
    ...
    public static <T1, T2, T3, T4> Predicate4<T1, T2, T3, T4> third(Predicate<? super T1> p1,
                                                                    Predicate<? super T2> p2,
                                                                    Predicate<? super T3> p3,
                                                                    Predicate<? super T4> p4) {
        return (a, b, c, d) -> !p1.test(a) && !p2.test(b) && p3.test(c) && !p4.test(d);
    ...
    public static <T1, T2, T3, T4> Predicate4<T1, T2, T3, T4> fourth(Predicate<? super T1> p1,
                                                                     Predicate<? super T2> p2,
                                                                     Predicate<? super T3> p3,
                                                                     Predicate<? super T4> p4) {
        return (a, b, c, d) -> !p1.test(a) && !p2.test(b) && !p3.test(c) && p4.test(d);
    ...
    public static <T1, T2, T3, T4> Predicate4<T1, T2, T3, T4> or(Predicate<? super T1> p1,
                                                                 Predicate<? super T2> p2,
                                                                 Predicate<? super T3> p3,
                                                                 Predicate<? super T4> p4) {
        return (a, b, c, d) -> p1.test(a) || p2.test(b) || p3.test(c) || p4.test(d);
    ...
    public static <T1, T2, T3, T4> Predicate4<T1, T2, T3, T4> xor(Predicate<? super T1> p1,
                                                                  Predicate<? super T2> p2,
                                                                  Predicate<? super T3> p3,
                                                                  Predicate<? super T4> p4) {
        return (a, b, c, d) -> p1.test(a) ^ p2.test(b) ^ p3.test(c) ^ p4.test(d);
