...
public interface Predicate6<T1, T2, T3, T4, T5, T6> {
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> self(Predicate6<T1, T2, T3, T4, T5, T6> pred) {
        return pred;
    }
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> and(Predicate<? super T1> p1,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> first(Predicate<? super T1> p1,
                                                                                    Predicate<? super T2> p2,
                                                                                    Predicate<? super T3> p3,
                                                                                    Predicate<? super T4> p4,
                                                                                    Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> second(Predicate<? super T1> p1,
                                                                                     Predicate<? super T2> p2,
                                                                                     Predicate<? super T3> p3,
                                                                                     Predicate<? super T4> p4,
                                                                                     Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> third(Predicate<? super T1> p1,
                                                                                    Predicate<? super T2> p2,
                                                                                    Predicate<? super T3> p3,
                                                                                    Predicate<? super T4> p4,
                                                                                    Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> fourth(Predicate<? super T1> p1,
                                                                                     Predicate<? super T2> p2,
                                                                                     Predicate<? super T3> p3,
                                                                                     Predicate<? super T4> p4,
                                                                                     Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> fifth(Predicate<? super T1> p1,
                                                                                    Predicate<? super T2> p2,
                                                                                    Predicate<? super T3> p3,
                                                                                    Predicate<? super T4> p4,
                                                                                    Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> sixt(Predicate<? super T1> p1,
                                                                                   Predicate<? super T2> p2,
                                                                                   Predicate<? super T3> p3,
                                                                                   Predicate<? super T4> p4,
                                                                                   Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> or(Predicate<? super T1> p1,
                                                                                 Predicate<? super T2> p2,
                                                                                 Predicate<? super T3> p3,
                                                                                 Predicate<? super T4> p4,
                                                                                 Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6> Predicate6<T1, T2, T3, T4, T5, T6> xor(Predicate<? super T1> p1,
                                                                                  Predicate<? super T2> p2,
                                                                                  Predicate<? super T3> p3,
                                                                                  Predicate<? super T4> p4,
                                                                                  Predicate<? super T5> p5,
