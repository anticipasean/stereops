...
public interface Predicate7<T1, T2, T3, T4, T5, T6, T7> {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> self(Predicate7<T1, T2, T3, T4, T5, T6, T7> pred) {
        return pred;
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> and(Predicate<? super T1> p1,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> first(Predicate<? super T1> p1,
                                                                                            Predicate<? super T2> p2,
                                                                                            Predicate<? super T3> p3,
                                                                                            Predicate<? super T4> p4,
                                                                                            Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> second(Predicate<? super T1> p1,
                                                                                             Predicate<? super T2> p2,
                                                                                             Predicate<? super T3> p3,
                                                                                             Predicate<? super T4> p4,
                                                                                             Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> third(Predicate<? super T1> p1,
                                                                                            Predicate<? super T2> p2,
                                                                                            Predicate<? super T3> p3,
                                                                                            Predicate<? super T4> p4,
                                                                                            Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> fourth(Predicate<? super T1> p1,
                                                                                             Predicate<? super T2> p2,
                                                                                             Predicate<? super T3> p3,
                                                                                             Predicate<? super T4> p4,
                                                                                             Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> fifth(Predicate<? super T1> p1,
                                                                                            Predicate<? super T2> p2,
                                                                                            Predicate<? super T3> p3,
                                                                                            Predicate<? super T4> p4,
                                                                                            Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> sixt(Predicate<? super T1> p1,
                                                                                           Predicate<? super T2> p2,
                                                                                           Predicate<? super T3> p3,
                                                                                           Predicate<? super T4> p4,
                                                                                           Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> seventh(Predicate<? super T1> p1,
                                                                                              Predicate<? super T2> p2,
                                                                                              Predicate<? super T3> p3,
                                                                                              Predicate<? super T4> p4,
                                                                                              Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> or(Predicate<? super T1> p1,
                                                                                         Predicate<? super T2> p2,
                                                                                         Predicate<? super T3> p3,
                                                                                         Predicate<? super T4> p4,
                                                                                         Predicate<? super T5> p5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Predicate7<T1, T2, T3, T4, T5, T6, T7> xor(Predicate<? super T1> p1,
                                                                                          Predicate<? super T2> p2,
                                                                                          Predicate<? super T3> p3,
                                                                                          Predicate<? super T4> p4,
                                                                                          Predicate<? super T5> p5,
