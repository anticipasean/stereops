...
public interface Function4<T1, T2, T3, T4, R> extends Function1<T1, Function1<T2, Function1<T3, Function1<T4, R>>>> {
    ...
    default Function1<T3, Function1<T4, R>> apply(final T1 s,
                                                  final T2 s2) {
        return Curry.curry4(this)
                    .apply(s)
                    .apply(s2);
    ...
    default Function1<T4, R> apply(final T1 s,
                                   final T2 s2,
                                   final T3 s3) {
        return Curry.curry4(this)
                    .apply(s)
    ...
    default Function4<T1, T2, T3, T4, R> memoize4Async(ScheduledExecutorService ex,
                                                       String cron) {
        return Memoize.memoizeQuadFunctionAsync(this,
                                                ex,
                                                cron);
    }
    ...
    default Function4<T1, T2, T3, T4, Future<R>> lift4(Executor ex) {
        ...
        return (s1, s2, s3, s4) -> Future.of(() -> apply(s1,
                                                         s2,
                                                         s3,
                                                         s4),
                                             ex);
    ...
    default Function4<T1, T2, T3, T4, Try<R, Throwable>> liftTry4() {
        return (s1, s2, s3, s4) -> Try.withCatch(() -> apply(s1,
                                                             s2,
                                                             s3,
                                                             s4),
                                                 Throwable.class);
    ...
    default Function4<T1, T2, T3, T4, Option<R>> lift4() {
        ...
        return (s1, s2, s3, s4) -> Option.ofNullable(apply(s1,
                                                           s2,
                                                           s3,
                                                           s4));
    }
    ...
    default <V> Function4<T1, T2, T3, T4, V> andThen4(Function<? super R, ? extends V> after) {
        return (t1, t2, t3, t4) -> after.apply(apply(t1,
                                                     t2,
                                                     t3,
                                                     t4));
    }
