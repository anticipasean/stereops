...
public interface Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> extends
    ...
    default Function1<T3, Function1<T4, Function1<T5, Function1<T6, Function1<T7, Function1<T8, R>>>>>> apply(final T1 s,
                                                                                                              final T2 s2) {
        return Curry.curry8(this)
                    .apply(s)
                    .apply(s2);
    ...
    default Function1<T4, Function1<T5, Function1<T6, Function1<T7, Function1<T8, R>>>>> apply(final T1 s,
                                                                                               final T2 s2,
                                                                                               final T3 s3) {
        return Curry.curry8(this)
                    .apply(s)
    ...
    default Function1<T5, Function1<T6, Function1<T7, Function1<T8, R>>>> apply(final T1 s,
                                                                                final T2 s2,
                                                                                final T3 s3,
                                                                                final T4 s4) {
        return Curry.curry8(this)
    ...
    default Function1<T6, Function1<T7, Function1<T8, R>>> apply(final T1 s,
                                                                 final T2 s2,
                                                                 final T3 s3,
                                                                 final T4 s4,
                                                                 final T5 s5) {
    ...
    default Function1<T7, Function1<T8, R>> apply(final T1 s,
                                                  final T2 s2,
                                                  final T3 s3,
                                                  final T4 s4,
                                                  final T5 s5,
    ...
    default Function1<T8, R> apply(final T1 s,
                                   final T2 s2,
                                   final T3 s3,
                                   final T4 s4,
                                   final T5 s5,
    ...
    default Function8<T1, T2, T3, T4, T5, T6, T7, T8, Maybe<R>> lazyLift8() {
        return (s1, s2, s3, s4, s5, s6, s7, s8) -> Maybe.fromLazy(Eval.later(() -> Maybe.ofNullable(apply(s1,
                                                                                                          s2,
                                                                                                          s3,
                                                                                                          s4,
                                                                                                          s5,
    ...
    default Function8<T1, T2, T3, T4, T5, T6, T7, T8, Future<R>> lift8(Executor ex) {
        ...
        return (s1, s2, s3, s4, s5, s6, s7, s8) -> Future.of(() -> apply(s1,
                                                                         s2,
                                                                         s3,
                                                                         s4,
                                                                         s5,
    ...
    default Function8<T1, T2, T3, T4, T5, T6, T7, T8, Try<R, Throwable>> liftTry8() {
        return (s1, s2, s3, s4, s5, s6, s7, s8) -> Try.withCatch(() -> apply(s1,
                                                                             s2,
                                                                             s3,
                                                                             s4,
                                                                             s5,
    ...
    default Function8<T1, T2, T3, T4, T5, T6, T7, T8, Option<R>> lift8() {
        ...
        return (s1, s2, s3, s4, s5, s6, s7, s8) -> Option.ofNullable(apply(s1,
                                                                           s2,
                                                                           s3,
                                                                           s4,
                                                                           s5,
