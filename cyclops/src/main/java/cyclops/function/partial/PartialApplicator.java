...
public class PartialApplicator extends Lambda {
    ...
    public static <T1, T2, R> Supplier<R> partial(final T1 t1,
                                                  final Function<T1, R> func) {
    ...
    public static <T1, T2, R> Supplier<R> partial2(final T1 t1,
                                                   final T2 t2,
                                                   final BiFunction<T1, T2, R> biFunc) {
        return () -> biFunc.apply(t1,
                                  t2);
    }
    ...
    public static <T1, T2, R> Function<T2, R> partial2(final T1 t1,
                                                       final BiFunction<T1, T2, R> biFunc) {
        return (t2) -> biFunc.apply(t1,
                                    t2);
    }
    ...
    public static <T1, T2, R> Function<T1, R> partial2b(final T2 t2,
                                                        final BiFunction<T1, T2, R> biFunc) {
        return (t1) -> biFunc.apply(t1,
                                    t2);
    }
    ...
    public static <T1, T2, T3, R> Supplier<R> partial3(final T1 t1,
                                                       final T2 t2,
                                                       final T3 t3,
                                                       final Function3<T1, T2, T3, R> triFunc) {
        return () -> triFunc.apply(t1,
                                   t2,
                                   t3);
    }
    ...
    public static <T1, T2, T3, R> Function<T3, R> partial3(final T1 t1,
                                                           final T2 t2,
                                                           final Function3<T1, T2, T3, R> triFunc) {
        return (t3) -> triFunc.apply(t1,
                                     t2,
                                     t3);
    }
    ...
    public static <T1, T2, T3, R> BiFunction<T2, T3, R> partial3(final T1 t1,
                                                                 final Function3<T1, T2, T3, R> triFunc) {
        return (t2, t3) -> triFunc.apply(t1,
                                         t2,
                                         t3);
    }
    ...
    public static <T1, T2, T3, T4, R> Supplier<R> partial4(final T1 t1,
                                                           final T2 t2,
                                                           final T3 t3,
                                                           final T4 t4,
                                                           final Function4<T1, T2, T3, T4, R> quadFunc) {
        return () -> quadFunc.apply(t1,
                                    t2,
                                    t3,
                                    t4);
    }
    ...
    public static <T1, T2, T3, T4, R> Function<T4, R> partial4(final T1 t1,
                                                               final T2 t2,
                                                               final T3 t3,
                                                               final Function4<T1, T2, T3, T4, R> quadFunc) {
        return (t4) -> quadFunc.apply(t1,
                                      t2,
                                      t3,
                                      t4);
    }
     ...
     */
    public static <T1, T2, T3, T4, R> BiFunction<T3, T4, R> partial4(final T1 t1,
                                                                     final T2 t2,
                                                                     final Function4<T1, T2, T3, T4, R> quadFunc) {
        return (t3, t4) -> quadFunc.apply(t1,
                                          t2,
                                          t3,
                                          t4);
    }
    ...
    public static <T1, T2, T3, T4, R> Function3<T2, T3, T4, R> partial4(final T1 t1,
                                                                        final Function4<T1, T2, T3, T4, R> quadFunc) {
        return (t2, t3, t4) -> quadFunc.apply(t1,
                                              t2,
                                              t3,
                                              t4);
    }
    ...
    public static <T1, T2, T3, T4, T5, R> Supplier<R> partial5(final T1 t1,
                                                               final T2 t2,
                                                               final T3 t3,
                                                               final T4 t4,
                                                               final T5 t5,
                                                               final Function5<T1, T2, T3, T4, T5, R> quintFunc) {
        return () -> quintFunc.apply(t1,
                                     t2,
                                     t3,
                                     t4,
                                     t5);
    ...
    public static <T1, T2, T3, T4, T5, R> Function<T5, R> partial5(final T1 t1,
                                                                   final T2 t2,
                                                                   final T3 t3,
                                                                   final T4 t4,
                                                                   final Function5<T1, T2, T3, T4, T5, R> quintFunc) {
        return (t5) -> quintFunc.apply(t1,
                                       t2,
                                       t3,
                                       t4,
                                       t5);
    ...
    public static <T1, T2, T3, T4, T5, R> BiFunction<T4, T5, R> partial5(final T1 t1,
                                                                         final T2 t2,
                                                                         final T3 t3,
                                                                         final Function5<T1, T2, T3, T4, T5, R> quintFunc) {
        return (t4, t5) -> quintFunc.apply(t1,
                                           t2,
                                           t3,
                                           t4,
                                           t5);
    ...
    public static <T1, T2, T3, T4, T5, R> Function3<T3, T4, T5, R> partial5(final T1 t1,
                                                                            final T2 t2,
                                                                            final Function5<T1, T2, T3, T4, T5, R> quintFunc) {
        return (t3, t4, t5) -> quintFunc.apply(t1,
                                               t2,
                                               t3,
                                               t4,
                                               t5);
    ...
    public static <T1, T2, T3, T4, T5, R> Function4<T2, T3, T4, T5, R> partial5(final T1 t1,
                                                                                final Function5<T1, T2, T3, T4, T5, R> quintFunc) {
        return (t2, t3, t4, t5) -> quintFunc.apply(t1,
                                                   t2,
                                                   t3,
                                                   t4,
                                                   t5);
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Supplier<R> partial6(final T1 t1,
                                                                   final T2 t2,
                                                                   final T3 t3,
                                                                   final T4 t4,
                                                                   final T5 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Function<T6, R> partial6(final T1 t1,
                                                                       final T2 t2,
                                                                       final T3 t3,
                                                                       final T4 t4,
                                                                       final T5 t5,
                                                                       final Function6<T1, T2, T3, T4, T5, T6, R> hexFunc) {
        return (t6) -> hexFunc.apply(t1,
                                     t2,
                                     t3,
                                     t4,
                                     t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, R> BiFunction<T5, T6, R> partial6(final T1 t1,
                                                                             final T2 t2,
                                                                             final T3 t3,
                                                                             final T4 t4,
                                                                             final Function6<T1, T2, T3, T4, T5, T6, R> hexFunc) {
        return (t5, t6) -> hexFunc.apply(t1,
                                         t2,
                                         t3,
                                         t4,
                                         t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Function3<T4, T5, T6, R> partial6(final T1 t1,
                                                                                final T2 t2,
                                                                                final T3 t3,
                                                                                final Function6<T1, T2, T3, T4, T5, T6, R> hexFunc) {
        return (t4, t5, t6) -> hexFunc.apply(t1,
                                             t2,
                                             t3,
                                             t4,
                                             t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Function4<T3, T4, T5, T6, R> partial6(final T1 t1,
                                                                                    final T2 t2,
                                                                                    final Function6<T1, T2, T3, T4, T5, T6, R> hexFunc) {
        return (t3, t4, t5, t6) -> hexFunc.apply(t1,
                                                 t2,
                                                 t3,
                                                 t4,
                                                 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Function5<T2, T3, T4, T5, T6, R> partial6(final T1 t1,
                                                                                        final Function6<T1, T2, T3, T4, T5, T6, R> hexFunc) {
        return (t2, t3, t4, t5, t6) -> hexFunc.apply(t1,
                                                     t2,
                                                     t3,
                                                     t4,
                                                     t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Supplier<R> partial7(final T1 t1,
                                                                       final T2 t2,
                                                                       final T3 t3,
                                                                       final T4 t4,
                                                                       final T5 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Function<T7, R> partial7(final T1 t1,
                                                                           final T2 t2,
                                                                           final T3 t3,
                                                                           final T4 t4,
                                                                           final T5 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> BiFunction<T6, T7, R> partial7(final T1 t1,
                                                                                 final T2 t2,
                                                                                 final T3 t3,
                                                                                 final T4 t4,
                                                                                 final T5 t5,
                                                                                 final Function7<T1, T2, T3, T4, T5, T6, T7, R> heptFunc) {
        return (t6, t7) -> heptFunc.apply(t1,
                                          t2,
                                          t3,
                                          t4,
                                          t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Function3<T5, T6, T7, R> partial7(final T1 t1,
                                                                                    final T2 t2,
                                                                                    final T3 t3,
                                                                                    final T4 t4,
                                                                                    final Function7<T1, T2, T3, T4, T5, T6, T7, R> heptFunc) {
        return (t5, t6, t7) -> heptFunc.apply(t1,
                                              t2,
                                              t3,
                                              t4,
                                              t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Function4<T4, T5, T6, T7, R> partial7(final T1 t1,
                                                                                        final T2 t2,
                                                                                        final T3 t3,
                                                                                        final Function7<T1, T2, T3, T4, T5, T6, T7, R> heptFunc) {
        return (t4, t5, t6, t7) -> heptFunc.apply(t1,
                                                  t2,
                                                  t3,
                                                  t4,
                                                  t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Function5<T3, T4, T5, T6, T7, R> partial7(final T1 t1,
                                                                                            final T2 t2,
                                                                                            final Function7<T1, T2, T3, T4, T5, T6, T7, R> heptFunc) {
        return (t3, t4, t5, t6, t7) -> heptFunc.apply(t1,
                                                      t2,
                                                      t3,
                                                      t4,
                                                      t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Function6<T2, T3, T4, T5, T6, T7, R> partial7(final T1 t1,
                                                                                                final Function7<T1, T2, T3, T4, T5, T6, T7, R> heptFunc) {
        return (t2, t3, t4, t5, t6, t7) -> heptFunc.apply(t1,
                                                          t2,
                                                          t3,
                                                          t4,
                                                          t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Supplier<R> partial8(final T1 t1,
                                                                           final T2 t2,
                                                                           final T3 t3,
                                                                           final T4 t4,
                                                                           final T5 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function<T8, R> partial8(final T1 t1,
                                                                               final T2 t2,
                                                                               final T3 t3,
                                                                               final T4 t4,
                                                                               final T5 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> BiFunction<T7, T8, R> partial8(final T1 t1,
                                                                                     final T2 t2,
                                                                                     final T3 t3,
                                                                                     final T4 t4,
                                                                                     final T5 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function3<T6, T7, T8, R> partial8(final T1 t1,
                                                                                        final T2 t2,
                                                                                        final T3 t3,
                                                                                        final T4 t4,
                                                                                        final T5 t5,
                                                                                        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
        return (t6, t7, t8) -> octFunc.apply(t1,
                                             t2,
                                             t3,
                                             t4,
                                             t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function4<T5, T6, T7, T8, R> partial8(final T1 t1,
                                                                                            final T2 t2,
                                                                                            final T3 t3,
                                                                                            final T4 t4,
                                                                                            final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
        return (t5, t6, t7, t8) -> octFunc.apply(t1,
                                                 t2,
                                                 t3,
                                                 t4,
                                                 t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function5<T4, T5, T6, T7, T8, R> partial8(final T1 t1,
                                                                                                final T2 t2,
                                                                                                final T3 t3,
                                                                                                final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
        return (t4, t5, t6, t7, t8) -> octFunc.apply(t1,
                                                     t2,
                                                     t3,
                                                     t4,
                                                     t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function6<T3, T4, T5, T6, T7, T8, R> partial8(final T1 t1,
                                                                                                    final T2 t2,
                                                                                                    final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
        return (t3, t4, t5, t6, t7, t8) -> octFunc.apply(t1,
                                                         t2,
                                                         t3,
                                                         t4,
                                                         t5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Function7<T2, T3, T4, T5, T6, T7, T8, R> partial8(final T1 t1,
                                                                                                        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> octFunc) {
        return (t2, t3, t4, t5, t6, t7, t8) -> octFunc.apply(t1,
                                                             t2,
                                                             t3,
                                                             t4,
                                                             t5,
