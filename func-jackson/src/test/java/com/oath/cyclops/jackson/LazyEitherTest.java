...
public class LazyEitherTest {
    ...
    @Test
    public void left() {
        assertThat(JacksonUtil.serializeToJson(LazyEither.left(10)),
                   equalTo("{\"left\":10}"));
    ...
    @Test
    public void right() {
        assertThat(JacksonUtil.serializeToJson(LazyEither.right(10)),
                   equalTo("{\"right\":10}"));
    ...
    public void infiniteEither() {
        Either<Exception, String> result = Option.<String>none().toTry(new Exception("asdf"))
                                                                .asEither();
        for (int i = 0; i < 10; i++) {
    ...
    public void roundTripLeft() {
        ...
        LazyEither<Integer, String> des = JacksonUtil.convertFromJson(json,
                                                                      LazyEither.class);
    ...
    public void roundTripRight() {
        ...
        System.out.println("Json " + json);
        LazyEither<String, Integer> des = JacksonUtil.convertFromJson(json,
                                                                      LazyEither.class);
