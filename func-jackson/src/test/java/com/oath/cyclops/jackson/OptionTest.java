...
public class OptionTest {
    ...
    public void roundTrip() {
        ...
        Option<Integer> des = JacksonUtil.convertFromJson(json,
                                                          Option.class);
    ...
    @Test
    public void none() {
        assertThat(JacksonUtil.serializeToJson(Option.none()),
                   equalTo("null"));
    }

    @Test
    public void some() {
        assertThat(JacksonUtil.serializeToJson(Option.some(5)),
                   equalTo("5"));
    }
    ...
    public void roundTripOptional() {
        ...
        System.out.println("Json " + json);
        Optional<Integer> des = JacksonUtil.convertFromJson(json,
                                                            Optional.class);
