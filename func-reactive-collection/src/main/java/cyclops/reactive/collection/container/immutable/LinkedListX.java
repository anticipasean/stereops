...
import cyclops.reactive.collection.container.immutable.lazy.impl.LazyLinkedListX;
import cyclops.reactive.collection.container.lazy.LazyCollectionX;
import cyclops.reactive.collection.container.mutable.ListX;
import cyclops.reactive.collection.function.higherkinded.ReactiveWitness.linkedListX;
...
public interface LinkedListX<T> extends To<LinkedListX<T>>, PersistentList<T>, LazyCollectionX<T>, IndexedSequenceX<T>,
     ...
     * @return LinkedListX
     */
    static <T> LinkedListX<T> fromPublisher(final Publisher<T> publisher) {
