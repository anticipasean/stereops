...
public abstract class ShakespearePlaysScrabbleWithStreams extends ShakespearePlaysScrabble {
    ...
    public List<Entry<Integer, List<String>>> measureThroughput() {
        ...
        Function<String, Map<Integer, Long>> histoOfLetters = word -> word.chars()
                                                                          .boxed()
        ...
        Function<String, Long> nBlanks = word -> histoOfLetters.apply(word)
                                                               .entrySet()
                                                               .stream()
                                                               .mapToLong(blank)
                                                               .sum();
        ...
        Function<String, Integer> score2 = word -> histoOfLetters.apply(word)
                                                                 .entrySet()
                                                                 .stream()
        ...
        // Stream to be maxed
        Function<String, IntStream> toBeMaxed = word -> Stream.of(first3.apply(word),
                                                                  last3.apply(word))
        ...
        Function<Function<String, Integer>, Stream<Map<Integer, List<String>>>> buildHistoOnScore = score -> Stream.of(buildShakerspeareWordsStream().filter(scrabbleWords::contains)
