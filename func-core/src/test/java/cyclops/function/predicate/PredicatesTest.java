...
public class PredicatesTest {
    ...
    public void testFilter() {
        ...
        ReactiveSeq.of(1,
                       2,
                       3)
                   .filter(anyOf(not(greaterThan(2)),
                                 in(1,
                                    10,
                                    20)));
        ReactiveSeq.of(1,
                       2,
                       3)
                   .filter(anyOf(not(greaterThanOrEquals(2)),
                                 in(1,
                                    10,
                                    20)));
        ReactiveSeq.of(1,
        ...
        ReactiveSeq.of(1,
                       2,
                       3)
                   .filter(anyOf(not(lessThanOrEquals(2)),
                                 in(1,
                                    10,
                                    20)));
        ReactiveSeq.of(1,
                       2,
                       3)
                   .filter(anyOf(not(eq(2)),
                                 in(1,
                                    10,
                                    20)));
        Stream.of(Maybe.of(2))
              .filter(eqv(Eval.now(2)));
    ...
    @Test
    public void testEqv() {
        assertThat(Stream.of(Maybe.of(2))
                         .filter(eqv(Eval.now(2)))
                         .collect(Collectors.toList())
                         .get(0),
                   equalTo(Maybe.of(2)));
    ...
    public void testEqvFalse() {
        assertThat(Stream.of(Maybe.of(3))
    ...
    public void hasItems() {
        assertTrue(Predicates.hasItems(Arrays.asList(1,
                                                     2,
                                                     3))
                             .test(Arrays.asList(10,
                                                 1,
                                                 23,
                                                 2,
                                                 3,
    ...
    public void startsWith() {
        assertFalse(Predicates.startsWith(1,
                                          2,
                                          3)
                              .test(Arrays.asList(10,
                                                  1,
    ...
    public void startsWithTrue() {
        assertTrue(Predicates.startsWith(1,
                                         2,
                                         3)
    ...
    public void endsWithTrue() {
        assertTrue(Predicates.endsWith(1,
                                       2,
                                       3)
                             .test(Arrays.asList(10,
                                                 1,
