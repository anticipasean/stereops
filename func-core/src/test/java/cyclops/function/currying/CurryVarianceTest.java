...
public class CurryVarianceTest {
    ...
    public void testBiFunc() {
        ...
        assertThat(CurryVariance.curry2(fn)
                                .apply(1)
                                .apply(2),
                   equalTo("3hello"));
    }
    ...
    public void testBiFuncInPlace() {
        ...
        assertThat(CurryVariance.curry2((Integer i, Integer j) -> "" + (i + j) + "hello")
                                .apply(1)
                                .apply(2),
                   equalTo("3hello"));
    }
    ...
    public void testMethodRef() {
        ...
        assertThat(CurryVariance.curry2(this::mult)
                                .apply(3)
                                .apply(2),
                   equalTo(6));
    }
    ...
    public void testMethodRef3() {
        ...
        assertThat(CurryVariance.curry3(this::three)
                                .apply(3)
                                .apply(2)
                                .apply("three"),
                   equalTo("three6"));
    ...
    public void testMethodRef4() {
        ...
        assertThat(CurryVariance.curry4(this::four)
                                .apply(3)
                                .apply(2)
                                .apply("three")
                                .apply("4"),
    ...
    public void testMethodRef5() {
        ...
        assertThat(CurryVariance.curry5(this::five)
                                .apply(3)
                                .apply(2)
                                .apply("three")
                                .apply("4")
    ...
    public void testMethodRef6() {
        ...
        assertThat(CurryVariance.curry6(this::six)
                                .apply(3)
                                .apply(2)
                                .apply("three")
                                .apply("4")
    ...
    public void testMethodRef7() {
        ...
        assertThat(CurryVariance.curry7(this::seven)
                                .apply(3)
                                .apply(2)
                                .apply("three")
                                .apply("4")
    ...
    public void testMethodRef8() {
        ...
        assertThat(CurryVariance.curry8(this::eight)
                                .apply(3)
                                .apply(2)
                                .apply("three")
                                .apply("4")
    ...
    public String three(Integer a,
                        Integer b,
                        String name) {
        return name + (a * b);
    }

    public String four(Integer a,
                       Integer b,
                       String name,
                       String postfix) {
