...
public class StreamableSeqOpertationsTest {
    ...
    public void zipEmpty() throws Exception {
        ...
        final Streamable<Integer> zipped = empty.zip(this.<Integer>of(),
                                                     (a, b) -> a + b);
    ...
    public void shouldReturnEmptySeqWhenZipEmptyWithNonEmpty() throws Exception {
        ...
        final Streamable<Integer> zipped = empty.zip(nonEmpty,
                                                     (a, b) -> a + b);
        assertTrue(zipped.collect(Collectors.toList())
                         .isEmpty());
    }
    ...
    public void shouldReturnEmptySeqWhenZipNonEmptyWithEmpty() throws Exception {
        ...
        final Streamable<Integer> zipped = nonEmpty.zip(empty,
                                                        (a, b) -> a + b);
    ...
    public void shouldZipTwoFiniteSequencesOfSameSize() throws Exception {
        ...
        final Streamable<String> first = of("A",
                                            "B",
                                            "C");
        final Streamable<Integer> second = of(1,
                                              2,
                                              3);

        final Streamable<String> zipped = first.zip(second,
                                                    (a, b) -> a + b);
    ...
    public void testShuffle() {
        Supplier<Streamable<Integer>> s = () -> of(1,
                                                   2,
                                                   3);
    ...
    public void testDuplicate() {
        Tuple2<Streamable<Integer>, Streamable<Integer>> copies = of(1,
                                                                     2,
                                                                     3,
                                                                     4,
                                                                     5,
    ...
    public void testSkipWhile() {
        Supplier<Streamable<Integer>> s = () -> Streamable.of(1,
                                                              2,
                                                              3,
                                                              4,
                                                              5);
    ...
    public void testUnzip() {
        Supplier<Streamable<Tuple2<Integer, String>>> s = () -> of(Tuple.tuple(1,
                                                                               "a"),
                                                                   Tuple.tuple(2,
                                                                               "b"),
                                                                   Tuple.tuple(3,
    ...
    public void testFoldLeft() {
        Supplier<Streamable<String>> s = () -> of("a",
                                                  "b",
                                                  "c");
    ...
    public void flattenEmpty() throws Exception {
        assertTrue(this.<Integer>of().flatMap(i -> Streamable.fromStream(asList(i,
                                                                                -i).stream()))
                                     .toList()
                                     .isEmpty());
    }
    ...
    public void flatten() throws Exception {
        assertThat(this.<Integer>of(1,
                                    2).flatMap(i -> Streamable.fromStream(asList(i,
                                                                                 -i).stream()))
                                      .toList(),
                   equalTo(asList(1,
                                  -1,
    ...
    public void flattenEmptyStream() throws Exception {
        ...
        assertThat(this.<Integer>of(1,
                                    ...
                                    8,
                                    9,
                                    10).flatMapStream(this::flatMapFun)
                                       .limit(10)
                                       .collect(Collectors.toList()),
                   equalTo(asList(2,
                                  3,
