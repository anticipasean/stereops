...
public class WindowingTest {
    ...
    public void windowUntilEmpty() {
        assertThat(ReactiveSeq.<Integer>of().groupedUntil(i -> i % 3 == 0)
                                            .toList()
                                            .size(),
                   equalTo(0));
    }
    ...
    @Test
    public void sliding() {
        List<Seq<Integer>> list = ReactiveSeq.of(1,
                                                 2,
                                                 3,
                                                 4,
                                                 5,
    ...
    public void grouped() {
        ...
        List<Vector<Integer>> list = ReactiveSeq.of(1,
                                                    2,
                                                    3,
                                                    4,
                                                    5,
    ...
    public void sliding2() {
        ...
        List<Seq<Integer>> sliding = ReactiveSeq.of(1,
                                                    2,
                                                    3,
                                                    4,
                                                    5)
    ...
    public void slidingEmpty() {
        ...
        System.out.println("List " + ReactiveSeq.of()
                                                .sliding(1)
                                                .toList());
        assertThat(ReactiveSeq.of()
                              .sliding(1)
    ...
    public void slidingWithSmallWindowAtEndIterative() {
        ...
        Iterator<Seq<Integer>> it = ReactiveSeq.of(1,
                                                   2,
                                                   3,
                                                   4,
                                                   5)
