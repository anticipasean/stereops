...
public class SkipWhileOperatorTest {
    ...
    public void dropWhileStagesAsync() {
        ...
        Subscription s = Spouts.async(ReactiveSeq.of(1,
                                                     2,
                                                     3,
                                                     4,
                                                     5),
