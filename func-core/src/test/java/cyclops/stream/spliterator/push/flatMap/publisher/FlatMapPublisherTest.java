package cyclops.stream.spliterator.push.flatMap.publisher;
...
public class FlatMapPublisherTest {
    ...
    protected <U> ReactiveSeq<U> flux(U... array) {
        ...
        return Spouts.from(Flux.just(array)
                               .subscribeOn(Schedulers.fromExecutor(ex[indexToUse])));
    ...
    public void flatMapFlux() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            System.out.println("************Iteration " + i);
            System.out.println("************Iteration " + i);
            Assert.assertThat(flux(1).mergeMap(in -> flux(1,
                                                          2,
                                                          3))
                                     .toList(),
    ...
    public void flatMapFluxMaxCon() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            Assert.assertThat(flux(1).mergeMap(2,
                                               in -> flux(10,
                                                          20,
                                                          30))
                                     .toList(),
                              Matchers.equalTo(Arrays.asList(10,
                                                             20,
                                                             30)));
        }
    ...
    public void flatMapList() {
        for (int i = 0; i < 100_000; i++) {
            System.out.println("Iteration " + i);
            List<Integer> list = flux(1).mergeMap(in -> of(1,
                                                           2,
                                                           3))
                                        .toList();
    ...
    public void flatMapP2() {
        MatcherAssert.assertThat(Spouts.of(1,
                                           2,
                                           3)
                                       .mergeMap(i -> Spouts.of(1,
                                                                i))
                                       .toList(),
                                 Matchers.hasItems(1,
                                                   1,
    ...
    public void range() {
        ...
        List<Integer> res = Spouts.range(1,
                                         500)
    ...
    public void flatMapPAsync2Synchronous() {
        for (int k = 0; k < 5000; k++) {
            ...
            List<Integer> res = Spouts.from(Flux.just(1,
                                                      2,
                                                      3)
                                                .flatMap(i -> nextAsync()))
                                      .toList();
    ...
    public void flatMapPAsyncRS2() {
        for (int k = 0; k < 1000; k++) {
            ...
            List<Integer> res = Spouts.from(Spouts.of(1,
                                                      2,
                                                      3)
                                                  .peek(System.out::println)
                                                  .mergeMap(i -> nextAsync()))
    ...
    /**
     * @Test public void flatMapPAsyncRS2Conc(){ for(int k=0;k<1000;k++) { System.out.println("********0---------------------K " +
     * k);
     * <p>
     * <p>
     * <p>
     * <p>
     * List<Integer> res = of(1, 2, 3) .peek(System.out::println) .flatMapP(2,i -> nextAsync()) .collect(Collectors.toList());
     * System.out.println(res); assertThat(res.size(), equalTo(ListX.of(1, 2, 1, 2, 1, 2).size()));
     * <p>
     * assertThat(res, hasItems(1, 2)); int one = 0; int two = 0; for (Integer next : res) { if (next == 1) { one++; } if (next ==
     * 2) { two++; } } assertThat(one, equalTo(3)); assertThat(two, equalTo(3));
     * <p>
     * }
     * <p>
     * }
    ...
    public void arrayConcat() {
        for (int k = 0; k < 1000; k++) {
            ...
            List<Integer> res = Spouts.concat(nextAsync(),
                                              nextAsync(),
                                              nextAsync())
                                      .collect(Collectors.toList());
            System.out.println(res);
    ...
    public void arrayConcatIt() {
        for (int k = 0; k < 1000; k++) {
            ...
            List<Integer> res = new ArrayList();
            Iterator<Integer> it = Spouts.concat(nextAsync(),
                                                 nextAsync(),
                                                 nextAsync())
                                         .iterator();
            while (it.hasNext()) {
    ...
    public void flatMapPAsyncRS3() {
        for (int k = 0; k < 100; k++) {
            ...
            Flux<Integer> flux = Flux.from(Spouts.of(1,
                                                     2,
                                                     3)
                                                 .peek(System.out::println)
                                                 .mergeMap(i -> nextAsync()));
