package cyclops.stream.spliterator.standard.flatMap.publisher;
...
public class FlatMapPublisherTest {
    ...
    protected <U> ReactiveSeq<U> flux(U... array) {
        ...
        return Spouts.from(Flux.just(array)
                               .subscribeOn(Schedulers.fromExecutor(exec)));
        ...
        of(1,
           ...
           3).peek(System.out::println)
             ...
             .forEach(r -> System.out.println("Next res " + r + " count " + count.incrementAndGet()),
                      ...
                      () -> complete.set(true));//.request(Long.MAX_VALUE);

        while (!complete.get()) {

        }
        System.out.println("Count " + count);
        System.out.println("Size " + Spouts.of(1,
                                               2,
                                               3)
    ...
    /**
     * @Test public void flatMapPAsyncRS2() throws InterruptedException { for(int k=0;k<1000;k++) {
     * System.out.println("********0---------------------K " + k); System.out.println("********0---------------------K " + k);
     * System.out.println("********0---------------------K " + k); System.out.println("********0---------------------K " + k);
     * System.out.println("********0---------------------K " + k); System.out.println("********0---------------------K " + k);
     * <p>
     * <p>
     * <p>
     * List<Integer> res = of(1, 2, 3) .peek(System.out::println) .flatMapP(2,i -> nextAsync()) .peek(e->System.out.println("e " +
     * e)) .collect(Collectors.toList()); System.out.println(res);
     * <p>
    ...
    public void flatMapPAsyncRS3() {
        for (int k = 0; k < 100; k++) {
            ...
            List<Integer> res = Spouts.from(of(1,
                                               2,
                                               3).peek(System.out::println)
                                                 .mergeMap(i -> nextAsync()))
