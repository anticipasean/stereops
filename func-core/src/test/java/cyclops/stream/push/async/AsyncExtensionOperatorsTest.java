...
public class AsyncExtensionOperatorsTest {
    ...
    public void flatMapStreamFilterSimple() {
        assertThat(of(1,
                      null).flatMap(i -> of(i).filter(Objects::nonNull))
    ...
    public void duplicateFindOne() {
        Tuple2<Integer, Long> v2 = of(1).duplicate()
                                        ._1()
                                        .zipWithIndex()
                                        .takeOne()
                                        .toOptional()
    ...
    public void elementAt0() {
        ...
        assertThat(of(1).elementAtAndStream(0)
                        ._1(),
                   equalTo(1));
    }
    ...
    public void limitTimeEmpty() {
        List<Integer> result = Spouts.<Integer>of().peek(i -> sleep(i * 100))
                                                   .take(1000,
                                                         TimeUnit.MILLISECONDS)
                                                   .toList();
    ...
    public void endsWithBothEmpty() {
        assertTrue(Spouts.<Integer>of().endsWith(Arrays.asList()));
    }


    @Test
    public void streamable() {
        Streamable<Integer> repeat = Streamable.fromStream(of(1,
                                                              2,
                                                              3,
                                                              4,
                                                              5,
    ...
    public void flatMap() {
        for (int i = 0; i < 1000; i++) {
            ...
            assertThat(of(1).flatMap(in -> of(1,
                                              2,
                                              3))
                            .toList(),
                       equalTo(Arrays.asList(1,
