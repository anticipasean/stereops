...
public class DifferenceListTest extends BaseImmutableListTest {
    ...
    public void memoize() {
        count = 0;
        DifferenceList<Integer> list = DifferenceList.of(LazySeq.range(1,
                                                                       10))
                                                     .map(i -> count++);
    ...
    @Test
    public void append() {
        assertThat(DifferenceList.of(1,
                                     2,
                                     3)
                                 .append(DifferenceList.of(4,
                                                           5,
                                                           6))
                                 .run(),
    ...
    public void flatMap() {
        assertThat(DifferenceList.of(1,
                                 ...
                                 .append(DifferenceList.of(4,
                                                           5,
                                                           6))
                                 .flatMap(i -> DifferenceList.of(i * 2))
                                 .run(),
                   equalTo(LazySeq.of(2,
                                      4,
                                      6,
    ...
    public IterableX<Integer> range(int start,
                                    int end) {
        return DifferenceList.range(start,
                                    end);
    }
    ...
    public IterableX<Long> rangeLong(long start,
                                     long end) {
        return DifferenceList.rangeLong(start,
                                        end);
    }
    ...
    public <T> IterableX<T> iterate(int times,
                                    T seed,
                                    UnaryOperator<T> fn) {
        return DifferenceList.iterate(seed,
                                      fn,
                                      times);
    }
    ...
    public <T> IterableX<T> generate(int times,
                                     Supplier<T> fn) {
        return DifferenceList.generate(fn,
                                       times);
    }
    ...
    public <U, T> IterableX<T> unfold(U seed,
        ...
        return DifferenceList.unfold(seed,
                                     unfolder);
    }
