...
public class BankersQueueTest extends BaseImmutableQueueTest {
    ...
    public void enqueue2() {
        ...
        assertThat(q.dequeue(-1),
                   equalTo(Tuple.tuple(1,
                                       q.tail())));
        BankersQueue<Integer> q2 = q.dequeue(-1)
                                    ._2();

        assertThat(q2.dequeue(-1),
    ...
    public void fromStream() {
        System.out.println(BankersQueue.of(1,
                                           2,
                                           3));
        System.out.println(fromStream(Stream.of(1,
                                                2,
                                                3)));
        fromStream(Stream.of(1,
                             2,
                             3)).iterator();
    ...
    public void get() {
        ...
        System.out.println("1 " + q.dequeue(-1)
                                   ._2()
                                   .dequeue(-1));
        System.out.println("2 " + q.dequeue(-1)
                                   ._2()
                                   .dequeue(-1)
                                   ._2()
                                   .dequeue(-1));
    ...
    public IterableX<Integer> range(int start,
                                    int end) {
        return BankersQueue.fromStream(ReactiveSeq.range(start,
                                                         end));
    }
    ...
    public IterableX<Long> rangeLong(long start,
                                     long end) {
        return BankersQueue.fromStream(ReactiveSeq.rangeLong(start,
                                                             end));
    }
    ...
    public <T> IterableX<T> iterate(int times,
                                    T seed,
                                    UnaryOperator<T> fn) {
        return BankersQueue.fromStream(ReactiveSeq.iterate(seed,
                                                           fn)
                                                  .limit(times));
    }
    ...
    public <T> IterableX<T> generate(int times,
                                     Supplier<T> fn) {
        return BankersQueue.fromStream(ReactiveSeq.generate(fn)
                                                  .limit(times));
    }
    ...
    public <U, T> IterableX<T> unfold(U seed,
        ...
        return BankersQueue.fromStream(ReactiveSeq.unfold(seed,
                                                          unfolder));
    }
    ...
    public void streamable() {
        System.out.println("S" + of(1,
                                    2,
                                    3,
                                    4,
                                    5,
                                    6));
        Streamable<Integer> repeat = Streamable.fromIterable(of(1,
                                                                2,
                                                                3,
                                                                4,
                                                                5,
