...
public class Tuple7Test {
    ...
    public void visit() throws Exception {
        assertThat(tuple.fold((a, b, c, d, e, f, g) -> a + b + c + d + e + f + g),
                   equalTo(57));
    }
    ...
    public void testToString() throws Exception {
        assertThat(tuple.toString(),
                   equalTo("[2,5,10,10,10,10,10]"));
    }


    @Test
    public void transform() {
        assertThat(lazyT1.transform((a, b, c, d, e, f, g) -> a + b + c + d + e + f + g),
                   equalTo("hello1234810"));
    }
