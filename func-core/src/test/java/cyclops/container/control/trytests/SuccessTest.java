...
public class SuccessTest {
    ...
    @Test
    public void testGet() {
        assertThat(success.orElse(null),
                   equalTo(value));
    }
    ...
    public void testMap() {
        assertThat(success.map(x -> x + 1),
                   equalTo(Try.success(value + 1)));
    }

    @Test
    public void testFlatMap() {
        assertThat(success.flatMap(x -> Try.success(x + 1)),
                   equalTo(Try.success(value + 1)));
    }
    ...
    public void testRecover() {
        assertThat(success.recover(e -> 20),
                   equalTo(success));
    }

    @Test
    public void testRecoverSupplier() {
        assertThat(success.recover(() -> 20),
                   equalTo(success));
    }

    @Test
    public void testRecoverWith() {
        assertThat(success.recoverFlatMap(e -> Try.success(20)),
                   equalTo(success));
    }
    ...
    public void testRecoverFor() {
        ...
        assertThat(success.recoverFor(FileSystemException.class,
                                      e -> 10),
                   equalTo(Try.success(20)));
        assertThat(success.recoverFor(FileNotFoundException.class,
                                      e -> 15),
                   equalTo(Try.success(20)));
        assertThat(success.recoverFor(IOException.class,
                                      e -> 30),
                   equalTo(success));
    }
    ...
    public void testRecoverWithFor() {
        assertThat(success.recoverFlatMapFor(FileNotFoundException.class,
                                             e -> Try.success(20)),
                   equalTo(success));
    }
    ...
    public void testFlatten() {
        ...
        assertThat(Try.<Try<Integer, FileNotFoundException>, FileNotFoundException>success(success).to(Try::flatten),
                   equalTo(success));
    }
    ...
    public void testFlattenFailure() {
        ...
        assertThat(Try.<Try<Integer, FileNotFoundException>, FileNotFoundException>success(Try.failure(error)).to(Try::flatten),
    ...
    public void testOnFailClassOfQsuperXConsumerOfX() {
        ...
        errorCaptured = null;
        success.onFail(FileNotFoundException.class,
                       e -> errorCaptured = e);
        assertThat(errorCaptured,
                   is(nullValue()));
    }
    ...
    public void testToFailedOption() {
        ...
        assertThat(success.toFailedOption(),
                   is(Option.none()));
    }

    @Test
    public void testToFailedStream() {
        assertThat(success.toFailedStream()
                          .findFirst(),
                   is(Optional.empty()));
    }
