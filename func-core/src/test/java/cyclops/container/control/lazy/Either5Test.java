...
public class Either5Test {
    ...
    public void nullPublisher() {
        assertThat(LazyEither5.fromPublisher(Seq.of(null,
                                                    190)),
                   not(equalTo(LazyEither5.right(null))));
    }

    @Test
    public void fromNull() {
        System.out.println(LazyEither5.fromIterable(Seq.of()
                                                       .plus(null)));
        assertThat(LazyEither5.right(null),
                   equalTo(LazyEither5.right(null)));

        assertThat(LazyEither5.fromIterable(Seq.of()),
                   equalTo(LazyEither5.left1(null)));

        assertThat(LazyEither5.fromPublisher(Seq.of(null,
                                                    190)),
                   not(equalTo(LazyEither5.right(null))));
        assertTrue(LazyEither5.fromPublisher(Seq.of(null,
                                                    190))
                              .isLeft1());
        assertThat(LazyEither5.fromFuture(Future.ofResult(null)),
                   equalTo(LazyEither5.right(null)));
    ...
    public void testTraverseLeft1() {
        Vector<LazyEither5<Integer, String, String, String, String>> list = Vector.of(just,
                                                                                      none,
                                                                                      LazyEither5.<String, String, String, String, Integer>right(1))
                                                                                  .map(LazyEither5::swap1);
        LazyEither5<Integer, String, String, String, ReactiveSeq<String>> xors = LazyEither5.traverse(list,
                                                                                                      s -> "hello:" + s);
        assertThat(xors.map(s -> s.toList()),
                   equalTo(LazyEither5.right(Arrays.asList("hello:none"))));
    }
    ...
    public void testSequenceLeft1() {
        ...
        assertThat(xors.map(s -> s.toList()),
                   equalTo(LazyEither5.right(Arrays.asList("none"))));
    }

    @Test
    public void testSequenceLeft2() {
        Vector<LazyEither5<String, Integer, String, String, String>> list = Vector.of(just,
                                                                                      left2,
                                                                                      LazyEither5.<String, String, String, String, Integer>right(1))
                                                                                  .map(LazyEither5::swap2);
        LazyEither5<String, Integer, String, String, ReactiveSeq<String>> xors = LazyEither5.sequence(list);
        assertThat(xors.map(s -> s.toList()),
                   equalTo(LazyEither5.right(Arrays.asList("left2"))));
    }

    @Test
    public void testAccumulate() {
        LazyEither5<String, String, String, String, Integer> iors = LazyEither5.accumulate(Monoids.intSum,
                                                                                           Arrays.asList(none,
                                                                                                         just,
                                                                                                         LazyEither5.right(10)));
        assertThat(iors,
                   equalTo(LazyEither5.right(20)));
    }
    ...
    public void visit() {
        ...
        assertThat(left2.fold(secondary -> "no",
                              ...
                              primary -> "yes"),
                   equalTo("left2"));
        assertThat(left3.fold(secondary -> "no",
                              left2 -> "left2",
                              left3 -> "left3",
                              left4 -> "left4",
                              primary -> "yes"),
    ...
    public void testMapFunctionOfQsuperTQextendsR() {
        assertThat(just.map(i -> i + 5),
                   equalTo(LazyEither5.right(15)));
        assertThat(none.map(i -> i + 5),
                   equalTo(LazyEither5.left1("none")));
    }

    @Test
    public void testFlatMap() {
        assertThat(just.flatMap(i -> LazyEither5.right(i + 5)),
                   equalTo(LazyEither5.right(15)));
        assertThat(none.flatMap(i -> LazyEither5.right(i + 5)),
                   equalTo(LazyEither5.left1("none")));
    }
    ...
    public void testMkString() {
        assertThat(just.mkString(),
                   equalTo("Either5.right[10]"));
        assertThat(none.mkString(),
                   equalTo("Either5.left1[none]"));
    }
