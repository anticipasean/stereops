...
public class CompletableEitherTest {
    ...
    public void lazyTest() {
        CompletableEitherTest.right(10)
                             .flatMap(i -> {
                                 lazy = false;
                                 return CompletableEitherTest.right(15);
                             })
                             .map(i -> {
                                 lazy = false;
                                 return CompletableEitherTest.right(15);
    ...
    public void hashCodeTest() {
        ...
        assertThat(Either.right(10)
                         .hashCode(),
                   equalTo(CompletableEitherTest.right(10)
                                                .hashCode()));
    }
    ...
    public void testFlatMap() {
        assertThat(just.flatMap(i -> CompletableEitherTest.right(i + 5)),
                   equalTo(LazyEither.right(15)));
    ...
    public void testMkString() {
        assertThat(just.mkString(),
                   equalTo("CompletableEither[10]"));
        assertThat(none.mkString(),
                   equalTo("Either.left[java.util.NoSuchElementException: none]"));
    }
