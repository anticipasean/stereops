...
public class IorSecondaryTest {
    ...
    public void bimap() {
        ...
        Ior<RuntimeException, Integer> mapped = failure.bimap(e -> new RuntimeException(),
                                                              d -> d + 1);
    ...
    public void testFlatMap() {
        assertThat(failure.flatMap(x -> Ior.right(10)),
                   equalTo(failure));
    }
