...
public class ExceptionSoftener2Test {
    ...
    public void testSoftenBooleanSupplier() {
        assertThat(ExceptionSoftener.softenBooleanSupplier(() -> true)
                                    .getAsBoolean(),
                   equalTo(true));
    }
    ...
    public void testSoftenIntSupplier() {
        assertThat(ExceptionSoftener.softenIntSupplier(() -> 1)
                                    .getAsInt(),
                   equalTo(1));
    }
    ...
    public void testSoftenIntSupplierException() {
        ExceptionSoftener.softenIntSupplier(() -> {
            throw new IOException();
        })
                         .getAsInt();
    ...
    public void testSoftenLongSupplierCheckedLongSupplier() {
        assertThat(ExceptionSoftener.softenLongSupplier(() -> 1l)
                                    .getAsLong(),
                   equalTo(1l));
    }
    ...
    public void testSoftenLongSupplierException() {
        ExceptionSoftener.softenLongSupplier(() -> {
            throw new IOException();
        })
                         .getAsLong();
    ...
    public void testSoftenDoubleSupplier() {
        assertThat(ExceptionSoftener.softenDoubleSupplier(() -> 1d)
                                    .getAsDouble(),
                   equalTo(1d));
    }
    ...
    public void testSoftenDpubleSupplierException() {
        ExceptionSoftener.softenDoubleSupplier(() -> {
            throw new IOException();
        })
                         .getAsDouble();
    ...
    public void testSoftenCheckedFunctionOfTR() {
        assertThat(ExceptionSoftener.softenFunction((Integer a) -> a + 1)
                                    .apply(1),
                   equalTo(2));
    }
    ...
    public void testSoftenIntFunction() {
        assertThat(ExceptionSoftener.softenIntFunction(a -> a + 1)
                                    .apply(1),
                   equalTo(2));
    }
    ...
    public void testSoftenIntFunctionException() {
        ExceptionSoftener.softenIntFunction(this::loadId)
                         .apply(2);
    }
    ...
    public void testSoftenLongFunction() {
        assertThat(ExceptionSoftener.softenLongFunction(a -> a + 1)
                                    .apply(1),
                   equalTo(2));
    }
    ...
    public void testSoftenLongFunctionException() {
        ExceptionSoftener.softenLongFunction(this::loadIdLong)
                         .apply(2);
    }
    ...
    public void testSoftenDoubleFunction() {
        assertThat(ExceptionSoftener.softenDoubleFunction(a -> a + 1)
                                    .apply(1),
                   equalTo(2));
    }
    ...
    public void testSoftenDoubleFunctionException() {
        ExceptionSoftener.softenDoubleFunction(this::loadIdDouble)
                         .apply(2);
    }


    public String loadDir(String file,
    ...
    public void testSoftenCheckedBiFunctionOfT1T2R() {
        ExceptionSoftener.softenBiFunction(this::loadDir)
                         .apply("input",
                                "dir");
    }
    ...
    public void testSoftenCheckedPredicateOfT() {
        ExceptionSoftener.softenPredicate(this::test)
                         .test("input");
    }
    ...
    public void testSoftenDoublePredicate() {
        ExceptionSoftener.softenDoublePredicate(this::testDouble)
                         .test(1d);
    }
    ...
    public void testSoftenIntPredicateCheckedIntPredicate() {
        ExceptionSoftener.softenIntPredicate(this::testInt)
                         .test(1);
    }
    ...
    public void testSoftenLongPredicate() {
        ExceptionSoftener.softenLongPredicate(this::testLong)
                         .test(1l);
    }

    public boolean testBiPredicate(long input,
    ...
    public void testSoftenCheckedBiPredicateOfT1T2() {
        ExceptionSoftener.softenBiPredicate(this::testBiPredicate)
                         .test(1l,
                               "hello");
    }
    ...
    public void testSoftenCheckedConsumerOfT() {
        ExceptionSoftener.softenConsumer(this::testConsumer)
                         .accept(1l);
    }
    ...
    public void testSoftenDoubleConsumer() {
        ExceptionSoftener.softenDoubleConsumer(this::testDoubleConsumer)
                         .accept(1d);
    }

    @Test(expected = IOException.class)
    public void testSoftenIntConsumer() {
        ExceptionSoftener.softenIntConsumer(this::testConsumer)
                         .accept(1);
    }

    @Test(expected = IOException.class)
    public void testSoftenLongConsumer() {
        ExceptionSoftener.softenLongConsumer(this::testConsumer)
                         .accept(1l);
    }

    public boolean testBiConsumer(long input,
                                  long input2) throws IOException {
        throw new IOException();
    }

    @Test(expected = IOException.class)
    public void testSoftenCheckedBiConsumerOfT1T2() {
        ExceptionSoftener.softenBiConsumer(this::testBiConsumer)
                         .accept(1l,
                                 2l);
    }
