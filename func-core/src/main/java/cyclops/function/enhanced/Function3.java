...
//    @SuppressWarnings("unchecked")
    ...
    default Function3<S1, S2, S3, Maybe<R>> lazyLift3() {
        ...
        return (s1, s2, s3) -> Maybe.fromLazy(Eval.later(() -> Maybe.ofNullable(apply(s1,
                                                                                      s2,
                                                                                      s3))));
    }
    ...
    default Function3<S1, S2, S3, Future<R>> lift3(Executor ex) {
        Function3<S1, S2, S3, R> host = this;
        return (s1, s2, s3) -> Future.of(() -> host.apply(s1,
                                                          s2,
                                                          s3),
                                         ex);
    }
    ...
    default Function3<S1, S2, S3, Try<R, Throwable>> liftTry3() {
        Function3<S1, S2, S3, R> host = this;
        return (s1, s2, s3) -> Try.withCatch(() -> host.apply(s1,
                                                              s2,
                                                              s3),
                                             Throwable.class);
    }
    ...
    default Function3<S1, S2, S3, Option<R>> lift3() {
        Function3<S1, S2, S3, R> host = this;
        return (s1, s2, s3) -> Option.ofNullable(host.apply(s1,
                                                            s2,
                                                            s3));
    }
    ...
    /**
     * This methods creates a caching version of this BiFunction, caching is implemented via the Cacheable wrapper, that can be
     * used to wrap any concrete cache implementation
     * <p>
     ...
     * @return A caching (memoizing) version of this BiFunction, outputs for all inputs will be cached (unless ejected from the
     * cache)
     */
    ...
    default Function3<S1, S2, S3, R> memoize3Async(ScheduledExecutorService ex,
                                                   String cron) {
        return Memoize.memoizeTriFunctionAsync(this,
                                               ex,
                                               cron);
    }
    ...
    default Function1<S3, R> apply(final S1 s,
                                   final S2 s2) {
        return Curry.curry3(this)
                    .apply(s)
                    .apply(s2);
