...
public interface Function7<T1, T2, T3, T4, T5, T6, T7, R> extends
     ...
     */
    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<T1, T2, T3, T4, T5, T6, T7, R> λ(final Function7<T1, T2, T3, T4, T5, T6, T7, R> func7) {
        return func7;
    }

    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> v(final Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> func7) {
        return func7;
    }

    static <T1, T2, T3, T4, T5, T6, T7, R> Function7<T1, T2, T3, T4, T5, T6, T7, R> constant(R t) {
    ...
    default Function1<T3, Function1<T4, Function1<T5, Function1<T6, Function1<T7, R>>>>> apply(final T1 s,
                                                                                               final T2 s2) {
        return Curry.curry7(this)
                    .apply(s)
                    .apply(s2);
    ...
    default Function1<T4, Function1<T5, Function1<T6, Function1<T7, R>>>> apply(final T1 s,
                                                                                final T2 s2,
                                                                                final T3 s3) {
        return Curry.curry7(this)
                    .apply(s)
    ...
    default Function1<T5, Function1<T6, Function1<T7, R>>> apply(final T1 s,
                                                                 final T2 s2,
                                                                 final T3 s3,
                                                                 final T4 s4) {
        return Curry.curry7(this)
    ...
    default Function1<T6, Function1<T7, R>> apply(final T1 s,
                                                  final T2 s2,
                                                  final T3 s3,
                                                  final T4 s4,
                                                  final T5 s5) {
    ...
    default Function1<T7, R> apply(final T1 s,
                                   final T2 s2,
                                   final T3 s3,
                                   final T4 s4,
                                   final T5 s5,
    ...
    default <V> Function7<T1, T2, T3, T4, T5, T6, T7, V> andThen7(Function<? super R, ? extends V> after) {
        return (t1, t2, t3, t4, t5, t6, t7) -> after.apply(apply(t1,
                                                                 t2,
                                                                 t3,
                                                                 t4,
                                                                 t5,
    ...
    default Function7<T1, T2, T3, T4, T5, T6, T7, Maybe<R>> lazyLift7() {
        return (s1, s2, s3, s4, s5, s6, s7) -> Maybe.fromLazy(Eval.later(() -> Maybe.ofNullable(apply(s1,
                                                                                                      s2,
                                                                                                      s3,
                                                                                                      s4,
                                                                                                      s5,
    ...
    default Function7<T1, T2, T3, T4, T5, T6, T7, Future<R>> lift7(Executor ex) {
        ...
        return (s1, s2, s3, s4, s5, s6, s7) -> Future.of(() -> apply(s1,
                                                                     s2,
                                                                     s3,
                                                                     s4,
                                                                     s5,
    ...
    default Function7<T1, T2, T3, T4, T5, T6, T7, Try<R, Throwable>> liftTry7() {
        return (s1, s2, s3, s4, s5, s6, s7) -> Try.withCatch(() -> apply(s1,
                                                                         s2,
                                                                         s3,
                                                                         s4,
                                                                         s5,
    ...
    default Function7<T1, T2, T3, T4, T5, T6, T7, Option<R>> lift7() {
        ...
        return (s1, s2, s3, s4, s5, s6, s7) -> Option.ofNullable(apply(s1,
                                                                       s2,
                                                                       s3,
                                                                       s4,
                                                                       s5,
