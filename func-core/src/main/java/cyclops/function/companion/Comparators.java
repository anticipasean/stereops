...
public class Comparators {
    ...
    private final static Comparator IDENTITY_COMPARATOR_INSTANCE = (a, b) -> Comparator.<Integer>naturalOrder().compare(System.identityHashCode(a),
    ...
    public static <T> Comparator<T> naturalOrderIdentityComparator() {
        return (a, b) -> {
            if (a instanceof Comparable) {
                return Comparator.<Comparable>naturalOrder().compare((Comparable) a,
                                                                     (Comparable) b);
            }
            return identityComparator().compare(a,
                                                b);
        };
    }
}
