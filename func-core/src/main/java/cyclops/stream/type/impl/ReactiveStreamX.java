...
import static cyclops.reactive.ReactiveSeq.deferFromStream;
...
import cyclops.stream.spliterator.push.CompleteOperator;
import cyclops.stream.spliterator.push.FilterOperator;
import cyclops.stream.spliterator.push.FlatMapOperator;
import cyclops.stream.spliterator.push.FlatMapPublisher;
import cyclops.stream.spliterator.push.GroupedByTimeAndSizeOperator;
import cyclops.stream.spliterator.push.GroupedByTimeOperator;
import cyclops.stream.spliterator.push.GroupedStatefullyOperator;
import cyclops.stream.spliterator.push.GroupedWhileOperator;
import cyclops.stream.spliterator.push.GroupingOperator;
import cyclops.stream.spliterator.push.IterableSourceOperator;
import cyclops.stream.spliterator.push.LazyFilterOperator;
import cyclops.stream.spliterator.push.LazyMapOperator;
import cyclops.stream.spliterator.push.LazySingleValueOperator;
import cyclops.stream.spliterator.push.LimitLastOneOperator;
import cyclops.stream.spliterator.push.LimitLastOperator;
import cyclops.stream.spliterator.push.LimitOperator;
import cyclops.stream.spliterator.push.LimitWhileClosedOperator;
import cyclops.stream.spliterator.push.LimitWhileOperator;
import cyclops.stream.spliterator.push.LimitWhileTimeOperator;
import cyclops.stream.spliterator.push.MapOperator;
import cyclops.stream.spliterator.push.OnEmptyErrorOperator;
import cyclops.stream.spliterator.push.OnEmptyOperator;
import cyclops.stream.spliterator.push.OnErrorBreakWithPublisherOperator;
import cyclops.stream.spliterator.push.Operator;
import cyclops.stream.spliterator.push.OperatorToIterable;
import cyclops.stream.spliterator.push.PublisherToOperator;
import cyclops.stream.spliterator.push.RecoverOperator;
import cyclops.stream.spliterator.push.ReduceAllOperator;
import cyclops.stream.spliterator.push.SingleValueOperator;
import cyclops.stream.spliterator.push.SkipLastOneOperator;
import cyclops.stream.spliterator.push.SkipLastOperator;
import cyclops.stream.spliterator.push.SkipOperator;
import cyclops.stream.spliterator.push.SkipWhileClosedOperator;
import cyclops.stream.spliterator.push.SkipWhileOperator;
import cyclops.stream.spliterator.push.SkipWhileTimeOperator;
...
public class ReactiveStreamX<T> extends BaseExtendedStream<T> {
    ...
    public ReactiveSeq<T> insertAt(int pos,
        ...
        if (pos == 0) {
            return prependStream(fromIterable(values));
        }
        return Spouts.deferFromStream(() -> {
            ...
            return Spouts.of(zipWithIndex().flatMap(t -> {
                                 ...
                                 if (!added[0]) {
                                     added[0] = true;
                                     return ReactiveSeq.concat(fromIterable(values),
                                                               ReactiveSeq.of(t._1()));
                                 }
                                 return Stream.of(t._1());
                             }),
                             deferFromStream(() -> {
                                 return !added[0] ? fromIterable(values) : ReactiveSeq.empty();
                             }))
                         .concatMap(i -> i);
        });
