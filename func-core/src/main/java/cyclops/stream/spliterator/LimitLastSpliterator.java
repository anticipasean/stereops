...
public class LimitLastSpliterator<T> extends AbstractSpliterator<T> implements CopyableSpliterator<T> {
    ...
    public LimitLastSpliterator(final Spliterator<T> source,
                                final int limit) {
    ...
    public static <T> Spliterator<T> takeRight(Spliterator<T> source,
                                               int limit) {
        ...
        return new LimitLastSpliterator<T>(source,
                                           limit);
    }
    ...
    public Spliterator<T> copy() {
        return new LimitLastSpliterator<T>(CopyableSpliterator.copy(source),
                                           limit);
    }
}
