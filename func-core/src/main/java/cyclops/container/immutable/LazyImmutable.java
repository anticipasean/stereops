 ...
 * <p>
 * It will only allow its value to be set once. Unfortunately the compiler won't be able to tell if setOnce is called more than
 * once
 * <p>
 * example usage
 *
...
public class LazyImmutable<T> implements To<LazyImmutable<T>>, Supplier<T>, Consumer<T>, Transformable<T>, Iterable<T> {
    ...
    /* (non-Javadoc)
     * @see com.oath.cyclops.container.control.Matchable.ValueAndOptionalMatcher#iterator()
     */
    @Override
