 ...
 * <p>
 * <p>
 * Can be one of 4 types Left1 Left2 Left3 Right
 *
 ...
 * @author johnmcclean
 */
public interface LazyEither5<LT1, LT2, LT3, LT4, RT> extends Transformable<RT>, Filterable<RT>, BiTransformable<LT4, RT>,
                                                             To<LazyEither5<LT1, LT2, LT3, LT4, RT>>,
                                                             OrElseValue<RT, LazyEither5<LT1, LT2, LT3, LT4, RT>>, Unit<RT>,
                                                             Sealed5<LT1, LT2, LT3, LT4, RT>, Value<RT> {
    ...
    static <LT2, LT3, LT4, RT> LazyEither5.CompletableEither5<RT, LT2, LT3, LT4, RT> either5() {
        ...
        return new CompletableEither5<RT, LT2, LT3, LT4, RT>(c,
                                                             fromFuture(Future.of(c)));
    }
     ...
     */
    static <X, LT1 extends X, LT2 extends X, LT3 extends X, LT4 extends X, RT extends X> Consumer<Consumer<? super X>> consumeAny(LazyEither5<LT1, LT2, LT3, LT4, RT> either) {
        return in -> visitAny(in,
                              either);
    }

    static <X, LT1 extends X, LT2 extends X, LT3 extends X, LT4 extends X, RT extends X, R> Function<Function<? super X, R>, R> applyAny(LazyEither5<LT1, LT2, LT3, LT4, RT> either) {
        return in -> visitAny(either,
                              in);
    }

    @Deprecated //use foldAny
    static <X, LT1 extends X, LT2 extends X, LT3 extends X, LT4 extends X, RT extends X, R> R visitAny(LazyEither5<LT1, LT2, LT3, LT4, RT> either,
                                                                                                       Function<? super X, ? extends R> fn) {
        return foldAny(either,
                       fn);
    }

    static <X, LT1 extends X, LT2 extends X, LT3 extends X, LT4 extends X, RT extends X, R> R foldAny(LazyEither5<LT1, LT2, LT3, LT4, RT> either,
                                                                                                      Function<? super X, ? extends R> fn) {
    ...
    static <X, LT1 extends X, LT2 extends X, LT3 extends X, LT4 extends X, RT extends X> X visitAny(Consumer<? super X> c,
    ...
    static <LT2, LT3, LT4, RT> LazyEither5<Throwable, LT2, LT3, LT4, RT> either4() {
        return LazyEither5.fromFuture(Future.future());
    }
    ...
    static <LT2, LT3, LT4, RT> LazyEither5<Throwable, LT2, LT3, LT4, RT> fromFuture(Future<RT> future) {
        return fromLazy(Eval.fromFuture(future.<LazyEither5<Throwable, LT2, LT3, LT4, RT>>map(LazyEither5::right).recover(e -> LazyEither5.left1(e.getCause()))));
    }
     ...
     */
    static <LT1, LT2, LT3, LT4, PT> LazyEither5<LT1, LT2, LT3, LT4, ReactiveSeq<PT>> sequence(final Iterable<? extends LazyEither5<LT1, LT2, LT3, LT4, PT>> xors) {
        Objects.requireNonNull(xors);
        return sequence(ReactiveSeq.fromIterable(xors)
                                   .filter(LazyEither5::isRight));
    }

    static <L1, L2, L3, L4, T> LazyEither5<L1, L2, L3, L4, ReactiveSeq<T>> sequence(ReactiveSeq<? extends LazyEither5<L1, L2, L3, L4, T>> stream) {

        LazyEither5<L1, L2, L3, L4, ReactiveSeq<T>> identity = right(ReactiveSeq.empty());

        BiFunction<LazyEither5<L1, L2, L3, L4, ReactiveSeq<T>>, LazyEither5<L1, L2, L3, L4, T>, LazyEither5<L1, L2, L3, L4, ReactiveSeq<T>>> combineToStream = (acc, next) -> acc.zip(next,
                                                                                                                                                                                      (a, b) -> a.append(b));

        BinaryOperator<LazyEither5<L1, L2, L3, L4, ReactiveSeq<T>>> combineStreams = (a, b) -> a.zip(b,
    ...
    static <L1, L2, L3, L4, T, R> LazyEither5<L1, L2, L3, L4, ReactiveSeq<R>> traverse(Function<? super T, ? extends R> fn,
                                                                                       ReactiveSeq<LazyEither5<L1, L2, L3, L4, T>> stream) {
        return sequence(stream.map(h -> h.map(fn)));
    }

    /**
     * Traverse a Collection of Either3 producing an Either4 with a Seq, applying the transformation function to every element in
     * the list
     *
     ...
     */
    static <LT1, LT2, LT3, LT4, PT, R> LazyEither5<LT1, LT2, LT3, LT4, ReactiveSeq<R>> traverse(final Iterable<LazyEither5<LT1, LT2, LT3, LT4, PT>> xors,
                                                                                                Function<? super PT, ? extends R> fn) {
        return sequence(xors).map(l -> l.map(fn));
    }

    /**
     * Accumulate the results only from those Either3 which have a Right type present, using the supplied Monoid (a combining
     * BiFunction/BinaryOperator and identity element that takes two input values of the same type and returns the combined
     * result) {@see com.oath.cyclops.Monoids }.
     *
     * <pre>
     * {@code
     * Either4<String,String,String,Integer> just  = Either4.right(10);
     ...
     */
    static <LT1, LT2, LT3, LT4, RT> LazyEither5<LT1, LT2, LT3, LT4, RT> accumulate(final Monoid<RT> reducer,
                                                                                   final Iterable<LazyEither5<LT1, LT2, LT3, LT4, RT>> xors) {
     ...
     */
    static <T1, T2, T3, T> LazyEither5<Throwable, T1, T2, T3, T> fromPublisher(final Publisher<T> pub) {
        if (pub instanceof LazyEither5) {
            return (LazyEither5<Throwable, T1, T2, T3, T>) pub;
        }
     ...
     */
    static <ST, T, T2, T3, RT> LazyEither5<ST, T, T2, T3, RT> fromIterable(final Iterable<RT> iterable) {
     ...
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> rightEval(final Eval<RT> right) {
     ...
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left1Eval(final Eval<LT> left) {
     ...
     * @return Either4 Right instance
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> right(final RT right) {
     ...
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left1(final LT left) {
     ...
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left2(final M1 middle) {
     ...
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left3(final B middle) {
     ...
     * @return Third instance
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left4(final T4 middle) {
        return new Left4<>(Eval.now(middle));
    }
     ...
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left2Eval(final Eval<M1> middle) {
     ...
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left3Eval(final Eval<B> middle) {
     ...
     * @return Either4 third instance
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> left4Eval(final Eval<T4> middle) {
        return new Left4<>(middle);
    }
     ...
     * @return Either4 third instance
     */
    static <LT, M1, B, T4, RT> LazyEither5<LT, M1, B, T4, RT> foEval(final Eval<B> middle) {
        return new Left3<>(middle);
    }
    ...
    default LazyEither5<LT1, LT2, LT3, LT4, RT> filter(Predicate<? super RT> test,
                                                       Function<? super RT, ? extends LT1> rightToLeft) {
        return flatMap(e -> test.test(e) ? LazyEither5.right(e) : LazyEither5.left1(rightToLeft.apply(e)));
    }

    @Override
    default <R> R fold(Function<? super LT1, ? extends R> fn1,
                       Function<? super LT2, ? extends R> fn2,
                       Function<? super LT3, ? extends R> fn3,
                       Function<? super LT4, ? extends R> fn4,
                       Function<? super RT, ? extends R> fn5) {
        return this.fold(fn1,
                         fn2,
                         fn3,
                         fn4,
                         fn5);
    ...
    /**
     * Filter this Either4 resulting in a Maybe#none if it is not a Right instance or if the predicate does not hold. Otherwise
     * results in a Maybe containing the current value
     *
    ...
    /**
     * Flattening transformation on this Either4. Contains an internal trampoline so will convert tail-recursive calls to
     * iteration.
     *
     * @param mapper Mapping function
     * @return Mapped Either4
     */
    <RT1> LazyEither5<LT1, LT2, LT3, LT4, RT1> flatMap(Function<? super RT, ? extends LazyEither5<LT1, LT2, LT3, LT4, ? extends RT1>> mapper);
    ...
    /* (non-Javadoc)
     * @see cyclops.container.filterable.Filters#filterNot(java.util.function.Predicate)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cyclops.container.filterable.Filters#notNull()
     */
    @Override
    ...
    default <T2, R1, R2, R3, R> LazyEither5<LT1, LT2, LT3, LT4, R> forEach4(Function<? super RT, ? extends LazyEither5<LT1, LT2, LT3, LT4, R1>> value1,
        ...
        return this.flatMap(in -> {
            ...
            return a.flatMap(ina -> {
                LazyEither5<LT1, LT2, LT3, LT4, R2> b = value2.apply(in,
                                                                     ina);
                return b.flatMap(inb -> {
                    LazyEither5<LT1, LT2, LT3, LT4, R3> c = value3.apply(in,
                                                                         ina,
                                                                         inb);
    ...
    default <T2, R> LazyEither5<LT1, LT2, LT3, LT4, R> zip(final LazyEither5<LT1, LT2, LT3, LT4, ? extends T2> app,
     ...
     */
    @Override
    default LazyEither5<LT1, LT2, LT3, LT4, RT> bipeek(final Consumer<? super LT4> c1,
                                                       final Consumer<? super RT> c2) {

        return (LazyEither5<LT1, LT2, LT3, LT4, RT>) BiTransformable.super.bipeek(c1,
                                                                                  c2);
    }
    ...
    @AllArgsConstructor
    class CompletableEither5<ORG, LT1, LT2, LT3, RT> implements LazyEither5<Throwable, LT1, LT2, LT3, RT>,
                                                                Completable<ORG> {
        ...
        @Override
        public <R> R fold(Function<? super Throwable, ? extends R> left1,
                          Function<? super LT1, ? extends R> left2,
                          Function<? super LT2, ? extends R> left3,
                          Function<? super LT3, ? extends R> left4,
                          Function<? super RT, ? extends R> right) {
            return either.fold(left1,
                               left2,
                               left3,
                               left4,
                               right);
        ...
        @Override
        public <R1, R2> LazyEither5<Throwable, LT1, LT2, R1, R2> bimap(Function<? super LT3, ? extends R1> fn1,
                                                                       Function<? super RT, ? extends R2> fn2) {
            return either.bimap(fn1,
                                fn2);
        }
    ...
    final class Lazy<ST, M, M2, M3, PT> implements LazyEither5<ST, M, M2, M3, PT> {
        ...
        @Override
        public <RT1> LazyEither5<ST, M, M2, M3, RT1> flatMap(final Function<? super PT, ? extends LazyEither5<ST, M, M2, M3, ? extends RT1>> mapper) {
        ...
        public LazyEither5<ST, M, M2, M3, PT> recoverWith(Supplier<? extends LazyEither5<ST, M, M2, M3, PT>> supplier) {
            return new Lazy(lazy.map(m -> m.recoverWith(supplier)));
        }
        ...
        @Override
        public <R> R fold(final Function<? super PT, ? extends R> present,
                          final Supplier<? extends R> absent) {

            return trampoline().fold(present,
                                     absent);
        }

        @Override
        public final void subscribe(final Subscriber<? super PT> sub) {
            lazy.subscribe(new Subscriber<LazyEither5<ST, M, M2, M3, PT>>() {
                ...
                @Override
                public void onNext(LazyEither5<ST, M, M2, M3, PT> pts) {
                    if (pts.isRight()) {
        ...
        public LazyEither5<ST, M, M2, PT, M3> swap4() {
            return LazyEither5.fromLazy(lazy.map(m -> m.swap4()));

        }

        @Override
        public LazyEither5<ST, M, PT, M3, M2> swap3() {
            return LazyEither5.fromLazy(lazy.map(m -> m.swap3()));
        }

        @Override
        public LazyEither5<ST, PT, M2, M3, M> swap2() {
            return LazyEither5.fromLazy(lazy.map(m -> m.swap2()));
        }

        @Override
        public LazyEither5<PT, M, M2, M3, ST> swap1() {
            return LazyEither5.fromLazy(lazy.map(m -> m.swap1()));
        }
        ...
        public <R1, R2> LazyEither5<ST, M, M2, R1, R2> bimap(final Function<? super M3, ? extends R1> fn1,
            ...
            return LazyEither5.fromLazy(lazy.map(m -> m.bimap(fn1,
                                                              fn2)));
        }
        ...
        @Override
        public int hashCode() {
            return this.fold(LazyEither5::left1,
                             LazyEither5::left2,
                             LazyEither5::left3,
                             LazyEither5::left4,
                             LazyEither5::right)
    ...
    @AllArgsConstructor(access = AccessLevel.PRIVATE)
    class Right<ST, M, M2, M3, PT> implements LazyEither5<ST, M, M2, M3, PT> {

        private final Eval<PT> value;

        @Override
        public <R> LazyEither5<ST, M, M2, M3, R> map(final Function<? super PT, ? extends R> fn) {
            return new Right<ST, M, M2, M3, R>(value.map(fn));
        }
    ...
    @AllArgsConstructor(access = AccessLevel.PRIVATE)
    class Left1<ST, M, M2, M3, PT> implements LazyEither5<ST, M, M2, M3, PT> {
        ...
        @Override
        public Iterator<PT> iterator() {
            return Arrays.<PT>asList().iterator();
        }
    ...
    @AllArgsConstructor(access = AccessLevel.PRIVATE)
    class Left2<ST, M, M2, M3, PT> implements LazyEither5<ST, M, M2, M3, PT> {
    ...
    @AllArgsConstructor(access = AccessLevel.PRIVATE)
    class Left3<ST, M, M2, M3, PT> implements LazyEither5<ST, M, M2, M3, PT> {
    ...
    @AllArgsConstructor(access = AccessLevel.PRIVATE)
    class Left4<ST, M, M2, M3, PT> implements LazyEither5<ST, M, M2, M3, PT> {
