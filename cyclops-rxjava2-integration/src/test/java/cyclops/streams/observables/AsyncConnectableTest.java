...
public class AsyncConnectableTest {
    ...
    public void backpressureScheduledDelay() {
        ...
        assertThat(System.currentTimeMillis() - diff,
                   greaterThan(1500l));
    }
            ...
            range(0,
                  Integer.MAX_VALUE).limit(100)
                                    ...
                                    .runFuture(ForkJoinPool.commonPool(),
                                               t -> t.forEach(System.out::println,
                                                              System.err::println));
    ...
    public void hotStreamConnectPausable() throws InterruptedException {
        ...
        active = true;
        CountDownLatch latch = new CountDownLatch(1);
        PausableConnectable<Integer> s = range(0,
                                               Integer.MAX_VALUE).takeWhile(i -> active)
                                                                 .peek(v -> value = v)
                                                                 .peek(v -> latch.countDown())
        ...
        s.connect(new LinkedBlockingQueue<>())
         .limit(100)
         .runFuture(ForkJoinPool.commonPool(),
                    ft -> ft.forEach(System.out::println,
                                     System.err::println));
        ...
        assertTrue("value is " + value + ". oldValue is " + oldValue,
                   value != oldValue);
        s.unpause();
        latch.await();
        assertTrue(value != null);
