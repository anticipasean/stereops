...
public class ExtensionOperatorsRSTest {
    ...
    public void flatMapStreamFilterSimple() {
        assertThat(FlowableReactiveSeq.of(1,
                                          2)
    ...
    public void subStream() {
        List<Integer> list = FlowableReactiveSeq.of(1,
                                                    2,
                                                    3,
                                                    4,
                                                    5,
    ...
    public void permuations3() {
        System.out.println(FlowableReactiveSeq.of(1,
                                                  2,
                                                  3)
                                              .permutations()
                                              .map(s -> s.toList())
        ...
        assertThat(FlowableReactiveSeq.of(1,
                                      ...
                                      .map(s -> s.toList())
                                      .toList(),
                   equalTo(FlowableReactiveSeq.of(FlowableReactiveSeq.of(1,
                                                                         2,
                                                                         3),
                                                  FlowableReactiveSeq.of(1,
                                                                         3,
                                                                         2),
                                                  FlowableReactiveSeq.of(2,
                                                                         1,
                                                                         3),
                                                  FlowableReactiveSeq.of(2,
                                                                         3,
                                                                         1),
                                                  FlowableReactiveSeq.of(3,
                                                                         1,
                                                                         2),
                                                  FlowableReactiveSeq.of(3,
                                                                         2,
    ...
    public void onEmptySwitchEmpty() {
        assertThat(FlowableReactiveSeq.of()
                                      .onEmptySwitch(() -> FlowableReactiveSeq.of(1,
                                                                                  2,
                                                                                  3))
                                      .toList(),
    ...
    public void onEmptySwitch() {
        assertThat(FlowableReactiveSeq.of(4,
                                          5,
                                          6)
                                      .onEmptySwitch(() -> FlowableReactiveSeq.of(1,
                                                                                  2,
    ...
    public void elapsedIsPositive() {
        ...
        assertTrue(FlowableReactiveSeq.of(1,
                                          2,
                                          3,
                                          4,
                                          5)
    ...
    public void getMultiple1() {
        assertFalse(FlowableReactiveSeq.of(1)
                                       .elementAt(1)
                                       .isPresent());
    }
    ...
    public void singleEmpty() {
        assertTrue(FlowableReactiveSeq.of()
                                      .single()
                                      .orElse(null) == null);
    }
    ...
    public void limitTime() {
        List<Integer> result = FlowableReactiveSeq.of(1,
                                                      2,
                                                      3,
                                                      4,
                                                      5,
    ...
    public void limitTimeEmpty() {
        List<Integer> result = FlowableReactiveSeq.<Integer>of().peek(i -> sleep(i * 100))
                                                                .take(1000,
                                                                      TimeUnit.MILLISECONDS)
                                                                .toList();
    ...
    public void endsWithBothEmpty() {
        assertTrue(FlowableReactiveSeq.<Integer>of().endsWith(Arrays.asList()));
    }

    @Test
    public void streamable() {
        Streamable<Integer> repeat = FlowableReactiveSeq.of(1,
                                                            2,
                                                            3,
                                                            4,
                                                            5,
    ...
    public void testLazy() {
        Collection<Integer> col = FlowableReactiveSeq.of(1,
                                                         2,
                                                         3,
                                                         4,
                                                         5)
