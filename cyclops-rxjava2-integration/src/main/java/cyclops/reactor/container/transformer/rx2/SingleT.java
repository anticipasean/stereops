...
import cyclops.async.reactive.futurestream.companion.rx2.Singles;
...
public final class SingleT<W extends WitnessType<W>, T> implements To<SingleT<W, T>>, ReactiveTransformable<T>, Filterable<T>,
    ...
    public static <W extends WitnessType<W>, U1, U2, R> BiFunction<SingleT<W, U1>, SingleT<W, U2>, SingleT<W, R>> lift2(final BiFunction<? super U1, ? super U2, ? extends R> fn) {
    ...
    public <B> SingleT<W, B> map(final Function<? super T, ? extends B> f) {
        return new SingleT<W, B>(run.map(o -> o.map(Functions.rxFunction(f))));
    }
    ...
    public String toString() {
        return String.format("SingleT[%s]",
                             run.unwrap()
                                .toString());
    }
