...
public interface MaybeAnyM {
    ...
    /**
     * Construct an AnyM type from a Maybe. This allows the Maybe to be manipulated according to a standard interface along with a
    ...
    public static <T> AnyMValue<maybe, T> anyM(Maybe<T> maybe) {
        return AnyM.ofValue(maybe,
                            Rx2Witness.maybe.INSTANCE);
    }
