...
import cyclops.function.higherkinded.DataWitness.yoneda;
...
public interface Yoneda<U, T> extends Higher<Higher<yoneda, U>, T> {
    ...
    default <R> Yoneda<U, R> map(Function<? super T, ? extends R> outer,
                                 Functor<U> functor) {
