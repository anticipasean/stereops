...
public class ReactiveZippingRSTest {
	...
	public void zipUnevenRight(){
		assertEquals(asList("a"), of("a").to(Streamable::fromStream).toList());
		assertEquals(asList(tuple("a", 0L)), of("a").zip(of(0L,1L,2L)).to(Streamable::fromStream).toList());
		assertEquals(asList(tuple("a", 0L),tuple("b",1L)), of("a","b").zip(of(0L,1L,2L,3L)).to(Streamable::fromStream).toList());
		assertEquals(asList(tuple("a", 0L),tuple("b",1L)), of("a","b").zip(of(0L,1L,2L,3L,4L)).to(Streamable::fromStream).toList());
		assertEquals(asList(tuple("a", 0L),tuple("b",1L)), of("a","b").zip(of(0L,1L,2L,3L,4L,5L)).to(Streamable::fromStream).toList());
		assertEquals(asList(tuple( 0L,"a"),tuple(1L,"b")), of(0L,1L).zip(of("a","b","c","d")).to(Streamable::fromStream).toList());
	}
	...
	public void zipUnevenLeft(){
		...
		assertEquals(asList(tuple("a", 0L)), of("a","b").zip(of(0L)).to(Streamable::fromStream).toList());
		assertEquals(asList(tuple("a", 0L),tuple("b",1L)), of("a","b","c").zip(of(0L,1L)).to(Streamable::fromStream).toList());
		assertEquals(asList(tuple("a", 0L),tuple("b",1L)), of("a","b","c").zip(of(0L,1L)).to(Streamable::fromStream).collect(Collectors.toList()));
		assertEquals(asList(tuple("a", 0L),tuple("b",1L)), of("a","b","c","d").zip(of(0L,1L)).to(Streamable::fromStream).toList());
	...
	public void zip1(){
		assertEquals(asList("a"), of("a").to(Streamable::fromStream).toList());
		assertEquals(asList(tuple("a", 0L)), of("a").zip(of(0L)).to(Streamable::fromStream).toList());
	}
	@Test
	public void zip(){
	...
	public void testZipDifferingLength() {
		List<Tuple2<Integer, String>> list = of(1, 2).zip(of("a", "b", "c", "d")).to(Streamable::fromStream).toList();
