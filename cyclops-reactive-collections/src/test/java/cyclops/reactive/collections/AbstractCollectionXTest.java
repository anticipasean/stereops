...
public abstract class AbstractCollectionXTest extends AbstractIterableXTest {
    ...
    public abstract CollectionX<Integer> range(int start,
                                               int end);

    public abstract CollectionX<Long> rangeLong(long start,
                                                long end);

    public abstract <T> CollectionX<T> iterate(int times,
                                               T seed,
                                               UnaryOperator<T> fn);

    public abstract <T> CollectionX<T> generate(int times,
                                                Supplier<T> fn);

    public abstract <U, T> CollectionX<T> unfold(final U seed,
    ...
    public void testOnEmpty() throws AbstractIterableXTest.X {
        ...
        assertEquals(asList(2),
                     of(2).onEmptyGet(() -> 1)
                          ...
                          .listX());
        assertEquals(asList(2),
                     of(2).onEmptyError(() -> new AbstractIterableXTest.X())
                          .to()
                          .listX());
    ...
    public void plusLoopOpt() {
        ...
        assertThat(of(0,
                      1,
                      2).plusLoop(() -> i[0] != 20 ? Option.of(i[0]++) : Option.none())
                        .size(),
                   equalTo(13));
    }
    ...
    public void plusOneOrder() {
        assertThat(of().plusInOrder(1),
                   hasItem(1));
    }

    @Test
    public void plusAllOne() {
        assertThat(of().plusAll(of(1)),
                   hasItem(1));
    }
    ...
    public void minusAllOne() {
        assertThat(of().removeAll((Iterable) of(1))
                       .size(),
                   equalTo(0));
    }
    ...
    public void minusAllOneNotEmpty() {
        System.out.println(of(1).removeAll((Iterable) of(1)));
        assertThat(of(1).removeAll((Iterable) of(1))
                        .size(),
                   equalTo(0));
    }
    ...
    public void minusAllOneTwoValues() {
        assertThat(of(1,
                      2).removeAll((Iterable<Integer>) of(1)),
                   hasItem(2));
        assertThat(of(1,
                      2).removeAll((Iterable<Integer>) of(1)),
                   not(hasItem(1)));
    ...
    public void minusAllOneX() {
        assertThat(of().removeAll(ListX.of(1))
                       .size(),
                   equalTo(0));
    }
    ...
    public void minusAllOneNotEmptyX() {
        ...
        assertThat(of(1).removeAll(LinkedListX.of(1))
                        .size(),
                   equalTo(0));
    }
    ...
    /**
     * @Test public void testFindAny(){ assertThat(Arrays.asList(1,2,3),hasItem(of(1,2,3,4,5).filter(it -> it
     * <3).findAny().get())); }
     **/
    @Test
    ...
    public void collect() {
        assertThat(of(1,
                      ...
                      3,
                      4,
                      5).collect(java.util.stream.Collectors.toList())
                        .size(),
                   is(5));
        assertThat(of(1,
                      1,
