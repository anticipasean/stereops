...
public abstract class AbstractOrderDependentCollectionXTest extends AbstractCollectionXTest {
    ...
    public void testOfType() {
        ...
        assertThat((((CollectionX<Integer>) of(1,
                                               ...
                                               2,
                                               "b",
                                               3).ofType(Integer.class))).toListX(),
        ...
        assertThat(((CollectionX<Serializable>) of(1,
                                                   "a",
                                                   2,
                                                   "b",
                                                   3)

                       .ofType(Serializable.class)).toListX(),
                   containsInAnyOrder(1,
                                      "a",
                                      2,
                                      "b",
    ...
    /**
     * @Test public void whenGreaterThan2() { String res = of(5, 2, 3).visit((x, xs) -> xs.join(x > 2 ? "hello" : "world"), () ->
     * "boo!");
     * <p>
    ...
    public void testFoldRight() {
        Supplier<CollectionX<String>> s = () -> of("a",
                                                   "b",
                                                   "c");
