...
public class MapXsTest {
    ...
    public void toListX() {
        MapX.empty()
            .forEach(1l,
                     System.out::println);
        MapX<String, Integer> maps = MapXs.of("a",
                                              1,
                                              "b",
                                              2);
    ...
    public void toQueueX() {
        ...
        assertThat(strs.toList(),
                   equalTo(QueueX.of("a1",
                                     "b2")
                                 .toList()));
    }
    ...
    public void onEmptySwitch() {
        ...
        assertThat(MapX.<String, Integer>empty().onEmptySwitch(() -> MapX.fromMap(MapXs.of("hello",
                                                                                           10)))
                                                .get("hello"),
                   equalTo(10));
    }
