...
public abstract class AbstractSetTest extends AbstractCollectionXTest {
    ...
    public void allCombinations3NoOrd() {
        SetX<SetX<Integer>> x = of(1,
                                   2,
                                   3).combinations()
                                     .map(s -> s.to(ReactiveConvertableSequence::converter)
                                                .setX())
                                     .toSetX();
    ...
    /**
     * @Test public void testCycleTimesNoOrder() { assertEquals(2,of(1, 2).cycle(3).toListX().size()); }
     **/
    @Test
    ...
    public void slidingNoOrd() {
        ...
        System.out.println(list);
        assertTrue(list.containsValue(Seq.of(1,
                                             2)));
    }
    ...
    public void permuations3() {
        System.out.println(of(1,
                              ...
                              3).permutations()
                                .map(s -> s.toList())
                                .toList());
        CollectionX<List<Integer>> x = of(1,
                                          2,
                                          3).permutations()
                                            .map(s -> s.toList());
    ...
    public void batchWhileCollection() {
        assertThat(of(1,
                      ...
                      6).groupedWhile(i -> i % 3 != 0,
                        ...
                        .size(),
                   equalTo(2));
        CollectionX<Vector<Integer>> x = of(1,
                                            2,
                                            3,
                                            4,
                                            5,
