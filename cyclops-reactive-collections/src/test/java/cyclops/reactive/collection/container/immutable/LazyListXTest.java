...
public class LazyListXTest {
    ...
    public void testIntercalate() {
        ...
        assertThat(intercalated.size(),
                   equalTo(15));
        assertThat(intercalated.get(0)
                               .getName(),
                   equalTo("1"));
        assertThat(intercalated.get(1)
                               .getName(),
                   equalTo("2"));
        assertThat(intercalated.get(2)
                               .getName(),
                   equalTo("3"));
        assertThat(intercalated.get(3)
                               .getName(),
                   equalTo("A"));
        assertThat(intercalated.get(4)
                               .getName(),
                   equalTo("B"));
        assertThat(intercalated.get(5)
                               .getName(),
                   equalTo("C"));
        assertThat(intercalated.get(6)
                               .getName(),
                   equalTo("4"));
        assertThat(intercalated.get(7)
                               .getName(),
                   equalTo("5"));
        assertThat(intercalated.get(8)
                               .getName(),
                   equalTo("6"));
        assertThat(intercalated.get(9)
                               .getName(),
                   equalTo("A"));
        assertThat(intercalated.get(10)
                               .getName(),
                   equalTo("B"));
        assertThat(intercalated.get(11)
                               .getName(),
                   equalTo("C"));
        assertThat(intercalated.get(12)
                               .getName(),
                   equalTo("7"));
        assertThat(intercalated.get(13)
                               .getName(),
                   equalTo("8"));
        assertThat(intercalated.get(14)
                               .getName(),
                   equalTo("9"));
    }
    ...
    public void testIntercalate3() {
        ListX<Number> listOfNumber = ListX.of(-1,
                                              -1,
                                              -1);
        ListX<List<Long>> listOfLongList = ListX.of(new ListX[]{ListX.of(1l,
                                                                         2l,
                                                                         3l), ListX.of(4l,
                                                                                       5l,
                                                                                       6l), ListX.of(7l,
