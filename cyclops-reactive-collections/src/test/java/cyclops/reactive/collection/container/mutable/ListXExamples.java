...
public class ListXExamples {
    ...
    public void comprehension() {
        ...
        ListX<Integer> first10EvenInts = ListX.range(1,
                                                     10)
                                              .map(i -> i * 2);

        ListX<Integer> greaterThan12 = ListX.range(1,
                                                   10)
                                            .map(i -> i * 2)
                                            .filter(i -> i > 12);
    ...
    public void append() {
        ...
        ListX<Integer> oneToTen = ListX.of(1,
                                           2,
                                           3,
                                           4)
                                       .appendAll(5,
        ...
        ListX<Integer> alsoOneToTen = ListX.of(1,
                                               2,
                                               3,
                                               4)
                                           .plusAll(ListX.of(5,
    ...
    public void mutableImmutable() {
        ...
        ListX.of(1,
                 2,
                 3)
             .withCollector(ListX.immutableCollector());
    }
}
