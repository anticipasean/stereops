...
import cyclops.reactive.collection.container.mutable.eager.impl.MutableSequenceX;
import cyclops.reactive.collection.function.higherkinded.ReactiveWitness.list;
...
/**
 * An eXtended List type, that offers additional functional style operators such as bimap, filter and more Can operate eagerly,
 * lazily or reactively (async push)
 *
 * @param <T> the type of elements held in this ListX
 * @author johnmcclean
 */
public interface ListX<T> extends To<ListX<T>>, List<T>, LazyCollectionX<T>, MutableSequenceX<T>, Comparable<T>,
                                  OnEmptySwitch<T, List<T>>, Higher<list, T> {


    static <T> ListX<T> defer(Supplier<ListX<T>> s) {
     ...
     * @return ListX
     */
    static <T> ListX<T> narrowK(final Higher<list, T> list) {
        return (ListX<T>) list;
    }
     ...
     * @return Range ListX
     */
    static ListX<Integer> range(final int start,
                                final int end) {
     ...
     * @return Range ListX
     */
    static ListX<Long> rangeLong(final long start,
                                 final long end) {
     ...
     */
    static <U, T> ListX<T> unfold(final U seed,
     ...
     */
    static <T> ListX<T> fill(final long limit,
                             final T s) {
     ...
     * @return ListX generated from the provided Supplier
     */
    static <T> ListX<T> generate(final long limit,
                                 final Supplier<T> s) {
     ...
     */
    static <T> ListX<T> iterate(final long limit,
                                final T seed,
    ...
    static <T> Collector<T, ?, List<T>> immutableCollector() {
        return Collectors.collectingAndThen(defaultCollector(),
                                            (final List<T> d) -> Collections.unmodifiableList(d));
     ...
     */
    @SafeVarargs
    static <T> ListX<T> of(final T... values) {
    ...
    static <T> ListX<T> fromIterator(final Iterator<T> it) {
        return fromIterable(() -> it);
    }

    static <T> ListX<T> singleton(final T value) {
     ...
     *
     * @param publisher to construct ListX from
     * @return ListX
     */
    static <T> ListX<T> fromPublisher(final Publisher<T> publisher) {
     ...
     * @return
     */
    static <T> ListX<T> listX(ReactiveSeq<T> stream) {
        return new LazyListX<T>(null,
                                stream,
                                defaultCollector());
    }

    static <T> ListX<T> fromIterable(final Iterable<T> it) {
        if (it instanceof ListX) {
            return (ListX<T>) it;
        }
        if (it instanceof List) {
            return new LazyListX<T>((List<T>) it,
                                    null,
                                    defaultCollector());
        }
    ...
    static <T> ListX<T> fromIterable(final Collector<T, ?, List<T>> collector,
                                     final Iterable<T> it) {
        if (it instanceof ListX) {
     ...
     */
    static <T> ListX<T> narrow(final ListX<? extends T> listX) {
        return (ListX<T>) listX;
    }

    static <T, R> ListX<R> tailRec(T initial,
                                   Function<? super T, ? extends Iterable<? extends Either<T, R>>> fn) {
    ...
    default <R1, R2, R3, R> ListX<R> forEach4(Function<? super T, ? extends Iterable<R1>> stream1,
        ...
        return (ListX) LazyCollectionX.super.forEach4(stream1,
                                                      stream2,
                                                      stream3,
                                                      yieldingFunction);
    }
    ...
    default <R1, R2, R> ListX<R> forEach3(Function<? super T, ? extends Iterable<R1>> stream1,
        ...
        return (ListX) LazyCollectionX.super.forEach3(stream1,
                                                      stream2,
                                                      yieldingFunction);
    }
    ...
    default <R1, R> ListX<R> forEach2(Function<? super T, ? extends Iterable<R1>> stream1,
        ...
        return (ListX) LazyCollectionX.super.forEach2(stream1,
                                                      yieldingFunction);
    }
    ...
    default <T1> ListX<T1> from(final Iterable<T1> c) {
        return ListX.fromIterable(getCollector(),
                                  c);
    }

    @Override
    default <X> ListX<X> fromStream(final ReactiveSeq<X> stream) {
        return new LazyListX<>(null,
    ...
    /**
     * Combine two adjacent elements in a ListX using the supplied BinaryOperator This is a stateful grouping and reduction
     ...
     */
    @Override
    default ListX<T> combine(final BiPredicate<? super T, ? super T> predicate,
                             final BinaryOperator<T> op) {
        return (ListX<T>) LazyCollectionX.super.combine(predicate,
                                                        op);
    }

    @Override
    default ListX<T> combine(final Monoid<T> op,
                             final BiPredicate<? super T, ? super T> predicate) {
        return (ListX<T>) LazyCollectionX.super.combine(op,
                                                        predicate);
    }
     ...
     */
    @Override
    default ListX<T> slice(final long from,
                           final long to) {
        return (ListX<T>) LazyCollectionX.super.slice(from,
                                                      to);
    }
     ...
     */
    @Override
    default <U, R> ListX<R> zip(final Iterable<? extends U> other,
                                final BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (ListX<R>) LazyCollectionX.super.zip(other,
                                                    zipper);
    }
    ...
    @Override
    default <U> ListX<U> scanLeft(final U seed,
                                  final BiFunction<? super U, ? super T, ? extends U> function) {
        return (ListX<U>) LazyCollectionX.super.scanLeft(seed,
                                                         function);
    }
    ...
    @Override
    default <U> ListX<U> scanRight(final U identity,
                                   final BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (ListX<U>) LazyCollectionX.super.scanRight(identity,
                                                          combiner);
    }

    @Override
    default ListX<T> insertAt(final int i,
                              final T element) {
        return from(stream().insertAt(i,
                                      element));
    }

    @Override
    ListX<T> subList(int start,
                     int end);
    ...
    default ListX<T> insertAt(final int i,
        ...
        return fromStream(stream().insertAt(i,
                                            list));
    }
    ...
    default ListX<T> cycle(final Monoid<T> m,
        ...
        return (ListX<T>) LazyCollectionX.super.cycle(m,
                                                      times);
    }
     ...
     */
    @Override
    default <S, U> ListX<Tuple3<T, S, U>> zip3(final Iterable<? extends S> second,
                                               final Iterable<? extends U> third) {

        return (ListX) LazyCollectionX.super.zip3(second,
                                                  third);
    }
     ...
     */
    @Override
    default <T2, T3, T4> ListX<Tuple4<T, T2, T3, T4>> zip4(final Iterable<? extends T2> second,
                                                           final Iterable<? extends T3> third,
                                                           final Iterable<? extends T4> fourth) {

        return (ListX) LazyCollectionX.super.zip4(second,
                                                  third,
                                                  fourth);
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> ListX<C> grouped(final int size,
                                                                         final Supplier<C> supplier) {

        return (ListX<C>) LazyCollectionX.super.grouped(size,
                                                        supplier);
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> ListX<C> groupedWhile(final Predicate<? super T> predicate,
                                                                              final Supplier<C> factory) {

        return (ListX<C>) LazyCollectionX.super.groupedWhile(predicate,
                                                             factory);
    }

    @Override
    default <C extends PersistentCollection<? super T>> ListX<C> groupedUntil(final Predicate<? super T> predicate,
                                                                              final Supplier<C> factory) {

        return (ListX<C>) LazyCollectionX.super.groupedUntil(predicate,
                                                             factory);
    }
    ...
    @Override
    default <R> ListX<R> mergeMap(int maxConcurency,
                                  Function<? super T, ? extends Publisher<? extends R>> fn) {
        return (ListX<R>) LazyCollectionX.super.mergeMap(maxConcurency,
                                                         fn);
    }
    ...
    @Override
    default ListX<T> updateAt(int pos,
                              T value) {
        return (ListX<T>) LazyCollectionX.super.updateAt(pos,
                                                         value);
    }

    @Override
    default ListX<T> insertAt(int pos,
                              ReactiveSeq<? extends T> values) {
        return (ListX<T>) LazyCollectionX.super.insertAt(pos,
                                                         values);
    }
    ...
    @Override
    default ListX<T> deleteBetween(int start,
                                   int end) {
        return (ListX<T>) LazyCollectionX.super.deleteBetween(start,
                                                              end);
    }

    @Override
    default ListX<T> insertStreamAt(int pos,
                                    Stream<T> stream) {
        return (ListX<T>) LazyCollectionX.super.insertStreamAt(pos,
                                                               stream);
    }
    ...
    @Override
    default <EX extends Throwable> ListX<T> recover(Class<EX> exceptionClass,
                                                    final Function<? super EX, ? extends T> fn) {
        return (ListX<T>) LazyCollectionX.super.recover(exceptionClass,
                                                        fn);
    }

    @Override
    default ListX<T> plusLoop(int max,
                              IntFunction<T> value) {
        return (ListX<T>) LazyCollectionX.super.plusLoop(max,
                                                         value);
    }
    ...
    @Override
    default <T2, R> ListX<R> zip(final BiFunction<? super T, ? super T2, ? extends R> fn,
                                 final Publisher<? extends T2> publisher) {
        return (ListX<R>) LazyCollectionX.super.zip(fn,
                                                    publisher);
    }
    ...
    @Override
    default <S, U, R> ListX<R> zip3(final Iterable<? extends S> second,
                                    final Iterable<? extends U> third,
                                    final Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (ListX<R>) LazyCollectionX.super.zip3(second,
                                                     third,
                                                     fn3);
    }

    @Override
    default <T2, T3, T4, R> ListX<R> zip4(final Iterable<? extends T2> second,
                                          final Iterable<? extends T3> third,
                                          final Iterable<? extends T4> fourth,
                                          final Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (ListX<R>) LazyCollectionX.super.zip4(second,
                                                     third,
                                                     fourth,
                                                     fn);
    }
    ...
    default ListX<T> intercalate(List<? extends List<? extends T>> listOfLists) {
        ListX thisListX = this.to()
                              .listX();
        if (listOfLists.isEmpty()) {
            return thisListX;
        } else {
            ListX listOfListsX = ListX.fromIterable(listOfLists);
            return listOfListsX.intersperse(thisListX)
                               .concatMap(x -> x);
        }
    }

    class CompletableListX<T> implements InvocationHandler {
        ...
        public Object invoke(Object proxy,
            ...
            ListX<T> target = future.fold(l -> l,
                                          t -> {
