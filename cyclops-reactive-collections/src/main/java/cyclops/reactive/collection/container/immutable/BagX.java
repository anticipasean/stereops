...
import cyclops.reactive.collection.container.immutable.lazy.impl.LazyPBagX;
...
/**
 * A Lazy and Reactive Wrapper for Pesistent Bags (immutable collections like Sets that can contain duplicates). BagX is lazy -
 * chainging functional operations such as transform / filter / flatMap only results in the toX being traversed once. It is
 * materialized and cached on first access (or via {@link BagX#materialize()}
 * <p>
 * It is also possible to populate BagX asynchronously using reactive-streams publishers such as those created via the {@link
 * Spouts} class
 *
 * @param <T>
 */
public interface BagX<T> extends To<BagX<T>>, PersistentBag<T>, LazyCollectionX<T>, OnEmptySwitch<T, PersistentBag<T>> {
    ...
    static <T> BagX<T> defer(Supplier<BagX<T>> s) {
     ...
     */
    static <T> BagX<T> narrow(final BagX<? extends T> bagX) {
        return (BagX<T>) bagX;
    }
     ...
     * @return Range BagX
     */
    static BagX<Integer> range(final int start,
                               final int end) {
     ...
     * @return Range BagX
     */
    static BagX<Long> rangeLong(final long start,
                                final long end) {
     ...
     */
    static <U, T> BagX<T> unfold(final U seed,
     ...
     */
    static <T> BagX<T> generate(final long limit,
                                final Supplier<T> s) {
     ...
     * @return BagX generated from the provided Supplier
     */
    static <T> BagX<T> fill(final long limit,
                            final T s) {
     ...
     */
    static <T> BagX<T> iterate(final long limit,
                               final T seed,
     ...
     * @return
     */
    static <T> BagX<T> bagX(ReactiveSeq<T> stream) {

        return new LazyPBagX<>(null,
                               stream,
                               Reducers.toPersistentBag(),
                               Evaluation.LAZY);
    }

    static <T> BagX<T> of(final T... values) {
        return new LazyPBagX<>(null,
    ...
    static <T> BagX<T> singleton(final T value) {
        //use concrete type for singleton as used in Reducers
        return new LazyPBagX<>(Bag.of(value),
                               null,
                               Reducers.toPersistentBag(),
                               Evaluation.LAZY);
    }
     ...
     *
     * @param publisher to construct BagX from
     * @return BagX
     */
    static <T> BagX<T> fromPublisher(final Publisher<T> publisher) {
        return Spouts.from(publisher)
                     .to(ReactiveConvertableSequence::converter)
                     .bagX(Evaluation.LAZY);
    }

    static <T> BagX<T> fromIterable(final Iterable<T> iterable) {
        if (iterable instanceof BagX) {
            return (BagX) iterable;
        }
        if (iterable instanceof PersistentBag) {
            return new LazyPBagX<>((PersistentBag) iterable,
                                   null,
                                   Reducers.toPersistentBag(),
                                   Evaluation.LAZY);
        }
    ...
    static <T, R> BagX<R> tailRec(T initial,
                                  Function<? super T, ? extends BagX<? extends Either<T, R>>> fn) {
    ...
    default <R1, R2, R3, R> BagX<R> forEach4(Function<? super T, ? extends Iterable<R1>> stream1,
        ...
        return (BagX) LazyCollectionX.super.forEach4(stream1,
                                                     stream2,
                                                     stream3,
                                                     yieldingFunction);
    }
    ...
    default <R1, R2, R> BagX<R> forEach3(Function<? super T, ? extends Iterable<R1>> stream1,
        ...
        return (BagX) LazyCollectionX.super.forEach3(stream1,
                                                     stream2,
                                                     yieldingFunction);
    }
    ...
    default <R1, R> BagX<R> forEach2(Function<? super T, ? extends Iterable<R1>> stream1,
        ...
        return (BagX) LazyCollectionX.super.forEach2(stream1,
                                                     yieldingFunction);
    }
    ...
    /**
     * Combine two adjacent elements in a BagX using the supplied BinaryOperator This is a stateful grouping & reduction
     ...
     */
    @Override
    default BagX<T> combine(final BiPredicate<? super T, ? super T> predicate,
                            final BinaryOperator<T> op) {
        return (BagX<T>) LazyCollectionX.super.combine(predicate,
                                                       op);
    }

    @Override
    default BagX<T> combine(final Monoid<T> op,
                            final BiPredicate<? super T, ? super T> predicate) {
        return (BagX<T>) LazyCollectionX.super.combine(op,
                                                       predicate);
    }
    ...
    @Override
    BagX<T> plusAll(Iterable<? extends T> list);

    /* (non-Javadoc)
     * @see org.pcollections.PSet#removeValue(java.lang.Object)
     */
    @Override
    BagX<T> removeValue(T e);

    @Override
    BagX<T> removeAll(Iterable<? extends T> list);
     ...
     */
    @Override
    default BagX<T> slice(final long from,
                          final long to) {
        return (BagX<T>) LazyCollectionX.super.slice(from,
                                                     to);
    }
     ...
     */
    @Override
    default <U, R> BagX<R> zip(final Iterable<? extends U> other,
                               final BiFunction<? super T, ? super U, ? extends R> zipper) {

        return (BagX<R>) LazyCollectionX.super.zip(other,
                                                   zipper);
    }
    ...
    @Override
    default <U> BagX<U> scanLeft(final U seed,
                                 final BiFunction<? super U, ? super T, ? extends U> function) {
        return (BagX<U>) LazyCollectionX.super.scanLeft(seed,
                                                        function);
    }
    ...
    @Override
    default <U> BagX<U> scanRight(final U identity,
                                  final BiFunction<? super T, ? super U, ? extends U> combiner) {
        return (BagX<U>) LazyCollectionX.super.scanRight(identity,
                                                         combiner);
    }
     ...
     */
    @Override
    default BagX<T> cycle(final Monoid<T> m,
                          final long times) {

        return (BagX<T>) LazyCollectionX.super.cycle(m,
                                                     times);
    }
     ...
     */
    @Override
    default <S, U> BagX<Tuple3<T, S, U>> zip3(final Iterable<? extends S> second,
                                              final Iterable<? extends U> third) {

        return (BagX) LazyCollectionX.super.zip3(second,
                                                 third);
    }
     ...
     */
    @Override
    default <T2, T3, T4> BagX<Tuple4<T, T2, T3, T4>> zip4(final Iterable<? extends T2> second,
                                                          final Iterable<? extends T3> third,
                                                          final Iterable<? extends T4> fourth) {

        return (BagX) LazyCollectionX.super.zip4(second,
                                                 third,
                                                 fourth);
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> BagX<C> grouped(final int size,
                                                                        final Supplier<C> supplier) {

        return (BagX<C>) LazyCollectionX.super.grouped(size,
                                                       supplier);
    }
    ...
    @Override
    default <C extends PersistentCollection<? super T>> BagX<C> groupedWhile(final Predicate<? super T> predicate,
                                                                             final Supplier<C> factory) {

        return (BagX<C>) LazyCollectionX.super.groupedWhile(predicate,
                                                            factory);
    }

    @Override
    default <C extends PersistentCollection<? super T>> BagX<C> groupedUntil(final Predicate<? super T> predicate,
                                                                             final Supplier<C> factory) {

        return (BagX<C>) LazyCollectionX.super.groupedUntil(predicate,
                                                            factory);
    }
    ...
    @Override
    default <R> BagX<R> mergeMap(int maxConcurency,
                                 Function<? super T, ? extends Publisher<? extends R>> fn) {
        return (BagX<R>) LazyCollectionX.super.mergeMap(maxConcurency,
                                                        fn);
    }
    ...
    @Override
    default BagX<T> updateAt(int pos,
                             T value) {
        return (BagX<T>) LazyCollectionX.super.updateAt(pos,
                                                        value);
    }

    @Override
    default BagX<T> insertAt(int pos,
                             ReactiveSeq<? extends T> values) {
        return (BagX<T>) LazyCollectionX.super.insertAt(pos,
                                                        values);
    }
    ...
    @Override
    default BagX<T> deleteBetween(int start,
                                  int end) {
        return (BagX<T>) LazyCollectionX.super.deleteBetween(start,
                                                             end);
    }

    @Override
    default BagX<T> insertStreamAt(int pos,
                                   Stream<T> stream) {
        return (BagX<T>) LazyCollectionX.super.insertStreamAt(pos,
                                                              stream);
    }
    ...
    @Override
    default <EX extends Throwable> BagX<T> recover(Class<EX> exceptionClass,
                                                   final Function<? super EX, ? extends T> fn) {
        return (BagX<T>) LazyCollectionX.super.recover(exceptionClass,
                                                       fn);
    }

    @Override
    default BagX<T> plusLoop(int max,
                             IntFunction<T> value) {
        return (BagX<T>) LazyCollectionX.super.plusLoop(max,
                                                        value);
    }
    ...
    @Override
    default <T2, R> BagX<R> zip(final BiFunction<? super T, ? super T2, ? extends R> fn,
                                final Publisher<? extends T2> publisher) {
        return (BagX<R>) LazyCollectionX.super.zip(fn,
                                                   publisher);
    }
    ...
    @Override
    default <S, U, R> BagX<R> zip3(final Iterable<? extends S> second,
                                   final Iterable<? extends U> third,
                                   final Function3<? super T, ? super S, ? super U, ? extends R> fn3) {
        return (BagX<R>) LazyCollectionX.super.zip3(second,
                                                    third,
                                                    fn3);
    }

    @Override
    default <T2, T3, T4, R> BagX<R> zip4(final Iterable<? extends T2> second,
                                         final Iterable<? extends T3> third,
                                         final Iterable<? extends T4> fourth,
                                         final Function4<? super T, ? super T2, ? super T3, ? super T4, ? extends R> fn) {
        return (BagX<R>) LazyCollectionX.super.zip4(second,
                                                    third,
                                                    fourth,
                                                    fn);
    }
    ...
    class CompletableBagX<T> implements InvocationHandler {
