...
import cyclops.reactive.collection.function.higherkinded.ReactiveWitness.set;
...
public interface SetX<T> extends To<SetX<T>>, Set<T>, LazyCollectionX<T>, Higher<set, T>, OnEmptySwitch<T, Set<T>> {
    ...
    @Override
    default SetX<Vector<T>> grouped(final int groupSize) {
    ...
    @Override
    default SetX<Vector<T>> groupedUntil(final Predicate<? super T> predicate) {
