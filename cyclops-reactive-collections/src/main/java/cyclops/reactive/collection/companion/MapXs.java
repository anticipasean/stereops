...
public class MapXs {
    ...
    public static <K, V> MapX<K, V> of(final K key,
                                       final V value) {
        return MapX.fromMap(new Builder<K, V>(key,
                                              value).build());
    }
    ...
    public static <K, V> Builder<K, V> map(final K key,
                                           final V value) {
        return new Builder<K, V>(key,
                                 value);
    }
    ...
    public static final class Builder<K, V> {
        ...
        public Builder<K, V> put(final K key,
                                 final V value) {
            build.put(key,
                      value);
            return this;
