 ...
 * @author johnmcclean
 */
public interface CollectionX<T> extends IterableX<T>, Collection<T>, Unwrappable, RecoverableTraversable<T>,
                                        ReactiveTransformable<T>, Unit<T> {
    ...
    default <R> CollectionX<R> retry(final Function<? super T, ? extends R> fn,
        ...
        return (CollectionX<R>) ReactiveTransformable.super.retry(fn,
                                                                  retries,
                                                                  delay,
                                                                  timeUnit);
    }
    ...
    <R> CollectionX<R> mergeMap(int maxConcurecy,
    ...
    @Override
    <C extends PersistentCollection<? super T>> CollectionX<C> grouped(int size,
                                                                       Supplier<C> supplier);
    ...
    @Override
    <C extends PersistentCollection<? super T>> CollectionX<C> groupedWhile(Predicate<? super T> predicate,
                                                                            Supplier<C> factory);


    @Override
    <C extends PersistentCollection<? super T>> CollectionX<C> groupedUntil(Predicate<? super T> predicate,
                                                                            Supplier<C> factory);
    ...
    @Override
    <S, U> CollectionX<Tuple3<T, S, U>> zip3(Iterable<? extends S> second,
                                             Iterable<? extends U> third);


    @Override
    <T2, T3, T4> CollectionX<Tuple4<T, T2, T3, T4>> zip4(Iterable<? extends T2> second,
    ...
    default <T1> T1[] toArray(T1[] a) {
        return stream().toArray(i -> (T1[]) java.lang.reflect.Array.newInstance(a.getClass()
                                                                                 .getComponentType(),
                                                                                i));
    }
    ...
    /**
     * Perform a flatMap operation on this CollectionX. Results from the returned Iterables (from the provided transformation
    ...
    @Override
    CollectionX<T> combine(BiPredicate<? super T, ? super T> predicate,
                           BinaryOperator<T> op);
    ...
    @Override
    <U, R> CollectionX<R> zip(Iterable<? extends U> other,
                              BiFunction<? super T, ? super U, ? extends R> zipper);

    @Override
    <T2, R> CollectionX<R> zip(final BiFunction<? super T, ? super T2, ? extends R> fn,
    ...
    @Override
    <S, U, R> CollectionX<R> zip3(final Iterable<? extends S> second,
                                  final Iterable<? extends U> third,
                                  final Function3<? super T, ? super S, ? super U, ? extends R> fn3);

    <T2, T3, T4, R> CollectionX<R> zip4(final Iterable<? extends T2> second,
     ...
     * </pre>
     *
     * @param iterable1        Nested Stream to iterate over
     * @param iterable2        Nested Stream to iterate over
     * @param iterable3        Nested Stream to iterate over
     ...
     * </pre>
     *
     * @param iterable1        Nested Iterable to iterate over
     * @param yieldingFunction Function with pointers to the current element from both Streams that generates the new elements
     * @return ReactiveSeq with elements generated via nested iteration
     */
