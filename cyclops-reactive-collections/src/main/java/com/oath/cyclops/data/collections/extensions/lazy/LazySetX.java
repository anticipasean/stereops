...
public class LazySetX<T> extends AbstractLazyCollection<T, Set<T>> implements SetX<T> {
    ...
    public LazySetX(Set<T> list,
                    ReactiveSeq<T> seq,
                    Collector<T, ?, Set<T>> collector,
                    Evaluation strict) {
        super(list,
              seq,
              collector,
    ...
    public LazySetX(ReactiveSeq<T> seq,
                    Collector<T, ?, Set<T>> collector,
                    Evaluation strict) {
        super(null,
              seq,
    ...
    public <X> LazySetX<X> fromStream(ReactiveSeq<X> stream) {
        ...
        return new LazySetX<X>((Set) getList(),
