...
public interface FlattenableDisjunctDuetTemplate<W> extends FlattenableDuetTemplate<W>, IterableDisjunctDuetTemplate<W>,
                                                            FilterableDisjunctDuetTemplate<W>, PeekableDisjunctDuetTemplate<W> {
    ...
    @Override
    default <A, B> Duet<W, A, B> filterFirst(Duet<W, A, B> container,
        ...
        return flatMapFirst(container,
                            (A paramA) -> {
                                return condition.test(paramA) ? container : ifNotFitsCondition.apply(paramA);
                            });
    }

    @Override
    default <A, B> Duet<W, A, B> filterSecond(Duet<W, A, B> container,
        ...
        return flatMapSecond(container,
                             (B paramB) -> {
                                 return condition.test(paramB) ? container : ifNotFitsCondition.apply(paramB);
                             });
    }
