...
public interface AnyMs {
    ...
    /**
     * KleisliM arrow : A function that takes an input value t and embeds it inside a monadic context. arrowM makes use of Witness
     * Types to simulate higher-kinded types, and wraps the new monadic type inside an AnyM. AnyM makes use of sub-type
     * polymorphism (Object Orientd inheritance) to define monadic arrow (transform / flatMap etc) on the returned Object (for
     * parametric polymorphism use {@link Functions#arrow}
     *
     * @param w   WitnessType Object: defines the returned monad type (e.g. see {@link Witness.stream} for HKT encoding for
     *            Streams)
    ...
    public static <W extends WitnessType<W>, T> ListT<W, T> liftM(VectorX<T> v,
                                                                  W witness) {
        return ListT.of(witness.adapter()
                               .unit(v));
    }
    ...
    public static <W extends WitnessType<W>, T> ListT<W, T> liftM(ListX<T> l,
                                                                  W witness) {
        return ListT.of(witness.adapter()
                               .unit(l));
    }
    ...
    public static <W extends WitnessType<W>, ST, PT> EitherT<W, ST, PT> liftM(Either<ST, PT> e,
                                                                              W witness) {
        return EitherT.of(witness.adapter()
                                 .unit(e));
    }
    ...
    public static <W extends WitnessType<W>, T> EvalT<W, T> liftM(Eval<T> e,
                                                                  W witness) {
        return EvalT.of(witness.adapter()
                               .unit(e));
    }
    ...
    public static <W extends WitnessType<W>, T> MaybeT<W, T> liftM(Maybe<T> m,
                                                                   W witness) {
        return MaybeT.of(witness.adapter()
                                .unit(m));
    }
    ...
    public static <W extends WitnessType<W>, T> OptionT<W, T> liftM(Option<T> m,
                                                                    W witness) {
        return OptionT.of(witness.adapter()
                                 .unit(m));
    }
    ...
    public static <W extends WitnessType<W>, T> FutureT<W, T> liftM(Future<T> f,
                                                                    W witness) {
        return FutureT.of(witness.adapter()
                                 .unit(f));
    }
    ...
    public static <W extends WitnessType<W>, T> ListT<W, T> liftM(LinkedListX<T> l,
                                                                  W witness) {
        return ListT.of(witness.adapter()
                               .unit(l));
    }
    ...
    public static <T, W extends WitnessType<W>> CompletableFutureT<W, T> liftM(CompletableFuture<T> opt,
                                                                               W witness) {
        return CompletableFutureT.of(witness.adapter()
                                            .unit(opt));
    }
    ...
    public static <T, W extends WitnessType<W>> OptionalT<W, T> liftM(Optional<T> opt,
                                                                      W witness) {
        return OptionalT.of(witness.adapter()
                                   .unit(opt));
    }
    ...
    public static <T> StreamT<reactiveSeq, T> combinationsT(ReactiveSeq<T> s,
                                                            final int size) {
    ...
    public static <W extends WitnessType<W>, T> StreamT<W, T> liftM(ReactiveSeq<T> s,
                                                                    W witness) {
     ...
     * </pre>
     */
    public static <T, S, R> Stream<R> zipAnyM(final Stream<T> stream,
                                              final AnyM<Witness.stream, ? extends S> second,
                                              final BiFunction<? super T, ? super S, ? extends R> zipper) {
        return Streams.zipSequence(stream,
                                   second.to(Witness::stream),
                                   zipper);
    }
