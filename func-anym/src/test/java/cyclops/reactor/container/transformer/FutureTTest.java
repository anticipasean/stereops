...
public class FutureTTest implements Printable {
    ...
    public void setUp() throws Exception {
        ...
        just = AnyMs.liftM(Future.ofResult(10),
                           optional.INSTANCE);
    ...
    public void testWhenFunctionOfQsuperTQextendsRSupplierOfQextendsR() {
        ...
        assertThat(just.fold(i -> i + 1,
                             () -> 20),
                   equalTo(AnyM.ofNullable(11)));
        assertThat(none.fold(i -> i + 1,
                             () -> 20),
                   equalTo(AnyM.ofNullable(null)));
    }
    ...
    public void testConvertTo() {
        AnyM<optional, Stream<Integer>> toStream = just.fold(m -> Stream.of(m),
                                                             () -> Stream.of());

        assertThat(toStream.stream()
                           .flatMap(i -> i)
    ...
    public void testMkString() {
        assertThat(just.mkString(),
                   equalTo("FutureT[Optional[Future[10]]]"));
        assertThat(none.mkString(),
                   equalTo("FutureT[Optional.empty]"));
    }
    ...
    public void testReduceStreamOfQextendsMonoidOfT() {
        Seq<Integer> countAndTotal = just.foldLeft(ListX.of(Reducers.toCountInt(),
                                                            Reducers.toTotalInt()));
    ...
    public void testOrElseThrowSome() {
        ...
        assertThat(just.orElseThrow(() -> new RuntimeException()),
                   equalTo(10));
    }
