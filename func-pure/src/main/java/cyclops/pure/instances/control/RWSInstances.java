...
import static cyclops.pure.control.ReaderWriterState.narrowK;
import static cyclops.pure.control.ReaderWriterState.rws;
...
import cyclops.pure.control.ReaderWriterState;
...
public class RWSInstances {
    ...
    public <R, W, S, T> Active<Higher<Higher<Higher<rws, R>, W>, S>, T> allTypeclasses(ReaderWriterState<R, W, S, T> rws,
                                                                                       R val1,
                                                                                       S val2,
                                                                                       Monoid<W> monoid) {
        return Active.of(rws,
                         RWSInstances.definitions(val1,
                                                  val2,
                                                  monoid));
    }

    public <R, W, S, T, W2, R2> Nested<Higher<Higher<Higher<rws, R>, W>, S>, W2, R2> mapM(ReaderWriterState<R, W, S, T> rws,
                                                                                          R val1,
                                                                                          S val2,
                                                                                          Monoid<W> monoid,
                                                                                          Function<? super T, ? extends Higher<W2, R2>> fn,
                                                                                          InstanceDefinitions<W2> defs) {
        InstanceDefinitions<Higher<Higher<Higher<rws, R>, W>, S>> def1 = RWSInstances.definitions(val1,
                                                                                                  val2,
                                                                                                  monoid);
        ReaderWriterState<R, W, S, Higher<W2, R2>> r = rws.map(fn);
        Higher<Higher<Higher<Higher<rws, R>, W>, S>, Higher<W2, R2>> hkt = r;

        Nested<Higher<Higher<Higher<rws, R>, W>, S>, W2, R2> res = Nested.of(hkt,
                                                                             def1,
                                                                             defs);
        return res;
    }
    ...
    public static <R, W, S, T> Kleisli<Higher<Higher<Higher<rws, R>, W>, S>, ReaderWriterState<R, W, S, T>, T> kindKleisli(Monoid<W> m) {
        return Kleisli.of(RWSInstances.monad(m),
                          ReaderWriterState::widen);
    }
    ...
    public static <R, W, S> InstanceDefinitions<Higher<Higher<Higher<rws, R>, W>, S>> definitions(R val1,
                                                                                                  S val2,
                                                                                                  Monoid<W> monoid) {
        return new InstanceDefinitions<Higher<Higher<Higher<rws, R>, W>, S>>() {
            ...
            public <C2, T> Traverse<Higher<Higher<Higher<rws, R>, W>, S>> traverse() {
                return RWSInstances.traverse(val1,
                                             val2,
                                             monoid);
            }
            ...
            public <T> Foldable<Higher<Higher<Higher<rws, R>, W>, S>> foldable() {
                return RWSInstances.foldable(val1,
                                             val2,
                                             monoid);
            }
    ...
    public static <R, W, S> Functor<Higher<Higher<Higher<rws, R>, W>, S>> functor() {
        return new Functor<Higher<Higher<Higher<rws, R>, W>, S>>() {
            ...
            @Override
            public <T, R2> Higher<Higher<Higher<Higher<rws, R>, W>, S>, R2> map(Function<? super T, ? extends R2> fn,
                                                                                Higher<Higher<Higher<Higher<rws, R>, W>, S>, T> ds) {
    ...
    public static <R1, W, S> Foldable<Higher<Higher<Higher<rws, R1>, W>, S>> foldable(R1 val1,
                                                                                      S val2,
                                                                                      Monoid<W> monoid) {
        return new Foldable<Higher<Higher<Higher<rws, R1>, W>, S>>() {
            @Override
            public <T> T foldRight(Monoid<T> monoid,
                                   Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T> ds) {
                ReaderWriterState<R1, W, S, T> rws = narrowK(ds);
                return rws.run(val1,
                               val2)
                          .transform((a, b, t) -> monoid.fold(t));
            }
            ...
            public <T, R> R foldMap(Monoid<R> mb,
                                    ...
                                    Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T> nestedA) {
                return foldLeft(mb,
    ...
    public static <R1, W, S> Traverse<Higher<Higher<Higher<rws, R1>, W>, S>> traverse(R1 val1,
                                                                                      S val2,
                                                                                      Monoid<W> monoid) {
        return new Traverse<Higher<Higher<Higher<rws, R1>, W>, S>>() {
            @Override
            public <C2, T, R> Higher<C2, Higher<Higher<Higher<Higher<rws, R1>, W>, S>, R>> traverseA(Applicative<C2> applicative,
                                                                                                     Function<? super T, ? extends Higher<C2, R>> fn,
                                                                                                     Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T> ds) {
                ReaderWriterState<R1, W, S, T> rws = narrowK(ds);
                Higher<C2, R> x = rws.run(val1,
                                          val2)
                                     .transform((a, b, t) -> fn.apply(t));
                return applicative.map_(x,
                                        i -> rws((ra, rb) -> tuple(monoid.zero(),
                                                                   rb,
                                                                   i),
                                                 monoid));
            }
            ...
            @Override
            public <C2, T> Higher<C2, Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T>> sequenceA(Applicative<C2> applicative,
                                                                                                  Higher<Higher<Higher<Higher<rws, R1>, W>, S>, Higher<C2, T>> ds) {
            ...
            @Override
            public <T, R> Higher<Higher<Higher<Higher<rws, R1>, W>, S>, R> ap(Higher<Higher<Higher<Higher<rws, R1>, W>, S>, ? extends Function<T, R>> fn,
                                                                              Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T> apply) {
                return RWSInstances.<R1, W, S>applicative(monoid).ap(fn,
                                                                     apply);
            }
            ...
            @Override
            public <T, R> Higher<Higher<Higher<Higher<rws, R1>, W>, S>, R> map(Function<? super T, ? extends R> fn,
                                                                               Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T> ds) {
                return RWSInstances.<R1, W, S>functor().map(fn,
                                                            ds);
            }
        };
    }
    ...
    @AllArgsConstructor
    public static class RWSMonad<R1, W, S> implements Monad<Higher<Higher<Higher<rws, R1>, W>, S>>,
                                                      MonadRec<Higher<Higher<Higher<rws, R1>, W>, S>> {

        private final Monoid<W> monoid;

        @Override
        public <T, R> Higher<Higher<Higher<Higher<rws, R1>, W>, S>, R> flatMap(Function<? super T, ? extends Higher<Higher<Higher<Higher<rws, R1>, W>, S>, R>> fn,
                                                                               Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T> ds) {
        ...
        @Override
        public <T> Higher<Higher<Higher<Higher<rws, R1>, W>, S>, T> unit(T value) {
            return rws((a, s) -> tuple(monoid.zero(),
                                       s,
                                       value),
                       monoid);
        }
        ...
        @Override
        public <T, R> Higher<Higher<Higher<Higher<rws, R1>, W>, S>, R> tailRec(T initial,
                                                                               Function<? super T, ? extends Higher<Higher<Higher<Higher<rws, R1>, W>, S>, ? extends Either<T, R>>> fn) {
