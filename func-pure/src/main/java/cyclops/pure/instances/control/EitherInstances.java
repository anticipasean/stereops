...
import static cyclops.container.control.eager.either.Either.narrowK;
...
public class EitherInstances {
    ...
    @AllArgsConstructor
    public static class EitherTypeclasses<L> implements Monad<Higher<either, L>>, MonadRec<Higher<either, L>>,
        ...
        public <C2, T, R> Higher<C2, Higher<Higher<either, L>, R>> traverseA(Applicative<C2> applicative,
            ...
            return maybe.fold(left -> applicative.unit(Either.left(left)),
                              right -> applicative.map(m -> Either.right(m),
                                                       fn.apply(right)));
        }
        ...
        public <T, R> Higher<Higher<either, L>, R> tailRec(T initial,
            ...
            return Either.tailRec(initial,
                                  fn.andThen(Either::narrowK));
        }
    }
