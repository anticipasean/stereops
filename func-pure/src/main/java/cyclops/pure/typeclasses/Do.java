...
import cyclops.function.predicate.Predicate3;
import cyclops.function.predicate.Predicate4;
import cyclops.function.predicate.Predicate5;
import cyclops.function.predicate.Predicate6;
import cyclops.function.predicate.Predicate7;
import cyclops.function.predicate.Predicate8;
import cyclops.pure.instances.control.StateInstances;
...
public class Do<W> {
    ...
    public <W2, T1> DoNested<W2, T1> __(Functor<W2> f,
                                        Higher<W, Higher<W2, T1>> nested) {
        return new DoNested<>(nested,
                              f);
    }

    public <W2, T1> DoNested<W2, T1> __(Supplier<Functor<W2>> f,
                                        Higher<W, Higher<W2, T1>> nested) {
        return new DoNested<>(nested,
                              f.get());
    }
    ...
    public static class Sequence1<W> {
        ...
        public class DoSequence<W2, T1> {
            ...
            private Higher<W2, Higher<W, T1>> sequenceA(Applicative<W2> applicative) {
                return traverse.sequenceA(applicative,
                                          a);
            }

            public Do<W2>.DoNested<W, T1> traverse(Monad<W2> m1,
                                                   Applicative<W2> applicative) {

                return Do.forEach(m1)
                         .__(traverse,
    ...
    public static class Traverse1<W> {
        ...
        public class DoTraverse<T1> {
            ...
            private <W2, R> Higher<W2, Higher<W, R>> traverse(Applicative<W2> applicative,
                                                              Function<? super T1, ? extends Higher<W2, R>> fn) {
                return traverse.traverseA(applicative,
                                          fn,
                                          a);
            }

            public <W2, R> Do<W2>.DoNested<W, R> traverse(Monad<W2> m1,
                                                          Function<? super T1, ? extends Higher<W2, R>> fn) {
                return Do.forEach(m1)
                         .__(traverse,
                             traverse.traverseA(m1,
                                                fn,
                                                a));
            }

            public <S, R, R2> State<S, R2> traverseS(Function<? super T1, ? extends State<S, R>> fn,
                                                     Function<Higher<W, R>, R2> foldFn) {
                return State.narrowK(traverse(StateInstances.applicative(),
                                              fn))
                            .map(foldFn);

            }

            public <S, R> Tuple2<S, Do<W>.Do1<R>> runTraverseS(Monad<W> monad,
                                                               Function<? super T1, ? extends State<S, R>> fn,
                                                               S val) {
                return traverse.runTraverseS(fn,
                                             a,
                                             val)
                               .map2(i -> Do.forEach(monad)
                                            .__(i));
            }

            public Do<W>.Do1<T1> reverse(Monad<W> monad) {
                return Do.forEach(monad)
                         .__(traverse.reverse(a));
            }

            public <S, R> Tuple2<S, Do<W>.Do1<R>> mapAccumL(Monad<W> monad,
                                                            BiFunction<? super S, ? super T1, ? extends Tuple2<S, R>> f,
                                                            S z) {
                return traverse.mapAccumL(f,
                                          a,
                                          z)
                               .map2(i -> Do.forEach(monad)
                                            .__(i));
            ...
            public <R> R foldMap(Monoid<R> mb,
                                 final Function<? super T1, ? extends R> fn) {
                return traverse.foldMap(mb,
                                        fn,
                                        a);
            }

            public <R> Do<W>.Do1<R> mapWithIndex(Monad<W> monad,
                                                 BiFunction<? super T1, Long, ? extends R> f) {
                return Do.forEach(monad)
                         .__(traverse.mapWithIndex(f,
                                                   a));
            }

            public <W2, T2, R> Do<W>.Do1<R> zipWith(Monad<W> monad,
                                                    Foldable<W2> foldable,
                                                    BiFunction<? super T1, ? super Maybe<T2>, ? extends R> f,
                                                    Higher<W2, T2> ds2) {
                return Do.forEach(monad)
                         .__(traverse.zipWith(foldable,
                                              f,
                                              a,
                                              ds2));
    ...
    public static class Fold1<W> {
        ...
        public class DoFoldable<T1> {
            ...
            public <R> R foldMap(final Monoid<R> mb,
                                 final Function<? super T1, ? extends R> fn) {
                return folds.foldMap(mb,
                                     fn,
                                     a);
            }

            public <R> R foldr(final Function<T1, Function<R, R>> fn,
                               R r) {
                return folds.foldr(fn,
                                   r,
                                   a);
            }
            ...
            public T1 foldRight(Monoid<T1> monoid) {
                return folds.foldRight(monoid,
                                       a);
            }


            public T1 foldRight(T1 identity,
                                BinaryOperator<T1> semigroup) {
                return folds.foldRight(identity,
                                       semigroup,
                                       a);
            }

            public T1 foldLeft(Monoid<T1> monoid) {
                return folds.foldLeft(monoid,
                                      a);
            }

            public T1 foldLeft(T1 identity,
                               BinaryOperator<T1> semigroup) {
                return folds.foldLeft(identity,
                                      semigroup,
                                      a);
            }
            ...
            public T1 intercalate(Monoid<T1> monoid,
                                  T1 value) {
                return seq().intersperse(value)
                            .foldLeft(monoid);
            }
            ...
            public boolean anyMatch(Predicate<? super T1> pred) {
                return folds.anyMatch(pred,
                                      a);
            }

            public boolean allMatch(Predicate<? super T1> pred) {
                return folds.allMatch(pred,
                                      a);
            }
        }
    ...
    public class DoUnfolds {
        ...
        public <R, T> Do1<R> unfold(T b,
                                    Function<? super T, Option<Tuple2<R, T>>> fn) {
            return __(unfolds.unfold(b,
                                     fn));
        }

        public <T> Do1<T> replicate(long n,
                                    T value) {
            return __(unfolds.replicate(n,
                                        value));
        }
    ...
    public class DoNested<W2, T1> {
        ...
        public DoNested(Higher<W, Higher<W2, T1>> nested,
                        Functor<W2> f2) {
            this.nested = nested;
            this.f = Compose.compose(monad,
                                     f2);
        }


        public Do<W2>.Do1<T1> foldK(Foldable<W> folds,
                                    Monad<W2> m2,
                                    MonoidK<W2> monoid) {
            return Do.forEach(m2)
                     .__(() -> folds.foldK(monoid,
                                           nested));
        }

        public Do<W2>.Do1<T1> foldK(Supplier<Foldable<W>> folds,
                                    Supplier<Monad<W2>> m2,
                                    MonoidK<W2> monoid) {
            return foldK(folds.get(),
                         m2.get(),
                         monoid);
        }

        public Do<W>.Do1<T1> foldLeft(Foldable<W2> folds,
                                      Monoid<T1> monoid) {
            return __(() -> monad.map_(nested,
                                       i -> folds.foldLeft(monoid,
                                                           i)));
        }

        public Do<W>.Do1<T1> foldLeft(Supplier<Foldable<W2>> folds,
                                      Monoid<T1> monoid) {
            return foldLeft(folds.get(),
                            monoid);
        }
        ...
        public Do<W2>.DoNested<W, T1> sequence(Traverse<W> traverse,
                                               Monad<W2> monad) {
            return Do.forEach(monad)
                     .__(f.outer(),
                         traverse.sequenceA(monad,
                                            nested));
        }

        public <R1, R2> R2 fold(Function<? super Higher<W, R1>, ? extends R2> fn1,
                                Function<? super Higher<W2, T1>, ? extends R1> fn2) {
            return fn1.apply(monad.map_(nested,
                                        fn2));
        }
    ...
    public class Do1<T1> {
        ...
        public <R> Do1<R> map(Function<? super T1, ? extends R> mapper) {
            return new Do1<R>(() -> monad.map_(a.get(),
                                               mapper));
        }

        public <R> Do1<R> ap(Higher<W, Function<T1, R>> applicative) {
            return new Do1<R>(() -> monad.ap(applicative,
                                             a.get()));
        }

        public Do1<T1> peek(Consumer<? super T1> mapper) {
            return new Do1<>(() -> monad.peek(mapper,
                                              a.get()));
        }

        public <T2, R> Do1<R> zip(Higher<W, T2> fb,
                                  BiFunction<? super T1, ? super T2, ? extends R> f) {
            return new Do1<>(() -> monad.zip(a.get(),
                                             fb,
                                             f));
        }

        public Do1<T1> plus(MonadPlus<W> mp,
                            Higher<W, T1> b) {
            return new Do1<>(() -> mp.plus(a.get(),
                                           b));
        }

        public Do1<T1> plus(Supplier<MonadPlus<W>> mp,
                            Higher<W, T1> b) {
            return plus(mp.get(),
                        b);
        }
        ...
        public Do1<Tuple2<T1, Long>> zipWithIndex(Traverse<W> traverse) {
            return Do.forEach(monad)
                     .__(() -> traverse.zipWithIndex(a.get()));
        }
        ...
        public Do1<T1> guard(MonadZero<W> monadZero,
                             Predicate<? super T1> fn) {
            return new Do1<>(() -> monadZero.filter(fn,
                                                    a.get()));
        }
        ...
        public <R> Do2<R> __fold(Foldable<W> folds,
                                 Function<? super Fold1.DoFoldable, ? extends R> fn) {
            return __(in -> monad.unit(fn.apply(Do.folds(folds)
                                                  .__(a))));
        }

        public <R> Do2<R> __fold(Supplier<Foldable<W>> folds,
                                 Function<? super Fold1.DoFoldable, ? extends R> fn) {
            return __fold(folds.get(),
                          fn);
        }
        ...
        public class Do2<T2> {
            ...
            public <R> Do2<R> map(Function<? super T2, ? extends R> mapper) {
                return new Do2<>(in -> monad.map_(b.apply(in),
                                                  mapper));
            }

            public <R> Do2<R> ap(Higher<W, Function<T2, R>> applicative) {
                return new Do2<R>(in -> monad.ap(applicative,
                                                 b.apply(in)));
            }
            ...
            public <T3, R> Do2<R> zip(Higher<W, T3> fb,
                                      BiFunction<? super T2, ? super T3, ? extends R> f) {
                return new Do2<R>(in -> monad.zip(b.apply(in),
                                                  fb,
                                                  f));
            }
            ...
            public Do2<String> show(Show<W> show) {
                ...
                return new Do2<String>(in -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                 t -> b.apply(t)))));
            }

            public Do3<String> _show(Show<W> show) {

                return new Do3<>((x1, x2) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                 in -> b.apply(in)))));
            }
            ...
            public Do2<T2> guard(MonadZero<W> monadZero,
                                 BiPredicate<? super T1, ? super T2> fn) {
                return new Do2<>(t1 -> monadZero.filter(p -> fn.test(t1,
                                                                     p),
                                                        b.apply(t1)));
            }
            ...
            public <R> Do1<R> yield(BiFunction<? super T1, ? super T2, ? extends R> fn) {
                return Do.forEach(monad)
                         .__(() -> monad.flatMap_(a.get(),
                                                  in -> {

                                                      return monad.map_(b.apply(in),
                                                                        in2 -> fn.apply(in,
                                                                                        in2));
                                                  }));
            }
            ...
            public <R> R fold(Function<? super Higher<W, T2>, ? extends R> fn) {
                return fn.apply(monad.flatMap_(a.get(),
                                               b));
            }
            ...
            public class Do3<T3> {
                ...
                public <R> Do3<R> map(Function<? super T3, ? extends R> mapper) {
                    return new Do3<>((a, b) -> monad.map_(c.apply(a,
                                                                  b),
                                                          mapper));
                }

                public <R> Do3<R> ap(Higher<W, Function<T3, R>> applicative) {
                    return new Do3<R>((a, b) -> monad.ap(applicative,
                                                         c.apply(a,
                                                                 b)));
                }
                ...
                public <T4, R> Do3<R> zip(Higher<W, T4> fb,
                                          BiFunction<? super T3, ? super T4, ? extends R> f) {
                    return new Do3<R>((a, b) -> monad.zip(c.apply(a,
                                                                  b),
                                                          fb,
                                                          f));
                }
                ...
                public Do3<String> show(Show<W> show) {
                    ...
                    return new Do3<String>((a1, b1) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                           t1 -> monad.flatMap_(b.apply(t1),
                                                                                                                t2 -> c.apply(t1,
                                                                                                                              t2))))));
                ...
                public Do4<String> _show(Show<W> show) {
                    return new Do4<>((x1, x2, x3) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                         t1 -> monad.flatMap_(b.apply(t1),
                                                                                                              t2 -> c.apply(t1,
                                                                                                                            t2))))));
                ...
                public Do3<T3> guard(MonadZero<W> monadZero,
                                     Predicate3<? super T1, ? super T2, ? super T3> fn) {
                    return new Do3<>((t1, t2) -> monadZero.filter(p -> fn.test(t1,
                                                                               t2,
                                                                               p),
                                                                  c.apply(t1,
                                                                          t2)));
                    ...
                    return Do.forEach(monad)
                             .__(() -> monad.flatMap_(a.get(),
                                                      in -> {
                                                          ...
                                                          Higher<W, R> hk2 = monad.flatMap_(b.apply(in),
                                                                                            in2 -> {
                                                                                                Higher<W, R> hk3 = monad.map_(c.apply(in,
                                                                                                                                      in2),
                                                                                                                              in3 -> fn.apply(in,
                                                                                                                                              in2,
                                                                                                                                              in3));
                ...
                public <R> R fold(Function<? super Higher<W, T3>, ? extends R> fn) {
                    return fn.apply(monad.flatMap_(a.get(),
                                                   t1 -> {
                                                       return monad.flatMap_(b.apply(t1),
                                                                             t2 -> {
                                                                                 return c.apply(t1,
                                                                                                t2);
                                                                             });
                ...
                public class Do4<T4> {
                    ...
                    public <R> Do4<R> map(Function<? super T4, ? extends R> mapper) {
                        return new Do4<>((a, b, c) -> monad.map_(d.apply(a,
                                                                         b,
                                                                         c),
                                                                 mapper));
                    }
                    ...
                    public <R> Do4<R> ap(Higher<W, Function<T4, R>> applicative) {
                        return new Do4<R>((a, b, c) -> monad.ap(applicative,
                                                                d.apply(a,
                                                                        b,
                                                                        c)));
                    }
                    ...
                    public <T5, R> Do4<R> zip(Higher<W, T5> fb,
                                              BiFunction<? super T4, ? super T5, ? extends R> f) {
                        return new Do4<R>((a, b, c) -> monad.zip(d.apply(a,
                                                                         b,
                                                                         c),
                                                                 fb,
                                                                 f));
                    ...
                    public Do4<String> show(Show<W> show) {
                        return new Do4<String>((a1, b1, c1) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                                   t1 -> monad.flatMap_(b.apply(t1),
                                                                                                                        t2 -> monad.flatMap_(c.apply(t1,
                                                                                                                                                     t2),
                                                                                                                                             t3 -> d.apply(t1,
                                                                                                                                                           t2,
                                                                                                                                                           t3)))))));
                    ...
                    public Do5<String> _show(Show<W> show) {
                        return new Do5<>((x1, x2, x3, x4) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                                 t1 -> monad.flatMap_(b.apply(t1),
                                                                                                                      t2 -> monad.flatMap_(c.apply(t1,
                                                                                                                                                   t2),
                                                                                                                                           t3 -> d.apply(t1,
                    ...
                    public Do4<T4> guard(MonadZero<W> monadZero,
                                         Predicate4<? super T1, ? super T2, ? super T3, ? super T4> fn) {
                        return new Do4<>((t1, t2, t3) -> monadZero.filter(p -> fn.test(t1,
                                                                                       t2,
                                                                                       t3,
                                                                                       p),
                                                                          d.apply(t1,
                        ...
                        return Do.forEach(monad)
                                 .__(() -> monad.flatMap_(a.get(),
                                                          in -> {
                                                              ...
                                                              Higher<W, R> hk2 = monad.flatMap_(b.apply(in),
                                                                                                in2 -> {
                                                                                                    Higher<W, R> hk3 = monad.flatMap_(c.apply(in,
                                                                                                                                              in2),
                                                                                                                                      in3 -> {
                                                                                                                                          Higher<W, R> hk4 = monad.map_(d.apply(in,
                                                                                                                                                                                in2,
                                                                                                                                                                                in3),
                                                                                                                                                                        in4 -> fn.apply(in,
                                                                                                                                                                                        in2,
                    ...
                    public <R> R fold(Function<? super Higher<W, T4>, ? extends R> fn) {
                        return fn.apply(monad.flatMap_(a.get(),
                                                       t1 -> {
                                                           return monad.flatMap_(b.apply(t1),
                                                                                 t2 -> {
                                                                                     return monad.flatMap_(c.apply(t1,
                                                                                                                   t2),
                                                                                                           t3 -> {
                                                                                                               return d.apply(t1,
                                                                                                                              t2,
                    ...
                    public class Do5<T5> {
                        ...
                        public <R> Do5<R> map(Function<? super T5, ? extends R> mapper) {
                            return new Do5<>((a, b, c, d) -> monad.map_(e.apply(a,
                                                                                b,
                                                                                c,
                                                                                d),
                                                                        mapper));
                        ...
                        public <R> Do5<R> ap(Higher<W, Function<T5, R>> applicative) {
                            return new Do5<R>((a, b, c, d) -> monad.ap(applicative,
                                                                       e.apply(a,
                                                                               b,
                                                                               c,
                                                                               d)));
                        ...
                        public <T6, R> Do5<R> zip(Higher<W, T6> fb,
                                                  BiFunction<? super T5, ? super T6, ? extends R> f) {
                            return new Do5<R>((a, b, c, d) -> monad.zip(e.apply(a,
                                                                                b,
                                                                                c,
                                                                                d),
                                                                        fb,
                        ...
                        public Do6<String> _show(Show<W> show) {
                            return new Do6<>((x1, x2, x3, x4, x5) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                                         t1 -> monad.flatMap_(b.apply(t1),
                                                                                                                              t2 -> monad.flatMap_(c.apply(t1,
                                                                                                                                                           t2),
                                                                                                                                                   t3 -> d.apply(t1,
                        ...
                        public Do5<T5> guard(MonadZero<W> monadZero,
                            ...
                            return new Do5<>((t1, t2, t3, t4) -> monadZero.filter(p -> fn.test(t1,
                                                                                               t2,
                                                                                               t3,
                                                                                               t4,
                                                                                               p),
                                                                  ...
                                                                  Higher<W, R> hk2 = monad.flatMap_(b.apply(in),
                                                                                                    in2 -> {
                                                                                                        Higher<W, R> hk3 = monad.flatMap_(c.apply(in,
                                                                                                                                                  in2),
                                                                                                                                          in3 -> {
                                                                                                                                              Higher<W, R> hk4 = monad.flatMap_(d.apply(in,
                                                                                                                                                                                        in2,
                                                                                                                                                                                        in3),
                                                                                                                                                                                in4 -> {
                                                                                                                                                                                    Higher<W, R> hk5 = monad.map_(e.apply(in,
                                                                                                                                                                                                                          in2,
                                                                                                                                                                                                                          in3,
                                                                                                                                                                                                                          in4),
                                                                                                                                                                                                                  in5 -> fn.apply(in,
                                                               ...
                                                               return monad.flatMap_(b.apply(t1),
                                                                                     t2 -> {
                                                                                         return monad.flatMap_(c.apply(t1,
                                                                                                                       t2),
                                                                                                               t3 -> {
                                                                                                                   return monad.flatMap_(d.apply(t1,
                                                                                                                                                 t2,
                                                                                                                                                 t3),
                                                                                                                                         t4 -> {
                                                                                                                                             return e.apply(t1,
                        ...
                        public class Do6<T6> {
                            ...
                            public <R> Do6<R> map(Function<? super T6, ? extends R> mapper) {
                                return new Do6<>((a, b, c, d, e) -> monad.map_(fh.apply(a,
                                                                                        b,
                                                                                        c,
                                                                                        d,
                                                                                        e),
                            ...
                            public <R> Do6<R> ap(Higher<W, Function<T6, R>> applicative) {
                                return new Do6<R>((a, b, c, d, e) -> monad.ap(applicative,
                                                                              fh.apply(a,
                                                                                       b,
                                                                                       c,
                                                                                       d,
                            ...
                            public <T7, R> Do6<R> zip(Higher<W, T7> fb,
                                                      BiFunction<? super T6, ? super T7, ? extends R> fa) {
                                return new Do6<R>((a, b, c, d, e) -> monad.zip(fh.apply(a,
                                                                                        b,
                                                                                        c,
                                                                                        d,
                                                                                        e),
                            ...
                            public Do7<String> _show(Show<W> show) {
                                return new Do7<>((x1, x2, x3, x4, x5, x6) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                                                 t1 -> monad.flatMap_(b.apply(t1),
                                                                                                                                      t2 -> monad.flatMap_(c.apply(t1,
                                                                                                                                                                   t2),
                                                                                                                                                           t3 -> d.apply(t1,
                            ...
                            public Do6<T6> guard(MonadZero<W> monadZero,
                                ...
                                return new Do6<>((t1, t2, t3, t4, t5) -> monadZero.filter(p -> fn.test(t1,
                                                                                                       t2,
                                                                                                       t3,
                                                                                                       t4,
                                                                                                       t5,
                                                                                                            ...
                                                                                                            Higher<W, R> hk3 = monad.flatMap_(c.apply(in,
                                                                                                                                              ...
                                                                                                                                              in3 -> {
                                                                                                                                                  Higher<W, R> hk4 = monad.flatMap_(d.apply(in,
                                                                                                                                                                                            ...
                                                                                                                                                                                            in3),
                                                                                                                                                                                    in4 -> {
                                                                                                                                                                                        Higher<W, R> hk5 = monad.flatMap_(e.apply(in,
                                                                                                                                                                                                                                  in2,
                                                                                                                                                                                                                                  in3,
                                                                                                                                                                                                                                  in4),
                                                                                                                                                                                                                          in5 -> {
                                                                                                                                                                                                                              Higher<W, R> hk6 = monad.map_(fh.apply(in,
                                                                                                                                                                                                                                                                     in2,
                                                                                                                                                                                                                                                                     in3,
                                                                                                                                                                                                                                                                     in4,
                                                                                                                                                                                                                                                                     in5),
                                                                                             ...
                                                                                             return monad.flatMap_(c.apply(t1,
                                                                                                                   ...
                                                                                                                   t3 -> {
                                                                                                                       return monad.flatMap_(d.apply(t1,
                                                                                                                                                     ...
                                                                                                                                                     t3),
                                                                                                                                             t4 -> {
                                                                                                                                                 return monad.flatMap_(e.apply(t1,
                                                                                                                                                                               t2,
                                                                                                                                                                               t3,
                                                                                                                                                                               t4),
                                                                                                                                                                       t5 -> {
                            ...
                            public class Do7<T7> {
                                ...
                                public <R> Do7<R> map(Function<? super T7, ? extends R> mapper) {
                                    return new Do7<>((a, b, c, d, e, f) -> monad.map_(gh.apply(a,
                                                                                               b,
                                                                                               c,
                                                                                               d,
                                                                                               e,
                                ...
                                public <R> Do7<R> ap(Higher<W, Function<T7, R>> applicative) {
                                    return new Do7<R>((a, b, c, d, e, f) -> monad.ap(applicative,
                                                                                     gh.apply(a,
                                                                                              b,
                                                                                              c,
                                                                                              d,
                                ...
                                public <T8, R> Do7<R> zip(Higher<W, T8> fb,
                                                          BiFunction<? super T7, ? super T8, ? extends R> fa) {
                                    return new Do7<R>((a, b, c, d, e, f) -> monad.zip(gh.apply(a,
                                                                                               b,
                                                                                               c,
                                                                                               d,
                                                                                               e,
                                ...
                                public Do8<String> _show(Show<W> show) {
                                    return new Do8<>((x1, x2, x3, x4, x5, x6, x7) -> monad.unit(show.show(monad.flatMap_(a.get(),
                                                                                                                         t1 -> monad.flatMap_(b.apply(t1),
                                                                                                                                              t2 -> monad.flatMap_(c.apply(t1,
                                                                                                                                                                           t2),
                                                                                                                                                                   t3 -> d.apply(t1,
                                ...
                                public Do7<T7> guard(MonadZero<W> monadZero,
                                    ...
                                    return new Do7<>((t1, t2, t3, t4, t5, t6) -> monadZero.filter(p -> fn.test(t1,
                                                                                                               t2,
                                                                                                               t3,
                                                                                                               t4,
                                                                                                               t5,
                                                                                                                                                      ...
                                                                                                                                                      Higher<W, R> hk4 = monad.flatMap_(d.apply(in,
                                                                                                                                                                                        ...
                                                                                                                                                                                        in4 -> {
                                                                                                                                                                                            Higher<W, R> hk5 = monad.flatMap_(e.apply(in,
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      in4),
                                                                                                                                                                                                                              in5 -> {
                                                                                                                                                                                                                                  Higher<W, R> hk6 = monad.flatMap_(fh.apply(in,
                                                                                                                                                                                                                                                                             in2,
                                                                                                                                                                                                                                                                             in3,
                                                                                                                                                                                                                                                                             in4,
                                                                                                                                                                                                                                                                             in5),
                                                                                                                                                                                                                                                                    in6 -> {
                                                                                                                                                                                                                                                                        Higher<W, R> hk7 = monad.map_(gh.apply(in,
                                                                                                                                                                                                                                                                                                               in2,
                                                                                                                                                                                                                                                                                                               in3,
                                                                                                                                                                                                                                                                                                               in4,
                                                                                                                                                                                                                                                                                                               in5,
                                                                                                                           ...
                                                                                                                           return monad.flatMap_(d.apply(t1,
                                                                                                                                                 ...
                                                                                                                                                 t4 -> {
                                                                                                                                                     return monad.flatMap_(e.apply(t1,
                                                                                                                                                                                   ...
                                                                                                                                                                                   t4),
                                                                                                                                                                           t5 -> {
                                                                                                                                                                               return monad.flatMap_(fh.apply(t1,
                                                                                                                                                                                                              t2,
                                                                                                                                                                                                              t3,
                                                                                                                                                                                                              t4,
                                                                                                                                                                                                              t5),
                                ...
                                public class Do8<T8> {
                                    ...
                                    public <R> Do8<R> map(Function<? super T8, ? extends R> mapper) {
                                        return new Do8<>((a, b, c, d, e, f, g) -> monad.map_(eh.apply(a,
                                                                                                      b,
                                                                                                      c,
                                                                                                      d,
                                                                                                      e,
                                    ...
                                    public <R> Do8<R> ap(Higher<W, Function<T8, R>> applicative) {
                                        return new Do8<R>((a, b, c, d, e, f, g) -> monad.ap(applicative,
                                                                                            eh.apply(a,
                                                                                                     b,
                                                                                                     c,
                                                                                                     d,
                                    ...
                                    public <T9, R> Do8<R> zip(Higher<W, T9> fb,
                                                              BiFunction<? super T8, ? super T9, ? extends R> fa) {
                                        return new Do8<R>((a, b, c, d, e, f, g) -> monad.zip(eh.apply(a,
                                                                                                      b,
                                                                                                      c,
                                                                                                      d,
                                                                                                      e,
                                    ...
                                    public Do8<T8> guard(MonadZero<W> monadZero,
                                        ...
                                        return new Do8<>((t1, t2, t3, t4, t5, t6, t7) -> monadZero.filter(p -> fn.test(t1,
                                                                                                                       t2,
                                                                                                                       t3,
                                                                                                                       t4,
                                                                                                                       t5,
                                                                                                                                                                                                ...
                                                                                                                                                                                                Higher<W, R> hk5 = monad.flatMap_(e.apply(in,
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  in5 -> {
                                                                                                                                                                                                                                      Higher<W, R> hk6 = monad.flatMap_(fh.apply(in,
                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                 in5),
                                                                                                                                                                                                                                                                        in6 -> {
                                                                                                                                                                                                                                                                            Higher<W, R> hk7 = monad.flatMap_(gh.apply(in,
                                                                                                                                                                                                                                                                                                                       in2,
                                                                                                                                                                                                                                                                                                                       in3,
                                                                                                                                                                                                                                                                                                                       in4,
                                                                                                                                                                                                                                                                                                                       in5,
                                                                                                                                                                                                                                                                                                                       in6),
                                                                                                                                                                                                                                                                                                              in7 -> {
                                                                                                                                                                                                                                                                                                                  Higher<W, R> hk8 = monad.map_(eh.apply(in,
                                                                                                                                                                                                                                                                                                                                                         in2,
                                                                                                                                                                                                                                                                                                                                                         in3,
                                                                                                                                                                                                                                                                                                                                                         in4,
                                                                                                                                                                                                                                                                                                                                                         in5,
                                                                                                                                                         ...
                                                                                                                                                         return monad.flatMap_(e.apply(t1,
                                                                                                                                                                               ...
                                                                                                                                                                               t5 -> {
                                                                                                                                                                                   return monad.flatMap_(fh.apply(t1,
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  t5),
                                                                                                                                                                                                         t6 -> {
                                                                                                                                                                                                             return monad.flatMap_(gh.apply(t1,
                                                                                                                                                                                                                                            t2,
                                                                                                                                                                                                                                            t3,
                                                                                                                                                                                                                                            t4,
                                                                                                                                                                                                                                            t5,
