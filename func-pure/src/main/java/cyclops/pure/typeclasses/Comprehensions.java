...
public class Comprehensions<W1> {
    ...
    public <T1, T2, T3, R1, R2, R3, R> Higher<W1, R> forEach4(Higher<W1, T1> value1,
        ...
        return monad.flatMap_(value1,
                              in -> {

                                  Higher<W1, R1> a = value2.apply(in);
                                  return monad.flatMap_(a,
                                                        ina -> {
                                                            Higher<W1, R2> b = value3.apply(in,
                                                                                            ina);
                                                            return monad.flatMap_(b,
                                                                                  inb -> {
                                                                                      Higher<W1, R3> c = value4.apply(in,
                                                                                                                      ina,
                                                                                                                      inb);
                                                                                      return monad.map_(c,
    ...
    public <T, R1, R> Higher<W1, R> forEach2(Higher<W1, T> value1,
                                             Function<? super T, ? extends Higher<W1, R1>> value2,
    ...
    public static class Guarded<W1> {
        ...
        public <T1, T2, T3, R1, R2, R3, R> Higher<W1, R> forEach4(Higher<W1, ? extends T1> value1,
            ...
            return monadZero.flatMap_(value1,
                                      in -> {
                                                                        ...
                                                                        return monadZero.flatMap_(b,
                                                                                                  inb -> {
                                                                                                      Higher<W1, R3> c = value4.apply(in,
                                                                                                                                      ina,
                                                                                                                                      inb);
                                                                                                      Higher<W1, R3> x = monadZero.filter_(c,
                                      ...
                                      in -> {
                                          ...
                                          return monadZero.flatMap_(a,
                                                                    ina -> {
                                                                        Higher<W1, R2> b = value3.apply(in,
                                                                                                        ina);
                                                                        Higher<W1, R2> x = monadZero.filter_(b,
                                                                                                             in2 -> filterFunction.apply(in,
                                                                                                                                         ina,
                                                                                                                                         in2));
                                                                        return monadZero.map_(x,
        ...
        public <T, R1, R> Higher<W1, R> forEach2(Higher<W1, ? extends T> value1,
                                                 Function<? super T, ? extends Higher<W1, R1>> value2,
            ...
            return monadZero.flatMap_(value1,
                                      in -> {
                                          ...
                                          Higher<W1, R1> a = value2.apply(in);
                                          Higher<W1, R1> x = monadZero.filter_(a,
                                                                               in2 -> filterFunction.apply(in,
                                                                                                           in2));
                                          return monadZero.map_(x,
                                                                in2 -> yieldingFunction.apply(in,
