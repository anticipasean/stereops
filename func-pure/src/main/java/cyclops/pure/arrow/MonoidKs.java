...
public interface MonoidKs {
    ...
    static MonoidK<optional> optionalPresent() {
        return new MonoidK<optional>() {
            ...
            @Override
            public <T> Higher<optional, T> apply(Higher<optional, T> t1,
                                                 Higher<optional, T> t2) {
                return SemigroupKs.optionalPresent()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<list> listXConcat() {
        return new MonoidK<list>() {
            ...
            @Override
            public <T> Higher<list, T> apply(Higher<list, T> t1,
                                             Higher<list, T> t2) {
                return SemigroupKs.listXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<deque> dequeXConcat() {
        return new MonoidK<deque>() {
            ...
            @Override
            public <T> Higher<deque, T> apply(Higher<deque, T> t1,
                                              Higher<deque, T> t2) {
                return SemigroupKs.dequeXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<set> setXConcat() {
        return new MonoidK<set>() {
            ...
            @Override
            public <T> Higher<set, T> apply(Higher<set, T> t1,
                                            Higher<set, T> t2) {
                return SemigroupKs.setXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<queue> queueXConcat() {
        return new MonoidK<queue>() {
            ...
            @Override
            public <T> Higher<queue, T> apply(Higher<queue, T> t1,
                                              Higher<queue, T> t2) {
                return SemigroupKs.queueXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<linkedListX> linkedListXConcat() {
        return new MonoidK<linkedListX>() {
            ...
            @Override
            public <T> Higher<linkedListX, T> apply(Higher<linkedListX, T> t1,
                                                    Higher<linkedListX, T> t2) {
                return SemigroupKs.linkedListXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<lazySeq> lazySeqConcat() {
        return new MonoidK<lazySeq>() {
            ...
            @Override
            public <T> Higher<lazySeq, T> apply(Higher<lazySeq, T> t1,
                                                Higher<lazySeq, T> t2) {
                return SemigroupKs.lazySeqConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<seq> seqConcat() {
        return new MonoidK<seq>() {
            ...
            @Override
            public <T> Higher<seq, T> apply(Higher<seq, T> t1,
                                            Higher<seq, T> t2) {
                return SemigroupKs.seqConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<vector> vectorConcat() {
        return new MonoidK<vector>() {
            ...
            @Override
            public <T> Higher<vector, T> apply(Higher<vector, T> t1,
                                               Higher<vector, T> t2) {
                return SemigroupKs.vectorConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<vectorX> vectorXConcat() {
        return new MonoidK<vectorX>() {
            ...
            @Override
            public <T> Higher<vectorX, T> apply(Higher<vectorX, T> t1,
                                                Higher<vectorX, T> t2) {
                return SemigroupKs.vectorXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<persistentQueueX> persistentQueueXConcat() {
        return new MonoidK<persistentQueueX>() {
            ...
            @Override
            public <T> Higher<persistentQueueX, T> apply(Higher<persistentQueueX, T> t1,
                                                         Higher<persistentQueueX, T> t2) {
                return SemigroupKs.persistentQueueXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<persistentSetX> persistentSetXConcat() {
        return new MonoidK<persistentSetX>() {
            ...
            @Override
            public <T> Higher<persistentSetX, T> apply(Higher<persistentSetX, T> t1,
                                                       Higher<persistentSetX, T> t2) {
                return SemigroupKs.persistentSetXConcat()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<io> combineIO() {
        return new MonoidK<io>() {
            ...
            @Override
            public <T> Higher<io, T> apply(Higher<io, T> t1,
                                           Higher<io, T> t2) {
                return SemigroupKs.combineIO()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<reactiveSeq> combineReactiveSeq() {
        return new MonoidK<reactiveSeq>() {
            ...
            @Override
            public <T> Higher<reactiveSeq, T> apply(Higher<reactiveSeq, T> t1,
                                                    Higher<reactiveSeq, T> t2) {
                return SemigroupKs.combineReactiveSeq()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<reactiveSeq> firstNonEmptyReactiveSeq() {
        return new MonoidK<reactiveSeq>() {
            ...
            public <T> Higher<reactiveSeq, T> apply(Higher<reactiveSeq, T> t1,
                                                    Higher<reactiveSeq, T> t2) {
                return SemigroupKs.firstNonEmptyReactiveSeq()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<reactiveSeq> ambReactiveSeq() {
        return new MonoidK<reactiveSeq>() {
            ...
            public <T> Higher<reactiveSeq, T> apply(Higher<reactiveSeq, T> t1,
                                                    Higher<reactiveSeq, T> t2) {
                return SemigroupKs.ambReactiveSeq()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<reactiveSeq> mergeLatestReactiveSeq() {
        return new MonoidK<reactiveSeq>() {
            ...
            public <T> Higher<reactiveSeq, T> apply(Higher<reactiveSeq, T> t1,
                                                    Higher<reactiveSeq, T> t2) {
                return SemigroupKs.mergeLatestReactiveSeq()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<stream> combineStream() {
        return new MonoidK<stream>() {
            ...
            @Override
            public <T> Higher<stream, T> apply(Higher<stream, T> t1,
                                               Higher<stream, T> t2) {
                return SemigroupKs.combineStream()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<completableFuture> firstCompleteCompletableFuture() {
        return new MonoidK<completableFuture>() {
            ...
            @Override
            public <T> Higher<completableFuture, T> apply(Higher<completableFuture, T> t1,
                                                          Higher<completableFuture, T> t2) {
                return SemigroupKs.firstCompleteCompletableFuture()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<future> firstCompleteFuture() {
        return new MonoidK<future>() {
            ...
            @Override
            public <T> Higher<future, T> apply(Higher<future, T> t1,
                                               Higher<future, T> t2) {
                return SemigroupKs.firstCompleteFuture()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static MonoidK<future> firstSuccessfulFuture() {
        return new MonoidK<future>() {
            ...
            public <T> Higher<future, T> apply(Higher<future, T> t1,
                                               Higher<future, T> t2) {
                return SemigroupKs.firstSuccessfulFuture()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static <ST> MonoidK<Higher<either, ST>> firstRightEither(ST zero) {
        return new MonoidK<Higher<either, ST>>() {
            ...
            @Override
            public <T> Higher<Higher<either, ST>, T> apply(Higher<Higher<either, ST>, T> t1,
                                                           Higher<Higher<either, ST>, T> t2) {
                return SemigroupKs.<ST>firstRightEither().apply(t1,
                                                                t2);
            }
        };
    }
    ...
    static <ST> MonoidK<Higher<either, ST>> lastRightEither(ST zero) {
        return new MonoidK<Higher<either, ST>>() {
            ...
            public <T> Higher<Higher<either, ST>, T> apply(Higher<Higher<either, ST>, T> t1,
                                                           Higher<Higher<either, ST>, T> t2) {
                return SemigroupKs.<ST>lastRightEither().apply(t1,
                                                               t2);
            }
        };
    }
    ...
    static <X extends Throwable> MonoidK<Higher<tryType, X>> firstTrySuccess(X zero) {
        return new MonoidK<Higher<tryType, X>>() {
            ...
            @Override
            public <T> Higher<Higher<tryType, X>, T> apply(Higher<Higher<tryType, X>, T> t1,
                                                           Higher<Higher<tryType, X>, T> t2) {
                return SemigroupKs.<X>firstTrySuccess().apply(t1,
                                                              t2);
            }
        };
    }
    ...
    static <X extends Throwable> MonoidK<Higher<tryType, X>> lastTrySuccess(X zero) {
        return new MonoidK<Higher<tryType, X>>() {
            ...
            public <T> Higher<Higher<tryType, X>, T> apply(Higher<Higher<tryType, X>, T> t1,
                                                           Higher<Higher<tryType, X>, T> t2) {
                return SemigroupKs.<X>lastTrySuccess().apply(t1,
                                                             t2);
            }
        };
    }
    ...
    static <ST> MonoidK<Higher<ior, ST>> firstPrimaryIor(ST zero) {
        return new MonoidK<Higher<ior, ST>>() {
            ...
            @Override
            public <T> Higher<Higher<ior, ST>, T> apply(Higher<Higher<ior, ST>, T> t1,
                                                        Higher<Higher<ior, ST>, T> t2) {
                return SemigroupKs.<ST>firstPrimaryIor().apply(t1,
                                                               t2);
            }
        };
    }
    ...
    static <ST> MonoidK<Higher<ior, ST>> lastPrimaryIor(ST zero) {
        return new MonoidK<Higher<ior, ST>>() {
            ...
            public <T> Higher<Higher<ior, ST>, T> apply(Higher<Higher<ior, ST>, T> t1,
                                                        Higher<Higher<ior, ST>, T> t2) {
                return SemigroupKs.<ST>lastPrimaryIor().apply(t1,
                                                              t2);
            }
        };
    }
    ...
    static MonoidK<option> firstPresentOption() {
        return new MonoidK<option>() {
            ...
            @Override
            public <T> Higher<option, T> apply(Higher<option, T> t1,
                                               Higher<option, T> t2) {
                return SemigroupKs.firstPresentOption()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static <T> MonoidK<optional> firstPresentOptional() {
        return new MonoidK<optional>() {
            ...
            public <T> Higher<optional, T> apply(Higher<optional, T> t1,
                                                 Higher<optional, T> t2) {
                return SemigroupKs.firstPresentOptional()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static <T> MonoidK<option> lastPresentMaybe() {
        return new MonoidK<option>() {
            ...
            public <T> Higher<option, T> apply(Higher<option, T> t1,
                                               Higher<option, T> t2) {
                return SemigroupKs.lastPresentMaybe()
                                  .apply(t1,
                                         t2);
            }
        };
    ...
    static <T> MonoidK<optional> lastPresentOptional() {
        return new MonoidK<optional>() {
            ...
            public <T> Higher<optional, T> apply(Higher<optional, T> t1,
                                                 Higher<optional, T> t2) {
                return SemigroupKs.lastPresentOptional()
                                  .apply(t1,
                                         t2);
            }
        };
