...
public class FluxManagedTest {
    ...
    public void acquireFailed() {
        Try<String, Throwable> t = FluxManaged.of(Flux.defer(() -> {
    ...
    public void test() throws InterruptedException {
        Managed<Future<Integer>> squashed = Range.range(1,
                                                 ...
                                                 .lazySeq()
                                                 .map(this::resource)
                                                 .foldLeft(FluxManaged.monoid(zipFutures(intSum)));
    ...
    public void checkOpenFlatMap() {
        Try<ManagedTest.Resource, Throwable> t = FluxManaged.of(() -> new ManagedTest.Resource())
                                                            .flatMap(r -> {
                                                                if (r.open) {
                                                                    return Managed.managed(new ManagedTest.Resource());
                                                                }
