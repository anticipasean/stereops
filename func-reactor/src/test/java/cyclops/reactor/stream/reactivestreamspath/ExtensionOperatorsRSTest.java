...
public class ExtensionOperatorsRSTest {
    ...
    public void flatMapStreamFilterSimple() {
        assertThat(FluxReactiveSeq.of(1,
                                      2)
                                  .flatMap(i -> ReactiveSeq.of(i)
                                                           .filter(x -> x < 2))
    ...
    public void subStream() {
        List<Integer> list = FluxReactiveSeq.of(1,
                                                2,
                                                3,
                                                4,
                                                5,
    ...
    public void permuations3() {
        System.out.println(FluxReactiveSeq.of(1,
                                              2,
                                              3)
                                          .permutations()
                                          .map(s -> s.toList())
        ...
        assertThat(FluxReactiveSeq.of(1,
                                  ...
                                  .map(s -> s.toList())
                                  .toList(),
                   equalTo(FluxReactiveSeq.of(FluxReactiveSeq.of(1,
                                                                 2,
                                                                 3),
                                              FluxReactiveSeq.of(1,
                                                                 3,
                                                                 2),
                                              FluxReactiveSeq.of(2,
                                                                 1,
                                                                 3),
                                              FluxReactiveSeq.of(2,
                                                                 3,
                                                                 1),
                                              FluxReactiveSeq.of(3,
                                                                 1,
                                                                 2),
                                              FluxReactiveSeq.of(3,
                                                                 2,
    ...
    public void combinations2() {
        assertThat(FluxReactiveSeq.of(1,
                                  ...
                                  .map(s -> s.toList())
                                  .toList(),
                   equalTo(Arrays.asList(Arrays.asList(1,
                                                       2),
                                         Arrays.asList(1,
                                                       3),
                                         Arrays.asList(2,
    ...
    public void onEmptySwitchEmpty() {
        assertThat(FluxReactiveSeq.of()
                                  .onEmptySwitch(() -> FluxReactiveSeq.of(1,
                                                                          2,
                                                                          3))
                                  .toList(),
    ...
    public void onEmptySwitch() {
        assertThat(FluxReactiveSeq.of(4,
                                      5,
                                      6)
                                  .onEmptySwitch(() -> FluxReactiveSeq.of(1,
                                                                          2,
    ...
    public void elapsedIsPositive() {
        ...
        assertTrue(FluxReactiveSeq.of(1,
                                      2,
                                      3,
                                      4,
                                      5)
    ...
    public void getMultple() {
        assertThat(FluxReactiveSeq.of(1,
                                      ...
                                      5)
                                  .elementAt(2),
                   equalTo(Maybe.just(3)));
    }

    @Test
    public void getMultiple1() {
        assertFalse(FluxReactiveSeq.of(1)
                                   .elementAt(1)
                                   .isPresent());
    }
    ...
    @Test
    public void single2() {
        assertNull(FluxReactiveSeq.of(1,
                                      2)
                                  .single()
                                  .orElse(null));
    }
    ...
    public void limitTime() {
        List<Integer> result = FluxReactiveSeq.of(1,
                                                  2,
                                                  3,
                                                  4,
                                                  5,
    ...
    public void limitTimeEmpty() {
        List<Integer> result = FluxReactiveSeq.<Integer>of().peek(i -> sleep(i * 100))
                                                            .take(1000,
                                                                  TimeUnit.MILLISECONDS)
                                                            .toList();
    ...
    public void endsWithBothEmpty() {
        assertTrue(FluxReactiveSeq.<Integer>of().endsWith(Arrays.asList()));
    }

    @Test
    public void streamable() {
        Streamable<Integer> repeat = FluxReactiveSeq.of(1,
                                                        2,
                                                        3,
                                                        4,
                                                        5,
    ...
    public void testLazy() {
        Collection<Integer> col = FluxReactiveSeq.of(1,
                                                     2,
                                                     3,
                                                     4,
                                                     5)
    ...
    public void testPeek() {
        peek = 0;
        AnyM.fromStream(Stream.of(asList(1,
                                         3)))
    ...
    @Test
    public void testMap() {
        List<Integer> list = AnyM.fromStream(Stream.of(asList(1,
                                                              3)))
                                 .flatMap(c -> AnyM.fromStream(c.stream()))
                                 .stream()
                                 .map(i -> i * 2)
