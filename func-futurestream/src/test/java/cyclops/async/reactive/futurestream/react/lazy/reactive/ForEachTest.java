package cyclops.async.reactive.futurestream.react.lazy.reactive;
...
public class ForEachTest {
    ...
    public void forEachX() {
        ...
        Subscription s = DuplicationTest.of(1,
                                            2,
                                            3)
                                        .forEach(2,
                                                 System.out::println);
    ...
    public void forEachXWithErrors() {
        ...
        FutureStream<Integer> stream = DuplicationTest.of(() -> 1,
                                                          () -> 2,
                                                          () -> 3,
                                                          (Supplier<Integer>) () -> {
                                                          ...
                                                          () -> 4)
                                                      .map(Supplier::get);
        Subscription s = stream.forEach(2,
                                        i -> list.add(i),
                                        e -> error = e);
