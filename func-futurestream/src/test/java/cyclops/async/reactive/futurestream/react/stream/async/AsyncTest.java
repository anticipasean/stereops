package cyclops.async.reactive.futurestream.react.stream.async;
...
public class AsyncTest {
    ...
    public void testSequentialEager() {
        assertThat(SimpleReact.sequentialBuilder()
                              .isAsync(),
                   is(false));
    }
    ...
    public void testSequentialCommonEager() {
        assertThat(SimpleReact.sequentialCommonBuilder()
                              .isAsync(),
                   is(false));
    }
    ...
    public void testParallelLazyInt() {
        assertThat(LazyReact.parallelBuilder(3)
                            .isAsync(),
                   is(true));
    }
    ...
    public void testParallelEager() {
        assertThat(SimpleReact.parallelBuilder()
                              .isAsync(),
                   is(true));
    }
    ...
    public void testParallelEagerInt() {
        assertThat(SimpleReact.parallelBuilder(2)
                              .isAsync(),
                   is(true));
    }
    ...
    public void testParallelCommonEager() {
        assertThat(SimpleReact.parallelCommonBuilder()
                              .isAsync(),
                   is(true));
    }
