...
public class BaseSequentialTest {
    ...
    @Before
    public void setup() {
        empty = LazyReact.sequentialBuilder()
                         .of();
        nonEmpty = LazyReact.sequentialBuilder()
                            .of(1);
    }
    ...
    @Test
    public void dropUntilEmptyInclusive() {
        assertThat(of().dropUntilInclusive(p -> true)
                       .toList(),
                   equalTo(Arrays.asList()));
    }
    ...
    public void presentConvert() {
        ...
        assertTrue(of(1).to(ReactiveConvertableSequence::converter)
                        .optional()
                        .isPresent());
        assertTrue(of(1).to(ReactiveConvertableSequence::converter)
                        .listX()
    ...
    public void testSkipUntilInclusive() {
        ...
        assertEquals(asList(4,
                            5),
                     s.get()
                      .dropUntilInclusive(i -> i % 3 == 0)
                      .toList());
        assertEquals(asList(4,
                            5),
                     s.get()
                      .dropUntilInclusive(i -> i == 3)
                      .toList());
        assertEquals(asList(5),
                     s.get()
                      .dropUntilInclusive(i -> i == 4)
                      .toList());
