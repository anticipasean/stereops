...
public class BatchingInvestigationsTest {
    ...
    public void streamBatch() {
        ...
        queue.streamBatch(new Subscription(),
                          source -> {
             ...
             .filter(l -> l.size() > 0)
             .to(s -> new LazyReact(ThreadPools.getSequential()).fromStream(s))
             .async()
    ...
    public void batchIssueStreamSource() throws InterruptedException {
        ...
        StreamSource.futureStream(queue,
                                  new LazyReact(ThreadPools.getSequential()))
                    .groupedBySizeAndTime(10,
                                          500,
                                          TimeUnit.MILLISECONDS)
    ...
    public void groupedBySizeAndTimeNoQueue() {
        new LazyReact().generate(() -> {
            ...
            return "New message " + System.currentTimeMillis();
                       ...
                       .map(i -> i + "  t " + Thread.currentThread()
                                                    .getId())
                       .groupedBySizeAndTime(10,
                                             500,
                                             TimeUnit.MILLISECONDS)
