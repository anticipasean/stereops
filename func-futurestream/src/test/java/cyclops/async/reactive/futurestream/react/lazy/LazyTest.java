...
public class LazyTest implements Printable {
    ...
    public void subStream() {
        List<Integer> list = LazyReact.sequentialBuilder()
                                      .of(1,
                                          2,
                                          3,
                                          4,
    ...
    public void permuations3() {
        System.out.println(LazyReact.sequentialBuilder()
                                    .of(1,
                                        2,
                                        3)
                                    .permutations()
        ...
        assertThat(LazyReact.sequentialBuilder()
                            ...
                            .map(s -> s.toList())
                            .toList(),
                   equalTo(LazyReact.sequentialBuilder()
                                    .of(LazyReact.sequentialBuilder()
                                                 .of(1,
                                                     2,
                                                     3),
                                        LazyReact.sequentialBuilder()
    ...
    public void iterateTest() {
        ...
        assertThat(new LazyReact().iterate(1,
                                           i -> i + 1)
                                  .limit(5)
                                  .peek(System.out::println)
                                  .to(ReactiveConvertableSequence::converter)
    ...
    public void iterateTest2() {
        LazyReact react = new LazyReact(1,
                                        1);
        for (int x = 0; x < 5000; x++) {
            assertThat(react.iterate(1,
                                     i -> i + 1)
                            .limit(5)
    ...
    public void generateTest() {
        assertThat(new LazyReact().generate(() -> "hello")
                                  ...
                                  .get(),
                   equalTo("hellohellohellohellohello"));
    ...
    public void lazyParallel() {
        assertThat(LazyReact.parallelBuilder()
                            .ofAsync(() -> 1)
                            .map(list -> 1 + 2)
                            .block(),
                   equalTo(Arrays.asList(3)));
