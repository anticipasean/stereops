...
import cyclops.async.reactive.futurestream.react.base.BaseSequentialSeqTest;
...
public class LazySequentialSeqObjectPoolsTest extends BaseSequentialSeqTest {
    ...
    protected <U> FutureStream<U> of(U... array) {
        return new LazyReact(ThreadPools.getCurrentThreadExecutor()).objectPoolingOn()
                                                                    .sync()
                                                                    .of(array);
    }
    ...
    public void iteratorMap() {
        ...
        assertThat(of(1).peek(i -> System.out.println("peek1 " + i))
                        .map(i -> i * 2)
    ...
    public void shouldLazilyFlattenInfiniteStream() throws Exception {
        ...
        assertThat(LazyReact.sequentialCommonBuilder()
                            .iterate(1,
                                     n -> n + 1)
                            .flatMap(i -> Arrays.asList(i,
                                                        0,
                                                        -i)
                                                .stream())
                            .limit(10)
    ...
    public void testZipWithFutures() {
        Stream stream = of("a",
                           "b");
        List<Tuple2<Integer, String>> result = of(1,
                                                  2).actOnFutures()
                                                    .zip(stream)
                                                    .block();
    ...
    public void testZipFuturesWithIndex() {
        ...
        List<Tuple2<String, Long>> result = of("a",
                                               "b").actOnFutures()
                                                   .zipWithIndex()
                                                   .block();
