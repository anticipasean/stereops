...
import cyclops.pure.reactive.collections.mutable.MapX;
...
public abstract class BaseSeqTest {
    ...
    public void batchBySizeAndTimeTime() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            List<Vector<Integer>> list = react(() -> 1,
                                               () -> 2,
                                               () -> 3,
                                               () -> 4,
                                               () -> 5,
    ...
    public void batchByTimeSet() {
        for (int i = 0; i < 5000; i++) {
            List<TreeSet<Integer>> set = ofThread(1,
                                                  1,
                                                  1,
                                                  1,
                                                  1,
    ...
    public void testSorted() {
        FutureStream<Tuple2<Integer, String>> t1 = of(tuple(2,
                                                            "two"),
                                                      tuple(1,
                                                            "replaceWith"));
        ...
        FutureStream<Tuple2<Integer, String>> t2 = of(tuple(2,
                                                            "two"),
                                                      tuple(1,
                                                            "replaceWith"));
        ...
        FutureStream<Tuple2<Integer, String>> t3 = of(tuple(2,
                                                            "two"),
                                                      tuple(1,
                                                            "replaceWith"));
    ...
    public void shouldZipTwoFiniteSequencesOfSameSize() throws Exception {
        ...
        final FutureStream<String> first = of("A",
                                              "B",
                                              "C");
        final FutureStream<Integer> second = of(1,
                                                2,
                                                3);
    ...
    public void testCastException() {
        ...
        assertThat(ex.getClass(),
                   equalTo(ClassCastException.class));
    }
    ...
    public void testCastExceptionOnFail() {
        ...
        of(1,
           ...
           "b",
           3,
           null)//.capture(e-> {e.printStackTrace();ex =e;})
                .peek(it -> System.out.println(it))
                .cast(Integer.class)
                .onFail(e -> {
    ...
    public void testGroupByEager() {
        ImmutableMap<Integer, List<Integer>> mapA = of(1,
                                                       2,
                                                       3,
                                                       4).groupBy(i -> i % 2)
                                                         .map(v -> v.listView());
        ...
        assertThat(map1.get(0),
                   hasItem(2));
        assertThat(map1.get(0),
                   hasItem(4));
        assertThat(map1.get(1),
                   hasItem(1));
        assertThat(map1.get(1),
                   hasItem(3));
    ...
    public void testPartition100() {
        ...
        for (int i = 0; i < 0; i++) {
            Supplier<ReactiveSeq<Tuple2<Integer, Integer>>> s = () -> of(tuple(1,
                                                                               0),
                                                                         tuple(2,
                                                                               1),
                                                                         tuple(3,
            ...
            Tuple2<ReactiveSeq<Tuple2<Integer, Integer>>, ReactiveSeq<Tuple2<Integer, Integer>>> tuple = s.get()
                                                                                                          .partition(t -> t._2()
                                                                                                              < 3);

            Tuple2<ReactiveSeq<Integer>, ReactiveSeq<Integer>> t2 = tuple.transform((v1, v2) -> Tuple.<ReactiveSeq<Integer>, ReactiveSeq<Integer>>tuple(v1.map(t -> t._1()),
                                                                                                                                                        v2.map(t -> t._1())));
    ...
    public void flattenEmptyStream() throws Exception {
        ...
        assertThat(this.<Integer>of(1,
                                    ...
                                    8,
                                    9,
                                    10).flatMap(BaseSeqTest::flatMapFun)
                                       .limit(10)
                                       .collect(Collectors.toList())
                                       .size(),
                   equalTo(asList(2,
