...
public abstract class BaseSequentialSeqTest {
    ...
    public void testGroupByEager() {
        ...
        assertEquals(Option.some(Vector.of(2,
                                           4)),
                     map1.get(0));
        assertEquals(Option.of(Vector.of(1,
                                         3)),
                     map1.get(1));
        assertEquals(2,
                     map1.size());
    ...
    public void splitAtHeadInvestigate() {
        System.out.println("0" + of(1,
                                    ...
                                    3).splitAt(0)
                                      ...
                                      .listX());
        System.out.println("head " + of(1,
                                        2,
                                        3).splitAtHead()
                                          ._1());
        System.out.println("tail " + of(1,
                                        2,
                                        3).splitAtHead()
                                          ._2()
                                          .to(ReactiveConvertableSequence::converter)
    ...
    public void flattenEmptyStream() throws Exception {
        ...
        assertThat(this.<Integer>of(1,
                                    ...
                                    8,
                                    9,
                                    10).flatMap(BaseSequentialSeqTest::flatMapFun)
                                       .limit(10)
                                       .collect(Collectors.toList()),
                   equalTo(asList(2,
                                  3,
