...
public class GeneratorTest {
    ...
    /**
     ...
     @Test public void testGenerate() throws InterruptedException, ExecutionException {
     count =0;
     capture =0;
     ...
     @Test public void testGenerateOffset() throws InterruptedException, ExecutionException {
     count =0;
     ...
     @Test public void testIterate() throws InterruptedException, ExecutionException {
     count =0;
     List<String> strings = new SimpleReact()
     ...
     @Test public void testIterateWithOffset() throws InterruptedException, ExecutionException {
     ...
     @Test public void testIterateDataflowMovingConcurrently() throws InterruptedException, ExecutionException {
     count =0;
     second =0;
     SimpleReactStream s = new SimpleReact()
     .<Integer> react((input) -> {
     ...
     @Test public void testGenerateOverIteratorOptional() throws InterruptedException, ExecutionException {
     ...
     @Test public void testGenerateOverIteratorNull() throws InterruptedException, ExecutionException {
     List<Integer> list = Arrays.asList(1,2,3,4);
     Iterator<Integer> iterator = list.iterator();
     List<String> strings = new SimpleReact()
     .<Integer> react(() -> {
     ...
     @Test public void testGenerateParellel() throws InterruptedException, ExecutionException {
