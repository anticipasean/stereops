...
public class SimpleReactTest {
    ...
    public void streamOfEmpty() {
        List value = BaseSimpleReactStream.empty()
                                          .block();
    ...
    public void streamOfOne() {
        Integer value = BaseSimpleReactStream.of(1)
                                             .block()
                                             .firstValue(null);
        assertThat(value,
                   is(1));
    ...
    public void streamParallelOf() {
        BaseSimpleReactStream value = BaseSimpleReactStream.parallel(1,
                                                                     2);

        assertThat(value.getTaskExecutor(),
                   is(ForkJoinPool.commonPool()));
    }

    @Test
    public void futureStreamIterator() {
        assertThat(BaseSimpleReactStream.simpleReactStream(Arrays.asList(1,
                                                                         2,
                                                                         3,
                                                                         4)
                                                                 .iterator())
    ...
    public void futureStreamIterable() {
        assertThat(BaseSimpleReactStream.simpleReactStreamFromIterable(Arrays.asList(1,
                                                                                     2,
                                                                                     3,
                                                                                     4))
                                        .block()
    ...
    public void futureStreamTest() {
        assertThat(BaseSimpleReactStream.simpleReactStream((Stream) LazyReact.sequentialBuilder()
                                                                             .of(1,
                                                                                 2,
                                                                                 3,
                                                                                 4))
    ...
    public void futureStreamFromStreamTest() {
        assertThat(BaseSimpleReactStream.simpleReactStream(Stream.of(1,
                                                                     2,
                                                                     3,
                                                                     4))
                                        .block()
    ...
    public void syncTest() {
        BaseSimpleReactStream stream = BaseSimpleReactStream.of(1,
                                                                2,
                                                                3,
                                                                4)
                                                            .sync();
        assertThat(stream.isAsync(),
                   is(false));
    }
    ...
    public void whenChainEmptyBlockReturns() {
        new SimpleReact(new ForkJoinPool(1)).from(new ArrayList<>())
                                            .block();
    }
    ...
    public void testLazyParameters() {
        ...
        assertThat(new LazyReact(fjp).getExecutor(),
                   is(fjp));
    }
    ...
    public void testEagetParameters() {
        ForkJoinPool fjp = new ForkJoinPool();
        assertThat(new SimpleReact(fjp).getExecutor(),
                   is(fjp));
    }
    ...
    public void testReact() throws InterruptedException, ExecutionException {
        ...
        List<CompletableFuture<Integer>> futures = new SimpleReact().<Integer>ofAsync(() -> 1,
                                                                                      () -> 2,
                                                                                      () -> 3).with(it -> it * 100);
        ...
        new SimpleReact().fromStream(futures.stream())
                         .block();
    ...
    public void testReactList() throws InterruptedException, ExecutionException {
        ...
        List<CompletableFuture<Integer>> futures = new SimpleReact().<Integer>fromIterableAsync(Arrays.asList(() -> 1,
                                                                                                              () -> 2,
                                                                                                              () -> 3)).with(it ->
                                                                                                                                 it
                                                                                                                                     * 100);
    ...
    public void testReactListWithExtendedSuppliers() throws InterruptedException, ExecutionException {
        ...
        Iterable<DummySupplier> iterable = Arrays.asList(s1,
                                                         s2,
                                                         s3);
        List<CompletableFuture<Integer>> futures = new SimpleReact().<Integer>fromIterableAsync(iterable).with(it -> it * 100);
    ...
    public void testFromStreamAsyncWithExtendedSuppliers() throws InterruptedException, ExecutionException {
        ...
        Stream<DummySupplier> stream = Arrays.asList(s1,
                                                     ...
                                                     s3)
                                             .stream();
        List<CompletableFuture<Integer>> futures = new SimpleReact().<Integer>fromStreamAsync(stream).with(it -> it * 100);
    ...
    public void testReactListFromIteratorAsync() throws InterruptedException, ExecutionException {
        ...
        Iterator<DummySupplier> iterator = Arrays.asList(s1,
                                                         ...
                                                         s3)
                                                 .iterator();
        List<CompletableFuture<Integer>> futures = new SimpleReact().<Integer>fromIteratorAsync(iterator).with(it -> it * 100);
    ...
    public void testMultithreading() throws InterruptedException, ExecutionException {
        ...
        Set<Long> threads = new SimpleReact(new ForkJoinPool(10)).<Integer>ofAsync(() -> 1,
                                                                                   () -> 2,
                                                                                   () -> 3,
                                                                                   () -> 3,
                                                                                   () -> 3,
    ...
    public void testReactString() throws InterruptedException, ExecutionException {
        List<CompletableFuture<String>> futures = new SimpleReact().<Integer>ofAsync(() -> 1,
                                                                                     () -> 2,
                                                                                     () -> 3).with(it -> "*" + it);
    ...
    public void testReactChain() throws InterruptedException, ExecutionException {
        List<String> strings = new SimpleReact().<Integer>ofAsync(() -> 1,
                                                                  () -> 2,
                                                                  () -> 3).then((it) -> it * 100)
                                                                          .then((it) -> "*" + it)
        ...
        assertThat(strings.get(0),
                   is(containsString("*")));
        assertThat(Integer.valueOf(strings.get(0)
                                          .substring(1)),
                   is(greaterThan(99)));
    ...
    public void testGenericExtract() throws InterruptedException, ExecutionException {
        ...
        Set<Integer> result = new SimpleReact().<Integer>ofAsync(() -> 1,
                                                                 () -> 2,
                                                                 () -> 3,
                                                                 () -> 5).then(it -> it
            * 100).<Set<Integer>, Set<Integer>>allOf(Collectors.toSet(),
                                                     (Set<Integer> it) -> {
    ...
    public void testLargeChain() {
        BaseSimpleReactStream builder = new SimpleReact().ofAsync(() -> "Hello",
                                                                  () -> "World");
    ...
    public void testSeparatedChains() {
        BaseSimpleReactStream<String> orgBuilder = new SimpleReact().ofAsync(() -> "Hello",
                                                                             () -> "World");//.split(2);
        ...
        assertThat(completeResults.get(0)
                                  .length(),
                   greaterThan(100));
    }
    ...
    public void testReactMixedTypes() {
        ...
        List<Object> result = new SimpleReact().ofAsync(() -> "Hello",
                                                        () -> list)
                                               .block();
        assertThat(result.size(),
                   is(2));
    ...
    public void testReactPrimitive() {
        List<Boolean> result = new SimpleReact().ofAsync(() -> true,
                                                         () -> true)
                                                .block();
        assertThat(result.size(),
                   is(2));
    ...
    public void testThenPrimitive() {
        List<Boolean> result = new SimpleReact().ofAsync(() -> 1,
                                                         () -> 1)
                                                .then(it -> true)
                                                .block();
        assertThat(result.size(),
    ...
    public void testReactNull() {
        List<String> result = new SimpleReact().ofAsync(() -> null,
                                                        () -> "Hello")
                                               .block();
        assertThat(result.size(),
                   is(2));
    ...
    public void testThenNull() {
        List<String> result = new SimpleReact().ofAsync(() -> "World",
                                                        () -> "Hello")
                                               .then(in -> (String) null)
                                               .block();
        assertThat(result.size(),
    ...
    public void testCustomExecutor() {
        ...
        Mockito.doAnswer((invocation) -> {
            ...
            return null;
               ...
               .when(executor)
               .execute(Matchers.any(Runnable.class));

        new SimpleReact(executor).ofAsync(() -> "Hello",
                                          () -> "World")
                                 .block();
    ...
    public void testBlockInterruption() {
        ...
        final BaseSimpleReactStream<Integer> stage = new SimpleReact().<Integer>ofAsync(() -> 1,
                                                                                        () -> 2,
                                                                                        () -> 3).then((it) -> {
            try {
