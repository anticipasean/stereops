package cyclops.async.reactive.futurestream.react.async.pipes;
...
import cyclops.async.reactive.futurestream.subscriber.QueueBasedSubscriber;
...
public class PipesTest {
    ...
    public void evalIssue() {
        ...
        bus.register("reactor",
                     QueueFactories.<Integer>boundedNonBlockingQueue(1000).build());

        bus.publishTo("reactor",
                      ReactiveSeq.of(10,
                                     20,
                                     30));
    ...
    public void oneOrErrorFinishes() {
        ...
        results.add(bus.oneOrError("reactor")
                       .get());
        results.add(bus.oneOrError("reactor")
                       .get());
        results.add(bus.oneOrError("reactor")
    ...
    public void futureStreamTest() {
        ...
        List<String> res = bus.futureStream("reactor",
                              ...
                              .toOptional()
                              .get()
                              .map(i -> "fan-out toNested handle blocking I/O:" + Thread.currentThread()
                                                                                        .getId() + ":" + i)
                              .toList();
    ...
    public void xValues() throws InterruptedException {
        ...
        pipes.push("hello",
                   "world4");
        q.close();
        assertThat(pipes.xValues("hello",
                                 2),
                   equalTo(ListX.of("world",
                                    "world2")));
        assertThat(pipes.xValues("hello",
                                 2),
                   equalTo(ListX.of("world3",
                                    "world4")));
    ...
    public void nextAsync() {
        ...
        pipes.push("hello",
                   "world2");
        q.close();
        assertThat(pipes.oneOrErrorAsync("hello",
                                         ex)
                        .get(),
                   equalTo(Future.ofResult("world")
                                 .get()));
        assertThat(pipes.oneOrErrorAsync("hello",
                                         ex)
                        .get(),
                   equalTo(Future.ofResult("world2")
                                 .get()));
    }
    ...
    public void oneValueOrError() throws InterruptedException {
        ...
        assertThat(pipes.oneValueOrError("hello")
                        ...
                        .get()
                        .get(),
                   equalTo(Option.some("world")));
        assertThat(pipes.oneValueOrError("hello")
                        .toOptional()
                        .get()
                        .get(),
                   equalTo(Option.some("world2")));
    ...
    public void oneValueOrErrorTryException() throws InterruptedException {
        ...
        assertThat(pipes.oneValueOrError("hello",
                                         Throwable.class),
                   equalTo(Option.some(Try.success("world"))));
        assertThat(pipes.oneValueOrError("hello",
                                         Throwable.class)
                        .toOptional()
                        .get()
    ...
    public void subscribeTo() {
        ...
        QueueBasedSubscriber<String> subscriber = QueueBasedSubscriber.subscriber(c,
                                                                                  2);
        //Queue queue = new Queue();
        pipes.register("hello",
                       subscriber.getQueue());
        pipes.subscribeTo("hello",
                          subscriber,
        ...
        subscriber.getQueue()
                  .close();
        assertThat(subscriber.jdkStream()
                             .findAny()
                             .get(),
                   equalTo("world"));
    ...
    public void publishToSync() throws InterruptedException {
        ...
        pipes.<Integer>register("hello",
                                queue);
        pipes.publishTo("hello",
                        ReactiveSeq.of(1,
                                       2,
                                       3));
        queue.offer(4);
