...
public class FutureStreamImplTest {
    ...
    public void testOnComplete() {
        ...
        try {
            ...
            Thread t2 = new Thread(() -> {
                ((FutureStreamImpl) new LazyReact(10,
                                                  10).fromAdapter(topic)).onComplete(() -> {
    ...
    public void subcribeOnce() {
        ...
        CompletableFuture future1 = CompletableFuture.runAsync(() -> sub1.reactiveStream()
                                                                         .peek(a -> called1.set(true))
                                                                         .forEach(v -> System.out.println("1 -> " + v)));
        CompletableFuture future2 = CompletableFuture.runAsync(() -> sub2.reactiveStream()
                                                                         .peek(a -> called2.set(true))
                                                                         .forEach(v -> System.out.println("2 -> " + v)));
