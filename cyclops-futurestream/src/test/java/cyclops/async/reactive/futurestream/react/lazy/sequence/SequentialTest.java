...
public class SequentialTest {
    ...
    public void startsWith() {
        assertTrue(LazyReact.sequentialBuilder()
                            .of(1,
                                2,
                                3,
                                4)
    ...
    public void onEmptySwitchEmpty() {
        assertThat(LazyReact.sequentialBuilder()
                            .of()
                            .onEmptySwitch(() -> LazyReact.sequentialBuilder()
                                                          .of(1,
                                                              2,
                                                              3))
                            .toList(),
    ...
    public void singleEmpty() {
        Assert.assertNull(LazyReact.sequentialBuilder()
                                   .of()
                                   .singleOrElse(null));
    }
    ...
    public void limitTime() {
        List<Integer> result = LazyReact.sequentialBuilder()
                                        .of(1,
                                            2,
                                            3,
                                            4,
    ...
    public void streamable() {
        Streamable<Integer> repeat = LazyReact.sequentialBuilder()
                                              .of(1,
                                                  2,
                                                  3,
                                                  4,
    ...
    public void testLazy() {
        CollectionX<Integer> col = CollectionX.fromCollection(LazyReact.sequentialBuilder()
                                                                       .of(1,
                                                                           2,
                                                                           3,
                                                                           4,
