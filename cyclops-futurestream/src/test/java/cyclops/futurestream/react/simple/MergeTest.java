...
public class MergeTest {
    ...
    public void testMerge() throws InterruptedException, ExecutionException {
        ...
        List<String> result = stage1.merge(stage2)
                                    .block();
    ...
    public void testMergeTypes() throws InterruptedException, ExecutionException {
        ...
        List<Object> result = SimpleReactStream.<Object>merge(stage1,
                                                              stage2).block();
    ...
    public void mergeAndForkProcessing() {
        ...
        List<String> result1 = stage1.merge(stage2)
                                     .then(it -> it + "*")
                                     .peek(it -> System.out.println(it))
                                     .block();
        List<String> result2 = stage1.merge(stage2)
                                     .then(it -> it + "-")
                                     .block();
