...
public class OperationsOnFuturesTest {
    ...
    public void appendFutures() {
        List<String> result = of(1,
                                 2,
                                 3).actOnFutures()
                                   .appendAllFutures(CompletableFuture.completedFuture(100),
    ...
    public void appendStreamFutures() {
        List<String> result = of(1,
                                 2,
                                 3).actOnFutures()
                                   .appendStreamFutures(Stream.of(CompletableFuture.completedFuture(100),
                                                                  CompletableFuture.completedFuture(200),
                                                                  CompletableFuture.completedFuture(300)))
                                   .map(it -> it + "!!")
                                   .collect(Collectors.toList());
    ...
    public void prependStreamsFutures() {
        Stream<CompletableFuture<Integer>> streamOfFutures = Stream.of(CompletableFuture.completedFuture(100),
                                                                       CompletableFuture.completedFuture(200),
                                                                       CompletableFuture.completedFuture(300));
        List<String> result = of(1,
                                 2,
    ...
    public void prependFutures() {
        ...
        List<String> result = of(1,
                                 2,
                                 3).actOnFutures()
                                   .prependAllFutures(CompletableFuture.completedFuture(100),
                                                      CompletableFuture.completedFuture(200),
                                                      CompletableFuture.completedFuture(300))
                                   .map(it -> it + "!!")
                                   .collect(Collectors.toList());
    ...
    public void zipLfsCombiner() {
        BiFunction<CompletableFuture<Integer>, CompletableFuture<Integer>, CompletableFuture<Tuple2<Integer, Integer>>> combiner = (cf1, cf2) -> cf1.<Integer, Tuple2<Integer, Integer>>thenCombine(cf2,
                                                                                                                                                                                                    (v1, v2) -> tuple(v1,
                                                                                                                                                                                                                      v2));
        List<Tuple2<Integer, Integer>> list = of(1,
                                                 2,
    ...
    public void zipEmpty() throws Exception {
        ...
        final FutureStream<Tuple2<Integer, Integer>> zipped = empty.actOnFutures()
                                                                   .zip(this.<Integer>of());
    ...
    public void shouldReturnEmptySeqWhenZipNonEmptyWithEmpty() throws Exception {
        ...
        final FutureStream<Tuple2<Integer, Integer>> zipped = nonEmpty.actOnFutures()
                                                                      .zip(empty);
    ...
    public void shouldZipTwoFiniteSequencesOfSameSize() throws Exception {
        ...
        FutureStream<Tuple2<String, Integer>> zipped = first.actOnFutures()
                                                            .zip(second);
    ...
    public void testToSet() {
        Set<CompletableFuture<Integer>> list = of(1,
                                                  2,
                                                  3).actOnFutures()
                                                    .toSet();

        List<Integer> joined = list.stream()
                                   .map(f -> f.join())
                                   .collect(Collectors.toList());
        for (Integer i : of(1,
                            2,
    ...
    public void testReduce() {
        ...
        CompletableFuture<Integer> sum = LazyReact.sequentialBuilder()
                                                  .of(1,
                                                      2,
                                                      3)
                                                  .actOnFutures()
                                                  .reduce((cf1, cf2) -> cf1.thenCombine(cf2,
                                                                                        (a, b) -> a + b))
                                                  .get();
    ...
    public void testReduceIdentity() {
        CompletableFuture<Integer> sum = of(1,
                                            2,
                                            3).actOnFutures()
                                              .reduce(CompletableFuture.completedFuture(0),
                                                      (cf1, cf2) -> cf1.thenCombine(cf2,
                                                                                    (a, b) -> a + b));
    ...
    public void testToCollect() {
        List<CompletableFuture<Integer>> list = of(1,
                                                   2,
                                                   3).actOnFutures()
                                                     .collect(Collectors.toList());
    ...
    public void testDuplicate() {
        Tuple2<FutureStream<Integer>, FutureStream<Integer>> copies = of(1,
                                                                         2,
                                                                         3,
                                                                         4,
                                                                         5,
    ...
    public void testZipWithIndex() {
        ...
        assertEquals(asList(tuple("a",
                     ...
                     of("a",
                        "b").zipWithIndex()
                            .toList());
        Assert.assertEquals(asList(tuple("a",
                                         0L),
                                   tuple("b",
                                         1L),
                                   tuple("c",
    ...
    public void testFoldLeft() {
        ...
        BinaryOperator<CompletableFuture<String>> concat = (cf1, cf2) -> cf1.thenCombine(cf2,
                                                                                         String::concat);
        assertTrue(s.get()
                    .actOnFutures()
                    .foldLeft(identity,
