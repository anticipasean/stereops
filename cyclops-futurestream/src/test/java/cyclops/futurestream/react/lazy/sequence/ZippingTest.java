...
public class ZippingTest {
    ...
    @Test
    public void zip() {
        List<Tuple2<Integer, Integer>> list = DuplicationTest.of(1,
                                                                 2,
                                                                 3,
                                                                 4,
                                                                 5,
                                                                 6)
                                                             .zip(DuplicationTest.of(100,
                                                                                     200,
                                                                                     300,
                                                                                     400))
    ...
    @Test
    public void zip3() {
        List<Tuple3<Integer, Integer, Character>> list = DuplicationTest.of(1,
                                                                            2,
                                                                            3,
                                                                            4,
                                                                            5,
                                                                            6)
                                                                        .zip3(DuplicationTest.of(100,
                                                                                                 200,
                                                                                                 300,
                                                                                                 400),
                                                                              DuplicationTest.of('a',
                                                                                                 'b',
                                                                                                 'c'))
                                                                        .peek(it -> System.out.println(it))
    ...
    @Test
    public void zip4() {
        List<Tuple4<Integer, Integer, Character, String>> list = DuplicationTest.of(1,
                                                                                    2,
                                                                                    3,
                                                                                    4,
                                                                                    5,
                                                                                    6)
                                                                                .zip4(DuplicationTest.of(100,
                                                                                                         200,
                                                                                                         300,
                                                                                                         400),
                                                                                      DuplicationTest.of('a',
    ...
    public void shouldZipTwoFiniteSequencesOfSameSize() throws Exception {
        ...
        final ReactiveSeq<String> first = DuplicationTest.of("A",
                                                             "B",
                                                             "C");
        final ReactiveSeq<Integer> second = DuplicationTest.of(1,
                                                               2,
                                                               3);
    ...
    public void testZipDifferingLength() {
        List<Tuple2<Integer, String>> list = DuplicationTest.of(1,
                                                                2)
                                                            .zip(DuplicationTest.of("a",
                                                                                    "b",
                                                                                    "c",
                                                                                    "d"))
                                                            .toList();
    ...
    public void testZipWithIndex() {
        ...
        assertThat(DuplicationTest.of("a")
                                  .zipWithIndex()
                                  .map(t -> t._2())
                                  .findFirst()
                                  .get(),
                   is(0l));
        Assert.assertEquals(asList(Tuple.tuple("a",
                                               0L)),
                            DuplicationTest.of("a")
                                           .zipWithIndex()
                                           .toList());
    ...
    public void testUnzip() {
        ...
        Supplier<ReactiveSeq<Tuple2<Integer, String>>> s = () -> DuplicationTest.of(Tuple.tuple(1,
                                                                                                "a"),
                                                                                    Tuple.tuple(2,
                                                                                                "b"),
                                                                                    Tuple.tuple(3,
    ...
    public void testUnzip3WithLimits() {
        ...
        Supplier<ReactiveSeq<Tuple3<Integer, String, Long>>> s = () -> DuplicationTest.of(new Tuple3(1,
                                                                                                     "a",
                                                                                                     2l),
                                                                                          new Tuple3(2,
                                                                                                     "b",
    ...
    public void testUnzip4() {
        ...
        Supplier<ReactiveSeq<Tuple4<Integer, String, Long, Character>>> s = () -> DuplicationTest.of(new Tuple4(1,
                                                                                                                "a",
                                                                                                                2l,
                                                                                                                'z'),
                                                                                                     new Tuple4(2,
