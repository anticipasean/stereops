...
public class QueueBasedSubscriber<T> implements Subscriber<T> {
     ...
     */
    public static <T> cyclops.reactive.subscriber.QueueBasedSubscriber<T> subscriber(final Counter counter,
                                                                                     final int maxConcurrency) {
        return new cyclops.reactive.subscriber.QueueBasedSubscriber<>(counter,
                                                                      maxConcurrency);
    }
     ...
     * @return QueueBasedSubscriber
     */
    public static <T> cyclops.reactive.subscriber.QueueBasedSubscriber<T> subscriber(final Queue<T> q,
                                                                                     final Counter counter,
                                                                                     final int maxConcurrency) {
        return new cyclops.reactive.subscriber.QueueBasedSubscriber<>(q,
                                                                      counter,
                                                                      maxConcurrency);
    }
     ...
     * @return QueueBasedSubscriber
     */
    public static <T> cyclops.reactive.subscriber.QueueBasedSubscriber<T> subscriber(final QueueFactory<T> factory,
                                                                                     final Counter counter,
                                                                                     final int maxConcurrency) {

        return new cyclops.reactive.subscriber.QueueBasedSubscriber<>(factory,
                                                                      counter,
                                                                      maxConcurrency);
    }

    private Stream<T> genJdkStream() {
        final Continueable subscription = new cyclops.reactive.subscription.Subscription();
