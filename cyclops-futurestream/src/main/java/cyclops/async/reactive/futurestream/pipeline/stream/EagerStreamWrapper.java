...
public class EagerStreamWrapper implements StreamWrapper {
    ...
    public EagerStreamWrapper(final List<CompletableFuture> list,
    ...
    public EagerStreamWrapper(final AsyncList async,
                              final Optional<Consumer<Throwable>> errorHandler) {
        list = null;
        stream = null;
        this.async = async;
    ...
    public EagerStreamWrapper(final Stream<CompletableFuture> stream,
                              final Optional<Consumer<Throwable>> errorHandler) {
        this.stream = stream;
    ...
    public EagerStreamWrapper(final CompletableFuture cf,
                              final Optional<Consumer<Throwable>> errorHandler) {
        async = null;
    ...
    static List<CompletableFuture> collect(final Stream<CompletableFuture> stream,
                                           final Collector c,
                                           final Optional<Consumer<Throwable>> errorHandler) {

        final Function<Throwable, Object> captureFn = t -> {
            BlockingStreamHelper.captureUnwrap(t,
                                               errorHandler);
    ...
    public EagerStreamWrapper withNewStream(final Stream<CompletableFuture> stream,
                                            final SimpleReact simple) {
    ...
    static class AsyncList {
        ...
        public AsyncList(final Stream<CompletableFuture> stream,
            ...
            if (stream instanceof SimpleReactStream) {
                ...
                async = CompletableFuture.supplyAsync(() -> stream.collect(Collectors.toList()),
                                                      service);
            }
        ...
        public AsyncList(final CompletableFuture<Stream<CompletableFuture>> cf,
                         final Executor service) {
