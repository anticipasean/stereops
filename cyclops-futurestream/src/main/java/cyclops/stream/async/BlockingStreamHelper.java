...
import cyclops.internal.react.exceptions.SimpleReactCompletionException;
...
public class BlockingStreamHelper {
    ...
    static <T, A, R> R block(final BlockingStream<T> blocking,
                             final Collector collector,
                             final EagerStreamWrapper lastActive) {
        final Stream<CompletableFuture> stream = lastActive.stream();

        return (R) stream.map((future) -> {
            return getSafe(future,
                           blocking.getErrorHandler());
        })
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    static <R> R block(final BlockingStream blocking,
                       final Collector collector,
                       final LazyStreamWrapper lastActive) {
    ...
    public static void captureUnwrap(final Throwable e,
                                     final Optional<Consumer<Throwable>> errorHandler) {
        if (e instanceof SimpleReactFailedStageException) {
            captureFailedStage((SimpleReactFailedStageException) e,
                               errorHandler);
    ...
    static void capture(final Throwable t,
                        final Optional<Consumer<Throwable>> errorHandler) {
        SimpleReactFailedStageException.matchable(t)
                                       .fold(general -> captureGeneral(general,
                                                                       errorHandler),
                                             sr -> captureFailedStage(sr,
                                                                      errorHandler));
    }

    static Void captureFailedStage(final SimpleReactFailedStageException e,
                                   final Optional<Consumer<Throwable>> errorHandler) {
    ...
    static Void captureGeneral(final Throwable t,
                               final Optional<Consumer<Throwable>> errorHandler) {
    ...
    public static Object throwSafe(final FastFuture next,
                                   final Optional<Consumer<Throwable>> errorHandler) {
        try {
            return next.join();
    ...
    @SuppressWarnings("rawtypes")
    public static Object getSafe(final FastFuture next,
                                 final Optional<Consumer<Throwable>> errorHandler) {
        try {
            return next.join();
        } catch (final SimpleReactCompletionException e) {
    ...
    @SuppressWarnings("rawtypes")
    public static Object extractNonFiltered(final FastFuture next,
                                            final Optional<Consumer<Throwable>> errorHandler) {
    ...
    @SuppressWarnings("rawtypes")
    static Object getSafe(final CompletableFuture next,
                          final Optional<Consumer<Throwable>> errorHandler) {
        try {
            return next.get();
