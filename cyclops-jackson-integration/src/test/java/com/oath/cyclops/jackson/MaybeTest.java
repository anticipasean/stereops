...
public class MaybeTest {
    ...
    public void roundTrip() {
        ...
        Maybe<Integer> des = JacksonUtil.convertFromJson(json,
                                                         Maybe.class);
    ...
    @Test
    public void nothing() {
        assertThat(JacksonUtil.serializeToJson(Maybe.nothing()),
                   equalTo("null"));
    }

    @Test
    public void just() {
        assertThat(JacksonUtil.serializeToJson(Maybe.just(5)),
                   equalTo("5"));
    }
