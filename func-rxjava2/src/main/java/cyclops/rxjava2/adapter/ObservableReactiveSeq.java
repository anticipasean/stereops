...
public interface ObservableReactiveSeq {
    ...
    public static ReactiveSeq<Long> interval(long interval,
                                             TimeUnit unit) {
    ...
    public static ReactiveSeq<Long> interval(long initialDelay,
                                             long period,
                                             TimeUnit unit) {
    ...
    public static ReactiveSeq<Long> interval(long initialDelay,
                                             ...
                                             TimeUnit unit,
                                             Scheduler scheduler) {
        return reactiveSeq(Observable.interval(initialDelay,
                                               period,
                                               unit,
                                               scheduler));
    }
    ...
    public static ReactiveSeq<Integer> range(int start,
                                             int count) {
        return reactiveSeq(Observable.range(start,
                                            count));
    }
    ...
    public static ReactiveSeq<Long> timer(long initialDelay,
                                          long period,
                                          TimeUnit unit) {
        return interval(initialDelay,
                        period,
    ...
    public static ReactiveSeq<Long> timer(long delay,
                                          TimeUnit unit) {
        return timer(delay,
                     unit,
                     Schedulers.computation());
    ...
    public static ReactiveSeq<Long> timer(long delay,
                                          TimeUnit unit,
                                          Scheduler scheduler) {
        return reactiveSeq(Observable.timer(delay,
                                            unit,
                                            scheduler));
    }
