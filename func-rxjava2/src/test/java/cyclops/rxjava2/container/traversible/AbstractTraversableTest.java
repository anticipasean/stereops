package cyclops.rxjava2.container.traversible;
...
public abstract class AbstractTraversableTest {
    ...
    public void testSkipWhile() {
        Supplier<Traversable<Integer>> s = () -> of(1,
                                                    2,
                                                    3,
                                                    4,
                                                    5);
    ...
    @Test
    public void zip() {
        List<Tuple2<Integer, Integer>> list = ((Traversable<Tuple2<Integer, Integer>>) of(1,
                                                                                          2,
                                                                                          3,
                                                                                          4,
                                                                                          5,
    ...
    public void limitTimeEmpty() {
        List<Integer> result = ReactiveSeq.<Integer>of().peek(i -> sleep(i * 100))
                                                        .take(1000,
    ...
    public void zip2of() {
        ...
        List<Tuple2<Integer, Integer>> list = ReactiveSeq.fromIterable(of(1,
                                                                          2,
                                                                          3,
                                                                          4,
                                                                          5,
    ...
    public void zipEmpty() throws Exception {
        ...
        final Traversable<Integer> zipped = this.<Integer>empty().zip(ReactiveSeq.<Integer>of(),
                                                                      (a, b) -> a + b);
        assertTrue(zipped.stream()
                         .collect(java.util.stream.Collectors.toList())
                         .isEmpty());
    }
    ...
    public void shouldReturnEmptySeqWhenZipEmptyWithNonEmpty() throws Exception {
        ...
        final Traversable<Integer> zipped = this.<Integer>empty().zip(of(1,
                                                                         2),
                                                                      (a, b) -> a + b);
        assertTrue(zipped.stream()
                         .collect(java.util.stream.Collectors.toList())
    ...
    public void shouldReturnEmptySeqWhenZipNonEmptyWithEmpty() throws Exception {
        ...
        final Traversable<Integer> zipped = of(1,
                                               2,
    ...
    public void shouldZipTwoFiniteSequencesOfSameSize() throws Exception {
        ...
        final Traversable<String> first = of("A",
                                             "B",
                                             "C");
        final Traversable<Integer> second = of(1,
                                               2,
                                               3);

        final Traversable<String> zipped = first.zip(second,
                                                     (a, b) -> a + b);

        assertThat(zipped.stream()
                         .collect(java.util.stream.Collectors.toList())
                         .size(),
                   is(3));
    }
    ...
    public void testZipDifferingLength() {
        List<Tuple2<Integer, String>> list = ReactiveSeq.fromIterable(of(1,
                                                                         2).zip(of("a",
                                                                                   "b",
                                                                                   "c",
                                                                                   "d").stream())
    ...
    public void testSorted() {
        ...
        Traversable<Tuple2<Integer, Integer>> t1 = of(tuple(2,
                                                            2),
                                                      tuple(1,
                                                            1));

        List<Tuple2<Integer, Integer>> s1 = t1.sorted()
                                              .stream()
                                              .toList();
        ...
        Traversable<Tuple2<Integer, String>> t2 = of(tuple(2,
                                                           "two"),
                                                     tuple(1,
                                                           "replaceWith"));
        ...
        Traversable<Tuple2<Integer, String>> t3 = of(tuple(2,
                                                           "two"),
                                                     tuple(1,
                                                           "replaceWith"));
