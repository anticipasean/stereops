...
public class SingleTTest implements Printable {
    ...
    public void optionalVMaybe() {
        ...
        just(10).map(i -> print("maybe " + (i + 10)));
    ...
    public void testMkString() {
        assertThat(just.mkString(),
                   containsString("SingleT[Optional[io.reactivex.internal.operators.single.SingleJust"));
        assertThat(none.mkString(),
                   equalTo("SingleT[Optional.empty]"));
    }
